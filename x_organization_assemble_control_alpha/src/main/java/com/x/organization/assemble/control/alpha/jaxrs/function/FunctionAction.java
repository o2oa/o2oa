package com.x.organization.assemble.control.alpha.jaxrs.function;
...
public class FunctionAction extends StandardJaxrsAction {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response setText(@Context HttpServletRequest request, @PathParam("attribute") String attribute,
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response createPassword(@Context HttpServletRequest request, @PathParam("attribute") String attribute) {
		ActionResult<WrapOutCount> result = new ActionResult<>();
		try {
