...
public class ActionInput extends ActionBase {

	private static Logger logger = LoggerFactory.getLogger(ActionInput.class);

	protected ActionResult<FileWo> execute(EffectivePerson effectivePerson, byte[] bytes,
		...
		try (InputStream is = new ByteArrayInputStream(bytes);
			...
			workbook.write(os);
			FileWo wo = new FileWo(os.toByteArray(), this.contentType(false, name),
