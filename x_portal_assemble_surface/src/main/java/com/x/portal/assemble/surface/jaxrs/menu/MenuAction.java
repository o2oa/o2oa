...
@Path("menu")
public class MenuAction extends AbstractJaxrsAction {

	private static Logger logger = LoggerFactory.getLogger(MenuAction.class);

	@HttpMethodDescribe(value = "获取Menu内容.", response = WrapOutMenu.class)
	@GET
	@Path("{id}")
	...
	@HttpMethodDescribe(value = "列示属于指定Portal的Menu.", response = WrapOutMenu.class)
	@GET
