...
class ActionListCountCompletedTaskByApplication extends ActionListCountCompletedTask {
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			for (DateRange o : os) {
				...
				for (ApplicationStub stub : this.listStub()) {
					...
					Long count = this.count(business, o, stub.getValue(), HttpAttribute.x_empty_symbol,
