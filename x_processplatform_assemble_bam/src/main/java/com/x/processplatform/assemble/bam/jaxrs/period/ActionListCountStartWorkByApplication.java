...
class ActionListCountStartWorkByApplication extends ActionListCountStartWork {
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			for (DateRange o : os) {
				...
				for (ApplicationStub stub : this.listStub()) {
					...
					p.put("count", this.count(business, o, stub.getValue(), HttpAttribute.x_empty_symbol, companyName,
