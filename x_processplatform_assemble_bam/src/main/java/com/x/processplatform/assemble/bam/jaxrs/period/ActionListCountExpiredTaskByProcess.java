...
class ActionListCountExpiredTaskByProcess extends ActionListCountExpiredTask {
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			for (DateRange o : os) {
				...
				for (ProcessStub stub : this.listStub(applicationId)) {
					...
					p.put("count", this.count(business, o, applicationId, stub.getValue(), HttpAttribute.x_empty_symbol,
