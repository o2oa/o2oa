...
public class Review_ extends SliceJpaObject_  {
    public static volatile SingularAttribute<Review,String> activity;
    public static volatile SingularAttribute<Review,String> activityName;
    public static volatile SingularAttribute<Review,String> activityToken;
    public static volatile SingularAttribute<Review,ActivityType> activityType;
    ...
    public static volatile SingularAttribute<Review,String> company;
    public static volatile SingularAttribute<Review,Boolean> completed;
    public static volatile SingularAttribute<Review,Date> createTime;
    public static volatile SingularAttribute<Review,String> creatorCompany;
    public static volatile SingularAttribute<Review,String> creatorDepartment;
    ...
    public static volatile SingularAttribute<Review,String> department;
    public static volatile SingularAttribute<Review,String> id;
    public static volatile SingularAttribute<Review,String> identity;
    ...
    public static volatile SingularAttribute<Review,ReviewType> reviewType;
    public static volatile SingularAttribute<Review,String> sequence;
    ...
    public static volatile SingularAttribute<Review,Date> updateTime;
