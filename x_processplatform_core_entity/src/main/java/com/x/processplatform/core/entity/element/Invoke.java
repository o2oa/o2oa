...
@Entity
@ContainerEntity
@Table(name = PersistenceProperties.Element.Invoke.table)
...
public class Invoke extends Activity {
	...
	@EntityFieldDescribe("调用方式.")
	@Enumerated(EnumType.STRING)
	@Column(length = InvokeMode.length, name = "xinvokeMode")
	@CheckPersist(allowEmpty = true)
	private InvokeMode invokeMode;

	@EntityFieldDescribe("jaxws地址")
	@Column(length = JpaObject.length_255B, name = "xjaxwsAddress")
	@CheckPersist(allowEmpty = true)
	private String jaxwsAddress;

	@EntityFieldDescribe("jaxws调用方法")
	@Column(length = JpaObject.length_128B, name = "xjaxwsMethod")
	@CheckPersist(allowEmpty = true)
	private String jaxwsMethod;

	@EntityFieldDescribe("jaxws参数脚本.")
	@Column(length = AbstractPersistenceProperties.processPlatform_name_length, name = "xjaxwsParameterScript")
	@CheckPersist(allowEmpty = true)
	private String jaxwsParameterScript;

	@EntityFieldDescribe("jaxws参数脚本文本.")
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = JpaObject.length_1M, name = "xjaxwsParameterScriptText")
	@CheckPersist(allowEmpty = true)
	private String jaxwsParameterScriptText;

	@EntityFieldDescribe("路由查询后事件脚本.")
	@Column(length = AbstractPersistenceProperties.processPlatform_name_length, name = "xjaxwsResponseScript")
	@CheckPersist(allowEmpty = true)
	...
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = JpaObject.length_1M, name = "xjaxwsResponseScriptText")
	@CheckPersist(allowEmpty = true)
	private String jaxwsResponseScriptText;

	@EntityFieldDescribe("jaxrs地址")
	@Column(length = JpaObject.length_255B, name = "xjaxrsAddress")
	@CheckPersist(allowEmpty = true)
	private String jaxrsAddress;

	@EntityFieldDescribe("jaxrs方式")
	@Column(length = JpaObject.length_8B, name = "xjaxrsMethod")
	@CheckPersist(allowEmpty = true)
	private String jaxrsMethod;

	@EntityFieldDescribe("jaxrs参数脚本.")
	@Column(length = AbstractPersistenceProperties.processPlatform_name_length, name = "xjaxrsParameterScript")
	@CheckPersist(allowEmpty = true)
	private String jaxrsParameterScript;

	@EntityFieldDescribe("jaxrs参数脚本文本.")
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = JpaObject.length_1M, name = "xjaxrsParameterScriptText")
	@CheckPersist(allowEmpty = true)
	private String jaxrsParameterScriptText;

	@EntityFieldDescribe("jaxrs数据脚本.")
	@Column(length = AbstractPersistenceProperties.processPlatform_name_length, name = "xjaxrsBodyScript")
	@CheckPersist(allowEmpty = true)
	...
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = JpaObject.length_1M, name = "xjaxrsBodyScriptText")
	@CheckPersist(allowEmpty = true)
	private String jaxrsBodyScriptText;

	@EntityFieldDescribe("发送请求的类型")
	@Column(length = JpaObject.length_128B, name = "xjaxrsContentType")
	@CheckPersist(allowEmpty = true)
	private String jaxrsContentType;

	@EntityFieldDescribe("jaxrs响应脚本.")
	@Column(length = AbstractPersistenceProperties.processPlatform_name_length, name = "xjaxrsResponseScript")
	@CheckPersist(allowEmpty = true)
	private String jaxrsResponseScript;

	@EntityFieldDescribe("jaxrs响应脚本文本.")
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = JpaObject.length_1M, name = "xjaxrsResponseScriptText")
	@CheckPersist(allowEmpty = true)
	private String jaxrsResponseScriptText;

	@EntityFieldDescribe("是否附带cipher内容")
