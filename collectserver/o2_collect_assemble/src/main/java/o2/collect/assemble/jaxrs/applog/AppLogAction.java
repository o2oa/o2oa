...
@Path("applog")
@JaxrsDescribe("app日志")
public class AppLogAction extends StandardJaxrsAction {

	private static Logger logger = LoggerFactory.getLogger(AppLogAction.class);
	...
	@JaxrsMethodDescribe(value = "列示AppLog对象,下一页.", action = ActionListNext.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "列示AppLog对象,上一页.", action = ActionListPrev.class)
	@GET
