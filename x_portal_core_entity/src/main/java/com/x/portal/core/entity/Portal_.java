...
public class Portal_ extends SliceJpaObject_  {
    ...
    public static volatile ListAttribute<Portal,String> availableCompanyList;
    public static volatile ListAttribute<Portal,String> availableDepartmentList;
    ...
    public static volatile SingularAttribute<Portal,Date> createTime;
    ...
    public static volatile SingularAttribute<Portal,String> sequence;
    public static volatile SingularAttribute<Portal,Date> updateTime;
}
