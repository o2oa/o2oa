...
class ActionListNextWithReferenceType extends ActionBase {
	ActionResult<List<WrapOutFile>> execute(EffectivePerson effectivePerson, String id, Integer count,
		...
		result = this.standardListNext(copier, id, count, "sequence", equals, null, null, null, null, null, null, true,
				DESC);
		return result;
	}
}
