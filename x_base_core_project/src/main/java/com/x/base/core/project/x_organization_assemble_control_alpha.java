...
public class x_organization_assemble_control_alpha extends Assemble {

	public static final String name = "组织管理alpha";
	...
	public static void main(String[] args) {
		try {
			...
			x_organization_assemble_control_alpha o = new x_organization_assemble_control_alpha();
