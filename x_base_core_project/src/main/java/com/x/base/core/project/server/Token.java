...
public class Token {
	...
	public String getInitialManager() {
		return Objects.toString(this.initialManager, defaultInitialManager);
	}

	public String getSso() {
		return Objects.toString(this.sso, initPassword);
	}
	...
	public InitialManager initialManagerInstance() {
		...
		o.roleList.add(RoleDefinition.CompanyCreator);
		o.roleList.add(RoleDefinition.GroupCreator);
		o.roleList.add(RoleDefinition.Manager);
		o.roleList.add(RoleDefinition.MeetingManager);
		o.roleList.add(RoleDefinition.PersonManager);
		o.roleList.add(RoleDefinition.ProcessPlatformCreator);
		o.roleList.add(RoleDefinition.ProcessPlatformManager);
		return o;
	}
