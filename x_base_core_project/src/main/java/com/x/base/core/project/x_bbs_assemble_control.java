...
public class x_bbs_assemble_control extends Assemble {
	...
	static {
		...
		containerEntities.add("com.x.bbs.entity.BBSSubjectPictureBase64");
		...
		containerEntities.add("com.x.bbs.entity.BBSVoteOptionBinary");
