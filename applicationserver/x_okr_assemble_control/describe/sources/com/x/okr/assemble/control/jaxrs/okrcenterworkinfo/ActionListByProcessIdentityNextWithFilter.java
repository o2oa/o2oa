...
public class ActionListByProcessIdentityNextWithFilter extends BaseAction {

	private static  Logger logger = LoggerFactory.getLogger( ActionListByProcessIdentityNextWithFilter.class );
