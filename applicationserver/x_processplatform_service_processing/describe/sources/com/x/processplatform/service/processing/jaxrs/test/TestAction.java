...
public class TestAction extends StandardJaxrsAction {
	...
	public void scanUrge(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void scanExpire(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void delayTrigger(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void scanTrigger(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request) {
