...
public class UserManagerService {
	...
	public String getShortNameWithPersonName(String targetPerson) throws Exception {
		Business business = null;
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			business = new Business(emc);
			if( StringUtils.isNotEmpty( targetPerson ) ) {
				Person person = business.organization().person().getObject(targetPerson);
				if( person != null ) {
	...
	public String getShortNameWithUnitName(String unitName) throws Exception {
		Business business = null;
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			business = new Business(emc);
	...
	public List<String> listPersonWithDutyAndUnitName( String unitName, String dutyName ) throws Exception {
		Business business = null;
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			business = new Business(emc);
			if( StringUtils.isNotEmpty( unitName ) && StringUtils.isNotEmpty( dutyName ) ) {
	...
	public String getPersonWithDutyAndUnitName( String unitName, String dutyName ) throws Exception {
		List<String> personNames = listPersonWithDutyAndUnitName( unitName, dutyName );
		if( ListTools.isNotEmpty( personNames )) {
