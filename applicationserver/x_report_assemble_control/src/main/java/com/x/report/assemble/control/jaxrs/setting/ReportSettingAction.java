...
public class ReportSettingAction extends StandardJaxrsAction{
	
	private static Logger logger = LoggerFactory.getLogger( ReportSettingAction.class );
	...
	public Response listAllReportSetting(@Context HttpServletRequest request ) {
