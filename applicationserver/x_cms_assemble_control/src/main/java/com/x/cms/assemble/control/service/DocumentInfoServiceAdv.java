...
public class DocumentInfoServiceAdv {
	...
	public Long countWithCondition( List<String> viewAbleCategoryIds, String title, List<String> publisherList, 
			List<String> createDateList,  List<String> publishDateList,  List<String> statusList, String documentType, List<String> importBatchNames, List<String> personNames, 
			List<String> unitNames, List<String> groupNames, List<String> extensionStringList, List<String> extensionDoubleList, List<String> extensionBooleanList, 
		...
		try ( EntityManagerContainer emc = EntityManagerContainerFactory.instance().create() ) {
			return documentInfoService.countWithCondition( emc, viewAbleCategoryIds, title, publisherList, createDateList, publishDateList, 
					statusList, documentType, importBatchNames, personNames, unitNames, groupNames, extensionStringList, extensionDoubleList, extensionBooleanList, manager );
		} catch ( Exception e ) {
			throw e;
		}
	}
	...
	public List<Document> listNextWithCondition(String id, Integer count, List<String> viewAbleCategoryIds, String title, List<String> publisherList, 
			List<String> createDateList,  List<String> publishDateList,  List<String> statusList, String documentType, List<String> importBatchNames, List<String> personNames, 
			List<String> unitNames, List<String> groupNames,  String orderField, String order, List<String> extensionStringList, List<String> extensionDoubleList, 
			List<String> extensionBooleanList, Boolean manager) throws Exception {
		if( ListTools.isEmpty( viewAbleCategoryIds ) && !manager ){
			return null;
		}
		...
		try ( EntityManagerContainer emc = EntityManagerContainerFactory.instance().create() ) {
			return documentInfoService.listNextWithCondition( emc, id, count, viewAbleCategoryIds, title, publisherList, createDateList, publishDateList, 
					statusList, documentType, importBatchNames, personNames, unitNames,  groupNames, orderField, order, extensionStringList, 
