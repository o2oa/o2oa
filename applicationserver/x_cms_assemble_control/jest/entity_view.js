...
function data_get_view( ) {
	...
	if( "{id}" == service_url ){
		...
		if( catagoryId == null || catagoryId == "" || catagoryId == undefined){
			alert("请填写catagoryId");return false;
		}
	...
	}else if("list/form/{formId}" == service_url ){
		query_url = query_url.replace( "{formId}",formId );
		if( formId == null || formId == "" || formId == undefined){
			alert("请填写formId");return false;
		}
	}
