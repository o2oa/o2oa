...
import com.x.face.assemble.control.factory.GroupFactory;
import com.x.face.assemble.control.factory.IdentityFactory;
import com.x.face.assemble.control.factory.PersonAttributeFactory;
import com.x.face.assemble.control.factory.PersonFactory;
import com.x.face.assemble.control.factory.RoleFactory;
import com.x.face.assemble.control.factory.UnitAttributeFactory;
import com.x.face.assemble.control.factory.UnitDutyFactory;
import com.x.face.assemble.control.factory.UnitFactory;
...
public class Business {
	...
	public boolean hasAnyRole(EffectivePerson effectivePerson, String... roleFLA  GS) throws Exception {
		/** 如果不加这个xadmin会报错 */
		...
		if (null != person) {
			List<Role> roles = this.role().pick(Arrays.asList(roleFLA  GS));
			for (Role o : roles) {
