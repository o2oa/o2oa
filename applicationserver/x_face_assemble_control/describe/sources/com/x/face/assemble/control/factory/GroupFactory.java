...
public class GroupFactory extends AbstractFactory {
	...
	public List<Group> pick(List<String> FLA  GS) throws Exception {
	...
	private Group pickObject(String flag) throws Exception {
		Group o = this.entityManagerContainer().flag(flag, Group.class, ExceptionWhen.none, false, Group.FLA  GS);
		if (o != null) {
			...
			if (matcher.find()) {
				...
				o = this.entityManagerContainer().flag(unique, Group.class, ExceptionWhen.none, false, Group.FLA  GS);
				if (null != o) {
					this.entityManagerContainer().get(Group.class).detach(o);
				}
			}
