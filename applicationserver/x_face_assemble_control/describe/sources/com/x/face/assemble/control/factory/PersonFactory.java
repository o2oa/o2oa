...
public class PersonFactory extends AbstractFactory {
	...
	private Person pickObject(String flag) throws Exception {
		Person o = this.entityManagerContainer().flag(flag, Person.class, ExceptionWhen.none, false, Person.FLA  GS);
		if (o != null) {
			...
			if (matcher.find()) {
				...
				o = this.entityManagerContainer().flag(unique, Person.class, ExceptionWhen.none, false, Person.FLA  GS);
				if (null != o) {
					this.entityManagerContainer().get(Person.class).detach(o);
				}
			}
	...
	public List<Person> pick(List<String> FLA  GS) throws Exception {
	...
	public void setPassword(Person person, String password) throws Exception {
		...
		//Integer passwordPeriod = Config.person().passwordPeriod();
