package com.x.strategydeploy.assemble.common.date;
...
public class DateOperation {
	...
	public long getDeff(String date1, String date2) {
		...
		try {
			...
			logger.error(new Exception("系统获取得到两个时间之前的分差发生异常", e));
		}
		return dayNumber;
	}
	...
	public String changeDateFormat(String dateString) {
		...
		try {
			...
			try {
				...
				logger.error(new Exception("系统日期格式转换发生异常", e1));
			}
			logger.error(new Exception("系统日期格式转换发生异常", e));
		}
	...
	public String getStartOfWeek(String dateString) {
		...
		try {
			...
			logger.error(new Exception("系统getStartOfWeek日期格式转换发生异常", e));
		} catch (Exception e) {
			logger.error(new Exception("系统getStartOfWeek发生异常", e));
		}
		return null;
	}
	...
	public String getEndOfWeek(String dateString) {
		try {
			...
			logger.error(new Exception("系统getEndOfWeek日期格式转换发生异常", e));
		} catch (Exception e) {
			logger.error(new Exception("系统getEndOfWeek发生异常", e));
		}
		return null;
	}
	...
	public String getDateCNString(String dateString, String style) throws Exception {
		...
		try {
			...
			logger.error(new Exception("系统getDateCNString日期格式转换发生异常", e));
		}
		if (_date == null) {
			_date = new Date();
		}
	...
	public String getDateCNString2(String dateString, String style) throws Exception {
		...
		try {
			...
			logger.error(new Exception("系统getDateCNString2日期格式转换发生异常", e));
		}
		if (_date == null) {
			_date = new Date();
		}
	...
	public int getWeekNumOfYear(String dateString) {
		try {
			...
			logger.error(new Exception("系统getWeekNumOfYear日期格式转换发生异常", e));
		} catch (Exception e) {
			logger.error(new Exception("系统getWeekNumOfYear发生异常", e));
		}
		return -1;
	}
