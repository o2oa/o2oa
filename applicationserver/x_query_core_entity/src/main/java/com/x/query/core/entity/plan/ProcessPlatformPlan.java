...
public class ProcessPlatformPlan extends Plan {
	...
	public static class WhereEntry extends GsonPropertyObject {
		...
		// private Predicate workPredicate_application(CriteriaBuilder cb, Root<Work>
		// root) throws Exception {
		// List<String> _application_ids = ListTools.extractField(this.applicationList,
		// Application.id_FIELDNAME,
		// String.class, true, true);
		// List<String> _application_names =
		// ListTools.extractField(this.applicationList, Application.name_FIELDNAME,
		// String.class, true, true);
		// List<String> _application_alias =
		// ListTools.extractField(this.applicationList, Application.alias_FIELDNAME,
		// String.class, true, true);
		// List<String> _process_ids = ListTools.extractField(this.processList,
		// Process.id_FIELDNAME, String.class,
		// true, true);
		// List<String> _process_names = ListTools.extractField(this.processList,
		// Process.name_FIELDNAME, String.class,
		// true, true);
		// List<String> _process_alias = ListTools.extractField(this.processList,
		// Process.alias_FIELDNAME,
		// String.class, true, true);
		...
		// return StringUtils.isNotEmpty(o);
		// }).collect(Collectors.toList());
		// if (_application_ids.isEmpty() && _application_names.isEmpty() &&
		// _application_alias.isEmpty()
		// && _process_ids.isEmpty() && _process_names.isEmpty() &&
		// _process_alias.isEmpty()) {
		// return null;
		// }
		...
		// p = cb.or(p, root.get(Work_.applicationName).in(_application_names));
		// }
		// if (!_application_alias.isEmpty()) {
		// p = cb.or(p, root.get(Work_.applicationAlias).in(_application_alias));
		// }
		// if (!_process_ids.isEmpty()) {
		// p = cb.or(p, root.get(Work_.process).in(_process_ids));
		// }
		// if (!_process_names.isEmpty()) {
		// p = cb.or(p, root.get(Work_.processName).in(_process_names));
		// }
		// if (!_process_alias.isEmpty()) {
		// p = cb.or(p, root.get(Work_.processAlias).in(_process_alias));
		// }
		// return p;
		// }
