...
public class CalendarAction extends StandardJaxrsAction{
	...
	public Response listMyCalendar(@Context HttpServletRequest request ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response listPublicCalendar(@Context HttpServletRequest request ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response followCalendar(@Context HttpServletRequest request, @JaxrsParameterDescribe("日历信息ID") @PathParam("id") String id  ) {
		ActionResult<WrapOutBoolean> result = new ActionResult<>();
		EffectivePerson effectivePerson = this.effectivePerson(request);
		Boolean check = true;
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response followCalendarCancel(@Context HttpServletRequest request, @JaxrsParameterDescribe("日历信息ID") @PathParam("id") String id  ) {
		ActionResult<WrapOutBoolean> result = new ActionResult<>();
		EffectivePerson effectivePerson = this.effectivePerson(request);
		Boolean check = true;
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response isCalendarManager(@Context HttpServletRequest request, @JaxrsParameterDescribe("指定的日历ID") String accountId) {
		ActionResult<WrapOutBoolean> result = new ActionResult<>();
		EffectivePerson effectivePerson = this.effectivePerson(request);
		Boolean check = true;
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response save( @Context HttpServletRequest request, @JaxrsParameterDescribe("日历信息") JsonElement jsonElement) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response destory(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("日历信息ID") @PathParam("id") String id ) {
