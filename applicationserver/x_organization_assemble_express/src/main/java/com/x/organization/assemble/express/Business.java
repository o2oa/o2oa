...
public class Business {
	...
	public List<String> expendUnitToIdentity(List<String> unitList) throws Exception {
		...
		return this.identity().listIdentityDistinguishedNameSorted(identityIdList);
	}

//	public Boolean personHasAnyRole(EffectivePerson effectivePerson, List<String> roleList, List<String> unitList)
//			throws Exception {
//		this.role().
//		return true;
//	}
