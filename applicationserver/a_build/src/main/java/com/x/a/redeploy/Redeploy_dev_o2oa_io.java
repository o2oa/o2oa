...
public class Redeploy_dev_o2oa_io {

	private static Logger logger = LoggerFactory.getLogger(Redeploy_dev_o2oa_io.class);

	public static final String HOST = "dev.o2oa.io";
