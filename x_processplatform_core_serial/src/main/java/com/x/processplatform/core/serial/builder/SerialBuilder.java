...
public class SerialBuilder {
	...
	public SerialBuilder(EntityManagerContainer emc, String processId, String workId) throws Exception {
		this.emc = emc;
	...
	public class Serial {
		...
		public String company() {
			return work.getCreatorCompany();
		}

		public String department() {
			return work.getCreatorDepartment();
		}
