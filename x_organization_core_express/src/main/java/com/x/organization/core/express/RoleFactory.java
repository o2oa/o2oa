...
public class RoleFactory {
	...
	public WrapRole getWithName(String name) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"role/list/person/" + URLEncoder.encode(name, "UTF-8")).getData(WrapRole.class);
		} catch (Exception e) {
	...
	public List<WrapRole> listWithPerson(String name) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"role/list/person/" + URLEncoder.encode(name, "UTF-8")).getDataAsList(WrapRole.class);
		} catch (Exception e) {
	...
	public List<WrapRole> listWithGroup(String name) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"role/list/group/" + URLEncoder.encode(name, "UTF-8")).getDataAsList(WrapRole.class);
		} catch (Exception e) {
	...
	public List<WrapRole> listPinyinInitial(String key) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"role/list/pinyininitial/" + URLEncoder.encode(key, "UTF-8")).getDataAsList(WrapRole.class);
		} catch (Exception e) {
	...
	public List<WrapRole> listLikePinyin(String key) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"role/list/like/pinyin/" + URLEncoder.encode(key, "UTF-8")).getDataAsList(WrapRole.class);
		} catch (Exception e) {
	...
	public List<WrapRole> listLike(String key) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"role/list/like/" + URLEncoder.encode(key, "UTF-8")).getDataAsList(WrapRole.class);
		} catch (Exception e) {
