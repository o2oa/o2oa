...
public class PersonFactory {
	...
	public WrapPerson getWithName(String name) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class, "person/" + URLEncoder.encode(name, "UTF-8"))
					.getData(WrapPerson.class);
		} catch (Exception e) {
	...
	public WrapPerson flag(String flag) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class, "person/flag/" + URLEncoder.encode(flag, "UTF-8"))
					.getData(WrapPerson.class);
		} catch (Exception e) {
	...
	public WrapPerson getWithIdentity(String identity) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"person/identity/" + URLEncoder.encode(identity, "UTF-8")).getData(WrapPerson.class);
		} catch (Exception e) {
	...
	public WrapPerson getWithCredential(String credential) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"person/credential/" + URLEncoder.encode(credential, "UTF-8")).getData(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listWithDepartment(String name) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class,
							"person/list/department/" + URLEncoder.encode(name, "UTF-8"))
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listWithPersonAttribute(String attribute) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class,
							"person/list/personattribute/" + URLEncoder.encode(attribute, "UTF-8"))
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listWithGroupSubDirect(String name) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class,
							"person/list/group/" + URLEncoder.encode(name, "UTF-8") + "/sub/direct")
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listWithGroupSubNested(String name) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class,
							"person/list/group/" + URLEncoder.encode(name, "UTF-8") + "/sub/nested")
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listPinyinInitial(String key) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class,
							"person/list/pinyininitial/" + URLEncoder.encode(key, "UTF-8"))
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listLikePinyin(String key) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class,
							"person/list/like/pinyin/" + URLEncoder.encode(key, "UTF-8"))
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listLike(String key) throws Exception {
		try {
			return context.applications().getQuery(x_organization_assemble_express.class,
					"person/list/like/" + URLEncoder.encode(key, "UTF-8")).getDataAsList(WrapPerson.class);
		} catch (Exception e) {
	...
	public List<WrapPerson> listLoginRecent(Integer count) throws Exception {
		try {
			return context.applications()
					.getQuery(x_organization_assemble_express.class, "person/list/login/recent/" + count)
					.getDataAsList(WrapPerson.class);
		} catch (Exception e) {
