...
public class ExcuteListByLevel extends ExcuteBase {
	
	protected ActionResult<List<WrapOutLog>> execute( HttpServletRequest request, EffectivePerson effectivePerson, String operationLevel ) throws Exception {
