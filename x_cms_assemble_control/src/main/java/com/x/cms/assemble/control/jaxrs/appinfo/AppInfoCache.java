...
import com.x.cms.assemble.control.AbstractAppInfoCache;
...
public class AppInfoCache extends AbstractAppInfoCache {

	private volatile static AppInfoCache INSTANCE;
