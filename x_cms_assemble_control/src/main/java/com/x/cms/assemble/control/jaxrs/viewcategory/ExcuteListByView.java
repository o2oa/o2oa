...
public class ExcuteListByView extends ExcuteBase {
	
	@SuppressWarnings("unchecked")
	protected ActionResult<List<WrapOutViewCategory>> execute( HttpServletRequest request, EffectivePerson effectivePerson, String viewId ) throws Exception {
