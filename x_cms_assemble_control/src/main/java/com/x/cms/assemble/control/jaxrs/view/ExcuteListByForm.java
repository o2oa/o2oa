...
public class ExcuteListByForm extends ExcuteBase {
	
	@SuppressWarnings("unchecked")
	protected ActionResult<List<WrapOutView>> execute( HttpServletRequest request, EffectivePerson effectivePerson, String formId ) throws Exception {
