var service_base_path = '../jaxrs/viewcatagory';
function data_get_viewcatagory( ) {
...
function data_put_viewcatagory( id ) {
...
function data_post_viewcatagory( id ) {
    $.ajax({
		type : 'post',
		dataType : 'json',
		contentType : 'application/json; charset=utf-8',
...
function data_delete_viewcatagory( id ) {
