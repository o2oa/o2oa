...
public class DynamicPersistService {
	 ...
	 * @throws Exception
	 */
	public List<Dynamic> taskSaveDynamic( Task object_old, Task object_new, EffectivePerson effectivePerson, String content ) throws Exception {
		if ( object_new == null) {
			throw new Exception("object is null.");
		}
		if ( effectivePerson == null ) {
		...
		List<Dynamic> result = new ArrayList<>();
		List<Dynamic> dynamics = dynamicService.getTaskDynamic( object_old, object_new, effectivePerson );	
		try ( EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			if( ListTools.isNotEmpty( dynamics )) {
				 for( Dynamic dynamic : dynamics ) {
					 dynamic = dynamicService.save( emc, dynamic, content );
	 ...
	 * @throws Exception
	 */
	public void taskManagerUpdateDynamic(Task task, List<String> addManagers, List<String> removeManagers, EffectivePerson effectivePerson ) throws Exception {
		if ( task == null) {
			throw new Exception("task object is null.");
		}
		if ( effectivePerson == null ) {
	 ...
	 * @throws Exception
	 */
	public void taskParticipantsUpdateDynamic(Task task, List<String> addParticipants, List<String> removeParticipants, EffectivePerson effectivePerson ) throws Exception {
		if ( task == null) {
			throw new Exception("task object is null.");
		}
		if ( effectivePerson == null ) {
