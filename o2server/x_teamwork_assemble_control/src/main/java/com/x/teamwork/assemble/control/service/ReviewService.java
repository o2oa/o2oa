...
//		if( !review.getExecutorUnit().equalsIgnoreCase( task.getExecutorUnit() )) { return true; }
		...
		if( review.getArchive().equals(task.getArchive()) ) { return true; }
		if( review.getCompleted().equals(task.getCompleted()) ) { return true; }
		if( review.getOvertime().equals(task.getOvertime()) ) { return true; }
		if( review.getDeleted().equals(task.getDeleted()) ) { return true; }
		if( review.getArchive().equals(task.getArchive()) ) { return true; }
		if( review.getArchive().equals(task.getArchive()) ) { return true; }
		...
		if( review.getProgress().equals(task.getProgress()) ) { return true; }
		if( review.getOrder().equals(task.getOrder()) ) { return true; }
		if( !review.getSequence().equalsIgnoreCase( task.getSequence() )) { return true; }
		if( review.getClaimed().equals(task.getClaimed()) ) { return true; }
		if( review.getRemindRelevance().equals(task.getRemindRelevance()) ) { return true; }
		return false;
	}
