...
public class BatchOperationPersistService {
	...
	private static final Logger logger = LoggerFactory.getLogger( BatchOperationPersistService.class );
	...
	public BatchOperation addOperation( BatchOperation cmsBatchOperation ) throws Exception {
		...
		try ( EntityManagerContainer emc = EntityManagerContainerFactory.instance().create() ) {
			...
			emc.commit();
			emc.get(BatchOperation.class).detach(cmsBatchOperation);
			//将批量操作信息压入队列
	 ...
	 * @throws Exception
	 */
	public BatchOperation addOperation( String objType, String optType, String bundle, String oldInfo, String description ) {
