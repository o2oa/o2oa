...
public class ActionUnStar extends BaseAction {

	private static Logger logger = LoggerFactory.getLogger(ActionUnStar.class);
	...
	protected ActionResult<Wo> execute(HttpServletRequest request, EffectivePerson effectivePerson, String flag) throws Exception {
		...
		try {					
			projectPersistService.unStar( flag,  effectivePerson );
