...
public class Calendar_EventAction extends StandardJaxrsAction{
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response getRFC(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("日历事件信息ID") @PathParam("id") String id ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response destorySingleEvent(@Context HttpServletRequest request, 
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response destoryAllEventsWithRepeatMaster(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("日历事件信息ID") @PathParam("eventId") String eventId ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response destoryAfterEvent(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("日历事件信息ID") @PathParam("eventId") String eventId ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response listWithFilter(@Context HttpServletRequest request, @JaxrsParameterDescribe("查询条件") JsonElement jsonElement ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response listWithFilterSample(@Context HttpServletRequest request, @JaxrsParameterDescribe("查询条件") JsonElement jsonElement ) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response create( @Context HttpServletRequest request, @JaxrsParameterDescribe("日历事件信息") JsonElement jsonElement) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response updateAllEventsWithRepeatMaster(
			@JaxrsParameterDescribe("日历事件信息ID") @PathParam("eventId") String eventId,
			@Context HttpServletRequest request, @JaxrsParameterDescribe("日历事件信息") JsonElement jsonElement) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response updateAfterEvent( 
			@JaxrsParameterDescribe("日历事件信息ID") @PathParam("eventId") String eventId,
			@Context HttpServletRequest request, @JaxrsParameterDescribe("日历事件信息") JsonElement jsonElement) {
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response updateSingleEvent( 
			@JaxrsParameterDescribe("日历事件信息ID") @PathParam("eventId") String eventId,
			@Context HttpServletRequest request, @JaxrsParameterDescribe("日历事件信息") JsonElement jsonElement) {
