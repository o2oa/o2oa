...
class QueueAddAfterQueueAndBeforeParallelTest {
	...
	@DisplayName("A后加签EFG,EFG串行处理,F前加签IJK,IJK并行处理，即串行-后加签串行-前加签并行")
	@Test
	@Order(1)
	void test01() {
