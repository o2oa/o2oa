...
class QueueAddBeforeParallelAndAfterQueueTest {
	...
	@DisplayName("A前加签EFG,EFG并行处理,F后加签IJK,IJK串行处理，即串行-前加签并行-后加签串行")
	@Test
	@Order(1)
	void test01() {
