...
public class Data extends ListOrderedMap<String, Object> {
	...
	public void setAttachmentList(List<FileInfo> attachmentList) throws Exception {
	...
	public static class DataAttachment extends GsonPropertyObject {
		...
		static WrapCopier<FileInfo, DataAttachment> copier = WrapCopierFactory.wo(FileInfo.class,
