...
public class BatchOperation extends SliceJpaObject {

	private static final long serialVersionUID = 7668822947307502058L;

	private static final String TABLE = PersistenceProperties.BatchOperation.table;
	...
	@Column(length = length_255B, name = ColumnNamePrefix + oldInfo_FIELDNAME)
