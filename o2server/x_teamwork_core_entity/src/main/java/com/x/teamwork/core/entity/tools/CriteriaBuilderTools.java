...
public class CriteriaBuilderTools {
	...
	public static <T extends JpaObject, T_ extends SliceJpaObject_> Predicate composePredicateWithQueryFilter(
		...
		if( queryFilter == null ) {
			return p == null ? cb.conjunction() : p;
		}
		//组装条件
	 ...
	 * @throws Exception
	 */
	public static <T extends JpaObject, T_ extends SliceJpaObject_> List<T> listNextWithCondition(EntityManager em, Class<T> cls, Class<T_> cls_,
							Integer maxCount, QueryFilter queryFilter, Object sequenceFieldValue,  String orderField, String order ) throws Exception {
