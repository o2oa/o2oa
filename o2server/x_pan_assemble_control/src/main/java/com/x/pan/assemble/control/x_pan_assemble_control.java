 ...
 * @author sword
 */
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.CUSTOM, name = "新版企业网盘", packageName = "com.x.pan.assemble.control",
		...
		storeJars = { "x_organization_core_entity", "x_organization_core_express", "x_file_core_entity" },
		storageTypes = { StorageType.file }, customJars = { "x_pan_core_entity" })
