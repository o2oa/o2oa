...
import com.x.report.assemble.control.jaxrs.setting.exception.ExceptionSettingNameEmpty;
...
public class ActionSave extends BaseAction {
	...
	protected ActionResult<Wo> execute( HttpServletRequest request, EffectivePerson effectivePerson, JsonElement jsonElement ) throws Exception {
		...
		Wi wrapIn = null;
		Report_S_Setting report_S_Setting = new Report_S_Setting();
		Boolean check = true;
		...
		if( check ){
			try {
				report_S_Setting = report_S_SettingServiceAdv.save( report_S_Setting );
	...
	public static class Wi extends Report_S_Setting {
		
		private static final long serialVersionUID = -5076990764713538973L;
		
		public static List<String> Excludes = new ArrayList<String>(JpaObject.FieldsUnmodify);
		
		public static WrapCopier< Wi, Report_S_Setting > copier = WrapCopierFactory.wi( Wi.class, Report_S_Setting.class, null, Wi.Excludes );
