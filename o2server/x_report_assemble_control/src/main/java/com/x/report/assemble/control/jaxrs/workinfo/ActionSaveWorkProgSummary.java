...
public class ActionSaveWorkProgSummary extends BaseAction {
	
	private Logger logger = LoggerFactory.getLogger( ActionSaveWorkProgSummary.class );
...
//		if( check ){
//			if( StringUtils.isEmpty(wi.getWorkProgSummary()) ){
//				check = false;
...
//		}
		...
		if( check ){
			try {
				workInfo = report_I_WorkInfoServiceAdv.saveWorkProgSummary( wi.getId(), wi.getWorkProgSummary() );
