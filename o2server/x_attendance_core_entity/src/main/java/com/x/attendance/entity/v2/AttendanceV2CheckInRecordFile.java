...
@Schema(name = "AttendanceV2CheckInRecordFile", description = "打卡考勤记录附件.")
@Entity
@ContainerEntity(dumpSize = 10, type = ContainerEntity.Type.content, reference = ContainerEntity.Reference.strong)
@Table(name = PersistenceProperties.AttendanceV2CheckInRecordFile.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.AttendanceV2CheckInRecordFile.table + JpaObject.IndexNameMiddle
				+ JpaObject.DefaultUniqueConstraintSuffix, columnNames = { JpaObject.IDCOLUMN,
						JpaObject.CREATETIMECOLUMN, JpaObject.UPDATETIMECOLUMN, JpaObject.SEQUENCECOLUMN }) })
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Storage(type = StorageType.custom)
public class AttendanceV2CheckInRecordFile extends StorageObject {

	private static final long serialVersionUID = -8271301969060699763L;

	private static final String TABLE = PersistenceProperties.AttendanceV2CheckInRecordFile.table;

	private static final String BASE_PATH = "o2_attendance";
	...
	public AttendanceV2CheckInRecordFile() {
	}

	public AttendanceV2CheckInRecordFile(String storage, String name, String creator) {
