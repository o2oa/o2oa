...
public class StatisticUnitForMonth extends SliceJpaObject {

	private static final long serialVersionUID = -3491074853394166341L;
	private static final String TABLE = PersistenceProperties.StatisticUnitForMonth.table;

	public StatisticUnitForMonth(Long lateCount, Long leaveEarlyCount, Long offDutyCount, Long onDutyCount,
			Double absenceDayCount, Double employeeCount, Double onDutyEmployeeCount, Double onSelfHolidayCount,
			Long lackOfTimeCount, Long abNormalDutyCount) {
