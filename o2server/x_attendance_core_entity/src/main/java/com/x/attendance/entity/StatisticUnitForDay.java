...
public class StatisticUnitForDay extends SliceJpaObject {

	private static final long serialVersionUID = 440601082336632065L;
	private static final String TABLE = PersistenceProperties.StatisticUnitForDay.table;
	...
	public void onPersist() throws Exception {
		...
		this.setSequence(StringUtils.join( this.statisticDate, topUnitName + "#"+unitName, this.getId()) );
	}
	/*
	 * =============================================================================
	 * ===== 以上为 JpaObject 默认字段
