...
class ActionDeleteDataPath6 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionDeleteDataPath6.class);
	...
	ActionResult<Wo> execute(EffectivePerson effectivePerson, String applicationDictFlag, String applicationFlag,
		...
		Wo wo = ThisApplication.context().applications()
				.deleteQuery(x_processplatform_service_processing.class, Applications.joinQueryUri("applicationdict",
						id, path0, path1, path2, path3, path4, path5, path6, "data"), id)
				.getData(Wo.class);
		result.setData(wo);
		return result;
	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionDeleteDataPath6$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 7941846151868616132L;
