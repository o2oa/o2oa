...
class ActionCreateDataPath0 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCreateDataPath0.class);

	ActionResult<Wo> execute(EffectivePerson effectivePerson, String applicationDictFlag, String applicationFlag,
			String path0, JsonElement jsonElement) throws Exception {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionCreateDataPath0$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -2119458154058983519L;
