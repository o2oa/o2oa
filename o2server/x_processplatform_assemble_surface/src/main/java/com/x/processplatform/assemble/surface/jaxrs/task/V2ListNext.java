...
class V2ListNext extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.V2ListNext$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = -1754516221349111011L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.V2ListNext$Wo")
