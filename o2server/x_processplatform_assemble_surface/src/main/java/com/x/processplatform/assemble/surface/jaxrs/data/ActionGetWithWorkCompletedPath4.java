...
class ActionGetWithWorkCompletedPath4 extends BaseAction {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionGetWithWorkCompletedPath4.class);
	...
	public static class WoControl extends WorkCompletedControl {
		...
		private static final long serialVersionUID = -1215276023131232893L;
