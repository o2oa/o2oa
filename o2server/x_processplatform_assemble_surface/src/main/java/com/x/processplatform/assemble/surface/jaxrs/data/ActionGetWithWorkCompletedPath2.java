...
class ActionGetWithWorkCompletedPath2 extends BaseAction {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionGetWithWorkCompletedPath2.class);
	...
	ActionResult<JsonElement> execute(EffectivePerson effectivePerson, String id, String path0, String path1,
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			if (BooleanUtils.isTrue(workCompleted.getMerged())) {
				...
				result.setData(this.getData(business, workCompleted.getJob(), path0, path1, path2));
			}
			return result;
		}
	}
	...
	public static class WoControl extends WorkCompletedControl {
		...
		private static final long serialVersionUID = -4797082780608458744L;
