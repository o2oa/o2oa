...
class V2ListCreateNext extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.readcompleted.V2ListCreateNext$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = 5786402629836765200L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.readcompleted.V2ListCreateNext$Wo")
