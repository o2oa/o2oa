...
class ActionListNextWithProcess extends BaseAction {
	...
	ActionResult<List<Wo>> execute(EffectivePerson effectivePerson, String id, Integer count, String processFlag)
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			return this.standardListNext(Wo.copier, id, count, Task.sequence_FIELDNAME, equals, null, null, null, null,
					null, null, null, true, DESC);
		}
	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.ActionListNextWithProcess.Wo")
