...
import com.x.processplatform.core.express.assemble.surface.jaxrs.task.ActionManageListPrevFilterWi;
...
class ActionManageListPrevFilter extends BaseAction {
	...
	ActionResult<List<Wo>> execute(EffectivePerson effectivePerson, String id, Integer count, JsonElement jsonElement)
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			if (effectivePerson.isManager()) {
				result = this.standardListPrev(Wo.copier, id, count, Task.sequence_FIELDNAME, equals, null, likes, ins,
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.ActionManageListPrevFilter.Wi")
	public class Wi extends ActionManageListPrevFilterWi {

		private static final long serialVersionUID = -8072138431524724956L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.ActionManageListPrevFilter.Wo")
