...
class ActionUpdateWithWorkPath7 extends BaseUpdateWithWorkPath {
		...
		Wo wo = ThisApplication.context().applications()
				.putQuery(
						x_processplatform_service_processing.class, Applications.joinQueryUri("data", "work",
								work.getId(), joinPath(path0, path1, path2, path3, path4, path5, path6, path7)),
						dataWi, work.getJob())
				.getData(Wo.class);
		result.setData(wo);
		return result;
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.data.ActionUpdateWithWorkPath7$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -8388786135772655642L;
