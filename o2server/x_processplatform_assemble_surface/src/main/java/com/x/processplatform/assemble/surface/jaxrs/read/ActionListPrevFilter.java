...
import com.x.processplatform.core.express.service.processing.jaxrs.read.ActionListPrevFilterWi;
...
class ActionListPrevFilter extends BaseAction {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.ActionListPrevFilter$Wi")
	public class Wi extends ActionListPrevFilterWi {

		private static final long serialVersionUID = -932217372616124548L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.ActionListPrevFilter$Wo")
