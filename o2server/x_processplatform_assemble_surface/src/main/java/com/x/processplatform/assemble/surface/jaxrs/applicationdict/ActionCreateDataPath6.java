...
class ActionCreateDataPath6 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCreateDataPath6.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionCreateDataPath6$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -7224946141276757013L;
