...
class ActionDeleteWithWorkPath2 extends BaseDeleteWithWorkPath {
	...
	ActionResult<Wo> execute(EffectivePerson effectivePerson, String id, String path0, String path1, String path2)
		...
		Wo wo = ThisApplication.context().applications()
				.postQuery(x_processplatform_service_processing.class,
						Applications.joinQueryUri("data", "work", work.getId(), joinPath(path0, path1, path2), "delete"), dataWi, work.getJob())
				.getData(Wo.class);
		result.setData(wo);
		return result;
	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.data.ActionDeleteWithWorkPath2$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 8405742899197791153L;
