...
class V2ListCreatePrev extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.V2ListCreatePrev$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = 5436037625839874722L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.task.V2ListCreatePrev$Wo")
