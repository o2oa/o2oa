...
class ActionUpdateDataPath2 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionUpdateDataPath2.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionUpdateDataPath2$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 8267906706474551998L;
