...
class ActionCreateWithWorkPath4 extends BaseCreateWithWorkPath {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCreateWithWorkPath4.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.data.ActionCreateWithWorkPath4$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 2091167605193411253L;
