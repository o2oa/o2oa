...
class ActionDeleteDataPath4 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionDeleteDataPath4.class);

	ActionResult<Wo> execute(EffectivePerson effectivePerson, String applicationDictFlag, String applicationFlag,
			String path0, String path1, String path2, String path3, String path4) throws Exception {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionDeleteDataPath4$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -4104023667936075424L;
