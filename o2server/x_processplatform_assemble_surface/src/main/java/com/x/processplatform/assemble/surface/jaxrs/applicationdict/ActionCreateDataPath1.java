...
class ActionCreateDataPath1 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCreateDataPath1.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionCreateDataPath1$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -1898987124500347360L;
