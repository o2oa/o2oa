...
class V2ListCreatePrev extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.V2ListCreatePrev$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = 348864637434446667L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.V2ListCreatePrev$Wo")
