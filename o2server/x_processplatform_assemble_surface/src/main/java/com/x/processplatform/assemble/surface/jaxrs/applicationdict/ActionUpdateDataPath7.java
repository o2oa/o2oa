...
class ActionUpdateDataPath7 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionUpdateDataPath7.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionUpdateDataPath7$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 8465151407186021398L;
