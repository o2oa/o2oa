...
class ActionCreateWithWorkPath2 extends BaseCreateWithWorkPath {
	...
	ActionResult<Wo> execute(EffectivePerson effectivePerson, String id, String path0, String path1, String path2,
		...
		Wo wo = ThisApplication.context().applications()
				.postQuery(x_processplatform_service_processing.class,
						Applications.joinQueryUri("data", "work", work.getId(), joinPath(path0, path1, path2)), dataWi,
						work.getJob())
				.getData(Wo.class);
		result.setData(wo);
		return result;
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.data.ActionCreateWithWorkPath2$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 653825707741185346L;
