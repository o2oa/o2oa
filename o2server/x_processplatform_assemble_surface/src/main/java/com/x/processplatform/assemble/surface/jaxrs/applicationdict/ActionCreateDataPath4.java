...
class ActionCreateDataPath4 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCreateDataPath4.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionCreateDataPath4$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -3646113299578036460L;
