...
class V2ListPrev extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.V2ListPrev$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = 7511242068001109648L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.V2ListPrev$Wo")
