...
public class TaskBuilder {
	...
	public static void updatePrevTaskIdentity
	...
	public static void updatePrevTaskIdent1ity(List<String> newlyTaskIds, List<TaskCompleted> prevSeriesTaskCompleteds,
