...
class ActionCreateDataPath5 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCreateDataPath5.class);

	ActionResult<Wo> execute(EffectivePerson effectivePerson, String applicationDictFlag, String applicationFlag,
			String path0, String path1, String path2, String path3, String path4, String path5, JsonElement jsonElement)
			throws Exception {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionCreateDataPath5$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -6268917479261258887L;
