...
class ActionListPrevWithFilter extends BaseAction {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActionListPrevWithFilter.class);
	...
	public static class Wi extends GsonPropertyObject {
		...
		private static final long serialVersionUID = 6206358857235583089L;
