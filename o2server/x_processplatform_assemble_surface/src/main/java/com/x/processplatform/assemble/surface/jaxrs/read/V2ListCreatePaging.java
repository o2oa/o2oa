...
class V2ListCreatePaging extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.V2ListCreatePaging$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = -2427390389515533232L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.read.V2ListCreatePaging$Wo")
