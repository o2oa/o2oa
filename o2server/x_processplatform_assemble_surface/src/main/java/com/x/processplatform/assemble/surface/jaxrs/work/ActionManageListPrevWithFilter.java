...
class ActionManageListPrevWithFilter extends BaseAction {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActionManageListPrevWithFilter.class);
	...
	public static class Wi extends GsonPropertyObject {
		...
		private static final long serialVersionUID = 5319882054321016855L;
