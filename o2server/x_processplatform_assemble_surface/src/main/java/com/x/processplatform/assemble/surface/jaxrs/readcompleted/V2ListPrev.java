...
class V2ListPrev extends V2Base {
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.readcompleted.V2ListPrev$Wi")
	public static class Wi extends RelateFilterWi {

		private static final long serialVersionUID = -1630331774783015393L;

	}

	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.readcompleted.V2ListPrev$Wo")
