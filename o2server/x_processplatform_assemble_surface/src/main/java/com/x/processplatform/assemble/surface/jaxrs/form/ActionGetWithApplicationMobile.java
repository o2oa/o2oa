...
class ActionGetWithApplicationMobile extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionGetWithApplicationMobile.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.form.ActionGetWithApplicationMobile$Wo")
	public static class Wo extends WoMaxAgeFastETag {

		private static final long serialVersionUID = -1711274566307641961L;
