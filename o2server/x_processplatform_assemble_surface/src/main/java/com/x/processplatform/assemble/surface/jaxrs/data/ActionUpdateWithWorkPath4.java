...
class ActionUpdateWithWorkPath4 extends BaseUpdateWithWorkPath {

	private static final Logger LOGGER = LoggerFactory.getLogger(ActionUpdateWithWorkPath4.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.data.ActionUpdateWithWorkPath4$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -5300984346268955501L;
