...
class ActionUpdateDataPath5 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionUpdateDataPath5.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionUpdateDataPath5$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = -6259690907701359413L;
