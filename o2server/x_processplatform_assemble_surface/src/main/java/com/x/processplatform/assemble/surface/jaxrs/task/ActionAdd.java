...
import com.x.processplatform.core.express.assemble.surface.jaxrs.task.ActionAddWi;
...
public class ActionAdd extends BaseAction {
	...
	private boolean add(Task task, List<String> distinguishedNameList, boolean before, String mode) throws Exception {
		com.x.processplatform.core.express.service.processing.jaxrs.task.ActionAddWi req = new com.x.processplatform.core.express.service.processing.jaxrs.task.ActionAddWi();
		...
		return ThisApplication.context().applications()
				...
				.getData(com.x.processplatform.core.express.service.processing.jaxrs.task.ActionAddWo.class).getValue();
	}
	...
	public static class Wi extends ActionAddWi {
