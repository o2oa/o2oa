...
class ActionUpdateDataPath3 extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionUpdateDataPath3.class);
	...
	@Schema(name = "com.x.processplatform.assemble.surface.jaxrs.applicationdict.ActionUpdateDataPath3$Wo")
	public static class Wo extends WoId {

		private static final long serialVersionUID = 697770826824309869L;
