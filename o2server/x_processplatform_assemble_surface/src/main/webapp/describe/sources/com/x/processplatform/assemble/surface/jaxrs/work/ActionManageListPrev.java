	...
	ActionResult<List<Wo>> execute(EffectivePerson effectivePerson, String id, Integer count, String applicationFlag)
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			if (effectivePerson.isManager()
				...
				result = this.standardListPrev(Wo.copier, id, count, "sequence", equalsTerms, null, null, null, null,
				...
				if (ListTools.isNotEmpty(ids)) {
					...
					result = this.standardListPrev(Wo.copier, id, count, "sequence", null, null, null, inTerms, null,
							null, null, null, true, DESC);
				}
			}
			/** 添加权限 */
