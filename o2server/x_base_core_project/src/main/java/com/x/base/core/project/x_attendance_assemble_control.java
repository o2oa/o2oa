...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "考勤管理", packageName = "com.x.attendance.assemble.control", containerEntities = {
        ...
        "com.x.attendance.entity.AttendanceImportFileInfo",
        "com.x.attendance.entity.AttendanceScheduleSetting",
        "com.x.attendance.entity.AttendanceSetting",
        ...
        "com.x.attendance.entity.AttendanceWorkPlace",
        "com.x.attendance.entity.StatisticPersonForMonth",
        "com.x.attendance.entity.StatisticTopUnitForDay",
        "com.x.attendance.entity.StatisticTopUnitForMonth",
        "com.x.attendance.entity.StatisticUnitForDay",
        "com.x.attendance.entity.StatisticUnitForMonth",
        "com.x.attendance.entity.AttendanceDingtalkDetail",
        "com.x.attendance.entity.AttendanceQywxDetail",
        "com.x.attendance.entity.DingdingQywxSyncRecord",
        "com.x.attendance.entity.StatisticDingdingPersonForMonth",
        "com.x.attendance.entity.StatisticDingdingUnitForDay",
        "com.x.attendance.entity.StatisticDingdingUnitForMonth",
        "com.x.attendance.entity.StatisticQywxPersonForMonth",
        "com.x.attendance.entity.StatisticQywxUnitForDay",
        ...
        "com.x.attendance.entity.v2.AttendanceV2PersonConfig",
        ...
        "com.x.attendance.entity.v2.AttendanceV2LeaveCarryForward",
        "com.x.attendance.entity.v2.AttendanceV2LeaveAccount",
        "com.x.attendance.entity.v2.AttendanceV2LeaveGrantRecord",
        "com.x.attendance.entity.v2.AttendanceV2LeaveGrantJob",
        "com.x.attendance.entity.v2.AttendanceV2LeavePolicy",
        "com.x.attendance.entity.v2.AttendanceV2LeaveLedger",
        "com.x.attendance.entity.v2.AttendanceV2LeaveTransaction",
        "com.x.attendance.entity.v2.AttendanceV2LeaveRequest",
        "com.x.attendance.entity.v2.AttendanceV2LeaveUsageDetail",
