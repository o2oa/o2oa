...
public class HttpConnection {
    ...
    public static String getAsString(String address, List<NameValuePair> heads, int connectTimeout,
            int readTimeout)
            throws Exception {
    ...
    public static <T> T getAsObject(String address, List<NameValuePair> heads, Class<T> cls)
            throws Exception {
        String result = getAsString(address, heads);
        return XGsonBuilder.instance().fromJson(result, cls);
    }

    public static <T> List<T> getAsObjects(String address, List<NameValuePair> heads, Class<T> cls)
            throws Exception {
    ...
    public static HttpConnectionResponse post(String address, List<NameValuePair> heads,
            String body,
    ...
    public static HttpConnectionResponse post(String address, List<NameValuePair> heads,
        ...
        try {
            ...
            if (status == HttpURLConnection.HTTP_MOVED_TEMP
                ...
                String redirect = connection.getHeaderField(HEAD_LOCATION);
                if (StringUtils.isNotBlank(redirect)) {
                    return post(redirect, heads, body);
                }
            }
            readResultString(connection, response);
        } catch (Exception e) {
    ...
    public static String postAsString(String address, List<NameValuePair> heads, String body)
            throws Exception {
    ...
    public static <T> T postAsObject(String address, List<NameValuePair> heads, String body,
            Class<T> cls)
            throws Exception {
    ...
    public static <T> List<T> postAsObjects(String address, List<NameValuePair> heads, String body,
            Class<T> cls)
            throws Exception {
        Type collectionType = new TypeToken<ArrayList<T>>() {
        }.getType();
    ...
    public static HttpConnectionResponse put(String address, List<NameValuePair> heads, String body,
            int connectTimeout,
            int readTimeout, Supplier<HttpConnectionResponse> supplier) {
        HttpURLConnection connection = null;
        try {
    ...
    public static String putAsString(String address, List<NameValuePair> heads, String body)
            throws Exception {
    ...
    public static <T> T putAsObject(String address, List<NameValuePair> heads, String body,
            Class<T> cls)
            throws Exception {
    ...
    public static <T> List<T> putAsObjects(String address, List<NameValuePair> heads, String body,
            Class<T> cls)
            throws Exception {
        Type collectionType = new TypeToken<ArrayList<T>>() {
        }.getType();
    ...
    public static HttpConnectionResponse delete(String address, List<NameValuePair> heads,
            int connectTimeout,
            int readTimeout, Supplier<HttpConnectionResponse> supplier) {
        HttpURLConnection connection = null;
        try {
    ...
    public static String deleteAsString(String address, List<NameValuePair> heads)
            throws Exception {
    ...
    public static <T> T deleteAsObject(String address, List<NameValuePair> heads, Class<T> cls)
            throws Exception {
        String result = deleteAsString(address, heads);
        return XGsonBuilder.instance().fromJson(result, cls);
    }

    public static <T> List<T> deleteAsObjects(String address, List<NameValuePair> heads,
            Class<T> cls)
            throws Exception {
        Type collectionType = new TypeToken<ArrayList<T>>() {
        }.getType();
    ...
    public static HttpURLConnection prepare(String address, List<NameValuePair> heads)
            throws Exception {
        ...
        try {
            map.put(ConnectionAction.ACCESS_CONTROL_ALLOW_HEADERS,
                    ConnectionAction.ACCESS_CONTROL_ALLOW_HEADERS_VALUE + ", " + Config.person()
                            .getTokenName());
        } catch (Exception e) {
        ...
        map.put(ConnectionAction.ACCESS_CONTROL_ALLOW_METHODS,
    ...
    public static String readResultString(HttpURLConnection connection) throws Exception {
        ...
        if (code == HttpURLConnection.HTTP_OK || code == HttpURLConnection.HTTP_CREATED
            ...
            throw new IllegalStateException(
                    "connection{url:" + connection.getURL() + "}, response error{responseCode:"
    ...
    public static void checkAddress(String address) throws Exception {
        ...
        if (addressLower.startsWith(HTTP_PROTOCOL) || addressLower.startsWith(HTTPS_PROTOCOL)) {
            ...
            if (ListTools.isNotEmpty(httpWhiteList)) {
                Optional<String> optional = httpWhiteList.stream()
                        .filter(o -> addressLower.indexOf("://" + o) > -1)
                        .findFirst();
