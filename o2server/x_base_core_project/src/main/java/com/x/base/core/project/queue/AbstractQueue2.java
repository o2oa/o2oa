...
//
//public abstract class AbstractQueue2<T> {
//
//	private static Logger logger = LoggerFactory.getLogger(AbstractQueue2.class);
//
...
//	 * 标识自己，将会传入到执行线程中使用
//	 */
//	private AbstractQueue2<T> abstractQueue = this;
//	/**
