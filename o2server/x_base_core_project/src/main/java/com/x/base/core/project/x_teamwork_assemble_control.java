...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "工作管理", packageName = "com.x.teamwork.assemble.control", containerEntities = {
		...
		,"com.x.teamwork.core.entity.TaskRelevance","com.x.teamwork.core.entity.TaskStatuType","com.x.teamwork.core.entity.TaskTag","com.x.teamwork.core.entity.TaskTagRele","com.x.teamwork.core.entity.TaskView","com.x.teamwork.core.entity.ProjectPermission",
		"com.x.general.core.entity.GeneralFile"},
		storageTypes = { StorageType.teamwork },
		storeJars = { "x_organization_core_entity", "x_organization_core_express", "x_general_core_entity", "x_teamwork_core_entity" })
