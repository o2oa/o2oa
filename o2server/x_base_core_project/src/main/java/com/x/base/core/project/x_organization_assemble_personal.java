...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "组织管理个人", packageName = "com.x.organization.assemble.personal", containerEntities = {
		...
		"com.x.organization.core.entity.PersonExtend", "com.x.organization.core.entity.Identity",
		"com.x.organization.core.entity.Unit", "com.x.organization.core.entity.UnitAttribute",
		"com.x.organization.core.entity.UnitDuty", "com.x.organization.core.entity.Custom",
		"com.x.organization.core.entity.Definition", "com.x.organization.core.entity.accredit.Empower",
