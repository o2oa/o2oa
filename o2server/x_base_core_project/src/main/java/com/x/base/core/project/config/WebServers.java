...
public class WebServers extends ConcurrentSkipListMap<String, WebServer> {
    ...
    public static final List<String> WEB_SERVER_FOLDERS = Arrays.asList("api", "o2_core", "o2_lib",
            "x_component_ANN", "x_component_AppCenter", "x_component_AppMarketV2",
            "x_component_AppMarketV2_Application", "x_component_appstore", "x_component_appstore_application",
            "x_component_Attendance", "x_component_attendancev2", "x_component_BAM",
            "x_component_Calendar", "x_component_cms_Column", "x_component_cms_ColumnManager",
            "x_component_cms_DictionaryDesigner", "x_component_cms_Document", "x_component_cms_FormDesigner",
            "x_component_cms_Index", "x_component_cms_Module", "x_component_cms_QueryViewDesigner",
            "x_component_cms_ScriptDesigner", "x_component_cms_ViewDesigner", "x_component_cms_Xform",
            "x_component_Collect", "x_component_Common", "x_component_ConfigDesigner",
            "x_component_Console", "x_component_ControlPanel", "x_component_CRM",
            "x_component_Deployment", "x_component_DesignCenter", "x_component_Empty",
            "x_component_FaceSet", "x_component_File", "x_component_FindDesigner",
            "x_component_Forum", "x_component_ForumCategory", "x_component_ForumDocument",
            "x_component_ForumPerson", "x_component_ForumSearch", "x_component_ForumSection",
            "x_component_ftsearch", "x_component_Homepage", "x_component_HotArticle",
            "x_component_IMV2", "x_component_LogViewer", "x_component_Meeting",
            "x_component_Minder", "x_component_MinderEditor", "x_component_Note",
            ...
            "x_component_portal_PortalManager", "x_component_portal_ScriptDesigner", "x_component_portal_WidgetDesigner",
            "x_component_process_Application", "x_component_process_ApplicationExplorer", "x_component_process_DictionaryDesigner",
            "x_component_process_FormDesigner", "x_component_process_ProcessDesigner", "x_component_process_ProcessManager",
            "x_component_process_ScriptDesigner", "x_component_process_StatDesigner", "x_component_process_TaskCenter",
            "x_component_process_ViewDesigner", "x_component_process_WidgetDesigner", "x_component_process_Work",
            "x_component_process_workcenter", "x_component_process_Xform", "x_component_Profile",
            "x_component_query_ImporterDesigner", "x_component_query_Query", "x_component_query_QueryExplorer",
            "x_component_query_QueryManager", "x_component_query_StatDesigner", "x_component_query_StatementDesigner",
            "x_component_query_TableDesigner", "x_component_query_ViewDesigner", "x_component_Search",
            "x_component_Selector", "x_component_service_AgentDesigner", "x_component_service_DictionaryDesigner",
            "x_component_service_InvokeDesigner", "x_component_service_ScriptDesigner", "x_component_service_ServiceManager",
            "x_component_Setting", "x_component_systemconfig", "x_component_Template",
            "x_component_ThreeMember", "x_desktop");
