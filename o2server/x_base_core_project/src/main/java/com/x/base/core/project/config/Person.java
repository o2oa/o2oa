...
public class Person extends ConfigObject {
	...
	public static final String DEFAULT_PASSWORD = "(var v = person.getMobile(); return v.substring(v.length - 6))";
	...
	public Boolean getCaptchaLogin() {
		return BooleanUtils.isFalse(this.captchaLogin) ? false : true;
	}
	...
	public Boolean getFaceLogin() {
		return BooleanUtils.isTrue(this.faceLogin) ? true : false;
	}
	...
	public boolean isMobile(String mobile) {
		...
		Matcher _m = Pattern.compile(this.getMobileRegex()).matcher(mobile);
		if (!_m.find()) {
			return false;
		}
		return true;
