...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "内容管理", packageName = "com.x.cms.assemble.control", containerEntities = {
		...
		"com.x.cms.core.entity.DocumentCommentCommend", "com.x.portal.core.entity.Script",
		"com.x.processplatform.core.entity.element.Script",
		"com.x.processplatform.core.entity.element.Form" }, storageTypes = { StorageType.cms,
				StorageType.processPlatform }, storeJars = { "x_processplatform_core_entity",
