...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "内容管理", packageName = "com.x.cms.assemble.control", containerEntities = {
		...
		"com.x.processplatform.core.entity.element.Form", "com.x.program.center.core.entity.Script" },
		storageTypes = { StorageType.cms, StorageType.processPlatform },
		storeJars = { "x_processplatform_core_entity", "x_organization_core_entity", "x_organization_core_express",
				"x_cms_core_entity", "x_cms_core_express", "x_query_core_entity", "x_query_core_express",
