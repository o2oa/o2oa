...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "数据查询", packageName = "com.x.query.assemble.surface", containerEntities = {
        ...
        "com.x.query.core.entity.ImportRecordItem", "com.x.query.core.entity.ItemAccess",
        ...
        "com.x.processplatform.core.entity.content.Attachment", "com.x.processplatform.core.entity.content.Task",
