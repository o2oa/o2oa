...
@Module(type = ModuleType.ASSEMBLE, category = ModuleCategory.OFFICIAL, name = "组织管理认证", packageName = "com.x.organization.assemble.authentication", containerEntities = {
		...
		"com.x.organization.core.entity.OauthCode", "com.x.organization.core.entity.log.TokenThreshold" }, storeJars = {
				"x_organization_core_entity", "x_organization_core_express" })
