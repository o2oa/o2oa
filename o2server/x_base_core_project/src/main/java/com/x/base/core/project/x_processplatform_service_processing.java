...
@Module(type = ModuleType.SERVICE, category = ModuleCategory.OFFICIAL, name = "流程服务", packageName = "com.x.processplatform.service.processing", containerEntities = {
		...
		"com.x.program.center.core.entity.Script", "com.x.processplatform.core.entity.content.Attachment",
		"com.x.processplatform.core.entity.content.DataRecord", "com.x.processplatform.core.entity.content.DocSign",
		...
		"com.x.processplatform.core.entity.content.Record", "com.x.processplatform.core.entity.content.Review",
		"com.x.processplatform.core.entity.content.SerialNumber", "com.x.processplatform.core.entity.content.Snap",
		...
		"com.x.processplatform.core.entity.content.WorkLog", "com.x.processplatform.core.entity.content.Handover",
		...
		"com.x.processplatform.core.entity.element.Manual", "com.x.processplatform.core.entity.element.Mapping",
		"com.x.processplatform.core.entity.element.Merge", "com.x.processplatform.core.entity.element.Parallel",
		"com.x.processplatform.core.entity.element.Process", "com.x.processplatform.core.entity.element.Publish",
		...
		"com.x.processplatform.core.entity.log.MergeItemPlan" }, storageTypes = {
				StorageType.processPlatform, StorageType.cms }, storeJars = { "x_organization_core_entity",
						...
						"x_portal_core_entity", "x_program_center_core_entity" })
