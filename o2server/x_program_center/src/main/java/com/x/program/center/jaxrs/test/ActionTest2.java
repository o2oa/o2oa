...
import com.x.program.center.script.GraalScriptingFactory;
...
class ActionTest2 extends BaseAction {
	...
	ActionResult<Wo> execute(EffectivePerson effectivePerson, JsonElement jsonElement) throws Exception {
		...
		Source source = GraalScriptingFactory.functionalization(wi.getText());
		System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!222222222");
		System.out.println(source.getCharacters());
		System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!2222222222");
		Value value = GraalScriptingFactory.eval(source);
		System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
