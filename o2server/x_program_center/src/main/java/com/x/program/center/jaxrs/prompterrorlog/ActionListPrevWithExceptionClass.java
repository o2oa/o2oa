...
class ActionListPrevWithExceptionClass extends BaseAction {
	ActionResult<List<Wo>> execute(EffectivePerson effectivePerson, String id, Integer count, String exceptionClass)
			throws Exception {
		ActionResult<List<Wo>> result = new ActionResult<>();
		EqualsTerms equalsTerms = new EqualsTerms();
		equalsTerms.put(PromptErrorLog.exceptionClass_FIELDNAME, exceptionClass);
