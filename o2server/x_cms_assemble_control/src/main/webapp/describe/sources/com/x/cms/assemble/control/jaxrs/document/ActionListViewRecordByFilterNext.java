...
public class ActionListViewRecordByFilterNext extends BaseAction {

	private static  Logger logger = LoggerFactory.getLogger( ActionListViewRecordByFilterNext.class );
