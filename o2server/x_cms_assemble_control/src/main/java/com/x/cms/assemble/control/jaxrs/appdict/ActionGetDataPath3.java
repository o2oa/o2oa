...
class ActionGetDataPath3 extends BaseAction {
	...
	ActionResult<JsonElement> execute(EffectivePerson effectivePerson, String appDictFlag, String appInfoFlag, String path0,
			String path1, String path2, String path3) throws Exception {
