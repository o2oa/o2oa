 ...
 * @author sword
 */
public class ActionGetFileDiffToken extends BaseAction {

    private static final Logger logger = LoggerFactory.getLogger(ActionGetFileDiffToken.class);

    ActionResult<Wo> execute(HttpServletRequest request, EffectivePerson effectivePerson,
                             String id, Integer version, String token) throws Exception {
