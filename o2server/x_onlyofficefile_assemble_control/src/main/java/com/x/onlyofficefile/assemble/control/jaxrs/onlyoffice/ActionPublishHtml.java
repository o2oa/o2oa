...
public class ActionPublishHtml extends BaseAction {
	...
	private static final String PUBLISH_PATH = "onlyoffice_builder";

	protected ActionResult<Wo> execute(EffectivePerson effectivePerson, String name, JsonElement jsonElement ) throws Exception {
		...
		this.dispatch(true, name+".docbuilder", PUBLISH_PATH, htmlContent.getBytes(StandardCharsets.UTF_8));
	...
	public static class Wi extends GsonPropertyObject {
		@FieldDescribe("Docbuilder，发布为o2server/webServer/onlyoffice_builder/{name}.docbuilder")
