...
public class ActionListAscWithFilterPageCount extends BaseAction {
	private static Logger logger = LoggerFactory.getLogger(ActionListAscWithFilterPageCount.class);
	...
	protected ActionResult<List<Wo>> execute(HttpServletRequest request, EffectivePerson effectivePerson, Integer page,
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			logger.info("ActionListAscWithFilterPageCount-->execute:" + id);
