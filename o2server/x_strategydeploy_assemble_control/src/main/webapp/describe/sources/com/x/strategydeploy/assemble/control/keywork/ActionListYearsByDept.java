...
public class ActionListYearsByDept extends BaseAction {
	private static  Logger logger = LoggerFactory.getLogger(ActionListYearsByDept.class);

	public static class Wo extends WrapStringList {

	}

	protected Wo execute(HttpServletRequest request, EffectivePerson effectivePerson, String _dept) throws Exception {
