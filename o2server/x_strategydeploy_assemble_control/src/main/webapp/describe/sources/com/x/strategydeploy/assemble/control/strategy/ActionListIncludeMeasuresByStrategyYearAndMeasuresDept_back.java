...
//import com.x.strategydeploy.assemble.control.measures.BaseAction.MeasuresInfo_MultiLanguage;
//import com.x.strategydeploy.assemble.control.measures.BaseAction.MeasuresInfo_MultiLanguage.MultiLanguage;
...
//
//public class ActionListIncludeMeasuresByStrategyYearAndMeasuresDept_back extends BaseAction {
//	private static Logger logger = LoggerFactory.getLogger(ActionListIncludeMeasuresByStrategyYearAndMeasuresDept_back.class);
...
//		public List<MeasuresInfo_MultiLanguage> measureList = new ArrayList<MeasuresInfo_MultiLanguage>();
//
//		public List<MeasuresInfo_MultiLanguage> getMeasureList() {
//			return measureList;
//		}
//
//		public void setMeasureList(List<MeasuresInfo_MultiLanguage> measureList) {
...
//		List<MeasuresInfo_MultiLanguage> _includeObjsML = new ArrayList<MeasuresInfo_MultiLanguage>();
//
...
//					_includeObjs = ActionListIncludeMeasuresByStrategyYearAndMeasuresDept_back.getMeasuresInfoListByParentid(o.getId());
//
//					WrapCopier<MeasuresInfo, MeasuresInfo_MultiLanguage> _copier = WrapCopierFactory.wo(MeasuresInfo.class, MeasuresInfo_MultiLanguage.class, null, Wo.Excludes);
//
//					for (MeasuresInfo measuresInfo : _includeObjs) {
//						MeasuresInfo_MultiLanguage measuresinfo_multilanguage = new MeasuresInfo_MultiLanguage();
//						measuresinfo_multilanguage = _copier.copy(measuresInfo, measuresinfo_multilanguage);
//						measuresinfo_multilanguage.setDeptlistML(MeasuresInfo_MultiLanguage.getDeptlistMLBySelf(business, measuresInfo));
//						_includeObjsML.add(measuresinfo_multilanguage);
//					}
//
...
//						_woincludemeasures.setMeasureList(_includeObjsML);
//					} else {
//						for (MeasuresInfo measuresInfo : _includeObjs) {
//							//相关部门过滤
