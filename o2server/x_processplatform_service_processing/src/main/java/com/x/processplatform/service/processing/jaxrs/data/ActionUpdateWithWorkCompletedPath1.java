...
import com.x.processplatform.service.processing.jaxrs.data.ActionUpdateWithWorkCompletedPath0.Wo;

class ActionUpdateWithWorkCompletedPath1 extends BaseAction {

	@ActionLogger
	private static Logger logger = LoggerFactory.getLogger(ActionUpdateWithWorkCompletedPath1.class);
		...
		Callable<String> callable = new Callable<String>() {
			public String call() throws Exception {
				try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
					...
					updateData(business, workCompleted, jsonElement, path0, path1);
				}
				return "";
			}
		};
