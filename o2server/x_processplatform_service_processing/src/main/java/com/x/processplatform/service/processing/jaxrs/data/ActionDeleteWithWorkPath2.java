...
import com.x.processplatform.service.processing.jaxrs.data.ActionDeleteWithWorkPath1.Wo;

class ActionDeleteWithWorkPath2 extends BaseAction {

	@ActionLogger
	private static Logger logger = LoggerFactory.getLogger(ActionDeleteWithWorkPath2.class);
