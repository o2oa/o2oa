...
import com.x.processplatform.service.processing.jaxrs.data.ActionUpdateWithWorkCompletedPath3.Wo;

class ActionUpdateWithWorkCompletedPath4 extends BaseAction {

	@ActionLogger
	private static Logger logger = LoggerFactory.getLogger(ActionUpdateWithWorkCompletedPath4.class);
