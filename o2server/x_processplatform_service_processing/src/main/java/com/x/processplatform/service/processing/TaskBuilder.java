...
//	}
//
//	public static void updatePrevTask(String series, String activityToken, String job) throws Exception {
//		com.x.processplatform.core.express.service.processing.jaxrs.task.V2UpdatePrevTaskWi req = new com.x.processplatform.core.express.service.processing.jaxrs.task.V2UpdatePrevTaskWi();
//		if (!StringUtils.isAnyBlank(series, activityToken, job)) {
//			req.setSeries(series);
//			req.setActivityToken(activityToken);
//			req.setJob(job);
//			ThisApplication.context().applications()
//					.postQuery(false, x_processplatform_service_processing.class,
//							Applications.joinQueryUri("task", "v2", "update", "prev", "task"), req, job)
//					.getData(com.x.processplatform.core.express.service.processing.jaxrs.task.V2UpdatePrevTaskWo.class);
//		}
//	}
//
//	/**
...
//	 */
//	@Deprecated
//	public static void updatePrevTask11Ident1ity(List<String> newlyTaskIds, List<TaskCompleted> prevSeriesTaskCompleteds,
