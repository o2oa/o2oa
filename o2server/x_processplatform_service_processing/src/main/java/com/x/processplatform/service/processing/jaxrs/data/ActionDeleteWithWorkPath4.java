...
import com.x.processplatform.service.processing.jaxrs.data.ActionDeleteWithWorkPath3.Wo;

class ActionDeleteWithWorkPath4 extends BaseAction {

	@ActionLogger
	private static Logger logger = LoggerFactory.getLogger(ActionDeleteWithWorkPath4.class);
