...
import com.x.processplatform.service.processing.jaxrs.data.ActionUpdateWithWorkPath1.Wo;

class ActionUpdateWithWorkPath2 extends BaseAction {

	@ActionLogger
	private static Logger logger = LoggerFactory.getLogger(ActionUpdateWithWorkPath2.class);
