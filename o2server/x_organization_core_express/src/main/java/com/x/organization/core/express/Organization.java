...
import com.x.organization.core.express.distinguishedname.DistinguishedNameFactory;
...
public class Organization {
	...
	public PersonAttributeFactory personAttribute() {
	...
	public UnitAttributeFactory unitAttribute() {
	...
	public UnitDutyFactory unitDuty() {
	...
	public EmpowerLogFactory empowerLog() {
	...
	private DistinguishedNameFactory distinguishedName;

	public DistinguishedNameFactory distinguishedName() {
		if (null == this.distinguishedName) {
			this.distinguishedName = new DistinguishedNameFactory(context);
		}
