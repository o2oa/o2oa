...
class ActionListToEnable extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionListToEnable.class);
	...
	@Schema(name = "com.x.organization.assemble.personal.jaxrs.empower.ActionListToEnable$Wo")
