...
class ActionManagerDelete extends BaseAction {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionManagerDelete.class);
	...
	@Schema(name = "com.x.organization.assemble.personal.jaxrs.empower.ActionManagerDelete$Wo")
	public static class Wo extends WrapBoolean {

		private static final long serialVersionUID = -6517635285224011295L;
