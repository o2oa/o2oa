...
class ActionListCountExpiredWorkByUnit extends BaseAction {
	
	private static Logger logger = LoggerFactory.getLogger(ActionListCountExpiredWorkByUnit.class);
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			for (DateRange o : os) {
				...
				for (UnitStub stub : ThisApplication.period.getExpiredTaskUnitStubs()) {
					...
					w.setCount(this.countExpiredWork(business, o, applicationId, processId, stub.getValue(),
	...
	public static class Wo extends LinkedHashMap<String, List<WoUnit>> {
		...
		private static final long serialVersionUID = -8577778422815522095L;
