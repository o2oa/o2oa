...
class ActionListCountStartTask extends BaseAction {

	private static Logger logger = LoggerFactory.getLogger(ActionListCountStartTask.class);
	...
	ActionResult<List<Wo>> execute(String applicationId, String processId, String activityId, String unit,
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			for (DateRange o : os) {
				...
				wo.setName(str);
				wo.setValue(str);
				wo.setCount(this.countStartTask(business, o, applicationId, processId, activityId, unit, person));
				list.add(wo);
			}
			result.setData(list);
			return result;
