...
class ActionListCountExpiredTaskByApplication extends BaseAction {
	
	private static Logger logger = LoggerFactory.getLogger(ActionListCountExpiredTaskByApplication.class);
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			for (DateRange o : os) {
				...
				for (ApplicationStub stub : this.listStub()) {
					...
					w.setCount(this.countExpiredTask(business, o, stub.getValue(), StandardJaxrsAction.EMPTY_SYMBOL,
