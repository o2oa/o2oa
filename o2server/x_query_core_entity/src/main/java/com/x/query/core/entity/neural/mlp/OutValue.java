...
@Entity
@ContainerEntity
@Table(name = PersistenceProperties.Neural.Mlp.OutValue.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.Neural.Mlp.OutValue.table + JpaObject.IndexNameMiddle
...
public class OutValue extends SliceJpaObject {
	...
	private static final String TABLE = PersistenceProperties.Neural.Mlp.OutValue.table;
