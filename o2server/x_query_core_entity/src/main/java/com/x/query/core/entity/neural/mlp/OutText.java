...
@Entity
@ContainerEntity
@Table(name = PersistenceProperties.Neural.Mlp.OutText.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.Neural.Mlp.OutText.table + JpaObject.IndexNameMiddle
				+ JpaObject.DefaultUniqueConstraintSuffix, columnNames = { JpaObject.IDCOLUMN,
						JpaObject.CREATETIMECOLUMN, JpaObject.UPDATETIMECOLUMN, JpaObject.SEQUENCECOLUMN }) })
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class OutText extends SliceJpaObject {

	private static final long serialVersionUID = -5610293696763235753L;

	private static final String TABLE = PersistenceProperties.Neural.Mlp.OutText.table;
