...
@Entity
@ContainerEntity
@Table(name = PersistenceProperties.Neural.Mlp.InValue.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.Neural.Mlp.InValue.table + JpaObject.IndexNameMiddle
...
public class InValue extends SliceJpaObject {
	...
	private static final String TABLE = PersistenceProperties.Neural.Mlp.InValue.table;
