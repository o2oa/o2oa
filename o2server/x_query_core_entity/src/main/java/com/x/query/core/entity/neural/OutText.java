...
@Table(name = PersistenceProperties.Neural.OutText.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.Neural.OutText.table + JpaObject.IndexNameMiddle
...
public class OutText extends SliceJpaObject {
	...
	private static final String TABLE = PersistenceProperties.Neural.OutText.table;
