...
@Entity
@ContainerEntity
@Table(name = PersistenceProperties.Neural.Mlp.InText.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.Neural.Mlp.InText.table + JpaObject.IndexNameMiddle
...
public class InText extends SliceJpaObject {
	...
	private static final String TABLE = PersistenceProperties.Neural.Mlp.InText.table;
