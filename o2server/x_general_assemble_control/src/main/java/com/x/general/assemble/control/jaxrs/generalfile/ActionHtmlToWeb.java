...
public class ActionHtmlToWeb extends BaseAction {

	private static final Logger logger = LoggerFactory.getLogger(ActionHtmlToWeb.class);
	private static final String PUBLISH_PATH = "general_html";
	...
	public static class Wi extends GsonPropertyObject {
		@FieldDescribe("html内容，发布为o2server/webServer/general_html/{id}.html")
