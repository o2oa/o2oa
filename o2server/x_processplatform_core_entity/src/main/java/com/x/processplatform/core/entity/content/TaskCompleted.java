...
public class TaskCompleted extends SliceJpaObject implements ProjectionInterface {
	...
	// 回退
	public static final String PROCESSINGTYPE_GOBACK = "goBack";
	// 继续流转
...
//			this.empowerTo = this.properties.getEmpowerTo();
	...
	public TaskCompleted(Task task, String processingType, Date completedTime, Long duration) {
		...
		if (null != task.getProperties().getPrevTask()) {
			...
			prevTask.setActivityToken(task.getProperties().getPrevTask().getActivityToken());
