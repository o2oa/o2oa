...
public class Delay extends Activity {
	...
	private static final long serialVersionUID = -704100044342120941L;
	private static final String TABLE = PersistenceProperties.Element.Delay.table;
	...
	public DelayProperties getProperties() {
		if (null == this.properties) {
	...
	public void setProperties(DelayProperties properties) {
	...
	@FieldDescribe("延时至时间.")
	@Column(name = ColumnNamePrefix + delayTime_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	private Date delayTime;

	public static final String delayDataPath_FIELDNAME = "delayDataPath";
	@FieldDescribe("minute类型中指定数字值的路径,until类型中截至时间的路径值.")
	@Column(name = ColumnNamePrefix + delayDataPath_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	private String delayDataPath;

	public static final String delayScript_FIELDNAME = "delayScript";
	@IdReference(Script.class)
	@FieldDescribe("延时计算脚本.")
	@Column(length = length_255B, name = ColumnNamePrefix + delayScript_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	private String delayScript;

	public static final String delayScriptText_FIELDNAME = "delayScriptText";
	@FieldDescribe("延时计算脚本文本.")
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = JpaObject.length_1M, name = ColumnNamePrefix + delayScriptText_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	private String delayScriptText;

	public static final String delayMinute_FIELDNAME = "delayMinute";
	@FieldDescribe("延时分钟,工作时间.")
	@Column(name = ColumnNamePrefix + delayMinute_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	private Integer delayMinute;

	public static final String workMinute_FIELDNAME = "workMinute";
	@FieldDescribe("minute是工作时间.")
	@Column(name = ColumnNamePrefix + workMinute_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	...
	public String getDelayDataPath() {
		return delayDataPath;
	}

	public void setDelayDataPath(String delayDataPath) {
		this.delayDataPath = delayDataPath;
	}

	public String getDelayScript() {
		return delayScript;
	}

	public void setDelayScript(String delayScript) {
		this.delayScript = delayScript;
	}

	public String getDelayScriptText() {
		return delayScriptText;
	}

	public void setDelayScriptText(String delayScriptText) {
		this.delayScriptText = delayScriptText;
	}
	...
	public Boolean getWorkMinute() {
		return workMinute;
	}

	public void setWorkMinute(Boolean workMinute) {
