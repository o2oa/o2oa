...
@Table(name = PersistenceProperties.Message.WorkEvent.table, uniqueConstraints = {
        @UniqueConstraint(name = PersistenceProperties.Message.WorkEvent.table + JpaObject.IndexNameMiddle
                + JpaObject.DefaultUniqueConstraintSuffix, columnNames = { JpaObject.IDCOLUMN,
                        JpaObject.CREATETIMECOLUMN, JpaObject.UPDATETIMECOLUMN, JpaObject.SEQUENCECOLUMN }) })
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class WorkEvent extends SliceJpaObject {

    private static final String TABLE = PersistenceProperties.Message.WorkEvent.table;
