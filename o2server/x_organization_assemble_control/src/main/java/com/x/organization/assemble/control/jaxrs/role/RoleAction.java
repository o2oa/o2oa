...
public class RoleAction extends StandardJaxrsAction {
	...
	@JaxrsMethodDescribe(value = "获取角色.", action = ActionGet.class)
	@GET
	@Path("{flag}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void get(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request,
			@JaxrsParameterDescribe("角色标识") @PathParam("flag") String flag) {
	...
	@JaxrsMethodDescribe(value = "创建角色.", action = ActionCreate.class)
	@POST
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	public void edit(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request,
			@JaxrsParameterDescribe("角色标识") @PathParam("flag") String flag, JsonElement jsonElement) {
	...
	@JaxrsMethodDescribe(value = "更新角色mockputtopost.", action = ActionEdit.class)
	@POST
	...
	@JaxrsMethodDescribe(value = "删除角色对象mockdeletetoget.", action = ActionDelete.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "列示角色对象,下一页.", action = ActionListNext.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "列示角色对象,上一页.", action = ActionListPrev.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "根据给定的人员的的角色.", action = ActionListWithPerson.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "根据给定的Group ID,获取其拥有的角色对象.", action = ActionListWithGroup.class)
	@GET
	@Path("list/group/{groupFlag}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void listWithGroup(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request,
		...
		ActionResult<List<ActionListWithGroup.Wo>> result = new ActionResult<>();
		EffectivePerson effectivePerson = this.effectivePerson(request);
		try {
			result = new ActionListWithGroup().execute(effectivePerson, groupFlag);
		} catch (Exception e) {
			logger.error(e, effectivePerson, request, null);
			result.error(e);
		}
	...
	@JaxrsMethodDescribe(value = "获取拼音首字母开始的Person.", action = ActionListPinyinInitial.class)
	@PUT
	...
	@JaxrsMethodDescribe(value = "获取拼音首字母开始的Person mockputtopost.", action = ActionListPinyinInitial.class)
	@POST
