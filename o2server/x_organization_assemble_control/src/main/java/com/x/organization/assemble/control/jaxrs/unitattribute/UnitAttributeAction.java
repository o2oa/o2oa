...
@Path("unitattribute")
@JaxrsDescribe("组织属性操作")
public class UnitAttributeAction extends BaseAction {
	...
	@JaxrsMethodDescribe(value = "创建组织属性.", action = ActionCreate.class)
	@POST
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@JaxrsMethodDescribe(value = "更新组织属性.", action = ActionEdit.class)
	@PUT
	@Path("{flag}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void edit(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request,
			@JaxrsParameterDescribe("组织属性标识") @PathParam("flag") String flag, JsonElement jsonElement) {
	...
	@JaxrsMethodDescribe(value = "更新组织属性mockputtopost.", action = ActionEdit.class)
	@POST
	...
	@JaxrsMethodDescribe(value = "删除组织属性.", action = ActionDelete.class)
	@DELETE
	@Path("{flag}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public void delete(@Suspended final AsyncResponse asyncResponse, @Context HttpServletRequest request,
			@JaxrsParameterDescribe("组织属性标识") @PathParam("flag") String flag) {
	...
	@JaxrsMethodDescribe(value = "删除组织属性mockdeletetoget.", action = ActionDelete.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "列示组织属性,下一页.", action = ActionListNext.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "列示组织属性,上一页.", action = ActionListPrev.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "根据给定的组织,列示其所有的组织属性对象.", action = ActionListWithUnit.class)
	@GET
	@Path("list/unit/{flag}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
