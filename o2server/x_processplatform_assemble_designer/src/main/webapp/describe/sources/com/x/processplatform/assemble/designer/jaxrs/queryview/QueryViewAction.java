...
public class QueryViewAction extends BaseAction {
	...
	@JaxrsMethodDescribe(value = "列示QueryView按应用分类.", action = ActionList.class)
	@GET
	@Path("list")
	...
	@JaxrsMethodDescribe(value = "列示QueryView对象,下一页.", action = ActionListNext.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "列示QueryView对象,上一页.", action = ActionListPrev.class)
	@GET
	...
	@JaxrsMethodDescribe(value = "获取QueryView内容.", action = ActionGet.class)
	@GET
	@Path("{id}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@JaxrsMethodDescribe(value = "创建QueryView.", action = ActionCreate.class)
	@POST
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@JaxrsMethodDescribe(value = "更新QueryView.", action = ActionEdit.class)
	@PUT
	@Path("{id}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@JaxrsMethodDescribe(value = "模拟执行queryView", action = ActionSimulate.class)
	@PUT
	@Path("{id}/simulate")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
