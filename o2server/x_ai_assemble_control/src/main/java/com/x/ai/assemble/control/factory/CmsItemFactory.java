package com.x.ai.assemble.control.factory;

import com.x.ai.assemble.control.AbstractFactory;
...
public class CmsItemFactory extends AbstractFactory {


	public CmsItemFactory(Business business) throws Exception {
		super(business);
	}

	public Long countWithDocWithPath(String docId, String... paths) throws Exception {
	...
	public List<Item> listWithDocWithPath(String docId, String... paths) throws Exception {
		EntityManager em = this.entityManagerContainer().get(Item.class);
		CriteriaBuilder cb = em.getCriteriaBuilder();
	...
	public Item getWithDocWithPath(String docId, String path0, String path1, String path2, String path3, String path4,
	...
	public Integer getArrayLastIndexWithDocWithPath(String docId, String... paths) throws Exception {
		EntityManager em = this.entityManagerContainer().get(Item.class);
		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<Item> cq = cb.createQuery(Item.class);
		Root<Item> root = cq.from(Item.class);
	...
	public List<Item> listWithDocWithPathWithAfterLocation(String docId, Integer index, String... paths)
			throws Exception {
		EntityManager em = this.entityManagerContainer().get(Item.class);
		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<Item> cq = cb.createQuery(Item.class);
