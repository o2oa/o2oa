...
public class DocFunction {
    ...
    public static final Function<Pair<Business, String>, Pair<String, Optional<Doc>>> wrapWork = param -> {
        try {
            Work work = param.first().entityManagerContainer().find(param.second(), Work.class);
            if (null != work) {
                ...
                doc.setCreateTimeMonth(
                        DateTools.format(work.getCreateTime(), DateTools.format_yyyyMM));
                doc.setUpdateTimeMonth(
                        DateTools.format(work.getUpdateTime(), DateTools.format_yyyyMM));
                ...
                doc.addBoolean(Indexs.PREFIX_FIELD_PROCESSPLATFORM_BOOLEAN,
                        TaskCompleted.completed_FIELDNAME, false);
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        Work.creatorUnitLevelName_FIELDNAME,
                ...
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING, Work.process_FIELDNAME,
                        work.getProcess());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        Work.processName_FIELDNAME,
                        work.getProcessName());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        Work.processAlias_FIELDNAME,
                        work.getProcessAlias());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING, Work.job_FIELDNAME,
                        work.getJob());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING, Work.serial_FIELDNAME,
                        work.getSerial());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        Work.activityName_FIELDNAME,
    ...
    public static final Function<Pair<Business, String>, Pair<String, Optional<Doc>>> wrapWorkCompleted = param -> {
        try {
            WorkCompleted workCompleted = param.first().entityManagerContainer()
                    .find(param.second(),
                            WorkCompleted.class);
            if (null != workCompleted) {
                ...
                doc.setCreateTimeMonth(
                        DateTools.format(workCompleted.getCreateTime(), DateTools.format_yyyyMM));
                doc.setUpdateTimeMonth(
                        DateTools.format(workCompleted.getUpdateTime(), DateTools.format_yyyyMM));
                ...
                doc.addBoolean(Indexs.PREFIX_FIELD_PROCESSPLATFORM_BOOLEAN,
                        TaskCompleted.completed_FIELDNAME, true);
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.creatorUnitLevelName_FIELDNAME,
                        workCompleted.getCreatorUnitLevelName());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.application_FIELDNAME,
                        workCompleted.getApplication());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.applicationName_FIELDNAME,
                        workCompleted.getApplicationName());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.applicationAlias_FIELDNAME,
                        workCompleted.getApplicationAlias());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.process_FIELDNAME,
                        workCompleted.getProcess());
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.processName_FIELDNAME,
                ...
                doc.addString(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRING,
                        WorkCompleted.serial_FIELDNAME,
                        workCompleted.getSerial());
                doc.addBoolean(Indexs.PREFIX_FIELD_PROCESSPLATFORM_BOOLEAN,
                        WorkCompleted.expired_FIELDNAME,
                        workCompleted.getExpired());
                doc.addDate(Indexs.PREFIX_FIELD_PROCESSPLATFORM_DATE,
                        WorkCompleted.expireTime_FIELDNAME,
    ...
    public static final Function<Pair<Business, String>, Pair<String, Optional<Doc>>> wrapDocument = param -> {
        try {
            Document document = param.first().entityManagerContainer()
                    .find(param.second(), Document.class);
            CategoryInfo categoryInfo = param.first().entityManagerContainer()
                    .find(document.getCategoryId(), CategoryInfo.class);
            if ((null != document) && (!StringUtils.equals(document.getDocumentType(),
                    Document.DOCUMENT_TYPE_DATA)) && (null == categoryInfo
                    || BooleanUtils.isNotFalse(categoryInfo.getIndexAble()))) {
                ...
                doc.setCreateTimeMonth(
                        DateTools.format(document.getCreateTime(), DateTools.format_yyyyMM));
                doc.setUpdateTimeMonth(
                        DateTools.format(document.getUpdateTime(), DateTools.format_yyyyMM));
                ...
                doc.addString(Indexs.PREFIX_FIELD_CMS_STRING, Document.appName_FIELDNAME,
                        document.getAppName());
                doc.addString(Indexs.PREFIX_FIELD_CMS_STRING, Document.appAlias_FIELDNAME,
                        document.getAppAlias());
                doc.addString(Indexs.PREFIX_FIELD_CMS_STRING, Document.categoryId_FIELDNAME,
                ...
                doc.addString(Indexs.PREFIX_FIELD_CMS_STRING, Indexs.FIELD_DESCRIPTION,
                        document.getDescription());
                doc.addDate(Indexs.PREFIX_FIELD_CMS_STRING, Indexs.FIELD_PUBLISHTIME,
                        document.getPublishTime());
                doc.addDate(Indexs.PREFIX_FIELD_CMS_STRING, Indexs.FIELD_MODIFYTIME,
                        document.getModifyTime());
                update(param.first(), document, doc,
                        Config.query().index().getDataStringThreshold());
    ...
    private static List<String> readers(Business business, Work work) throws Exception {
        List<String> list = business.entityManagerContainer()
                .fetchEqualAndEqual(Review.class, PROCESSPLATFORM_REVIEW_FIELDS,
                        Review.job_FIELDNAME, work.getJob(),
                        Review.application_FIELDNAME, work.getApplication())
    ...
    private static void workAddTaskPersonNames(Doc doc, Business business, Work work)
            throws Exception {
        List<Task> list = business.entityManagerContainer()
                .listEqualAndEqual(Task.class, Task.job_FIELDNAME,
                        work.getJob(), Task.application_FIELDNAME, work.getApplication());
        doc.addStrings(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRINGS,
                Indexs.FIELD_ROCESSPLATFORM_TASKPERSONNAMES,
                list.stream().map(Task::getPerson).filter(StringUtils::isNotBlank)
                        .map(OrganizationDefinition::name)
                        .distinct().collect(Collectors.toList()));
        doc.addStrings(Indexs.PREFIX_FIELD_PROCESSPLATFORM_STRINGS,
                Indexs.FIELD_ROCESSPLATFORM_PREVTASKPERSONNAMES,
                list.stream().map(Task::getPerson).filter(StringUtils::isNotBlank)
                        .map(OrganizationDefinition::name)
                        .distinct().collect(Collectors.toList()));
    }

    private static List<String> readers(Business business, WorkCompleted workCompleted)
            throws Exception {
        List<String> list = business.entityManagerContainer()
                .fetchEqualAndEqual(Review.class, PROCESSPLATFORM_REVIEW_FIELDS,
                        Review.job_FIELDNAME,
                        workCompleted.getJob(), Review.application_FIELDNAME,
                        workCompleted.getApplication())
                .stream().map(Review::getPerson).filter(StringUtils::isNotBlank).distinct()
                .collect(Collectors.toList());
    ...
    private static List<String> readers(Business business, com.x.cms.core.entity.Document document)
            throws Exception {
        List<String> list = business.entityManagerContainer()
                ...
                .stream().map(com.x.cms.core.entity.Review::getPermissionObj)
    ...
    private static void update(Business business, Work work, Doc wrap) {
        ...
        try {
            items = business.entityManagerContainer()
                    .listEqualAndEqual(Item.class, DataItem.bundle_FIELDNAME,
                            work.getJob(), DataItem.itemCategory_FIELDNAME, ItemCategory.pp);
            if (!ListTools.isEmpty(items)) {
                wrap.setBody(
                        DataItemConverter.ItemText.text(items, true, true, true, true, true, ","));
                wrap.setSummary(HanLP.getSummary(wrap.getBody(),
                        Config.query().index().getSummaryLength()));
                if (BooleanUtils.isTrue((Config.query().index().getWorkIndexAttachment()))) {
                    wrap.setAttachment(attachment(business, work.getJob()));
                } else {
                    wrap.setAttachment("");
                }
                update(wrap, CONVERTER.assemble(items), "",
                        Config.query().index().getDataStringThreshold());
            } else {
                LOGGER.warn("class:DocFunction, function:update work:{}, items is empty.",
                        work.getId());
            }
        } catch (Exception e) {
    ...
    private static void update(Business business, WorkCompleted workCompleted, Doc wrap) {
        ...
        try {
            if (BooleanUtils.isTrue(workCompleted.getMerged())) {
                ...
                items = business.entityManagerContainer()
                        .listEqualAndEqual(Item.class, DataItem.bundle_FIELDNAME,
                                workCompleted.getJob(), DataItem.itemCategory_FIELDNAME,
                                ItemCategory.pp);
            }
            if (!ListTools.isEmpty(items)) {
                wrap.setBody(
                ...
                if (BooleanUtils.isTrue(
                        (Config.query().index().getWorkCompletedIndexAttachment()))) {
    ...
    private static void update(Business business, com.x.cms.core.entity.Document document, Doc wrap,
        ...
        try {
            ...
            if (!ListTools.isEmpty(items)) {
                ...
                LOGGER.warn("class:DocFunction, function:update document:{}, items is empty.",
                        document.getId());
            }
        } catch (Exception e) {
    ...
    private static void update(Doc wrap, JsonElement jsonElement, String name,
            Integer dataStringThreshold) {
        if (null != jsonElement && (!jsonElement.isJsonNull()) && (!StringUtils.startsWith(name,
            ...
            if (jsonElement.isJsonPrimitive()) {
                ...
                jsonElement.getAsJsonObject().entrySet().stream()
                        .forEach(o -> update(wrap, o.getValue(),
                                StringUtils.isEmpty(name) ? o.getKey() : (name + "." + o.getKey()),
                                dataStringThreshold));
            }
        }
    }
    ...
    private static void updateArray(Doc doc, JsonArray jsonArray, String name,
            Integer dataStringThreshold) {
    ...
    private static void updateArrayString(Doc wrap, String name, List<JsonPrimitive> list) {
        List<String> values = list.stream().map(JsonPrimitive::getAsString)
                .collect(Collectors.toList());
        if (BooleanUtils
                .isTrue(values.stream().map(DateTools::isDateTimeOrDateOrTime)
                        .reduce(true, (a, b) -> a && b))) {
    ...
    private static String attachment(Business business, String job) throws Exception {
        ...
        Tika tika = new Tika();
        for (Attachment o : business.entityManagerContainer()
                .listEqual(Attachment.class, Attachment.job_FIELDNAME,
                        job)) {
            list.add(o.getName());
            ...
            if ((null != o.getLength()) && (o.getLength() > 0)
                    && (o.getLength()
                    < Config.query().index().getAttachmentMaxSize() * 1024 * 1024)) {
                list.add(storageObjectToText(tika, o));
            } else {
                LOGGER.warn("忽略文件长度为0或者过大的附件:{}, size:{}, id:{}.", o.getName(),
                        o.getLength(), o.getId());
            }
        }
    ...
    private static String attachment(Business business, com.x.cms.core.entity.Document document)
            throws Exception {
        List<String> list = new ArrayList<>();
        Tika tika = new Tika();
        for (FileInfo o : business.entityManagerContainer()
                .listEqual(FileInfo.class, FileInfo.documentId_FIELDNAME,
                        document.getId())) {
            list.add(o.getName());
            if (StringUtils.isNotEmpty(o.getText())) {
                list.add(o.getText());
    ...
    private static String storageObjectToText(Tika tika, StorageObject storageObject)
        ...
        try {
            ...
            LOGGER.warn(
                    "error extract attachment text, storageObject:{}, name:{}, exception class:{}, message:{}.",
                    storageObject.getId(), storageObject.getName(), th.getClass().getName(),
                    th.getMessage());
        }
