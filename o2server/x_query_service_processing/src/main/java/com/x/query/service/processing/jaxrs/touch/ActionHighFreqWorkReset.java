...
class ActionHighFreqWorkReset extends BaseAction {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActionHighFreqWorkReset.class);
    ...
    @Schema(name = "com.x.query.service.processing.jaxrs.touch.ActionHighFreqWorkReset$Wo")
