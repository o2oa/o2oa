...
class ActionLowFreqDocumentReset extends BaseAction {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActionLowFreqDocumentReset.class);
    ...
    @Schema(name = "com.x.query.service.processing.jaxrs.touch.ActionLowFreqDocumentReset$Wo")
