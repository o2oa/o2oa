...
public class ActionSubjectUnLock extends BaseAction {
	
	private static  Logger logger = LoggerFactory.getLogger( ActionSubjectUnLock.class );
	...
	protected ActionResult<Wo> execute( HttpServletRequest request, EffectivePerson effectivePerson, String id ) throws Exception {
		...
		if (check) {
			try {
				subjectInfo = subjectInfoServiceAdv.lock( id, false, effectivePerson.getDistinguishedName() );
