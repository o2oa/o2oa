...
public class ActionSubjectUnAcceptReply extends BaseAction {
	
	private static  Logger logger = LoggerFactory.getLogger( ActionSubjectUnAcceptReply.class );
	...
	protected ActionResult<Wo> execute( HttpServletRequest request, EffectivePerson effectivePerson, String id ) throws Exception {
		...
		if (check) {
			try {
				subjectInfo = subjectInfoServiceAdv.acceptReply( id, "", effectivePerson.getDistinguishedName() );
