...
public class WrapInFilter extends GsonPropertyObject {
	...
	private List<String> workProcessStatusList;
	...
	public List<String> getWorkProcessStatusList() {
		return workProcessStatusList;
	}

	public void setWorkProcessStatusList(List<String> workProcessStatusList) {
		this.workProcessStatusList = workProcessStatusList;
	}
	...
	public void addQueryWorkProcessStatus( String status ) {
		if( workProcessStatusList == null ){
			workProcessStatusList = new ArrayList<String>();
		}
		if( !workProcessStatusList.contains( status )){
			workProcessStatusList.add( status );
		}
	}
