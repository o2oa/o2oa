...
public class ActionStReportStatusExport extends BaseAction {

	private static  Logger logger = LoggerFactory.getLogger(ActionStReportStatusExport.class);
	...
	protected ActionResult<Wo> execute( HttpServletRequest request, EffectivePerson effectivePerson, JsonElement jsonElement ) throws Exception {
		...
		if ( check ) {
			try {
				...
				result.setData( new Wo( fileName ) );
			} catch ( Exception e ) {
