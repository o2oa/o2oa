...
import com.x.okr.assemble.control.jaxrs.okrworkdynamics.exception.ExceptionWorkDynamicsSave;
...
public class ActionSave extends BaseAction {
	...
	protected ActionResult<Wo> execute( HttpServletRequest request,EffectivePerson effectivePerson, JsonElement jsonElement ) throws Exception {
		...
		if( check ){
			try {
				...
				result.setData( new Wo( okrWorkDynamics.getId() ));
			} catch (Exception e) {
				Exception exception = new ExceptionWorkDynamicsSave( e );
				result.error( exception );
				logger.error( e, effectivePerson, request, null);
			}
		}
	...
	public static class Wi extends OkrWorkDynamics {
