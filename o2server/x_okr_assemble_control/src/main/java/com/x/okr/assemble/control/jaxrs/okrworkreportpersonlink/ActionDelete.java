...
import com.x.okr.assemble.control.jaxrs.okrworkreportpersonlink.exception.ExceptionReportPersonLinkDelete;
	...
	protected ActionResult<Wo> execute( HttpServletRequest request, EffectivePerson effectivePerson, String id ) throws Exception {
		...
		if( id == null || id.isEmpty() ){
			...
			try{
				...
				Exception exception = new ExceptionReportPersonLinkDelete( e, id );
				result.error( exception );
