...
public class OkrAttachmentFileInfoAction extends StandardJaxrsAction{
	...
	public Response listByCenterId(@Context HttpServletRequest request, 
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response listByWorkId(@Context HttpServletRequest request, 
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response listByWorkReportId(@Context HttpServletRequest request, 
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response deleteCenterAttachment(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("中心工作ID") @PathParam( "id" ) String id) {
		EffectivePerson effectivePerson = this.effectivePerson( request );
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response deleteWorkAttachment(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("具体工作ID") @PathParam( "id" ) String id) {
		EffectivePerson effectivePerson = this.effectivePerson( request );
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response deleteReportAttachment(@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("工作汇报ID") @PathParam( "id" ) String id) {
		EffectivePerson effectivePerson = this.effectivePerson( request );
	...
	public void reportAttachmentUpload(@Suspended final AsyncResponse asyncResponse, 
			@Context HttpServletRequest request, 
			@JaxrsParameterDescribe("汇报ID") @PathParam("id") String id, 
	...
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.MULTIPART_FORM_DATA)
	public void workAttachmentUpload(@Suspended final AsyncResponse asyncResponse, 
			@Context HttpServletRequest request, 
