...
MWF.xApplication.cms.Xform.Form = MWF.CMSForm =  new Class({
    ...
    options: {
        ...
        "saveOnClose" : false,
        "showAttachment" : true,
        "moduleEvents": ["queryLoad","postLoad","beforeLoad", "afterLoad", "beforeSave", "postSave", "afterSave", "beforeClose", "beforePublish", "postPublish", "afterPublish", "beforeModulesLoad", "afterModulesLoad"]
    },
            ...
            if (data.distinguishedName ){
                ...
                if( type ){
                    result.push({
                        ...
                        permissionObjectName : data.distinguishedName
                    })
                }
            }
        });
