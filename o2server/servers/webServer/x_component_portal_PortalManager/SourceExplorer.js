...
MWF.xApplication.portal.PortalManager.SourceExplorer = new Class({
    ...
    options: {
        "style": "default",
        "tooltip": {
            "create": MWF.xApplication.portal.PortalManager.LP.source.create,
            "search": MWF.xApplication.portal.PortalManager.LP.source.search,
            "searchText": MWF.xApplication.portal.PortalManager.LP.source.searchText,
            "noElement": MWF.xApplication.portal.PortalManager.LP.source.noNoticeText
        }
    },
    ...
    _createElement: function(e){
        ...
        var createDefaultPage = function(e, template){
            layout.desktop.getPageDesignerStyle(function(){
                ...
                layout.desktop.openApplication(e, "portal.SourceDesigner", options);
            }.bind(this));
        };
    ...
    _loadItemDataList: function(callback){
        this.app.restActions.listSource(this.app.options.application.id,callback);
    },
    _getItemObject: function(item){
        return new MWF.xApplication.portal.PortalManager.SourceExplorer.Source(this, item)
    },
...
MWF.xApplication.portal.PortalManager.SourceExplorer.Source= new Class({
	...
	_open: function(e){
        ...
        this.explorer.app.desktop.openApplication(e, "portal.SourceDesigner", options);
	},
	_getIcon: function(){
	...
	_getLnkPar: function(){
		return {
			...
			"par": "portal.SourceDesigner#{\"id\": \""+this.data.id+"\"}"
		};
	},
...
//		});
//	},
    deleteSource: function(callback){
		this.explorer.actions.deleteSource(this.data.id, function(){
			this.node.destroy();
			if (callback) callback();
		}.bind(this));
	}
