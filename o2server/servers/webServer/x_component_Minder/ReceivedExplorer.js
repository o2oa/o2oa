...
MWF.xApplication.Minder.ReceivedExplorer = new Class({
    ...
    loadList: function( filterData ){
        ...
        this.currentView = new MWF.xApplication.Minder.ReceivedExplorer.List( this.listNode, this.app, this, {
            templateUrl : this.path + this.options.style + ( this.getViewType() == "list" ? "/listItem_received.json" : "/tileItem.json" ),
            "scrollEnable" : true
        });
...
MWF.xApplication.Minder.ReceivedExplorer.List = new Class({
    ...
    _getCurrentPageData: function(callback, count){
        ...
        this.actions.listMyReceivedMind(id, count, filter, function(json){
