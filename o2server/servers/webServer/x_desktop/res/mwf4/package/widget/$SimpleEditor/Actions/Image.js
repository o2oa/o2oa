...
MWF.widget.SimpleEditor.Actions.Image = new Class({
    Implements: [Options, Events],
    options: {
        style: "default",
        title: MWF.LP.widget.SimpleEditor.insertImage
    },
    ...
    showDialog: function () {
        ...
        html += "         <image src='" + MWF.defaultPath + "/widget/$SimpleEditor/default/img/refresh.png' style='cursor:pointer;' id='imageRefresh' title='重置大小'>"
        html += "      </td>"
        html += "    </tr>";
        html += "    <tr>";
        html += "       <td width='50' style='padding:2px;'>"
