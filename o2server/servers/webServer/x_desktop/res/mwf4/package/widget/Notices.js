...
MWF.widget.Notices = new Class({
	...
	initialize: function(options){
		...
		this.path = MWF.defaultPath+"/widget/$Panel/";
		this.cssPath = MWF.defaultPath+"/widget/$Panel/"+this.options.style+"/css.wcss";
		this._loadCss();
		
		this.setStatus();
		
		MWF.widget.Panel.panels.push(this);
	},
	load: function(){
...
//			});
	...
	createTitleNode: function(){
		...
		this.titleNode.addEvent("click", function(){
			...
			var idx = maxIndex;
			MWF.widget.Panel.panels.each(function(panel){
	...
	closePanel: function(){
		...
		this.showHideMorph.start(this.css.container).chain(function(){
			MWF.widget.Panel.panels.erase(this);
