...
MWF.widget.Maplist = new Class({
    ...
    createItem: function(value, key){
        return new MWF.widget.Maplist.Item(this, value, key);
    },
	loadContent: function(obj){
		Object.each(obj, function(value, key){
			var item = this.createItem(value, key);
			//new MWF.widget.Maplist.Item(this, value, key)
			item.load();
...
MWF.widget.Maplist.Style = new Class({
    Implements: [Options, Events],
    Extends: MWF.widget.Maplist,
    createItem: function(value, key){
        return new MWF.widget.Maplist.Style.Item(this, value, key);
    }
});

MWF.widget.Maplist.Style.Item = new Class({
    Extends: MWF.widget.Maplist.Item,
    ...
    createImageContent: function(dlg){
        ...
        this.uploadImageAction = new Element("div", {"styles": this.maplist.css.imageEditActionNode, "text": MWF.LP.widget.uploadImg}).inject(actionArea);
        this.clearImageAction = new Element("div", {"styles": this.maplist.css.imageEditActionNode, "text": MWF.LP.widget.clearImg}).inject(actionArea);
        ...
        this.clearImageAction.addEvent("click", function(e){
            var _self = this;
            this.maplist.app.confirm("infor", e, MWF.LP.widget.clearImg_confirmTitle, MWF.LP.widget.clearImg_confirm, 300, 100, function(){
