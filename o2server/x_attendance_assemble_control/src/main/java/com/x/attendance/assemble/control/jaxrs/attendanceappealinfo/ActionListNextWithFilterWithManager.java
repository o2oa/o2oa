...
//查询带权限的申诉，部门管理员只查询部门的，公司管理员查询公司的
//考勤管理员或超级管理员查询所有的
public class ActionListNextWithFilterWithManager extends BaseAction {

	private static  Logger logger = LoggerFactory.getLogger(ActionListNextWithFilterWithManager.class);
