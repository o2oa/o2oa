...
@Entity
@Table(name = PersistenceProperties.OnlyOfficeFileVersion.table, uniqueConstraints = {
		@UniqueConstraint(name = PersistenceProperties.OnlyOfficeFileVersion.table+ JpaObject.IndexNameMiddle
				+ JpaObject.DefaultUniqueConstraintSuffix, columnNames = { JpaObject.IDCOLUMN,
						JpaObject.CREATETIMECOLUMN, JpaObject.UPDATETIMECOLUMN, JpaObject.SEQUENCECOLUMN }) })
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Storage(type = custom)
public class OnlyOfficeFileVersion extends StorageObject {

	private static final long serialVersionUID = -3571860069634404610L;
	private static final String TABLE = PersistenceProperties.OnlyOfficeFileVersion.table;
	...
	public OnlyOfficeFileVersion(){}

	public OnlyOfficeFileVersion(OnlyOfficeFile o){
		this.fileName = o.getFileName();
		this.status = o.getStatus();
		this.docId = o.getDocId();
		this.category = o.getCategory();
		this.relevanceId = o.getRelevanceId();
		this.fileVersion = Integer.valueOf(o.getFileVersion());
	...
	@FieldDescribe("原始文件ID")
	@Column(length = length_128B, name = ColumnNamePrefix + fileId_FIELDNAME)
	...
	@FieldDescribe("文件类型：diff|file")
	@Column(length = length_64B,name = ColumnNamePrefix + fileType_FIELDNAME)
	@CheckPersist(allowEmpty = true)
	...
	public static final String fileVersionInfo_FIELDNAME = "fileVersionInfo";
	@FieldDescribe("文件版本描述信息")
	@Lob
	@Basic(fetch = FetchType.EAGER)
	@Column(length = length_64K, name = ColumnNamePrefix + fileVersionInfo_FIELDNAME)
