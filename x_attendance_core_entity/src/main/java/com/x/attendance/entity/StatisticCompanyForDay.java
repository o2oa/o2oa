...
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.StatisticCompanyForDay.table)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class StatisticCompanyForDay extends SliceJpaObject {

	private static final long serialVersionUID = 5211190018798042409L;
	private static final String TABLE = PersistenceProperties.StatisticCompanyForDay.table;
	...
	public void prePersist() {
		...
		if (null == this.sequence) {
			this.sequence = StringUtils.join( this.statisticDate, this.companyName, this.getId() );
