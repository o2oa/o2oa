...
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.StatisticDepartmentForMonth.table)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class StatisticDepartmentForMonth extends SliceJpaObject {

	private static final long serialVersionUID = -3491074853394166341L;
	private static final String TABLE = PersistenceProperties.StatisticDepartmentForMonth.table;

	public StatisticDepartmentForMonth( Long lateCount, Long leaveEarlyCount, Long offDutyCount, Long onDutyCount, Double absenceDayCount,
			Double employeeCount, Double onDutyEmployeeCount, Double onSelfHolidayCount, Long lackOfTimeCount, Long abNormalDutyCount ){
	...
	public StatisticDepartmentForMonth( ){}
	/**
	 * 获取明细记录ID
	 */
	public String getId() {
	...
	public void prePersist() {
		...
		if (null == this.sequence) {
			this.sequence = StringUtils.join( this.statisticYear + this.statisticMonth, this.companyName, this.organizationName, this.getId() );
