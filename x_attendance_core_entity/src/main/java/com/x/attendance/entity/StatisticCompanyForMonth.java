...
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.StatisticCompanyForMonth.table)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class StatisticCompanyForMonth extends SliceJpaObject {

	private static final long serialVersionUID = 2327868796380781985L;
	private static final String TABLE = PersistenceProperties.StatisticCompanyForMonth.table;
	...
	public void prePersist() {
		...
		if (null == this.sequence) {
			this.sequence = StringUtils.join( this.statisticYear + this.statisticMonth, this.companyName, this.getId() );
