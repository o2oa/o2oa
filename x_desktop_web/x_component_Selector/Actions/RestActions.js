...
MWF.xApplication.Selector.contextRoot = "x_component_Selector";
MWF.xApplication.Selector.Actions = MWF.xApplication.Selector.Actions || {};
...
MWF.xApplication.Selector.Actions.RestActions = new Class({
    ...
    getPersonComplex: function(success, failure, name, async){
        this.action1.invoke({"name": "getPersonComplex","async": async, "parameter": {"name": name},	"success": success,	"failure": failure});
    },
