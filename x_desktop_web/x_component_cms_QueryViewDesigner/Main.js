...
MWF.xApplication.cms.QueryViewDesigner.Main = new Class({
	...
	onQueryLoad: function(){
		...
		if (!this.actions) this.actions = new MWF.xApplication.cms.ColumnManager.Actions.RestActions();
    ...
    getApplication:function(callback){
        if (!this.application){
            this.actions.getColumn(this.options.application, function(json){
    ...
    loadViewData: function(id, callback){
		this.actions.getQueryView(id, function(json){
			if (json){
                ...
                if (!this.application){
                    this.actions.getColumn(data.application, function(json){
                        this.application = {"name": json.data.appName, "id": json.data.id};
