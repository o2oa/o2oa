...
MWF.xApplication.cms.QueryViewDesigner.widget.PersonSelector = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "/x_component_cms_QueryViewDesigner/widget/$PersonSelector/";
        this.cssPath = "/x_component_cms_QueryViewDesigner/widget/$PersonSelector/"+this.options.style+"/css.wcss";
        this._loadCss();
            ...
            if (this.options.type.toLowerCase()=="duty"){
                ...
                this.options.names.each(function(name){
                    MWF.require("MWF.widget.Identity", function(){
                        ...
                        if (this.options.type.toLowerCase()=="category") this.identitys.push(new MWF.widget.Category({"name": name.name, "id": name.id}, this.node, explorer));
                ...
                "onComplete": function(items){
                    ...
                    MWF.require("MWF.widget.Identity", function(){
                        items.each(function(item){
                            ...
                            if (this.options.type.toLowerCase()=="category") this.identitys.push(new MWF.widget.Category(item.data, this.node, explorer));
