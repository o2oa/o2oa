...
MWF.xApplication.process.Application.WorkExplorer = new Class({
    ...
    selectedFilterItem: function(item){
        if (!item.hasClass("applicationFilterItemNode_over")){
            ...
            if (!this.filter) this.filter = {};
            this.filter[key] = [{"value": value, "name": name}];
...
MWF.xApplication.process.Application.WorkExplorer.Work = new Class({
    ...
    reload: function(callback){
        if (this.relative){
            ...
            this.explorer.actions.getWork(this.data.id, this.explorer.app.options.id, function(json){
                this.data = json.data;
    ...
    listRelatives: function() {
        if (this.data.splitting){
            this.explorer.actions.listRelatives(this.data.id, this.explorer.app.options.id, function(json){
                if (json.data){
    ...
    processWork: function(e){
        ...
        this.explorer.app.confirm("warn", e, lp.flowWorkTitle, text, 380, 130, function(){
            _self.explorer.actions.flowWork(_self.data.id, _self.explorer.app.options.id, {}, function(){
    ...
    rerouteWorkToActivity: function(activity, type, opinion, success, failure){
        this.explorer.actions.rerouteWork(function(json){
            if (success) success();
        }.bind(this), function(xhr, text, error){
            if (failure) failure(xhr, text, error);
        }, this.data.id, activity, type);
    },
    openWork: function(e){
    ...
    remove: function(e){
        ...
        this.explorer.app.confirm("warn", e, lp.deleteWorkTitle, text, 350, 120, function(){
            this.close();
            _self.explorer.app.confirm("warn", e, lp.deleteWorkTitle, {"html": lp.deleteAllWork}, 380, 180, function(){
    ...
    listAssignments: function(){
        this.explorer.actions.listAssignments(this.data.id, this.explorer.app.options.id, function(json){
    ...
    setActions: function(){
        ...
        if (this.data.control.allowProcessing){
            this.processNode = new Element("div", {"styles": this.css.actionProcessNode, "title": this.explorer.app.lp.flow}).inject(this.actionAreaNode);
        }
    ...
    removeTask: function(task){
        var id = task.data.id;
        this.explorer.actions.removeTask(id, this.explorer.app.options.id, function(json){
    ...
    removeDone: function(done){
        var id = done.data.id;
        this.explorer.actions.removeDone(id, this.explorer.app.options.id, function(json){
    ...
    removeRead: function(read){
        var id = read.data.id
        this.explorer.actions.removeRead(id, this.explorer.app.options.id, function(json){
    ...
    removeReaded: function(readed){
        ...
        this.explorer.actions.removeReaded(id, this.explorer.app.options.id, function(json){
...
MWF.xApplication.process.Application.WorkExplorer.Task = new Class({
    ...
    setTaskContent: function () {
        ...
        new MWF.widget.Identity({"name": this.data.identity}, this.personAreaNode, explorer, false, null, {"style": "task"});
    ...
    resetPeople: function (items) {
        ...
        this.explorer.actions.resetTask(this.data.id, this.explorer.app.options.id, data, function(){
    ...
    submitTask: function(routeName, opinion, processer, dlg){
        ...
        this.explorer.actions.flowTask(this.data.id, this.explorer.app.options.id, data, function(){
            processer.destroy();
            dlg.close();
...
MWF.xApplication.process.Application.WorkExplorer.Read = new Class({
    ...
    resetPeople: function (items) {
        ...
        this.explorer.actions.resetRead(this.data.id, this.explorer.app.options.id, data, function(){
            this.work.childNode.destroy();
            this.work.childNode = null;
            this.work.loadChild();
        }.bind(this));
    ...
    doFlagRead: function(){
        this.explorer.actions.flagRead(this.data.id, this.explorer.app.options.id, {}, function(){
            this.work.childNode.destroy();
            this.work.childNode = null;
            this.work.loadChild();
        }.bind(this));
