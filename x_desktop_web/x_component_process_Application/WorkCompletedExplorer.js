...
MWF.xApplication.process.Application.WorkCompletedExplorer = new Class({
    ...
    removeWorkCompleted: function(work){
        this.actions.removeWorkCompleted(work.data.id, this.app.options.id, function(json){
...
MWF.xApplication.process.Application.WorkCompletedExplorer.Work = new Class({
    ...
    reload: function(callback){
        this.explorer.actions.getWorkCompleted(this.data.id, this.explorer.app.options.id, function(json){
            this.data = json.data;
    ...
    listAssignments: function(){
        this.explorer.actions.listWorkCompletedAssignments(this.data.id, this.explorer.app.options.id, function(json){
