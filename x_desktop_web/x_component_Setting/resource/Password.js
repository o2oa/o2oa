...
MWF.xApplication.Setting.resource.Password = new Class({
    ...
    saveDocument: function(){
        ...
        this.app.actions.updateResPassword(this.json, function(){
