...
MWF.xApplication.Attendance.Main = new Class({
	...
	loadLayout: function(){
		...
		this.manageCompanys = [];
		this.restActions = new MWF.xApplication.Attendance.Actions.RestActions();
		this.createNode();
	...
	openPersonIndex : function(){
		MWF.xDesktop.requireApp("Attendance", "PersonIndex", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.PersonIndex(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	openPersonDetail : function(){
		MWF.xDesktop.requireApp("Attendance", "PersonDetail", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.PersonDetail(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	openDepartmentIndex : function(){
		MWF.xDesktop.requireApp("Attendance", "DepartmentIndex", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.DepartmentIndex(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	openDepartmentDetail : function(){
		MWF.xDesktop.requireApp("Attendance", "DepartmentDetail", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.DepartmentDetail(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	...
	openCompanyDetail : function(){
		MWF.xDesktop.requireApp("Attendance", "CompanyDetail", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.CompanyDetail(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	openSelfHoliday : function(){
		MWF.xDesktop.requireApp("Attendance", "SelfHolidayExplorer", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.SelfHolidayExplorer(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	openMyAppealDeal : function(){
		MWF.xDesktop.requireApp("Attendance", "MyAppealExplorer", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.MyAppealExplorer(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	...
	openImportedInvalidInfor : function(){
		MWF.xDesktop.requireApp("Attendance", "InvalidInforExplorer", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.InvalidInforExplorer(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	openAbnormalExport : function(){
		MWF.xDesktop.requireApp("Attendance", "AbnormalExportExplorer", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.AbnormalExportExplorer(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	...
	openStaticsCycleExplorer : function(){
		MWF.xDesktop.requireApp("Attendance", "StatisticsCycleExplorer", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.StatisticsCycleExplorer(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
	...
	openPersonSetting : function(){
		MWF.xDesktop.requireApp("Attendance", "PersonSettingExplorer", function(){
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.PersonSettingExplorer(this.explorerContent, this, this.restActions,{"isAdmin":this.isAdmin() } );
			this.explorer.load();
		}.bind(this));
	},
