...
MWF.xApplication.Attendance.PermissionExplorer.Permission = new Class({
    ...
    load: function(){
        if( this.data.organizationName )this.data.department = this.data.organizationName;
    ...
    createNode: function(){
        ...
        var html = "<table width='100%' height='200' border='0' cellPadding='0' cellSpacing='0'>" +
            ...
            "</tr>" +
            "<tr id='departmentArea'>" +
            "<td style='height: 30px; line-height: 30px;  text-align: left' >"+lp.department+":</td>" +
        ...
        this.department.addEvent("click",function(){
            this.selectDepartment( this.role.get("value") )
        }.bind(this))
    ...
    okCreate: function(e){
        var data = {
            ...
            //"organizationOu" : this.department.get("value")=="" ? "" : this.data.organizationOu,
    ...
    selectDepartment: function( u ){
        var options = {
            "type": u=="COMPANY" ? "company" : "department",
