...
MWF.xApplication.Attendance.AbnormalExportExplorer = new Class({
    ...
    initialize: function(node, app, actions, options){
        ...
        this.app = app;
        this.path = "/x_component_Attendance/$AbnormalExportExplorer/";
        this.cssPath = "/x_component_Attendance/$AbnormalExportExplorer/"+this.options.style+"/css.wcss";
        this._loadCss();
    ...
    loadView : function( filterData ){
        ...
        //this.view = new MWF.xApplication.Attendance.AbnormalExportExplorer.View(this.elementContentNode, this.app,this, this.viewData, this.options.searchKey );
...
MWF.xApplication.Attendance.AbnormalExportExplorer.View = new Class({
    Extends: MWF.xApplication.Attendance.Explorer.View,
    _createItem: function(data){
        //return new MWF.xApplication.Attendance.AbnormalExportExplorer.Document(this.table, data, this.explorer, this);
    },
...
MWF.xApplication.Attendance.AbnormalExportExplorer.Document = new Class({
