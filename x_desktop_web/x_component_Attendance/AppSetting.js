...
MWF.xApplication.Attendance.AppSetting = new Class({
    ...
    createNode: function(){
        ...
        var html = "<table width='100%' bordr='0' cellpadding='5' cellspacing='0' styles='formTable'>"+
            ...
            "<tr><td styles='formTableTitle' lable='APPEAL_AUDITOR_VALUE'></td>"+
        ...
        this.itemTemplate = {
            ...
            APPEAL_AUDITOR_TYPE : { text : "考勤结果申诉审核人确定方式",
                type : "select",
                value : d.APPEAL_AUDITOR_TYPE ,
                selectValue : ["人员属性","所属部门职位","指定人"] //,"指定角色"]
            },
            APPEAL_AUDITOR_VALUE : { text : "考勤结果申诉审核人确定内容",
                type : "text",
