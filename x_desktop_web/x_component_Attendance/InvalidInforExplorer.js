...
MWF.xApplication.Attendance.InvalidInforExplorer = new Class({
    ...
    initialize: function(node, app, actions, options){
        ...
        this.app = app;
        this.path = "/x_component_Attendance/$InvalidInforExplorer/";
        this.cssPath = "/x_component_Attendance/$InvalidInforExplorer/"+this.options.style+"/css.wcss";
        this._loadCss();
    ...
    loadView : function(){
        this.view = new MWF.xApplication.Attendance.InvalidInforExplorer.View(this.elementContentNode, this.app,this, this.viewData, this.options.searchKey );
        this.view.load();
        this.setContentSize();
    },
...
MWF.xApplication.Attendance.InvalidInforExplorer.View = new Class({
    Extends: MWF.xApplication.Attendance.Explorer.View,
    _createItem: function(data){
        return new MWF.xApplication.Attendance.InvalidInforExplorer.Document(this.table, data, this.explorer, this);
    },
...
MWF.xApplication.Attendance.InvalidInforExplorer.Document = new Class({
