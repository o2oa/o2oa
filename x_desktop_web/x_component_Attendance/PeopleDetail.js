...
MWF.xApplication.Attendance.PeopleDetail = new Class({
    ...
    loadTab : function(){
        ...
        MWF.require("MWF.widget.Tab", function(){
            ...
            //        this.selfHolidayExplorer = new MWF.xApplication.Attendance.PeopleDetail.SelfHolidayExplorer( this.selfHolidayArea, this );
...
MWF.xApplication.Attendance.PeopleDetail.SelfHolidayExplorer = new Class({
