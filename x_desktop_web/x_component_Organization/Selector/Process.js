...
MWF.xApplication.Organization.Selector.Process = new Class({
    ...
    _newItemCategory: function(data, selector, item, level){
        return new MWF.xApplication.Organization.Selector.Process.ItemCategory(data, selector, item, level)
    },
    ...
    _newItemSelected: function(data, selector, item){
        return new MWF.xApplication.Organization.Selector.Process.ItemSelected(data, selector, item)
    },
    _listItemByPinyin: function(callback, failure, key){
        return false;
    },
    _newItem: function(data, selector, container, level){
        return new MWF.xApplication.Organization.Selector.Process.Item(data, selector, container, level);
    }
});
MWF.xApplication.Organization.Selector.Process.Item = new Class({
...
MWF.xApplication.Organization.Selector.Process.ItemSelected = new Class({
...
MWF.xApplication.Organization.Selector.Process.ItemCategory = new Class({
