...
MWF.xApplication.process.FormDesigner.Module.Tab = MWF.FCTab = new Class({
	...
	_loadPageStyle: function(){
        if (!this.json.tabNodeContainer) this.json.tabNodeContainer = Object.clone(this.tabWidget.css.tabNodeContainer);
        if (!this.json.contentNodeContainer) this.json.contentNodeContainer = Object.clone(this.tabWidget.css.contentNodeContainer);
        if (!this.json.tabStyles) this.json.tabStyles = Object.clone(this.tabWidget.css.tabNode);
        if (!this.json.tabTextStyles) this.json.tabTextStyles = Object.clone(this.tabWidget.css.tabTextNode);
        if (!this.json.tabCurrentStyles) this.json.tabCurrentStyles = Object.clone(this.tabWidget.css.tabNodeCurrent);
        if (!this.json.tabTextCurrentStyles) this.json.tabTextCurrentStyles = Object.clone(this.tabWidget.css.tabTextNodeCurrent);
        if (!this.json.contentNodeContainer) this.json.contentNodeContainer.clear = "both";
		this._setTabWidgetStyles();
	},
