MWF.xDesktop.requireApp("cms.ApplicationManager", "DictionaryExplorer", null, false);
MWF.xApplication.cms.ApplicationManager.ScriptExplorer = new Class({
	Extends: MWF.xApplication.cms.ApplicationManager.DictionaryExplorer,
    ...
    _getItemObject: function(item, index){
        return new MWF.xApplication.cms.ApplicationManager.ScriptExplorer.Script(this, item, {index : index})
    },
    setTooltip: function(){
...
MWF.xApplication.cms.ApplicationManager.ScriptExplorer.Script = new Class({
	Extends: MWF.xApplication.cms.ApplicationManager.DictionaryExplorer.Dictionary,
