...
MWF.xDesktop.requireApp("cms.ApplicationManager", "FormExplorer", null, false);
MWF.xDesktop.requireApp("cms.ApplicationManager", "ViewExplorer", null, false);
MWF.xApplication.cms.ApplicationManager.CategoryExplorer = new Class({
    ...
    initialize: function(node, naviNode, actions, options){
        ...
        this.path = "/x_component_cms_ApplicationManager/$CategoryExplorer/";
        this.cssPath = "/x_component_cms_ApplicationManager/$CategoryExplorer/"+this.options.style+"/css.wcss";
    ...
    loadCategoryList : function( options ){
        this.categoryList = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.CategoryList(this, this.naviNode, {
    ...
    loadForm : function( ){
        this.formExplorer = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.FormExplorer(this.formNode, this.app.restActions, {style : "full"});
    ...
    loadView : function( ){
        this.viewExplorer = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.ViewExplorer(this.viewNode, this.app.restActions, {style : "full"});
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.CategoryList = new Class({
    Implements: [Options, Events],
    options : {
        columnId : ""
    },
    ...
    loadCategoryByData: function( cData, relativeNode, relativePosition, callback ){
        var category = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.Category( this, this.node, cData, {
    ...
    newCategory : function( relativeNode, positon ){
        var category = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.Category( this, this.node, {}, {
            "isNew" : true,
            "relativeNode" : relativeNode,
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.Category = new Class({
    Implements: [Options, Events],
    options: {
        "style": "default",
        "isNew" : false,
        ...
        "actions_edit" : [
            {
                ...
                "event": "click",
                "action": "saveCategory",
                "title": MWF.xApplication.cms.ApplicationManager.LP.category.saveCategory
            },
            {
                "name": "cancel",
                "icon": "cancel.png",
                ...
                "event": "click",
                "action": "cancel",
                "title": MWF.xApplication.cms.ApplicationManager.LP.category.cancelEdit
            }
        ],
        "actions_read": [
            {
                ...
                "event": "click",
                "action": "editCategory",
                "title": MWF.xApplication.cms.ApplicationManager.LP.category.editCategory
            },
            {
                ...
                "title": MWF.xApplication.cms.ApplicationManager.LP.category.insertCateogryBefore
            },
            {
            ...
            },
            {
                ...
                "title": MWF.xApplication.cms.ApplicationManager.LP.category.deleteCategory
            },
            {
                "name": "moveCategory",
                "icon": "turn.png",
                ...
                "event": "click",
                "action": "moveCategory",
                "title": MWF.xApplication.cms.ApplicationManager.LP.category.moveCategory
            }
        ]
    },
    ...
    createViewsNode: function( container, data ){
        var view = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.CategoryView( this, container, data  );
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.CategoryView = new Class({
    Implements: [Options, Events],
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.FormExplorer =  new Class({
    Extends: MWF.xApplication.cms.ApplicationManager.FormExplorer,
    Implements: [Options, Events],
    load: function(){
        //this.loadToolbar();
        this.loadContentNode();
    ...
    _getItemObject: function(item, index){
        return new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.Form(this, item, {"index":index});
    },
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.Form = new Class({
    Extends: MWF.xApplication.cms.ApplicationManager.FormExplorer.Form,
    options: {
        "where": "bottom",
        "index" : 1
    },
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.ViewExplorer =  new Class({
    Extends: MWF.xApplication.cms.ApplicationManager.ViewExplorer,
    Implements: [Options, Events],
    initialize: function(node, actions, options){
        this.setOptions(options);
        this.setTooltip();

        this.path = "/x_component_cms_ApplicationManager/$Explorer/";
        this.cssPath = "/x_component_cms_ApplicationManager/$Explorer/"+this.options.style+"/css.wcss";
    ...
    _getItemObject: function(item, index){
        ...
        var view = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer.View(this, item, {
...
MWF.xApplication.cms.ApplicationManager.CategoryExplorer.View = new Class({
    Extends: MWF.xApplication.cms.ApplicationManager.ViewExplorer.View,
    Implements: [Options],
    options: {
        "where": "bottom",
