MWF.xDesktop.requireApp("cms.ApplicationManager", "package", null, false);
MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", null, false);
MWF.xDesktop.requireApp("Organization", "Selector.package", null, false);
MWF.require("MWF.xAction.org.express.RestActions", null,false);
MWF.require("MWF.widget.Identity", null,false);
MWF.xApplication.cms.ApplicationManager.Main = new Class({
	...
	options: {
        ...
        "application" : null,
		"style": "default",
		"name": "cms.ApplicationManager",
		"icon": "icon.png",
		"width": "1100",
		"height": "720",
		"title": MWF.xApplication.cms.ApplicationManager.LP.title
	},
	onQueryLoad: function(){
		...
		this.lp = MWF.xApplication.cms.ApplicationManager.LP;
		this.currentContentNode = null;
	},
    loadApplication: function(callback){

        this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
...
//		}.bind(this));
    ...
    loadStartMenu: function(callback){
        ...
        this.menu = new MWF.xApplication.cms.ApplicationManager.Menu(this, this.startMenuNode, {
            "onPostLoad": function(){
    ...
    applicationProperty: function(){
        ...
        this.property = new MWF.xApplication.cms.ApplicationManager.ApplicationProperty(this, this.propertyConfiguratorContent);
        this.property.load();
    },
    ...
    loadCategoryConfig: function(){
        MWF.xDesktop.requireApp("cms.ApplicationManager", "CategoryExplorer", function(){
            MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                var navi = this.menu.itemObject.categoryConfig;
                var subNode = navi.retrieve( "subNode" );
                if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                this.categoryConfigurator = new MWF.xApplication.cms.ApplicationManager.CategoryExplorer(this.categoryConfiguratorContent, subNode, this.restActions, {
    ...
    loadFormConfig: function(){
        MWF.xDesktop.requireApp("cms.ApplicationManager", "FormExplorer", function(){
            MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                this.formConfigurator = new MWF.xApplication.cms.ApplicationManager.FormExplorer(this.formConfiguratorContent, this.restActions, { "title" : "表单配置" });
    ...
    createForm : function(){
        if( this.formConfigurator ){
            ...
            MWF.xDesktop.requireApp("cms.ApplicationManager", "FormExplorer", function(){
                MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                    if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                    this.formConfigurator = new MWF.xApplication.cms.ApplicationManager.FormExplorer(this.formConfiguratorContent, this.restActions);
                    this.formConfigurator.app = this;
                    this.formConfigurator._createElement();
                }.bind(this));
            }.bind(this));
    ...
    loadDataConfig: function(){
        MWF.xDesktop.requireApp("cms.ApplicationManager", "DictionaryExplorer", function(){
            MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                this.dataConfigurator = new MWF.xApplication.cms.ApplicationManager.DictionaryExplorer(this.dataConfiguratorContent, this.restActions, { "title" : "数据配置" });
    ...
    createDataConfig : function(){
        if( this.dataConfigurator ){
            ...
            MWF.xDesktop.requireApp("cms.ApplicationManager", "DictionaryExplorer", function(){
                MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                    if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                    this.dataConfigurator = new MWF.xApplication.cms.ApplicationManager.DictionaryExplorer(this.dataConfiguratorContent, this.restActions);
                    this.dataConfigurator.app = this;
                    this.dataConfigurator._createElement();
                }.bind(this));
            }.bind(this));
    ...
    loadScriptConfig: function(){
        MWF.xDesktop.requireApp("cms.ApplicationManager", "ScriptExplorer", function(){
            MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                this.scriptConfigurator = new MWF.xApplication.cms.ApplicationManager.ScriptExplorer(this.scriptConfiguratorContent, this.restActions, { "title" : "脚本配置" });
    ...
    createScriptConfig : function(){
        if( this.scriptConfigurator ){
            ...
            MWF.xDesktop.requireApp("cms.ApplicationManager", "ScriptExplorer", function(){
                MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                    if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                    this.scriptConfigurator = new MWF.xApplication.cms.ApplicationManager.ScriptExplorer(this.scriptConfiguratorContent, this.restActions);
                    this.scriptConfigurator.app = this;
                    this.scriptConfigurator._createElement();
                }.bind(this));
            }.bind(this));
    ...
    loadViewConfig: function(){
        MWF.xDesktop.requireApp("cms.ApplicationManager", "ViewExplorer", function(){
            MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                this.viewConfigurator = new MWF.xApplication.cms.ApplicationManager.ViewExplorer(this.viewConfiguratorContent, this.restActions, { "title" : "列表配置" });
    ...
    createView : function(){
        if( this.viewConfigurator ){
            ...
            MWF.xDesktop.requireApp("cms.ApplicationManager", "ViewExplorer", function(){
                MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                    if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                    this.viewConfigurator = new MWF.xApplication.cms.ApplicationManager.ViewExplorer(this.viewConfiguratorContent, this.restActions);
                    this.viewConfigurator.app = this;
                    this.viewConfigurator._createElement();
                }.bind(this));
            }.bind(this));
    ...
    loadQueryViewConfig: function(){
        MWF.xDesktop.requireApp("cms.ApplicationManager", "QueryViewExplorer", function(){
            MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                this.queryViewConfigurator = new MWF.xApplication.cms.ApplicationManager.QueryViewExplorer(this.queryViewConfiguratorContent, this.restActions, { "title" : "数据视图配置" });
    ...
    createQueryView : function(){
        if( this.queryViewConfigurator ){
            ...
            MWF.xDesktop.requireApp("cms.ApplicationManager", "QueryViewExplorer", function(){
                MWF.xDesktop.requireApp("cms.ApplicationManager", "Actions.RestActions", function(){
                    if (!this.restActions) this.restActions = new MWF.xApplication.cms.ApplicationManager.Actions.RestActions();
                    this.queryViewConfigurator = new MWF.xApplication.cms.ApplicationManager.QueryViewExplorer(this.queryViewConfiguratorContent, this.restActions);
                    this.queryViewConfigurator.app = this;
                    this.queryViewConfigurator._createElement();
                }.bind(this));
            }.bind(this));
...
MWF.xApplication.cms.ApplicationManager.Menu = new Class({
    Implements: [Options, Events],
...
MWF.xApplication.cms.ApplicationManager.ApplicationProperty = new Class({
   ...
   //     html += "<tr><td class='formTitle'>"+this.app.lp.application.icon+"</td><td id='formApplicationIcon'></td></tr>";
        ...
        this.nameInput = new MWF.xApplication.cms.ApplicationManager.Input(this.propertyContentNode.getElement("#formApplicationName"), this.data.name, this.app.css.formInput);
        this.aliasInput = new MWF.xApplication.cms.ApplicationManager.Input(this.propertyContentNode.getElement("#formApplicationAlias"), this.data.alias, this.app.css.formInput);
        this.descriptionInput = new MWF.xApplication.cms.ApplicationManager.Input(this.propertyContentNode.getElement("#formApplicationDescription"), this.data.description, this.app.css.formInput);
        this.sortInput = new MWF.xApplication.cms.ApplicationManager.Input(this.propertyContentNode.getElement("#formApplicationSort"), this.data.appInfoSeq, this.app.css.formInput);

        //this.typeInput = new MWF.xApplication.cms.ApplicationManager.Input(this.propertyContentNode.getElement("#formApplicationType"), this.data.applicationCategory, this.app.css.formInput);
    },
...
MWF.xApplication.cms.ApplicationManager.Input = new Class({
    Implements: [Events],
