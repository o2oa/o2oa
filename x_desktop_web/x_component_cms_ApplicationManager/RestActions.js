...
MWF.xApplication.cms.ApplicationManager.RestActions = new Class({
	...
	listApplicationAddress: function(success, failure){
		...
		var callback = new MWF.xApplication.cms.ApplicationManager.RestActions.Callback(success, failure);
...
//		MWF.getJSON(url, callback);
	...
	getUUID: function(){
		...
		var id = "";
		var callback = new MWF.xApplication.cms.ApplicationManager.RestActions.Callback(function(ids){
			id = ids.data[0].id;
		}, null);
...
MWF.xApplication.cms.ApplicationManager.RestActions.Callback = new Class({
