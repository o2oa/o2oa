...
MWF.xApplication.cms.ApplicationManager = MWF.xApplication.cms.ApplicationManager || {};

MWF.xDesktop.requireApp("cms.ApplicationManager", "lp."+MWF.language, null, false);
MWF.xDesktop.requireApp("cms.ApplicationManager", "package", null, false);

MWF.xApplication.cms.ApplicationManager.Explorer = new Class({
    ...
    _getItemObject: function(item, index){
        return MWF.xApplication.cms.ApplicationManager.Explorer.Item(this, item, {index : index })
    }
});

MWF.xApplication.cms.ApplicationManager.Explorer.Item = new Class({
    ...
    deleteItem: function(){
        if (!this.deleteMode){
            ...
            this.deleteActionNode.setStyle("background-image", "url("+"/x_component_cms_ApplicationManager/$Explorer/default/processIcon/deleteProcess_red1.png)");
