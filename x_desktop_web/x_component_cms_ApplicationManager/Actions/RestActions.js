...
MWF.xApplication.cms.ApplicationManager.Actions = MWF.xApplication.cms.ApplicationManager.Actions || {};
MWF.xDesktop.requireApp("cms.ApplicationManager", "package", null, false);
MWF.require("MWF.xDesktop.Actions.RestActions", null, false);
MWF.require("MWF.widget.UUID", null, false);
MWF.xApplication.cms.ApplicationManager.Actions.RestActions = new Class({
	initialize: function(){
		this.action = new MWF.xDesktop.Actions.RestActions("/Actions/action.json", "x_cms_assemble_control", "x_component_cms_ApplicationManager");
	},
