...
MWF.xApplication.cms.ApplicationManager.QueryViewExplorer = new Class({
    ...
    _getItemObject: function(item, index){
        return new MWF.xApplication.cms.ApplicationManager.QueryViewExplorer.View(this, item, {index : index})
    },
...
MWF.xApplication.cms.ApplicationManager.QueryViewExplorer.View = new Class({
