...
MWF.xApplication.cms.ApplicationManager.ViewExplorer = new Class({
    ...
    _getItemObject: function(item, index){
        return new MWF.xApplication.cms.ApplicationManager.ViewExplorer.View(this, item, {index:index})
    },
    setTooltip: function(){
...
MWF.xApplication.cms.ApplicationManager.ViewExplorer.View = new Class({
