...
MWF.xApplication.Org.Actions = MWF.xApplication.Org.Actions || {};
MWF.require("MWF.xDesktop.Actions.RestActions", null, false);
MWF.xApplication.Org.Actions.ExpressRestActions = new Class({
	initialize: function(){
		this.action = new MWF.xDesktop.Actions.RestActions("/Actions/expressAction.json", "x_organization_assemble_express", "x_component_Organization");
	},
    //公司---------------------------------------------------------------
