...
MWF.xApplication.cms.Xform.Log_bak = MWF.CMSLog =  new Class({
    ...
    loadWorkLogLine_table: function(log, idx){
        ...
        if (log.connected){
            iconTd.setStyle("background-image", "url("+"/x_component_cms_Xform/$Form/"+this.form.options.style+"/icon/ok14.png)");
        }else{
            iconTd.setStyle("background-image", "url("+"/x_component_cms_Xform/$Form/"+this.form.options.style+"/icon/rightRed.png)");
        }
