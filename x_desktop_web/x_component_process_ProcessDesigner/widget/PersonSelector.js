            ...
            if (this.options.type.toLowerCase()=="duty"){
                ...
                this.options.names.each(function(name){
                    MWF.require("MWF.widget.Identity", function(){
                        if (this.options.type.toLowerCase()=="identity") this.identitys.push(new MWF.widget.Identity({"name": name.name || name, "id": name.id}, this.node, explorer));
                        if (this.options.type.toLowerCase()=="department") this.identitys.push(new MWF.widget.Department({"name": name.name || name, "id": name.id}, this.node, explorer));
                        if (this.options.type.toLowerCase()=="company") this.identitys.push(new MWF.widget.Company({"name": name.name || name, "id": name.id}, this.node, explorer));
                        if (this.options.type.toLowerCase()=="person") this.identitys.push(new MWF.widget.Person({"name": name.name || name, "id": name.id}, this.node, explorer));
                        ...
                        if (this.options.type.toLowerCase()=="formfield") this.identitys.push(new MWF.widget.FormField({"name": name, "id": name}, this.node, explorer));
                    }.bind(this));
                }.bind(this));
            }
        }
                ...
                "onComplete": function(items){
                    ...
                    MWF.require("MWF.widget.Identity", function(){
                        items.each(function(item){
                            ...
                            if (this.options.type.toLowerCase()=="formfield") this.identitys.push(new MWF.widget.FormField(item.data, this.node, explorer));
