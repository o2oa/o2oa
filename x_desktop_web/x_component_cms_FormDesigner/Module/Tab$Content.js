...
MWF.xApplication.cms.FormDesigner.Module.Tab$Content = MWF.CMSFCTab$Content = new Class({
	Extends: MWF.CMSFC$Container,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Tab$Content/tab$Content.html",
		"actions": []
	},
	...
	initialize: function(tab, page, options){
		...
		this.path = "/x_component_cms_FormDesigner/Module/Tab$Content/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Tab$Content/"+this.options.style+"/css.wcss";
