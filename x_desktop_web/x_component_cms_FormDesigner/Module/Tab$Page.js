...
MWF.xApplication.cms.FormDesigner.Module.Tab$Page = MWF.CMSFCTab$Page = new Class({
	Extends: MWF.CMSFC$Element,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Tab$Page/tab$Page.html",
		"actions": [
			{
		    	"name": "move",
		    	"icon": "move1.png",
	...
	initialize: function(tab, page, options){
		...
		this.path = "/x_component_cms_FormDesigner/Module/Tab$Page/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Tab$Page/"+this.options.style+"/css.wcss";
	...
	"delete": function(e){
		var module = this;
		this.form.designer.confirm("warn", e, MWF.CMSFD.LP.notice.deleteElementTitle, MWF.CMSFD.LP.notice.deleteElement, 300, 120, function(){
