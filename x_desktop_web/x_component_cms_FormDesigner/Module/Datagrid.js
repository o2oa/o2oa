...
MWF.xDesktop.requireApp("cms.FormDesigner", "Module.Datagrid$Data", null, false);
MWF.xDesktop.requireApp("cms.FormDesigner", "Module.Datagrid$Title", null, false);
MWF.xDesktop.requireApp("cms.FormDesigner", "Module.Table$Td", null, false);
MWF.xApplication.cms.FormDesigner.Module.Datagrid = MWF.CMSFCDatagrid = new Class({
	...
	initialize: function(form, options){
		...
		this.path = "/x_component_cms_FormDesigner/Module/Datagrid/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Datagrid/"+this.options.style+"/css.wcss";
		...
		this.form.getTemplateData("Datagrid$Data", function(data){
			tds.each(function(td){
				...
				if (!json){
					...
					tdContainer = new MWF.CMSFCDatagrid$Data(this.form);
	...
	_getElements: function(){
		...
		this.form.getTemplateData("Datagrid$Title", function(data){
			ths.each(function(th){
				...
				if (!json){
					var moduleData = Object.clone(data);
					thElement = new MWF.CMSFCDatagrid$Title(this.form);
