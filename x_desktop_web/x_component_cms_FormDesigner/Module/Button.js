...
MWF.xApplication.cms.FormDesigner.Module.Button = MWF.CMSFCButton = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Button/button.html"
	},
	
	initialize: function(form, options){
		this.setOptions(options);
		
		this.path = "/x_component_cms_FormDesigner/Module/Button/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Button/"+this.options.style+"/css.wcss";
