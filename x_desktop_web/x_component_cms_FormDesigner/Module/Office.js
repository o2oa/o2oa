...
MWF.xApplication.cms.FormDesigner.Module.Office = MWF.CMSFCOffice = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Office/office.html"
	},
	
	initialize: function(form, options){
		this.setOptions(options);
		
		this.path = "/x_component_cms_FormDesigner/Module/Office/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Office/"+this.options.style+"/css.wcss";
