...
MWF.xApplication.cms.FormDesigner.Module.Iframe = MWF.CMSFCIframe = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Iframe/iframe.html"
	},
	
	initialize: function(form, options){
		this.setOptions(options);
		
		this.path = "/x_component_cms_FormDesigner/Module/Iframe/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Iframe/"+this.options.style+"/css.wcss";
        ...
        if (this.json.valueType!="script"){
		    if (this.json.src){
                ...
                this.iconNode.getFirst().setStyles({
                    "background": "url("+MWF.defaultPath+"/cms/FormCustom/Module/Iframe/default/icon/close.png) 5px center no-repeat"
                });
