...
MWF.xApplication.cms.FormDesigner.Module.$Module = MWF.CMSFC$Module = new Class({
	...
	"delete": function(e){
		...
		this.form.designer.confirm("warn", module.node, MWF.CMSFD.LP.notice.deleteElementTitle, MWF.CMSFD.LP.notice.deleteElement, 300, 120, function(){
	...
	showProperty: function(){
		if (!this.property){
			this.property = new MWF.xApplication.cms.FormDesigner.Property(this, this.form.designer.propertyContentArea, this.form.designer, {
