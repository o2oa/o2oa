...
MWF.xApplication.cms.FormDesigner.Module.Datagrid$Title = MWF.CMSFCDatagrid$Title = new Class({
	Extends: MWF.CMSFC$Element,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Datagrid$Title/datagrid$Title.html",
		"actions": [
			{
				"name": "insertCol",
				"icon": "insertCol1.png",
	...
	initialize: function(form, options){
		...
		this.path = "/x_component_cms_FormDesigner/Module/Datagrid$Title/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Datagrid$Title/"+this.options.style+"/css.wcss";
	...
	deleteCol: function(e){
		var module = this;
		this.form.designer.confirm("warn", e, MWF.LP.cms.notice.deleteColTitle, MWF.LP.cms.notice.deleteCol, 300, 120, function(){
			module._deleteCol();
			this.close();
		}, function(){
			this.close();
