...
MWF.xApplication.cms.FormDesigner.Module.Table = MWF.CMSFCTable = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Table/table.html",
        "propertyMultiPath": "/x_component_cms_FormDesigner/Module/Table$Td/table$tdMulti.html",
		"multiActions": [
			{
		    	"name": "mergerCell",
		    	"icon": "mergerCell.png",
		    	"event": "click",
		    	"action": "mergerCell",
		    	"title": MWF.CMSFD.LP.formAction.mergerCell
		    }
		]
	},
	...
	initialize: function(form, options){
		...
		this.path = "/x_component_cms_FormDesigner/Module/Table/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Table/"+this.options.style+"/css.wcss";
		...
		this.form.getTemplateData("Table$Td", function(data){
			tds.each(function(td){
				...
				if (!json){
					...
					tdContainer = new MWF.CMSFCTable$Td(this.form);
