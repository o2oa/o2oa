...
MWF.xApplication.cms.FormDesigner.Module.Html = MWF.CMSFCHtml = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Html/html.html"
	},
	
	initialize: function(form, options){
		this.setOptions(options);
		
		this.path = "/x_component_cms_FormDesigner/Module/Html/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Html/"+this.options.style+"/css.wcss";
