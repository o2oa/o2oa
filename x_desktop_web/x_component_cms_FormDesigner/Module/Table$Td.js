...
MWF.xApplication.cms.FormDesigner.Module.Table$Td = MWF.CMSFCTable$Td = new Class({
	Extends: MWF.CMSFC$Container,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Table$Td/table$td.html",
		...
		"actions": [
		    {
		    	...
		    	"event": "click",
		    	"action": "insertRow",
		    	"title": MWF.CMSFD.LP.formAction.insertRow
		    },
		    {
		    	"name": "insertCol",
		    	"icon": "insertCol1.png",
		    	"event": "click",
		    	"action": "insertCol",
		    	"title": MWF.CMSFD.LP.formAction.insertCol
		    },
		    {
		    	"name": "deleteRow",
		    	"icon": "deleteRow1.png",
		    	"event": "click",
		    	"action": "deleteRow",
		    	"title": MWF.CMSFD.LP.formAction.deleteRow
		    },
		    {
		    	"name": "deleteCol",
		    	"icon": "deleteCol1.png",
		    	"event": "click",
		    	"action": "deleteCol",
		    	"title": MWF.CMSFD.LP.formAction.deleteCol
		    },
		    {
		    	"name": "splitCell",
		    	"icon": "splitCell.png",
		    	"event": "click",
		    	"action": "splitCell",
		    	"title": MWF.CMSFD.LP.formAction.splitCell
		    }
		]
	},
	...
	initialize: function(form, options){
		...
		this.path = "/x_component_cms_FormDesigner/Module/Table$Td/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Table$Td/"+this.options.style+"/css.wcss";
...
//	},
		...
		MWF.require("MWF.widget.Dialog", function(){
			...
			var dlg = new MWF.DL({
				...
				"buttonList": [
				    ...
				    {
				    	"text": MWF.CMSFD.LP.button.cancel,
				    	"action": function(){
				    		this.close();
				    	}
				    }
		...
		for (var n=1; n<=rows; n++){
			...
			for (var m=1; m<=cellNumber; m++){
				...
				this.form.getTemplateData("Table$Td", function(data){
					...
					var tdContainer = new MWF.CMSFCTable$Td(this.form);
	...
	deleteRow: function(e){
		var module = this;
		this.form.designer.confirm("warn", e, MWF.CMSFD.LP.notice.deleteRowTitle, MWF.CMSFD.LP.notice.deleteRow, 300, 120, function(){
			module._deleteRow();
			this.close();
		}, function(){
			this.close();
...
//		var currentRowspan = this.node.get("rowspan").toInt() || 1;
	...
	deleteCol: function(e){
		var module = this;
		this.form.designer.confirm("warn", e, MWF.CMSFD.LP.notice.deleteColTitle, MWF.CMSFD.LP.notice.deleteCol, 300, 120, function(){
			module._deleteCol();
			this.close();
		}, function(){
			this.close();
