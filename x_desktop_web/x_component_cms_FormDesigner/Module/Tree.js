...
MWF.xApplication.cms.FormDesigner.Module.Tree = MWF.CMSFCTree = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Tree/tree.html"
	},
	
	initialize: function(form, options){
		this.setOptions(options);
		
		this.path = "/x_component_cms_FormDesigner/Module/Tree/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Tree/"+this.options.style+"/css.wcss";
