...
MWF.xApplication.cms.FormDesigner.widget.ActionsEditor = new Class({
	...
	initialize: function(node, designer, options){
		...
		this.path = "/x_component_cms_FormDesigner/widget/$ActionsEditor/";
		this.cssPath = "/x_component_cms_FormDesigner/widget/$ActionsEditor/"+this.options.style+"/css.wcss";
		this._loadCss();
...
MWF.xApplication.cms.FormDesigner.widget.ActionsEditor.ButtonAction = new Class({
    ...
    setEvent: function(){
        ...
        this.delButton.addEvent("click", function(){
            var _self = this;
            this.editor.designer.confirm("warn", this.delButton, MWF.CMSFD.LP.notice.deleteButtonTitle, MWF.CMSFD.LP.notice.deleteButton, 300, 120, function(){
                _self.destroy();
