...
(function(){
    ...
    COMMON.Browser.Platform.isMobile = (COMMON.Browser.Platform.name.match(/(?:ios|webos|android|windows\sphone)/) ) ? true : false;
...
COMMON.Request = function(o){
	...
	this.async = (o.async==false) ? false : true;
...
COMMON.AjaxModule = {
	...
	"mootools": COMMON.contentPath+"/res/framework/mootools/mootools-1.6.0.min.js",
	"mootools-more": COMMON.contentPath+"/res/framework/mootools/mootools-1.6.0.min.js",
    ...
    "ace-tools": COMMON.contentPath+"/res/framework/ace/src-min/ext-language_tools.js",
    "kity": COMMON.contentPath+"/res/framework/kityminder/kity/kity.min.min.js",
	...
	init: function(){
		...
		this["mootools"] = COMMON.contentPath+"/res/framework/mootools/mootools-1.6.0.min.js";
		this["mootools-more"] = COMMON.contentPath+"/res/framework/mootools/mootools-1.6.0.min.js";
		this["mwf"] = COMMON.contentPath+"/res/mwf4/MWF.min.js";
		
		this["ckeditor"] = COMMON.contentPath+"/res/framework/htmleditor/ckeditor/ckeditor.js";
        ...
        this["d3"] = COMMON.contentPath+"/res/framework/d3/d3.js";

        this["ace"] = COMMON.contentPath+"/res/framework/ace/src-min/ace.js";
        this["ace-tools"] = COMMON.contentPath+"/res/framework/ace/src-min/ext-language_tools.js";
