            ...
            (function(){
                ...
                layout.openApplication = function(e, appNames, options, status){
                    ...
                    if (layout.app){
                        ...
                        sessionStorage[appName+(id ? id : "")+"status"] = JSON.stringify( status );
                        if( layout.debugger ){
                ...
                layout.load = function(){
                    ...
                    this.isAuthentication(function(){
                        ...
                        if( urlParams.app ){
                            ...
                            option = sessionStorage[ appName+ (id ? id : "") +"options" ];
                            if(option){
                            ...
                            status = sessionStorage[ appName+ (id ? id : "") +"status" ];
                            if(status){
                                status = JSON.parse(option)
                            }
                        }else{
                            var appName = "Forum";
                        }
