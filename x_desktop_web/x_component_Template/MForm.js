...
var MForm = new Class({
    ...
    formatRead : function(itemData) {
        ...
        this.itemContainers.each(function( el ) {
            ...
            //if (obj.type == "file" || obj.type == "attachment") {
            //    if ( obj.value && obj.value != "") {
            //        if( jQuery.type( obj.value ) == "string" ){
            //            jQuery.each(obj.value.split("^^"), function(i, n) {
            //                str = "<div><a target='_blank' href='" + self.filePreLink + encodeURIComponent(n) + "' class='inputlink'>" + n + "</a></div>";
            //                el.html(str);
            //            })
            //        }
            //    }
    ...
    formatEdit : function(itemData, isNew, unid) {
        ...
        this.labelContainers.each(function( el ) {
            ...
            if (self.options.showNotEmptyFlag && obj.notEmpty) {
                el.set("html","<span style='color:red;'>*</span>" + obj.text)
            } else {
                el.set("text",obj.text);
            }
        });
