...
public class QueryStatAction extends StandardJaxrsAction {
	...
	@HttpMethodDescribe(value = "列示QueryStat对象,上一页.", response = WrapOutQueryStat.class)
	@GET
	...
	@HttpMethodDescribe(value = "获取QueryStat内容.", response = WrapOutQueryStat.class)
	@GET
	@Path("{id}")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@HttpMethodDescribe(value = "创建QueryStat.", request = WrapInQueryStat.class, response = WrapOutId.class)
	@POST
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
	...
	@HttpMethodDescribe(value = "根据应用列示视图.", response = WrapInQueryStat.class)
	@GET
	...
	@HttpMethodDescribe(value = "模拟执行queryStat")
	@PUT
	@Path("{id}/simulate")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
