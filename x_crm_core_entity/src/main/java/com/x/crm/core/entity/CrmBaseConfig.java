...
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.CrmConfig.CrmBaseConfig.table)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class CrmBaseConfig extends SliceJpaObject {
	private static final long serialVersionUID = 3856138316794473791L;
	private static final String TABLE = PersistenceProperties.CrmConfig.CrmBaseConfig.table;
	...
	@EntityFieldDescribe("值类型: identity | number | date | text")
