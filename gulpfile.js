...
---------------------------------------------------------------------`);
    return gulp.src("o2server/evn-o2server-commons-scripting-commons/commons/**/*")
...
function clear_commons_git(cb){
    var dest = ['o2server/evn-o2server-commons-scripting-commons/', 'o2server/commons_git.tar.gz'];
    del(dest, { force: true });
    cb();
}
