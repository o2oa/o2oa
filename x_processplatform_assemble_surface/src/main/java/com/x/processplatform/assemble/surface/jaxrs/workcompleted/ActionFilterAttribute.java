...
public class ActionFilterAttribute extends ActionBase {
	...
	// private List<NameValueCountPair> listApplicationPair(Business business,
	// EffectivePerson effectivePerson)
	// throws Exception {
	// EntityManager em =
	// business.entityManagerContainer().get(WorkCompleted.class);
	// CriteriaBuilder cb = em.getCriteriaBuilder();
	// CriteriaQuery<String> cq = cb.createQuery(String.class);
	// Root<WorkCompleted> root = cq.from(WorkCompleted.class);
	// Predicate p = cb.equal(root.get(WorkCompleted_.creatorPerson),
