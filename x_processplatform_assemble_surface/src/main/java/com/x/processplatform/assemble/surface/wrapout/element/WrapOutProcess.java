...
public class WrapOutProcess extends Process {
	...
	private List<WrapOutCondition> conditionList;
	...
	public List<WrapOutCondition> getConditionList() {
		return conditionList;
	}

	public void setConditionList(List<WrapOutCondition> conditionList) {
