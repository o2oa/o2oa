...
class ActionCreateDataPath0 extends ActionBase {

	ActionResult<WrapOutId> execute(String applicationDictFlag, String applicationFlag, String path0,
		...
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			this.create(business, applicationDict, jsonElement, path0);
			emc.commit();
