...
public class ReadCompletedAction extends StandardJaxrsAction {
	...
	@HttpMethodDescribe(value = "列示当前用户的WorkCompleted对象,下一页.", response = WrapOutReadCompleted.class)
	@GET
	...
	@HttpMethodDescribe(value = "列示当前用户的WorkCompleted对象,上一页.", response = WrapOutReadCompleted.class)
	@GET
	...
	@HttpMethodDescribe(value = "列示指定应用当前用户的ReadCompleted对象,下一页.", response = WrapOutReadCompleted.class)
	@GET
	...
	@HttpMethodDescribe(value = "列示指定应用当前用户的ReadCompleted对象,上一页.", response = WrapOutReadCompleted.class)
	@GET
	...
	@HttpMethodDescribe(value = "列示指定流程当前用户的ReadCompleted对象,下一页.", response = WrapOutReadCompleted.class)
	@GET
	...
	@HttpMethodDescribe(value = "列示指定流程当前用户的ReadCompleted对象,上一页.", response = WrapOutReadCompleted.class)
	@GET
	...
	@HttpMethodDescribe(value = "获取用户对ReadCompleted的过滤信息,下一页.", response = WrapOutReadCompleted.class, request = WrapInFilter.class)
	@POST
	...
	@HttpMethodDescribe(value = "获取用户对ReadCompleted的过滤信息,上一页.", response = WrapOutReadCompleted.class, request = WrapInFilter.class)
	@POST
	...
	@HttpMethodDescribe(value = "管理删除已阅.", response = WrapOutId.class)
	@DELETE
	@Path("{id}/manage")
	@Produces(HttpMediaType.APPLICATION_JSON_UTF_8)
	@Consumes(MediaType.APPLICATION_JSON)
