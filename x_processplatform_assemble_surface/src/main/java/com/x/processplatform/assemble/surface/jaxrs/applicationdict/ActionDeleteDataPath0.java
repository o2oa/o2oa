...
class ActionDeleteDataPath0 extends ActionBase {

	ActionResult<WrapOutId> execute(String applicationDictFlag, String applicationFlag, String path0) throws Exception {
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			this.delete(business, applicationDict, path0);
			emc.commit();
