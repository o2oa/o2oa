...
//		}
	...
	checkUUID: function(){
		...
		idCount += this.process.endList.length;
		idCount += this.process.manualList.length;
		idCount += this.process.conditionList.length;
        idCount += this.process.choiceList.length;
		idCount += this.process.parallelList.length;
		idCount += this.process.splitList.length;
		idCount += this.process.mergeList.length;
		idCount += this.process.embedList.length;
		idCount += this.process.invokeList.length;
		idCount += this.process.cancelList.length;
		idCount += this.process.routeList.length;
