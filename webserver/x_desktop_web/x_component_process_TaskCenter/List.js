MWF.xApplication.process.TaskCenter.List = new Class({
            ...
            MWF.xDesktop.requireApp("process.Work", "Processor", function(){
                new MWF.xApplication.process.Work.Processor(dlg.content, this.selectedTask[0].data, {
                    ...
                    "onSubmit": function(routeName, opinion){
                        _self.submitDatchTask(routeName, opinion, this);
                        dlg.close();
                        delete this;
                    }
                })
    ...
    submitDatchTask: function(routeName, opinion, processor){
        this.hideDatch();
        this.selectedTask.each(function(item){
            item.submitTask(routeName, opinion, processor, true);
        }.bind(this));
        this.selectedTask = [];
    }
...
MWF.xApplication.process.TaskCenter.List.Item = new Class({
    ...
    submitTask: function(routeName, opinion, processor, flag){
