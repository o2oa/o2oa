...
MWF.xApplication.process.ApplicationExplorer.Main = new Class({
        ...
        this.restActions.listApplicationCategory(function(json){
            ...
            json.data.each(function(category){
                if (category.applicationCategory){
                    this.createCategoryItemNode(category.applicationCategory, category.count);
                }else{
    ...
    cancelCreateApplication: function(e){
        ...
        if ($("createApplicationName").get("value") || $("createApplicationAlias").get("value") || $("createApplicationDescription").get("value")){
            this.confirm("warn", e, this.options.tooltip.createApplication_cancel_title, this.options.tooltip.createApplication_cancel, "320px", "100px", function(){
    ...
    deleteSelectedElements: function(e){
        ...
        this.confirm("infor", e, this.lp.application.deleteElementsTitle, {"html":confirmStr}, 530, 210, function(){
            ...
            _self.confirm("infor", e, _self.lp.application.deleteElementsTitle, {"html":confirmStr}, 420, 160, function(){
                var deleted = [];
                var doCount = 0;
...
MWF.xApplication.process.ApplicationExplorer.Application = new Class({
    ...
    loadTitleNode: function(){
        ...
        this.nameNode = new Element("div", {
            ...
            "text": this.data.name,
            "title": this.data.name+"--"+(this.data.applicationCategory || this.app.options.tooltip.unCategory)
        }).inject(this.titleNode);
        this.typeNode = new Element("div", {
            "styles": this.css.applicationItemTypeNode,
            "text": "--"+(this.data.applicationCategory || this.app.options.tooltip.unCategory)
        }).inject(this.titleNode);
    },
