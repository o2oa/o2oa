...
MWF.xApplication.cms.DictionaryDesigner.Dictionary = new Class({
    ...
    initialize: function(designer, data, options){
        ...
        this.areaNode = new Element("div", {"styles": {"overflow": "hidden"}});
    ...
    createChildrenItems: function(){
        if (!this.childrenItemCreated){
            switch(this.type){
                case "array":
                    this.value.each(function(v, idx){
                        this.children.push(this.createNewItem(idx, v, this, this.level+1, this.dictionary, false));
                    }.bind(this));
                    break;
                case "object":
                    Object.each(this.value, function(v, key){
                        this.children.push(this.createNewItem(key, v, this, this.level+1, this.dictionary, false));
                    }.bind(this));
                    break;
                default:
                    //nothing
