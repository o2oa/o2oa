...
MWF.xApplication.query.StatDesigner.Stat.Column = new Class({
    ...
    changeViewSelected: function(json){
        ...
        if (json){
            ...
            if (this.view.json.view){
                if (!this.view.queryView){
                    this.view.designer.actions.getView(this.view.json.view, function(view){
    ...
    checkColumn: function(){
        var flag = true;
        if (!this.view.queryView){
            this.designer.actions.getView(this.view.json.view, function(view){
                this.view.queryView = JSON.decode(view.data.data);
            }.bind(this), null, false);
        }

        var col = this.view.queryView.selectList.filter(function(c){
