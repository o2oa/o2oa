    ...
    loadOrgWidget: function(value, node){
        ...
        if (value && value.length){
            value.each(function(data){
                ...
                switch (flag.toLowerCase()){
                    case "i":
                        new MWF.widget.O2Identity(data, node, {"style": "xform"});
                        break;
                    case "p":
                        new MWF.widget.O2Person(data, node, {"style": "xform"});
                        break;
                    case "u":
                        new MWF.widget.O2Unit(data, node, {"style": "xform"});
                        break;
                    case "g":
                        new MWF.widget.O2Group(data, node, {"style": "xform"});
                        break;
                    default:
                        new MWF.widget.O2Other(data, node, {"style": "xform"});
                }
            }.bind(this));
        }
    },
