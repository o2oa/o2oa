 ...
 */
class MeetingRoomFragmentPresenter : BasePresenterImpl<MeetingRoomFragmentContract.View>(),
        MeetingRoomFragmentContract.Presenter {
                    ...
                    .flatMap { response ->
                        ...
                        resultList.map {
                            ...
                            it.roomList.map { room ->
                                roomList.add(room.copyToVO(startTime, endTime))
                            }
