...
class DemoAlertFragment: DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(DialogFragment.STYLE_NO_FRAME, R.style.demoAlertDialogStyle) //NO_FRAME就是dialog无边框，0指的是默认系统Theme
    }
...
//        val width = (metrics.widthPixels * 0.98).toInt() //DialogSearch的宽
        window?.setLayout(context?.dip(315) ?:315, context?.dip(485)?:485)
