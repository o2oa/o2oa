...
package net.zoneland.x.bpm.mobile.v1.zoneXBPM.utils.zxing.camera;
...
//			}
			...
			Log.i(TAG, "capture rectangle left:"+leftOffset+",top:"+topOffset+", right:"+(leftOffset + width)+", bottom:"+(topOffset + height));
