...
/**
 * 皮肤插件
 *   ChangeColorIconWithText 中的 icon 属性
 * Created by fancyLou on 2017/11/14.
 * Copyright © 2017 O2. All rights reserved.
 */

class IconChangeColorIconSkinAttr(attrName:String="", originResId:Int=0, resName:String=""):  BaseSkinAttr(attrName, originResId, resName) {
            ...
            FancySkinManager.instance().getResourceManager()?.let { manager ->
                ...
                if (drawable is BitmapDrawable) {
                    if (drawable.bitmap!=null) {
                        view.setMIconBitmap(drawable.bitmap)
                    }
                }
            }
        }
    ...
    override fun copy(attrName: String, originResId: Int, resName: String): BaseSkinAttr {
        return IconChangeColorIconSkinAttr(attrName, originResId, resName)
    }
}