...
MWF.xApplication.process.Xform.WritingBoard = MWF.APPWritingBoard =  new Class(
    ...
    _loadUserInterface: function(){
        ...
        if( !this.readonly && !this.json.isReadonly ){
            ...
            actionNode.addEvent("click", function(){
                ...
                if (layout.mobile){
                    o2.writingBoardCallback = function( str ){
                        var data = JSON.parse( str );
                        this.setData( data ? data.fileId : "" );
                        this.validation();
                        o2.writingBoardCallback = null;
                    }.bind(this);
                    // 兼容cms编辑表单
                    ...
                    var jsonString = JSON.stringify({
                        "mwfId" : this.json.id,
                        "callback" : "o2.writingBoardCallback",
    ...
    selectImage: function(d, callback){
        ...
        MWF.xDesktop.requireApp("process.Xform", "widget.WritingBoard", function(){
            this.writingBoard = new MWF.xApplication.process.Xform.widget.WritingBoard(this.form.app, {
                "style": "default",
                "aspectRatio" : ratio,
                ...
                "onChange" : function(){
                    callback( { src : this.writingBoard.imageSrc, id : this.writingBoard.imageId } );
                }.bind(this)
            });
            this.writingBoard.load();
        }.bind(this));
    },
