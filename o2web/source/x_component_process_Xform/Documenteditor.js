    ...
    /** @lends MWF.xApplication.process.Xform.Documenteditor# */
    {
        ...
        _createPage: function (callback, callbackAftreLoad) {
            ...
            var url =
                this.json.documentTempleteType === 'cus'
                    ...
                    : '../x_component_process_FormDesigner/Module/Documenteditor/templete/' +
                      (this.json.documentTempleteName || 'standard') +
                      '.html';
            url = url + (url.indexOf('?') !== -1 ? '&' : '?') + 'v=' + o2.version.v;

            this._clearCopytoTrs();
            fetch(o2.filterUrl(url))
                .then(function (res) {
                    return res.text();
                })
                .then(
        ...
        getTempleteJson: function (callback) {
            if (this.templeteJson) {
                ...
                o2.getJSON(
                    o2.filterUrl('../x_component_process_FormDesigner/Module/Documenteditor/templete/templete.json'),
                    function (json) {
        ...
        getShowControl: function () {
            var control = {};
            control.copiesSecretPriority = this._getShow(
                'copiesSecretPriority',
                'copiesSecretPriorityShow',
                'copiesSecretPriorityShowScript',
            );
        ...
        reSetShow: function (control) {
            ...
            debugger;
            if (
                (!control.copyto || !this.layout_copytoContent) &&
                (!control.copyto2 || !this.layout_copyto2Content) &&
                (!control.editionUnit || !this.layout_edition_issuance_unit) &&
                (!control.editionDate || !this.layout_edition_issuance_date) &&
                this.layout_editionArea.querySelectorAll('.doc_layout').length == 0
            ) {
                ...
                if (!this.copyToOrder) {
                    ...
                    if (this.layout_copytoContentTr && this.layout_copyto2ContentTr) {
                        //需要知道顺序
                        if (
                            this.layout_copytoContentTrP &&
                            this.layout_copyto2ContentTrP &&
                            this.layout_copytoContentTrP == this.layout_copyto2ContentTrP
                        ) {
                ...
                if (
                    ...
                    if (
                        this.layout_editionArea &&
                        (this.contentNode.getElement('.doc_layout_edition_issuance_date') ||
                            this.contentNode.getElement('.doc_layout_edition_issuance_unit')) &&
                        this.contentNode.querySelectorAll('.doc_layout').length == 0
                    ) {
                ...
                if (this.layout_editionArea && (this.layout_edition_issuance_date || this.layout_edition_issuance_unit)) {
                    ...
                    for (var i = 0; i < trs.length; i++) {
                        ...
                        for (var n = 0; n < tds.length; n++) {
                            ...
                            if (tdClassList.indexOf('line_top_thin_bottom_thick') != -1)
                                tdClassList = tdClassList.erase('line_top_thin_bottom_thick');
                            if (tdClassList.indexOf('line_top_thick_bottom_thin') != -1)
                                tdClassList = tdClassList.erase('line_top_thick_bottom_thin');
                            if (tdClassList.indexOf('line_top_thick_bottom_thick') != -1)
                                tdClassList = tdClassList.erase('line_top_thick_bottom_thick');
                            ...
                            if (i == 0 && i != trs.length - 1) {
                                if (tdClassList.indexOf('line_top_thin_bottom_thin') != -1)
                                    tdClassList = tdClassList.erase('line_top_thin_bottom_thin');
        ...
        reSetEdit: function (control) {
                    ...
                    this.layout_subject.addEvent(
                        ...
                        function (e) {
                            ...
                            if (!subject) {
                                ...
                                this.form.app.notice(
                                    MWF.xApplication.process.Xform.LP.subjectEmpty,
                                    'error',
                                    this.layout_subject,
                                    {x: 'center', y: 'top'},
                                    {x: 0, y: 60},
            ...
            if (this.layout_issuanceUnit) {
                if (!this.json.issuanceUnitValueData && this.json.issuanceUnitValueType == 'data') {
                    ...
                    this.layout_issuanceUnit.addEvent(
                        'blur',
                        function (e) {
                            ...
                            if (!issuanceUnit) {
                                ...
                                this.form.app.notice(
                                    MWF.xApplication.process.Xform.LP.issuanceUnitEmpty,
                                    'error',
                                    this.layout_issuanceUnit,
                                    {x: 'center', y: 'top'},
                                    {x: 0, y: 60},
                                );
                                e.preventDefault();
            ...
            this._createEditor(
                ...
                function () {
                    ...
                    if (!text || text == MWF.xApplication.process.Xform.LP.documentEditor.attachmentInfor) {
                        ...
                        this['attachmentTextEditor'].insertHtml(
                            '<div aria-label="分页符" class="cke_pagebreak" contenteditable="false" data-cke-display-name="pagebreak" data-cke-pagebreak="1" style="page-break-after: always" title="分页符"></div>' +
            ...
            this._loadFiletextPage(
                function () {
                    ...
                    if (this.form.businessData.data['$work']) {
                        ...
                        o2.Actions.load('x_processplatform_assemble_surface').DocumentVersionAction.listWithJobCategory(
                            id,
                            this.json.id,
                            function (json) {
                                this.historyDocumentList = json.data;
                                if (this.historyDocumentList.length) {
                                    o2.Actions.load('x_processplatform_assemble_surface').DocumentVersionAction.get(
                                        this.historyDocumentList[this.historyDocumentList.length - 1].id,
                                        function (json) {
        ...
        checkSaveNewEdition: function (callback) {
            ...
            if (this.form.businessData.work) {
                ...
                o2.Actions.load('x_processplatform_assemble_surface').DocumentVersionAction.create(
                    this.form.businessData.work.id,
                    editionData,
                    function (json) {
        ...
        checkSaveNewHistroy: function () {
            var p = o2.Actions.load('x_processplatform_assemble_surface').DocumentRevisionAction.getLast(
            ...
            p.then(
                function (json) {
                    if (!json.data || json.data.data != this.data.filetext) {
                        ...
                        return o2.Actions.load('x_processplatform_assemble_surface').DocumentRevisionAction.create(
                            this.form.businessData.work.id,
                            data,
                        );
                    }
        ...
        resetToolbarEvent: function (node) {
            if (Browser.ie11) {
                if (!this.waitLocation) {
                    this.waitLocation = window.setTimeout(
                        function () {
            ...
            if (this.allowEdit) {
                if (this.pages.length) {
                    ...
                    if (fileTextNode) {
                        ...
                        html =
                            '<span MWFnodetype="MWFToolBarButton" MWFButtonImage="../x_component_process_Xform/$Form/default/icon/editdoc.png" title="' +
                            MWF.xApplication.process.Xform.LP.editdoc +
                            '" MWFButtonAction="_switchReadOrEditInline" MWFButtonText="' +
                            MWF.xApplication.process.Xform.LP.editdoc +
                            '"></span>';
        ...
        _checkScale: function (offset) {
            ...
            if (this.pages.length) {
                ...
                // }
                if (this.history && this.history.historyListAreaNode)
                    contentSize_x = contentSize_x - this.history.historyListAreaNode.getComputedSize().totalWidth - 2;
                ...
                function (data, filename) {
                    if (filename) {
                        ...
                        if (this.form.businessData.work && !this.form.businessData.work.completedTime) {
                            ...
                            this.form.workAction.getWorkcompletedAttachmentStream(
                                data.id,
                                this.form.businessData.workCompleted
                                    ? this.form.businessData.workCompleted.id
                                    : this.form.businessData.work.id,
                            );
                        }
                    }
        ...
        getHistory: function (callback, nodiff) {
            if (this.history) {
                ...
                MWF.xDesktop.requireApp(
                    'process.Xform',
                    'widget.DocumentHistory',
                    function () {
        ...
        locationFiletextToolbar: function (editorName) {
            ...
            if (toolbarNode) {
                ...
                if (scrollNode) {
                    ...
                    if (editorName) {
                        if (this.reLocationAttachmentTextToolbarFun)
                            this.filetextScrollNode.removeEvent('scroll', this.reLocationAttachmentTextToolbarFun);
                        if (!this.reLocationAttachmentTextToolbarFun)
                            this.reLocationAttachmentTextToolbarFun = function () {
                        ...
                        if (this.reLocationFiletextToolbarFun)
                            this.filetextScrollNode.removeEvent('scroll', this.reLocationFiletextToolbarFun);
                        if (!this.reLocationFiletextToolbarFun)
                            this.reLocationFiletextToolbarFun = this.reLocationFiletextToolbarEvent.bind(this);
        ...
        _loadToolbars: function () {
            ...
            var editdoc,
                printdoc,
                history,
                fullscreen = MWF.xApplication.process.Xform.LP.fullScreen;
            ...
            if (this.allowPrint) {
                html +=
                    '<span MWFnodetype="MWFToolBarButton" MWFButtonImage="../x_component_process_Xform/$Form/default/icon/print.png" title="' +
                    printdoc +
                    '" MWFButtonAction="_printDoc" MWFButtonText="' +
                    printdoc +
                    '"></span>';
            }
            if (this.allowHistory) {
                html +=
                    '<span MWFnodetype="MWFToolBarButton" MWFButtonImage="../x_component_process_Xform/$Form/default/icon/versions.png" title="' +
                    history +
                    '" MWFButtonAction="_historyDoc" MWFButtonText="' +
                    history +
                    '"></span>';
            }
            if (this.json.canFullScreen !== 'n') {
                html +=
                    '<span MWFnodetype="MWFToolBarButton" MWFButtonImage="../x_component_process_Xform/$Form/default/icon/fullscreen.png" title="' +
                    fullscreen +
                    '" MWFButtonAction="fullScreen" MWFButtonText="' +
                    fullscreen +
                    '"></span>';
            }
            ...
            //    取消双野功能 todo
            this.doublePageAction = new Element('div', {
                styles: this.css.doc_toolbar_doublePage,
                text: MWF.xApplication.process.Xform.LP.doublePage,
            }).inject(this.toolbarNode);
            this.doublePageAction.addEvent(
                'click',
                function () {
                    if (this.options.pageShow !== 'double') {
                        this._doublePage();
            ...
            this.zoomSelectAction.addEvent(
                'change',
                function (e) {
        ...
        fullScreen: function (bt) {
            ...
            if (text === MWF.xApplication.process.Xform.LP.returnScreen) {
                ...
                if (this.fullScrollNode) {
                    if (!this.fullScrollNodeResizeFun)
                        this.fullScrollNodeResizeFun = function () {
        ...
        createWaitSplitPage: function () {
            ...
            this.waitSplitPageNode = new Element('div', {
                styles: this.form.css.waitSplitPageNode,
                text: MWF.xApplication.process.Xform.LP.computePage,
            }).inject(this.node);
        ...
        _getEditorConfig: function (editorName) {
            ...
            editorConfig.removeButtons =
                'EasyImageUpload,ExportPdf,Source,Save,NewPage,Preview,Print,Templates,Paste,PasteFromWord,Scayt,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Bold,Italic,Underline,Strike,Subscript,Superscript,CopyFormatting,RemoveFormat,Outdent,Indent,Blockquote,CreateDiv,BidiLtr,BidiRtl,Language,Link,Unlink,Anchor,Image,Flash,HorizontalRule,Smiley,SpecialChar,PageBreak,Iframe,TextColor,BGColor,Maximize,ShowBlocks,About,Styles,Font,FontSize';
            ...
            if (editorName) {
                ...
                if (!editorConfig['format_附件序号'])
                    editorConfig['format_附件序号'] = {
                        name: '附件序号',
                        element: 'div',
                        styles: {
                            'font-family': '黑体',
                ...
                if (!editorConfig['format_附件标题'])
                    editorConfig['format_附件标题'] = {
                        name: '附件标题',
                        element: 'div',
                        styles: {
                            'font-family': '方正小标宋简体',
        ...
        loadCkeditorFiletext: function (callback, inline, node, editorName) {
            if (node || this.layout_filetext) {
                o2.load(
                    '../o2_lib/htmleditor/ckeditor4161/ckeditor.js',
                    function () {
                        CKEDITOR.disableAutoInline = true;
                        ...
                        try {
                            ...
                            editor.on('afterPaste', function (e) {}.bind(this));
                            editor.on('afterPasteFromWord', function (e) {}.bind(this));
                            ...
                            editor.on(
                                ...
                                function (e) {
                                    ...
                                    while (
                                        scrollNode &&
                                        (scrollNode.getScrollSize().y <= scrollNode.getSize().y ||
                                            (scrollNode.getStyle('overflow') !== 'auto' && scrollNode.getStyle('4-y') !== 'auto'))
                                    ) {
                                        scrollNode = scrollNode.getParent();
                                    }
                                    if (scrollNode) {
                            ...
                            if (this.json.textIndent !== 'n') {
                                (node || this.layout_filetext).addEvent(
                                    'keyup',
                                    function (ev) {
        ...
        _bindFieldChange: function (name, dataItem, dom) {
            ...
            if (field) {
                var bindFun = function () {
                    ...
                    if (this[dom]) {
                        if (
                            dom == 'layout_redHeader' ||
                            dom == 'layout_issuanceUnit' ||
                            dom == 'layout_meetingAttendContent' ||
                            dom == 'layout_meetingLeaveContent' ||
                            dom == 'layout_meetingSitContent' ||
                            dom == 'layout_meetingRecordContent' ||
                            dom == 'layout_signer'
                        ) {
        ...
        _computeData: function (ev) {
            ...
            this._computeItemData(
                'attachment',
                'attachmentValueType',
                'attachmentValueData',
                'attachmentValueScript',
                ev,
                'layout_attachment',
            );
            this._computeItemData(
                'issuanceUnit',
                'issuanceUnitValueType',
                'issuanceUnitValueData',
                'issuanceUnitValueScript',
                ev,
                'layout_issuanceUnit',
            );
            this._computeItemData(
                'issuanceDate',
                'issuanceDateValueType',
                'issuanceDateValueData',
                'issuanceDateValueScript',
                ev,
                'layout_issuanceDate',
            );
            this._computeItemData(
            ...
            this._computeItemData(
                'editionUnit',
                'editionUnitValueType',
                'editionUnitValueData',
                'editionUnitValueScript',
                ev,
                'layout_edition_issuance_unit',
            );
            this._computeItemData(
                'editionDate',
                'editionDateValueType',
                'editionDateValueData',
                'editionDateValueScript',
                ev,
            ...
            this._computeItemData(
                'meetingAttend',
                'meetingAttendValueType',
                'meetingAttendValueData',
                'meetingAttendValueScript',
                ev,
                'layout_meetingAttendContent',
            );
            this._computeItemData(
                'meetingLeave',
                'meetingLeaveValueType',
                'meetingLeaveValueData',
                'meetingLeaveValueScript',
                ev,
                'layout_meetingLeaveContent',
            );
            this._computeItemData(
                'meetingSit',
                'meetingSitValueType',
                'meetingSitValueData',
                'meetingSitValueScript',
                ev,
                'layout_meetingSitContent',
            );
            this._computeItemData(
                'meetingRecord',
                'meetingRecordValueType',
                'meetingRecordValueData',
                'meetingRecordValueScript',
                ev,
                'layout_meetingRecordContent',
            );

            Object.each(
                this.json.customFields,
                function (field, k) {
        ...
        getData: function () {
            ...
            if (this.layout_annotation) {
                ...
                if (annotation.substring(annotation.length - 1, annotation.length) == '）')
        ...
        setAttachmentData: function () {
            ...
            if (this.data.attachment && this.data.attachment.length && this.data.attachment.each) {
                ...
                this.data.attachment.each(
                    function (name, idx) {
                        tmpdiv.set('html', this.attachmentTemplete);
                        if (this.data.attachment.length === 1) {
                            tmpdiv.getElement('p').setStyles({'margin-left': '0px', 'text-indent': '0px'});
                        }
        ...
        filterHtml: function (html) {
            var content = html.replace(/(?:<script[\s\S]*?)(?:(?:<\/script>)|(?:\/>))/gim, '');
            // content = content.replace(/(?<=[\"\'])javascript\:(?=.*")/gmi, "");
            //content = content.replace(/(?<=\s)on\w*|src|href(?=\=[\"\'])/gmi, function(match){
            content = content.replace(/\son\w*|src|href(?=\=[\"\'])/gim, function (match) {
                return 'data-' + match;
            });
            return content;
        },
        ...
        setData: function (data, diffFiletext) {
            if (data) {
                ...
                if (diffFiletext) {
                    ...
                    var html = data.filetext.replace(
                        /(?:<script(?:\s+[\w-]+(?:=(?:"[^"]*"|'[^']*'))?)*\s*>([\s\S]*?)<\/script\s*>)|(?:on\w+\s*=\s*(?:"[^"]*"|'[^']*'))|(?:javascript:.*)/g,
                        '',
                    );
                ...
                if (this.layout_meetingAttendTitle)
                    this.layout_meetingAttendTitle.set('text', data.meetingAttendTitle || this.json.defaultValue.meetingAttendTitle || ' ');
                if (this.layout_meetingLeaveTitle)
                    this.layout_meetingLeaveTitle.set('text', data.meetingLeaveTitle || this.json.defaultValue.meetingLeaveTitle || ' ');
                if (this.layout_meetingSitTitle)
                    this.layout_meetingSitTitle.set('text', data.meetingSitTitle || this.json.defaultValue.meetingSitTitle || ' ');

                if (this.layout_meetingAttendContent)
                    this.layout_meetingAttendContent.set('html', this.filterHtml(data.meetingAttend || ' '));
                ...
                if (this.layout_meetingRecordContent)
                    this.layout_meetingRecordContent.set('html', this.filterHtml(data.meetingRecord || ' '));
        ...
        toWord: function (callback, name, cb, notSave) {
            var docNmae =
                name || this.json.toWordFilename || this.form.businessData.data.subject || this.form.businessData.data['$work'].title;
            this.getData();
            this.reload(
                function () {
        ...
        toWordServiceService: function (body, callback, cb) {
            ...
            o2.Actions.get('x_processplatform_assemble_surface').docToWord(
                this.form.businessData.work.id,
                body,
                function (json) {
                    if (this.form.businessData.workCompleted) {
                        o2.Actions.get('x_processplatform_assemble_surface').getAttachmentWorkcompleted(
                            json.data.id,
                            this.form.businessData.workCompleted.id,
                            function (attjson) {
                        ...
                        o2.Actions.get('x_processplatform_assemble_surface').getAttachment(
                            json.data.id,
                            this.form.businessData.work.id,
                            function (attjson) {
                                if (callback) callback(attjson.data);
        ...
        toWordOOXMLService: function (formData, oo_content, callback, cb) {
            ...
            o2.Actions.get('x_processplatform_assemble_surface').V2UploadWorkOrWorkCompleted(
                this.form.businessData.work.id,
                formData,
                oo_content,
                function (json) {
        ...
        showToWord: function (att_word) {
            ...
            if (attModule) {
                var atts = [];
                attModule.attachmentController.attachments.each(
                    function (att) {
