 ...
 */
MWF.xApplication.orggrid.BaseInfor = new Class({
...
MWF.xApplication.orggrid.attribute = new Class({
...
MWF.xApplication.orggrid.PersonExplorer.PersonAttribute = new Class({
    Extends: MWF.xApplication.orggrid.attribute
});
MWF.xApplication.orggrid.PersonExplorer.PersonIdentity = new Class({
    Extends: MWF.xApplication.orggrid.attribute,
