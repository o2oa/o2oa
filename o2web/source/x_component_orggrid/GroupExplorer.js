...
MWF.xDesktop.requireApp("orggrid", "RoleExplorer", null, false);
MWF.xApplication.orggrid.GroupExplorer = new Class({
    ...
    _newElement: function(data, explorer){
        return new MWF.xApplication.orggrid.GroupExplorer.Group(data, explorer, this.isEditor);
    },
...
MWF.xApplication.orggrid.GroupExplorer.Group = new Class({
    ...
    showItemProperty: function(){
        this.content = new MWF.xApplication.orggrid.GroupExplorer.GroupContent(this);
    },
    ...
    _getIcon: function(){
        return "../x_component_orggrid/$Explorer/default/icon/group.png";
    }
});
MWF.xApplication.orggrid.GroupExplorer.GroupContent = new Class({
    ...
    _showItemPropertyTitle: function(){
        this.titleInfor = new MWF.xApplication.orggrid.GroupExplorer.GroupContent.TitleInfor(this);
    },
    _showItemPropertyBottom: function(){
        this.bottomInfor = new MWF.xApplication.orggrid.GroupExplorer.GroupContent.BottomInfor(this);
    },
    ...
    _listBaseInfor: function(){
        this.baseInfor = new MWF.xApplication.orggrid.GroupExplorer.GroupContent.BaseInfor(this);
    },
...
MWF.xApplication.orggrid.GroupExplorer.GroupContent.TitleInfor = new Class({
    Extends: MWF.xApplication.orggrid.RoleExplorer.RoleContent.TitleInfor,
    _getIcon: function(){
        return "../x_component_orggrid/$Explorer/default/icon/group70.png";
    }
});

MWF.xApplication.orggrid.GroupExplorer.GroupContent.BottomInfor = new Class({
...
MWF.xApplication.orggrid.GroupExplorer.GroupContent.BaseInfor = new Class({
    Extends: MWF.xApplication.orggrid.RoleExplorer.RoleContent.BaseInfor,
    ...
    edit: function(){
        ...
        if( this.data.id ){
            this.tooltip = new MWF.xApplication.orggrid.GroupExplorer.GroupContent.UniqueTooltip(this.explorer.app.content, tdContents[1], this.explorer.app, {}, {
                axis : "y",
                position : {
                    x : "right"
                },
...
MWF.xApplication.orggrid.GroupExplorer.GroupContent.UniqueTooltip = new Class({
    Extends: MTooltips,
    _getHtml : function(){
        var html =
