...
MWF.xApplication.query.ViewDesigner.Main = new Class({
	Extends: MWF.xApplication.Common.Main,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"name": "query.ViewDesigner",
		"icon": "icon.png",
		"title": MWF.APPDVD.LP.title,
		"appTitle": MWF.APPDVD.LP.title,
		"id": "",
        "tooltip": {
            "unCategory": MWF.APPDVD.LP.unCategory
        },
		"actions": null,
		"category": null,
		"processData": null
...
MWF.xApplication.query.ViewDesigner.View.NewNameForm = new Class({
    Extends: MPopupForm,
    Implements: [Options, Events],
    options: {
        "style": "design",
        ...
        "hasIcon": false,
        "draggable": true,
        "title" : MWF.xApplication.query.ViewDesigner.LP.newView
    },
    _createTableContent: function () {
        ...
        MWF.xDesktop.requireApp("Template", "MForm", function () {
            this.form = new MForm(this.formTableArea, this.data || {}, {
                ...
                hasColon: true,
                itemTemplate: {
                    selectQuery : { text: MWF.xApplication.query.ViewDesigner.LP.application , type : "org",  orgType : "Query", defaultValue :  this.data.queryName, orgWidgetOptions : {
                        "canRemove" : false
                    }},
                    name: {text: MWF.xApplication.query.ViewDesigner.LP.name, notEmpty: true}
                }
            }, this.app);
            this.form.load();
        }.bind(this),null, true)
