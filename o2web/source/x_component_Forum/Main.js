    ...
    createPersonNode : function( container, personName ){
        ...
        persons.each( function(userName, i){
            Promise.resolve( MWFForum.getDisplayName( userName ) ).then(function (name) {
                ...
                span.addEvents({
                    mouseover: function () {
                        this.node.setStyles(this.obj.css.person_over)
                    }.bind({node: span, obj: this}),
                    mouseout: function () {
                        this.node.setStyles(this.obj.css.person)
                    }.bind({node: span, obj: this}),
                    click: function () {
                        this.obj.openPerson(this.userName)
                    }.bind({userName: userName, obj: this})
                });
