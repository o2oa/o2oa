MWF.CMSSD = MWF.xApplication.cms.ScriptDesigner;
MWF.CMSSD.options = {
	"multitask": true,
	"executable": false
};
//MWF.xDesktop.requireApp("cms.ColumnManager", "Actions.RestActions", null, false);
MWF.xDesktop.requireApp("cms.ScriptDesigner", "Script", null, false);
MWF.require("MWF.xDesktop.UserData", null, false);
MWF.xApplication.cms.ScriptDesigner.Main = new Class({
	Extends: MWF.xApplication.Common.Main,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"name": "cms.ScriptDesigner",
		"icon": "icon.png",
		"title": MWF.CMSSD.LP.title,
		"appTitle": MWF.CMSSD.LP.title,
		"id": "",
		"actions": null,
		"category": null,
		"processData": null
...
//		this.processData = this.options.processData;
    ...
    loadScriptListNodes: function(){
        this.scriptListTitleNode = new Element("div", {
            ...
            "text": MWF.CMSSD.LP.scriptLibrary
    ...
    loadScriptByData: function(node, e){
        ...
        if (openNew){
            this.loadScriptData(script.id, function(data){
                var script = new MWF.xApplication.cms.ScriptDesigner.Script(this, data);
                script.load();
            }.bind(this), true);
        }
        //var _self = this;
        ...
        //    }
        //};
        //this.desktop.openApplication(e, "cms.ScriptDesigner", options);
    },
...
//				var y = e.event.y;
    ...
    loadScript: function(){
		...
		this.getScriptData(this.options.id, function(data){
			this.script = new MWF.xApplication.cms.ScriptDesigner.Script(this, data);
			this.script.load();
                ...
                if (this.status.openScripts){
                    this.status.openScripts.each(function(id){
                        this.loadScriptData(id, function(data){
                            ...
                            var script = new MWF.xApplication.cms.ScriptDesigner.Script(this, data, {"showTab": showTab});
                            script.load();
                        }.bind(this), true);
                    }.bind(this));
                }
        ...
        if (this.scriptTab.showPage){
            ...
            script.save(function(){
                if (script==this.script){
                    ...
                    this.setTitle(MWF.CMSSD.LP.title + "-"+name);
