...
var MWFCalendarv2DayView = MWF.xApplication.calendarv2.DayView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_calendarv2/$DayView/";
        this.cssPath = "../x_component_calendarv2/$DayView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
    ...
    loadCalendar: function(){
        ...
        this.calendar = new MWFCalendarv2DayView.Calendar(this, date  );
...
MWFCalendarv2DayView.DayWidth;
MWFCalendarv2DayView.HourHeight = 48;
MWFCalendarv2DayView.DayHeight = MWFCalendarv2DayView.HourHeight*24;
MWFCalendarv2DayView.DayMsec = 3600 * 24 * 1000;

MWFCalendarv2DayView.Calendar = new Class({
    Implements: [Events],
        ...
        if( this.isToday( this.date ) ){
            ...
            this.nowTimeNode = new Element("div",{
                styles : {
                    ...
                    "top" : nowTdPosition.y + ( (mintues - 2) / 60 ) * MWFCalendarv2DayView.HourHeight,
                    "height" : "2px",
                    "width" : MWFCalendarv2DayView.DayWidth,
    ...
    loadwholeDay : function( json ){
        this.wholeDay = new MWFCalendarv2DayView.Calendar.wholeDay( this, json, this.date);
    },
    ...
    loadDay: function(  dataArray ){
        this.day = new MWFCalendarv2DayView.Calendar.Day( this.dataTd, this.date, this, dataArray);
    },
    ...
    resetBodySize: function(){
        ...
        var hourTdX = 60;
        var tdX = MWFCalendarv2DayView.DayWidth = size.x - 40 - hourTdX;
    ...
    getIndexByPage: function( page ){
        ...
        var row = ( page.y - pos.y ) / MWFCalendarv2DayView.HourHeight;
    ...
    cellDrag: function(td, e){
        ...
        if(( this.pageOffsetHeight + MWFCalendarv2DayView.HourHeight * 1.5) > ( this.scrollNodeHeight + scrollNodeTop )){
            window.setTimeout( function(){
                this.scrollNode.scrollTo(0, scrollNodeTop + MWFCalendarv2DayView.HourHeight )
            }.bind(this), 200)
        }else if( this.pageOffsetHeight - MWFCalendarv2DayView.HourHeight * 1.5 < scrollNodeTop ){
            window.setTimeout( function(){
                this.scrollNode.scrollTo(0, scrollNodeTop - MWFCalendarv2DayView.HourHeight )
            }.bind(this), 200)
        }
...
MWFCalendarv2DayView.Calendar.wholeDay = new Class({
    Implements: [Events],
    ...
    load: function(){
        ...
        this.rangeList.each( function(r , i){
            var d = r.data;
            if( !d )return null;
            this.documentList.push( new MWFCalendarv2DayView.Calendar.wholeDayDocument( this, d, r ) );
        }.bind(this))
...
MWFCalendarv2DayView.Calendar.wholeDayDocument = new Class({
    ...
    load: function(){
        ...
        //    items.push( new MWFCalendarv2DayView.Calendar.wholeDayItem( this, d, i ) )
        //}.bind(this))
    },
    ...
    getCoordinate : function(){
        ...
        var width = (  diff / MWFCalendarv2DayView.DayMsec  ) * MWFCalendarv2DayView.DayWidth - 2;
        var left = ( ( dateStart - this.day.startTime ) / MWFCalendarv2DayView.DayMsec ) * MWFCalendarv2DayView.DayWidth + 3;
        //var marginRight = ( ( this.weekDateEnd - dateEnd ) / MWFCalendarv2DayView.DayMsec) * MWFCalendarv2DayView.DayWidth;
        return {
            top : top + 2,
            left : left,
...
MWFCalendarv2DayView.Calendar.Day = new Class({
    Implements: [Events],
    ...
    load: function(){
        ...
        this.rangeList.each( function(r , i){
            ...
            this.documentList.push( new MWFCalendarv2DayView.Calendar.Document(this.container, this, d, r ) );
        }.bind(this))
    },
    sortRange : function(){
        this.rangeList.sort( function(range1, range2){
...
MWFCalendarv2DayView.Calendar.Document = new Class({
    ...
    getCoordinate : function(){
        ...
        var height = Math.floor( ( ( range.endTime - range.startTime ) / MWFCalendarv2DayView.DayMsec ) * MWFCalendarv2DayView.DayHeight)-width_div;

        if(height < 16) height = 16;

        var top = Math.floor( ( ( range.startTime - this.day.startTime ) / MWFCalendarv2DayView.DayMsec ) * MWFCalendarv2DayView.DayHeight)-top_div;
        //var width = Math.floor(  MWFCalendarv2DayView.DayWidth / length )-2;
        //var left = ( width + 2)* index + 1;

        //var width = Math.floor(  MWFCalendarv2DayView.DayWidth / range.path.length  )-5;
        //var left = ( width + 5)* range.path.indexOf( data.id ) + 3;

        var width = Math.floor(  MWFCalendarv2DayView.DayWidth / this.day.rangeList.length  )-5;
        if( width > 150 ){
            width = 150;
        }
