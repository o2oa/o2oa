...
//MWF.xApplication.calendarv2.widget = MWF.xApplication.calendarv2.widget || {};
...
o2.widget.Schedule = o2.Schedule = new Class({
	...
	initialize: function(container, app, options){
		...
		this.path = this.options.path || "../x_component_calendarv2/widget/$Schedule/";

		this.cssPath = "../x_component_calendarv2/widget/$Schedule/"+this.options.style+"/css.wcss";
	...
	load: function(){
		...
		this.app = {
			...
			lp : MWF.xApplication.calendarv2.LP,
...
o2.Schedule.Calendar = new Class({
	...
	openEventForm : function(data){
		var form = new MWF.xApplication.calendarv2.EventForm(this, data, {
			isFull : true
		}, {app:this.app});
		form.view = this.view;
	...
	toDay : function( date ){
		...
		if (layout.desktop.apps[appId]){
			...
			layout.desktop.openApplication(null, "calendarv2", options);
		}
	},
