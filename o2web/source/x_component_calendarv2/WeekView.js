...
var MWFCalendarv2WeekView = MWF.xApplication.calendarv2.WeekView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_calendarv2/$WeekView/";
        this.cssPath = "../x_component_calendarv2/$WeekView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
    ...
    loadCalendar: function(){
        ...
        this.calendar = new MWFCalendarv2WeekView.Calendar(this, date  );
    ...
    show: function(){
        ...
        fx.start({
            "opacity": 1
            //"left": MWFCalendarv2.LeftNaviWidth+"px"
        }).chain(function(){
            //this.node.setStyles({
            //    "position": "static",
            //    "width": "auto"
...
MWFCalendarv2WeekView.DayWidth;
MWFCalendarv2WeekView.HourHeight = 48;
MWFCalendarv2WeekView.DayHeight = 24*MWFCalendarv2WeekView.HourHeight;
MWFCalendarv2WeekView.DayMsec = 3600 * 24 * 1000;
MWFCalendarv2WeekView.WeekWidth;
MWFCalendarv2WeekView.WeekMsec = MWFCalendarv2WeekView.DayMsec * 7;

MWFCalendarv2WeekView.Calendar = new Class({
    Implements: [Events],
    ...
    createWeekSelector: function(){
        //this.monthSelector = new MWFCalendarv2WeekView.Calendar.WeekSelector(this.date, this);
        this.weekCalendar = new MWFCalendarv2WeekView.WeekCalendar(this.titleTextNode, {
            "style":"meeting_blue",
        ...
        if( !this.tableHead ){
            ...
            for( var j=0; j<7; j++ ){
                ...
                td.addEvent("dblclick", function(ev){
                    ...
                    var form = new MWF.xApplication.calendarv2.EventForm(this,{}, {
        ...
        if( index > -1 ){
            ...
            this.nowTimeNode = new Element("div",{
                styles : {
                    ...
                    "top" : nowTdPosition.y + ( (mintues - 2) / 60 ) * MWFCalendarv2WeekView.HourHeight,
                    "height" : "2px",
                    "width" : MWFCalendarv2WeekView.DayWidth,
    ...
    loadWholeday : function( data ){
       this.wholeday = new MWFCalendarv2WeekView.Calendar.WholeDay( this, data, this.date);
    },
    ...
    loadDay: function( container, dateStr, array){
        ...
        //if(dayArray.length>0){
            this.dayMap[dateStr] = new MWFCalendarv2WeekView.Calendar.Day( container, date, this,  array);
        //}
        //if(wholeDayArray.length>0){
        //    this.wholedayMap[dateStr] = new MWFCalendarv2WeekView.Calendar.WholeDay( container, date, this, type, wholeDayArray);
        //}
    },
    ...
    resetBodySize: function(){
        ...
        var hourTdX = 60;
        MWFCalendarv2WeekView.WeekWidth = size.x - 40 - hourTdX;
        var tdX = MWFCalendarv2WeekView.DayWidth = Math.floor( (MWFCalendarv2WeekView.WeekWidth-8) / 7);
    ...
    getIndexByPage: function( page ){
        ...
        var col = (page.x - pos.x ) / (MWFCalendarv2WeekView.DayWidth + 1);
        if( col < 0 || col > 7 )return null;

        this.pageOffsetHeight = page.y - pos.y;
        var row = ( page.y - pos.y ) / MWFCalendarv2WeekView.HourHeight;
    ...
    cellDrag: function(td, e){
        ...
        if(( this.pageOffsetHeight + MWFCalendarv2WeekView.HourHeight * 1.5) > ( this.scrollNodeHeight + scrollNodeTop )){
            window.setTimeout( function(){
                this.scrollNode.scrollTo(0, scrollNodeTop + MWFCalendarv2WeekView.HourHeight )
            }.bind(this), 200)
        }else if( this.pageOffsetHeight - MWFCalendarv2WeekView.HourHeight * 1.5 < scrollNodeTop ){
            window.setTimeout( function(){
                this.scrollNode.scrollTo(0, scrollNodeTop - MWFCalendarv2WeekView.HourHeight )
            }.bind(this), 200)
        }
...
MWFCalendarv2WeekView.Calendar.WholeDay = new Class({
    Implements: [Events],
    ...
    load: function(){
        ...
        this.rangeList.each( function(r , i){
            var d = r.data;
            if( !d )return null;
            this.documentList.push( new MWFCalendarv2WeekView.Calendar.WholeDayDocument( this, d, r ) );
        }.bind(this))
...
MWFCalendarv2WeekView.Calendar.WholeDayDocument = new Class({
    ...
    load: function(){
        ...
        //    items.push( new MWFCalendarv2WeekView.Calendar.WholeDayItem( this, d, i ) )
        //}.bind(this))
    },
    ...
    createNode : function(){
        var lightColor = this.lightColor = MWFCalendarv2.ColorOptions.getLightColor( this.data.color );
        ...
        var node = this.node = new Element("div",{
            ...
            events : {
                click : function(){
                    var form = new MWF.xApplication.calendarv2.EventForm(this, this.data, {
                        isFull : true
                }, {app:this.app});
                    form.view = this.view;
        ...
        //if( this.isFirst ){
            var timeNode = new Element("div",{
                ...
                text : this.data.timeStart.format("%m-%d %H:%M") + MWF.xApplication.calendarv2.LP.to + this.data.timeEnd.format("%m-%d %H:%M")
            }).inject( node );
        ...
        this.tooltip = new MWF.xApplication.calendarv2.EventTooltip(this.app.content, this.node, this.app, this.data, {
            axis : "y", "delay" : 350
        });
    ...
    getCoordinate : function(){
        ...
        var width = (  diff / MWFCalendarv2WeekView.WeekMsec  ) * MWFCalendarv2WeekView.WeekWidth - 2;
        var left = ( ( timeStart - this.day.weekStartTime ) / MWFCalendarv2WeekView.WeekMsec ) * MWFCalendarv2WeekView.WeekWidth + 3;
        //var marginRight = ( ( this.weekTimeEnd - timeEnd ) / MWFCalendarv2WeekView.DayMsec) * MWFCalendarv2WeekView.DayWidth;
        return {
            top : top + 2,
            left : left,
...
MWFCalendarv2WeekView.Calendar.Day = new Class({
    Implements: [Events],
    ...
    load: function(){
        ...
        this.data.each( function(d , i){
            ...
            this.documentList.push( new MWFCalendarv2WeekView.Calendar.Document(this.container, this, d, range ) );
        }.bind(this))
    },
    sortRange : function(){
        this.rangeList.sort( function(range1, range2){
...
MWFCalendarv2WeekView.Calendar.Document = new Class({
    ...
    getCoordinate : function(){
        ...
        var height = Math.floor( ( ( range.endTime - range.startTime ) / MWFCalendarv2WeekView.DayMsec ) * MWFCalendarv2WeekView.DayHeight)-width_div;

        if(height < 16) height = 16;
        var top = Math.floor( ( ( range.startTime - this.day.startTime ) / MWFCalendarv2WeekView.DayMsec ) * MWFCalendarv2WeekView.DayHeight)-top_div;
        //var width = Math.floor(  MWFCalendarv2WeekView.DayWidth / length )-2;
        //var left = ( width + 2)* index + 1;

        //var width = Math.floor(  MWFCalendarv2WeekView.DayWidth / range.path.length  )-5;
        //var left = ( width + 5)* range.path.indexOf( data.id ) + 3;

        var width = Math.floor(  MWFCalendarv2WeekView.DayWidth / this.range.dayRangeCount  )-5;
...
MWFCalendarv2WeekView.WeekCalendar = new Class({
    ...
    _setDayTitle: function(node, year, month){
        ...
        if( MWF.language.substr(0, 2) === "zh" ){
            text = thisYear+ MWF.xApplication.calendarv2.LP.year +thisMonth+ MWF.xApplication.calendarv2.LP.month;
        }else{
    ...
    _setDayWeekTitleTh: function(table){
        ...
        cells.each(function(item, idx){
            if( idx == 0 ){
                item.set("text", MWF.xApplication.calendarv2.LP.week);
            }else{
                //var index;
