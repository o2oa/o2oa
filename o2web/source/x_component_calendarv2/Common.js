...
MWFCalendarv2.EventForm = new Class({
    Extends: MPopupForm,
            ...
            this.form = new MForm(this.formTableArea, data, {
                ...
                itemTemplate: {
                    ...
                    startTimeInput: { type : "oo-datetime", dataType: 'time-only', format: 'HH:mm',
                        defaultValue: defaultStartTime, disable : data.isAllDayEvent
                    },
    ...
    loadColor_Edited : function(){
        ...
        MWFCalendarv2.ColorOptions.deep.each( function( color , i){
            var div = new Element("div", {
                styles : this.css.colorNode,
                events : {
                    click : function(ev){
    ...
    openDeleteOptionForm : function( callback ){
        this.deleteOptionsForm = new MWFCalendarv2.DeleteOptionDialog( this, {}, {
    ...
    openSaveOptionForm : function( callback ){
        this.saveOptionsForm = new MWFCalendarv2.SaveOptionDialog( this, {}, {
            onPostOk : function( saveOptions ){
                if(callback){
                    callback(saveOptions)
                }
    ...
    getSaveData: function(){
        ...
        if( data ){
            ...
            if( this.currentColorNode ){
                ...
                data.color = MWFCalendarv2.ColorOptions.deep[0];
            }
            delete  data.range;
        }
        return data;
...
MWFCalendarv2.CalendarForm = new Class({
    Extends: MPopupForm,
    Implements: [Options, Events],
    options: {
        "style": "v10",
...
MWFCalendarv2.SaveOptionDialog = new Class({
    Extends: MPopupForm,
    Implements: [Options, Events],
    options: {
        "style": "v10",
...
MWFCalendarv2.DeleteOptionDialog = new Class({
    Extends: MPopupForm,
    Implements: [Options, Events],
    options: {
        "style": "v10",
...
MWFCalendarv2.EventTooltip = new Class({
    Extends: MTooltips,
    options : {
        displayDelay : 300
    },
    ...
    loadButton : function(){
        ...
        new Element("div",{
            ...
            events : { click : function() {
                debugger;
                var form = new MWFCalendarv2.EventForm(this, this.data, {
                    isFull : true
                }, {app:this.app});
                form.view = this.view;
    ...
    loadAttachment: function(){
        ...
        if( typeOf(this.data.attachmentList)=="array" && this.data.attachmentList[0] ){
            ...
            var attachmentContentNode = new Element("div", {
                ...
                this.attachmentController = new MWFCalendarv2.EventTooltip.AttachmentController(attachmentContentNode, this, {
                    "size": "min",
                    "isSizeChange": false,
                    "isReplace": false,
                    "isUpload": false,
...
MWFCalendarv2.EventTooltip.AttachmentController = new Class({
    ...
    loadMin: function(){
        ...
        while (this.attachments.length){
            ...
            atts.push(new MWFCalendarv2.EventTooltip.AttachmentMin(att.data, this));
        }
        this.attachments = atts;
    },
    addAttachment: function(data){
        if (this.options.size=="min"){
            this.attachments.push(new MWFCalendarv2.EventTooltip.AttachmentMin(data, this));
        }else{
...
MWFCalendarv2.EventTooltip.AttachmentMin = new Class({
