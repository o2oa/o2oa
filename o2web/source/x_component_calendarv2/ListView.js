MWF.xApplication.calendarv2.ListView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_calendarv2/$ListView/";
        this.cssPath = "../x_component_calendarv2/$ListView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
    ...
    loadList : function(){
        ...
        this.view = new MWF.xApplication.calendarv2.ListView.View(this);
    ...
    createMonthSelector: function(){
        MWF.xDesktop.requireApp("calendarv2","MonthView",null, false);
...
MWF.xApplication.calendarv2.ListView.View = new Class({
    ...
    loadLine: function(dateStr, item){
        this.items.push(new MWF.xApplication.calendarv2.ListView.View.DayLine(this, dateStr, item));
    },
    destroy: function(){
...
MWF.xApplication.calendarv2.ListView.View.DayLine = new Class({
    ...
    load: function(){
        ...
        wholeday.each( function( d ){
            new MWF.xApplication.calendarv2.ListView.View.Line( this, d, true );
        }.bind(this));

        var inoneday = this.data.inoneday || [];
        inoneday.each( function( d ){
            new MWF.xApplication.calendarv2.ListView.View.Line( this, d, false );
        }.bind(this))
    },
    destroy: function(){
...
MWF.xApplication.calendarv2.ListView.View.Line = new Class({
    ...
    openCalendar: function(e){ 
        this.form = new MWF.xApplication.calendarv2.EventForm(this,this.data.data, {
            isFull : true
        }, {app:this.app});
