...
COMMON.AjaxModule = {
    ...
    "ace": COMMON.contentPath+"/res/framework/ace/src-noconflict/ace.js",
    "ace-tools": COMMON.contentPath+"/res/framework/ace/src-noconflict/ext-language_tools.js",
    ...
    init: function(){
        ...
        this["ace"] = COMMON.contentPath+"/res/framework/ace/src-noconflict/ace.js";
        this["ace-tools"] = COMMON.contentPath+"/res/framework/ace/src-noconflict/ext-language_tools.js";
    ...
    loadDomSingle: function(url, callback, async, reload){
        ...
        if (!jsurl){
            jsurl = url;
            if (!COMMON["debugger"]){
                if (jsurl.indexOf("framework")===-1) jsurl = jsurl.replace(/\.js/, ".min.js");
            }
        }
