...
MWF.widget.ImageClipper = MWF.ImageClipper = new Class({
	...
	_loadWithSWF : function(){
		this.clipper = new MWF.widget.FlashImageClipper( this.container, this.options, this );
		this.clipper.load()
	},
	_loadWithH5 : function( imageBase64 ){
		this.clipper = new MWF.widget.HTML5ImageClipper( this.container, this.options, this );
...
MWF.widget.FlashImageClipper = new Class({
	Implements: [Options, Events],
	options: {
		"style": "default",
		"path": MWF.defaultPath+"/widget/$ImageClipper/",
	...
	renderFlash : function(){
		...
		var path = MWF.defaultPath+"/widget/$ImageClipper/";
...
MWF.widget.HTML5ImageClipper = new Class({
	Implements: [Options, Events],
	options: {
		"style": "default",
		"path": MWF.defaultPath+"/widget/$ImageClipper/",
