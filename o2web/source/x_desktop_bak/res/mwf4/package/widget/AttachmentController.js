...
MWF.widget.AttachmentController = MWF.widget.ATTER  = new Class({
	...
	loadMax: function(){
        ...
        while (atts.length){
            var att = atts.shift();
            this.attachments.push(new MWF.widget.AttachmentController.Attachment(att.data, this));
        }
    ...
    loadMin: function(){
        ...
        while (atts.length){
            var att = atts.shift();
            this.attachments.push(new MWF.widget.AttachmentController.AttachmentMin(att.data, this));
        }
        //this.attachments = atts;
    },
    loadMobile: function(){
    ...
    createListGroupActions: function(){
        ...
        this.sequenceAction = this.createAction(this.listActionsGroupNode, "seq", MWF.LP.widget.sequence, function(){
