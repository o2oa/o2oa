...
MWF.widget.O2View = new Class({
    ...
    getPersonData: function(){
        ...
        if (!this.data.query){
            var data = null;
            MWF.Actions.get("x_query_assemble_surface").getStatById(this.data.id, function(json){
                data = json.data
            }, null, false);
            this.data = data;
            return data;
...
MWF.widget.O2QueryView = new Class({
    ...
    getPersonData: function(){
        if (!this.data.query){
            var data = null;
            MWF.Actions.get("x_query_assemble_surface").getViewById(this.data.id, function(json){
                data = json.data
            }, null, false);
            this.data = data;
            return data;
