...
MWF.widget.SearchInput = new Class({
	...
	initialize: function(options){
        ...
        this.path = MWF.defaultPath+"/widget/$SearchInput/";
        this.cssPath = MWF.defaultPath+"/widget/$SearchInput/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.load();
	},
    load: function(){
    ...
    setEvent: function(){
        ...
        MWF.UD.getDataJson("searchKeys", function(json){
            this.keys = json || [];
    ...
    doSearch: function(){
        ...
        if (value){
            if (this.keys){
                ...
                MWF.UD.putData("searchKeys", this.keys);
            }
