MWF.xApplication.attendancev2.LP = {
  ...
  components: {
    ...
    monthDaySelectorPlaceholder: "请选择月日",
    monthDaySelectorMonth: "月",
    monthDaySelectorDay: "日",
  },
  // 我的
  ...
  shiftForm: {
    ...
    restPeriodLabel: "休息时段:",
    restPeriodStartPlaceholder: "休息开始时间",
    restPeriodEndPlaceholder: "休息结束时间",
    ...
    restPeriodNeedComplete: "休息时间段需要选择完整的开始和结束时间！",
    success: "保存成功！",
  ...
  leaveManagerV2: {
    ...
    importData: "导入数据",
    ledgerImportTitleSuffix: "导入数据",
    ledgerImportTemplate: "模板",
    ledgerImportTemplateDownload: "模板下载",
    ledgerImportGrantPeriod: "发放批次",
    ledgerImportGrantPeriodPlaceholder: "请输入发放批次",
    ledgerImportChooseFile: "选择 Excel 文件",
    ledgerImportHistory: "导入历史",
    ledgerImportHistoryEmpty: "暂无导入历史",
    ledgerImportTime: "导入时间",
    ledgerImportSubmitting: "导入中...",
    ledgerImportSubmit: "提交",
    ledgerImportTypeIdEmpty: "假期类型 ID 为空",
    ledgerImportCopySuccess: "复制成功",
    ledgerImportCopyFail: "复制失败",
    ledgerImportExcelFileError: "请选择 .xlsx 格式的 Excel 文件",
    ledgerImportTypeEmpty: "请选择假期类型",
    ledgerImportFileEmpty: "请选择 Excel 文件",
    ledgerImportFail: "导入失败",
    ...
    ledgerImportTemplatePerson: "人员",
    ledgerImportTemplateAmountSuffix: "发放额度",
    ledgerImportTemplateExpireDate: "过期日期(YYYY-MM-DD)",
    ledgerImportTemplateDefaultLeaveType: "假期",
    ledgerImportTemplateFileName: "{name}额度导入模板.xlsx",
    copyId: "[复制 ID]",
    calendar: {
      today: "回到今天",
      offday: "节假日",
      ...
      addHoliday: "新增节假日",
      name: "节假日名称",
      namePlaceholder: "请输入节假日名称",
      nameEmptyPlaceholder: "请输入节假日名称！",
      dateString: "日期",
      dateError: "请选择正确的日期！",
      offDay: "类型",
      deleteConfirm: "确认要删除这条节假日数据？",
      importHoliday: "导入节假日",
      importFormatTitle: "导入 JSON 格式",
      importFormatDesc: "请整理为一个 JSON 对象：year 为年份，overwrite 表示是否覆盖已存在日期，days 为节假日数组；每条数据 name 为名称，date 为 yyyy-MM-dd 日期，isOffDay 为 true 表示放假，false 表示调休上班。",
      importFormatCompatible: "接口也兼容 dateString/offDay 字段，数组字段也可以使用 holidayList 或 holidays；如果直接导入数组，内容等同于 days。",
      importJson: "节假日 JSON",
      importJsonEmpty: "请输入节假日 JSON！",
      importJsonError: "JSON 格式不正确，请检查后再导入！",
      importDataEmpty: "请至少填写一条节假日数据！",
      importOverwrite: "覆盖已存在日期的数据",
      startImport: "开始导入",
      importFail: "节假日导入失败！",
      importResult: "导入完成：总数 {total}，新增 {inserted}，更新 {updated}，跳过 {skipped}，错误 {errors}",
      ...
      tagOffday: "休",
      tagWeekend: "末",
      importExampleNewYear: "元旦",
      importExampleSpringFestivalWorkday: "春节调休上班",
      motherDay: "母亲节",
      fatherDay: "父亲节",
      lunarMonthPattern: "^(.+?月)(\\d+)日$",
      lunarNumberNames: ["", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十"],
      lunarDayPrefix: "初",
      lunarTwenty: "二十",
      lunarTwentyPrefix: "廿",
      lunarThirty: "三十",
    ...
    policy: {
      ...
      grantCron: "发放定时器",
      grantCronNotEmpty: "定时器不能为空",
      grantType: "发放方式",
      grantTypeYEARLY: "年度发放",
      grantTypeYearLabel: "每年发放日期：",
      grantTypeYearPlaceholder: "请选择每年发放的日期",
      grantTypeMONTHLY: "月度发放",
      grantTypeMonthLabel: "每月发放日期：",
      grantTypeMonthPlaceholder: "请填写每月发放的日期，填写数字1-28",
      grantTypeONE_TIME: "一次性发放",
      grantAmountLabel: "发放额度配置",
      grantAmount: "发放额度",
      grantAmountPlaceholder: "请输入发放额度, 必须为大于0的整数",
      description: "规则说明",
      grantTypeLabel: "额度类型配置",
      grantAmountTypeUseScript: "额度计算是否启用脚本",
      grantAmountScriptLabel: "额度计算脚本",
      grantAmountScriptNotEmpty: "额度计算脚本不能为空",
      ...
      expireTime: "假期有效期",
      expireTypeTHIS_YEAR: "本年指定日期过期",
      expireTypeNEXT_YEAR: "次年指定日期过期",
      expireTypeAFTER_GRANT: "发放后指定天数过期",
      expireTypePlaceholder: "请选择假期有效期类型",
      expireMonthDayPlaceholder: "请选择假期过期月日",
      expireValuePlaceholder: "请输入假期有效期，必须为大于0的整数",
      expireValueExtendDayPlaceholder: "过期值延长天数必须是大于等于0的整数！",
      day: "日",
      days: "天",
      year: "年",
      month: "月",
      grantMonthlyPrefix: "每人每月发放",
      grantOneTimePrefix: "一次性发放",
      grantYearlyPrefix: "每人每年发放",
      expireFromGrantDate: "自发放日起",
      expireOnMonthDayPrefix: "于",
      expireOnMonthDaySuffix: "过期",
      expireAfterYearExtend: "年后过期，延长",
      expireAfterMonthExtend: "月后过期， 延长",
      expireAfterDay: "天后过期",
      grantTypeMonthlyText: "每月{day}日，发放{amount}天",
      grantTypeYearlyFixedText: "每年{month}月{day}日，发放{amount}天",
      grantTypeYearlyServiceLenText: "每年{month}月{day}日，按司龄发放",
    },
    account: {
