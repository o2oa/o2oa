...
MWF.xApplication.process.FormDesigner.Module.PdfView = MWF.FCPdfView = new Class({
	...
	initialize: function(form, options){
		...
		this.path = "../x_component_process_FormDesigner/Module/PdfView/";
		this.cssPath = "../x_component_process_FormDesigner/Module/PdfView/"+this.options.style+"/css.wcss";

		this._loadCss();
		this.moduleType = "element";
		this.moduleName = "pdfview";
	...
	setIcon: function(){
		this.setIconNode("pdf", "PDF View", "#2b5797", 240);
	}
});
