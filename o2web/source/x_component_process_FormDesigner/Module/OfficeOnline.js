...
MWF.xApplication.process.FormDesigner.Module.OnlyOffice = MWF.FCOfficeOnline = new Class({
    Extends: MWF.FC$Element,
    Implements: [Options, Events],
    options: {
        "style": "default",
        "propertyPath": "../x_component_process_FormDesigner/Module/OfficeOnline/officeonline.html"
    },

    initialize: function(form, options){
        this.setOptions(options);

        this.path = "../x_component_process_FormDesigner/Module/OfficeOnline/";
        this.cssPath = "../x_component_process_FormDesigner/Module/OfficeOnline/"+this.options.style+"/css.wcss";

        this._loadCss();
        this.moduleType = "element";
        this.moduleName = "officeOnline";
