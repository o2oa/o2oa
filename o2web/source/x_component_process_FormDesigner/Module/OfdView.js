...
MWF.xApplication.process.FormDesigner.Module.OfdView = MWF.FCOfdView = new Class({
    Extends: MWF.FC$Element,
    Implements: [Options, Events],
    options: {
        "style": "default",
        "propertyPath": "../x_component_process_FormDesigner/Module/OfdView/ofdView.html"
    },

    initialize: function(form, options){
        this.setOptions(options);

        this.path = "../x_component_process_FormDesigner/Module/OfdView/";
        this.cssPath = "../x_component_process_FormDesigner/Module/OfdView/"+this.options.style+"/css.wcss";

        this._loadCss();
        this.moduleType = "element";
        this.moduleName = "ofdview";
    ...
    setIcon: function(){
        this.setIconNode("ofd", "OFD View", "#2b5797", 240);
    }
});
