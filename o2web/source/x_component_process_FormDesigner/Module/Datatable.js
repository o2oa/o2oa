...
MWF.xApplication.process.FormDesigner.Module.Datatable = MWF.FCDatatable = new Class({
	...
	options: {
		"style": "default",
		"propertyPath": "../x_component_process_FormDesigner/Module/Datatable/datatable.html"
	},

	initialize: function(form, options){
		this.setOptions(options);

		this.path = "../x_component_process_FormDesigner/Module/Datatable/";
		this.cssPath = "../x_component_process_FormDesigner/Module/Datatable/"+this.options.style+"/css.wcss";
