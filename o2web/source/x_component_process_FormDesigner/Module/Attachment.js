...
//		this.loadCkeditor();
	...
	_initModule: function(){
		...
		if (this.parentContainer && ["datagrid$Data","datatable$Column"].contains(this.parentContainer.json.moduleName) && !this.json.size) this.json.size = "min";
		if (this.parentContainer && ["datagrid$Data","datatable$Column"].contains(this.parentContainer.json.moduleName) && !this.json.listStyle) this.json.listStyle = "sequence";
