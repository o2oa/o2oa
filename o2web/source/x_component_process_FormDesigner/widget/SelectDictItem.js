...
MWF.xApplication.process.FormDesigner.widget.SelectDictItem = new Class({
	Implements: [Options, Events],
	Extends: MWF.widget.Common,
	options: {
        "title": "Select Dictionary Item",
		"style": "default",
        "width": "92",
        "height": "73",
        "referenceType": "",
	...
	initialize: function(designer, options){
        ...
        this.app = designer;
		this.path = "../x_component_process_FormDesigner/widget/$SelectDictItem/";
		this.cssPath = "../x_component_process_FormDesigner/widget/$SelectDictItem/"+this.options.style+"/css.wcss";
		this._loadCss();
	},
