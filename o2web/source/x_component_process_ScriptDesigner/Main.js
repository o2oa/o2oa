...
MWF.xApplication.process.ScriptDesigner.Main = new Class({
	Extends: MWF.xApplication.Common.Main,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"name": "process.ScriptDesigner",
		"icon": "icon.png",
...
//		this.processData = this.options.processData;
    ...
    loadScriptListNodes: function(){
        this.scriptListTitleNode = new Element("div", {
            ...
            "text": MWF.APPSD.LP.scriptLibrary
    ...
    loadScriptByData: function(node, e){
        ...
        if (openNew){
            this.loadScriptData(script.id, function(data){
                var script = new MWF.xApplication.process.ScriptDesigner.Script(this, data);
                script.load();
            }.bind(this), true);
        }
        //var _self = this;
...
//				var y = e.event.y;
    ...
    loadScript: function(){
		...
		this.getScriptData(this.options.id, function(data){
			this.script = new MWF.xApplication.process.ScriptDesigner.Script(this, data);
			this.script.load();
                ...
                if (this.status.openScripts){
                    this.status.openScripts.each(function(id){
                        this.loadScriptData(id, function(data){
                            ...
                            var script = new MWF.xApplication.process.ScriptDesigner.Script(this, data, {"showTab": showTab});
                            script.load();
                        }.bind(this), true);
                    }.bind(this));
                }
        ...
        if (this.scriptTab.showPage){
            ...
            script.save(function(){
                if (script==this.script){
                    ...
                    this.setTitle(MWF.APPSD.LP.title + "-"+name);
