var fn=Object.defineProperty;var vn=(L,y,M)=>y in L?fn(L,y,{enumerable:!0,configurable:!0,writable:!0,value:M}):L[y]=M;var C=(L,y,M)=>(vn(L,typeof y!="symbol"?y+"":y,M),M),d4=(L,y,M)=>{if(!y.has(L))throw TypeError("Cannot "+M)};var l=(L,y,M)=>(d4(L,y,"read from private field"),M?M.call(L):y.get(L)),c=(L,y,M)=>{if(y.has(L))throw TypeError("Cannot add the same private member more than once");y instanceof WeakSet?y.add(L):y.set(L,M)},p=(L,y,M,Wt)=>(d4(L,y,"write to private field"),Wt?Wt.call(L,M):y.set(L,M),M);var a=(L,y,M)=>(d4(L,y,"access private method"),M);var $OOUI=function(L){var r2,V1,c4,s5,k9,i5,E9,r5,M9,K,o5,S9,W1,h4,t2,j2,H,e2,n2,b,E,A,$,T,j,I,H1,Y1,q1,U1,X1,G1,K1,c1,_2,h1,D2,l2,F2,$2,I2,w2,p1,J1,Q1,u1,C1,m1,Q3,tt,p4,a5,et,u4,nt,C4,d5,A9,y2,Z1,st,m4,z2,jt,it,g4,c5,T9,g1,u3,h5,O9,x2,j1,t4,bn,f1,C3,e4,Ln,N2,Dt,a2,r1,R2,Ft,v1,m3,b1,g3,J,b2,rt,f4,p5,P9,B2,$t,u5,Z9,V2,It,C5,j9,W2,zt,k2,E2,M2,f5,D9,v5,F9,b5,$9,L5,I9,H2,n4,s4,_5,z9,w5,N9,y5,R9,i4,D,L1,x5,B9,lt,v4,_1,E5,V9,S2,S5,W9,w1,q2,Nt,A5,H9,T5,Y9,y1,f3,at,b4,O5,q9,P5,U9,j5,X9,D5,G9,F5,K9,$5,J9,I5,Q9,z5,t8,Q,O,x1,Y,N5,e8,ct,L4,R5,n8,ht,_4,B5,s8,pt,U2,Rt,V5,i8,W5,r8,H5,o8,Y5,l8,q5,a8,ut,w4,q,d2,R,k1,J5,d8,Q5,c8,te,h8,ee,p8,ne,u8,Ct,y4,mt,x4,se,C8,ie,m8,gt,k4,re,g8,ft,E4,oe,f8,A2,D1,le,v8,h2,o1,ae,b8,vt,M4,bt,S4,p2,l1,E1,v3,u2,a1,ce,L8,Lt,A4,he,_8,ue,w8,Ce,y8,me,x8,U,X2,P,M1,S1,C2,_t,T4,G2,wt,O4,ge,k8,yt,P4,fe,E8,A1,b3,xt,Z4,K2,Bt,ve,M8,be,S8,kt,j4,we,A8,xe,T8,ke,O8,Me,P8,Ae,Z8,Te,j8,O1,J2,T2,Q2,m2,X,g2,Oe,D8,Mt,D4,Pe,F8,St,F4,je,$8,De,I8,Fe,z8,$e,N8,Ie,R8,ze,B8,Ne,V8,Re,W8,f2,Be,H8,Ve,Y8,He,q8,At,$4,Ye,U8,qe,X8,Tt,I4,Ue,G8,P1,L3,Xe,K8,Ge,J8,Ke,Je,Qe,Q8,t3,t7,Z,e3,e7,a4,n3,n7,t1,Vt,s3,s7,Pt,z4,Zt,N4,i3,i7,r3,r7,o3,o7,l3,l7,e1,n1,v2,s1,P2,a3,G,d3,a7,c3,d7,h3,c7;"use strict";var y=globalThis&&globalThis.__spreadArray||function(s,n,t){if(t||arguments.length===2)for(var e=0,i=n.length,o;e<i;e++)(o||!(e in n))&&(o||(o=Array.prototype.slice.call(n,0,e)),o[e]=n[e]);return s.concat(o||Array.prototype.slice.call(n))},M=function(){function s(n,t,e){this.name=n,this.version=t,this.os=e,this.type="browser"}return s}(),Wt=function(){function s(n){this.version=n,this.type="node",this.name="node",this.os=process.platform}return s}(),h7=function(){function s(n,t,e,i){this.name=n,this.version=t,this.os=e,this.bot=i,this.type="bot-device"}return s}(),p7=function(){function s(){this.type="bot",this.bot=!0,this.name="bot",this.version=null,this.os=null}return s}(),u7=function(){function s(){this.type="react-native",this.name="react-native",this.version=null,this.os=null}return s}(),C7=/alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/,m7=/(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask\ Jeeves\/Teoma|ia_archiver)/,R4=3,g7=[["aol",/AOLShield\/([0-9\._]+)/],["edge",/Edge\/([0-9\._]+)/],["edge-ios",/EdgiOS\/([0-9\._]+)/],["yandexbrowser",/YaBrowser\/([0-9\._]+)/],["kakaotalk",/KAKAOTALK\s([0-9\.]+)/],["samsung",/SamsungBrowser\/([0-9\.]+)/],["silk",/\bSilk\/([0-9._-]+)\b/],["miui",/MiuiBrowser\/([0-9\.]+)$/],["beaker",/BeakerBrowser\/([0-9\.]+)/],["edge-chromium",/EdgA?\/([0-9\.]+)/],["chromium-webview",/(?!Chrom.*OPR)wv\).*Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/],["chrome",/(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/],["phantomjs",/PhantomJS\/([0-9\.]+)(:?\s|$)/],["crios",/CriOS\/([0-9\.]+)(:?\s|$)/],["firefox",/Firefox\/([0-9\.]+)(?:\s|$)/],["fxios",/FxiOS\/([0-9\.]+)/],["opera-mini",/Opera Mini.*Version\/([0-9\.]+)/],["opera",/Opera\/([0-9\.]+)(?:\s|$)/],["opera",/OPR\/([0-9\.]+)(:?\s|$)/],["pie",/^Microsoft Pocket Internet Explorer\/(\d+\.\d+)$/],["pie",/^Mozilla\/\d\.\d+\s\(compatible;\s(?:MSP?IE|MSInternet Explorer) (\d+\.\d+);.*Windows CE.*\)$/],["netfront",/^Mozilla\/\d\.\d+.*NetFront\/(\d.\d)/],["ie",/Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/],["ie",/MSIE\s([0-9\.]+);.*Trident\/[4-7].0/],["ie",/MSIE\s(7\.0)/],["bb10",/BB10;\sTouch.*Version\/([0-9\.]+)/],["android",/Android\s([0-9\.]+)/],["ios",/Version\/([0-9\._]+).*Mobile.*Safari.*/],["safari",/Version\/([0-9\._]+).*Safari/],["facebook",/FB[AS]V\/([0-9\.]+)/],["instagram",/Instagram\s([0-9\.]+)/],["ios-webview",/AppleWebKit\/([0-9\.]+).*Mobile/],["ios-webview",/AppleWebKit\/([0-9\.]+).*Gecko\)$/],["curl",/^curl\/([0-9\.]+)$/],["searchbot",C7]],B4=[["iOS",/iP(hone|od|ad)/],["Android OS",/Android/],["BlackBerry OS",/BlackBerry|BB10/],["Windows Mobile",/IEMobile/],["Amazon OS",/Kindle/],["Windows 3.11",/Win16/],["Windows 95",/(Windows 95)|(Win95)|(Windows_95)/],["Windows 98",/(Windows 98)|(Win98)/],["Windows 2000",/(Windows NT 5.0)|(Windows 2000)/],["Windows XP",/(Windows NT 5.1)|(Windows XP)/],["Windows Server 2003",/(Windows NT 5.2)/],["Windows Vista",/(Windows NT 6.0)/],["Windows 7",/(Windows NT 6.1)/],["Windows 8",/(Windows NT 6.2)/],["Windows 8.1",/(Windows NT 6.3)/],["Windows 10",/(Windows NT 10.0)/],["Windows ME",/Windows ME/],["Windows CE",/Windows CE|WinCE|Microsoft Pocket Internet Explorer/],["Open BSD",/OpenBSD/],["Sun OS",/SunOS/],["Chrome OS",/CrOS/],["Linux",/(Linux)|(X11)/],["Mac OS",/(Mac_PowerPC)|(Macintosh)/],["QNX",/QNX/],["BeOS",/BeOS/],["OS/2",/OS\/2/]];function f7(s){return s?V4(s):typeof document>"u"&&typeof navigator<"u"&&navigator.product==="ReactNative"?new u7:typeof navigator<"u"?V4(navigator.userAgent):L7()}function v7(s){return s!==""&&g7.reduce(function(n,t){var e=t[0],i=t[1];if(n)return n;var o=i.exec(s);return!!o&&[e,o]},!1)}function V4(s){var n=v7(s);if(!n)return null;var t=n[0],e=n[1];if(t==="searchbot")return new p7;var i=e[1]&&e[1].split(".").join("_").split("_").slice(0,3);i?i.length<R4&&(i=y(y([],i,!0),_7(R4-i.length),!0)):i=[];var o=i.join("."),d=b7(s),h=m7.exec(s);return h&&h[1]?new h7(t,o,d,h[1]):new M(t,o,d)}function b7(s){for(var n=0,t=B4.length;n<t;n++){var e=B4[n],i=e[0],o=e[1],d=o.exec(s);if(d)return i}return null}function L7(){var s=typeof process<"u"&&process.version;return s?new Wt(process.version.slice(1)):null}function _7(s){for(var n=[],t=0;t<s;t++)n.push("0");return n}var Ht,w7=new Uint8Array(16);function y7(){if(!Ht&&(Ht=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||typeof msCrypto<"u"&&typeof msCrypto.getRandomValues=="function"&&msCrypto.getRandomValues.bind(msCrypto),!Ht))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Ht(w7)}const x7=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;function k7(s){return typeof s=="string"&&x7.test(s)}for(var S=[],_3=0;_3<256;++_3)S.push((_3+256).toString(16).substr(1));function E7(s){var n=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,t=(S[s[n+0]]+S[s[n+1]]+S[s[n+2]]+S[s[n+3]]+"-"+S[s[n+4]]+S[s[n+5]]+"-"+S[s[n+6]]+S[s[n+7]]+"-"+S[s[n+8]]+S[s[n+9]]+"-"+S[s[n+10]]+S[s[n+11]]+S[s[n+12]]+S[s[n+13]]+S[s[n+14]]+S[s[n+15]]).toLowerCase();if(!k7(t))throw TypeError("Stringified UUID is invalid");return t}function W4(s,n,t){s=s||{};var e=s.random||(s.rng||y7)();if(e[6]=e[6]&15|64,e[8]=e[8]&63|128,n){t=t||0;for(var i=0;i<16;++i)n[t+i]=e[i];return n}return E7(e)}const H4=function(s,n,t){const e=n.toLowerCase();e==="text"?s.textContent=t:e==="html"?s.innerHTML=t:e==="styles"?r.setStyles(s,t):s.setAttribute(n,t)},M7=function(s,n){const t=n.toLowerCase();if(t==="text")return s.innerText||s.textContent||"";if(t==="html")return s.innerHTML||"";if(t==="value")switch(s.tagName.toString().toLowerCase()){case"select":return s.options[s.selectedIndex].value;default:return s.value}return s.getAttribute(n)},Yt=function(s){const n=P7(s||"").split(" "),t={};return n.filter(function(e){if(e!==""&&!t[e])return t[e]=e})},Y4=function(s){return!s.tagName||/^(?:body|html)$/i.test(s.tagName)},q4=function(s){return/html/i.test(s.tagName)},qt=function(s,n){return parseInt(r.getStyle(s,n))||0},S7=function(s){return qt(s,"border-top-width")},A7=function(s){return qt(s,"border-left-width")},T7=function(s,n){return{left:s.x-qt(n,"margin-left"),top:s.y-qt(n,"margin-top")}},r=(s,n)=>{let t;const e=s.replace(/^\S*?(?=\.|#|$)/,h=>(t=h,""));let i="",o;e&&(o=e.split(".").filter(u=>!!u).map(u=>{const m=u.split("#"),f=m.shift();return i=m.pop()||i,f}));const d=document.createElement(t);return i&&d.setAttribute("id",i),o&&o.length&&d.setAttribute("class",o.join(" ")),n&&r.set(d,n),d};Object.assign(r,{el:(s,n)=>v(s)==="string"&&s?(n||document).querySelector(s):s,els:(s,n)=>(n||document).querySelectorAll(s),addClass:(s,n)=>{const t=r.el(s);return Yt(n).forEach(e=>{t.classList.add(e)}),t},removeClass:(s,n)=>{const t=r.el(s);return Yt(n).forEach(e=>{t.classList.remove(e)}),t},hasClass:(s,n)=>r.el(s).classList.contains(n),toggleClass:(s,n,t=!1)=>{const e=r.el(s);return Yt(n).forEach(i=>{let o=t;(o==null||o===!1)&&(o=!r.hasClass(e,i)),o?r.addClass(e,i):r.removeClass(e,i)}),e},checkClass:(s,n,t)=>{const e=r.el(s);return Yt(n).forEach(i=>{t?r.addClass(e,i):r.removeClass(e,i)}),e},mapProps:(s,n)=>{const t=r.el(s);for(const e in n){const i=_(e);if(typeof n[e]=="boolean")n[e]=t.hasAttribute(e)||t.hasAttribute(i)||!1;else{const o=t.getAttribute(e)||t.getAttribute(i)||"";o!==n[e]&&(n[e]=o)}}return t},toggleAttr:(s,n,t)=>{const e=r.el(s);return t?e.setAttribute(n,t):e.removeAttribute(n),e},set:(s,n,t)=>{const e=r.el(s);return typeof n=="object"?Object.keys(n).forEach(i=>{H4(e,i,n[i])}):H4(e,n,t),e},get:(s,n)=>{const t=r.el(s);return M7(t,n)},setProperty:(s,n,t)=>{const e=r.el(s);return e.setAttribute(n,t),e},getScroll:s=>{const n=r.el(s);return{x:n.scrollLeft,y:n.scrollTop}},getScrolls:s=>{let t=r.el(s).parentNode,e={x:0,y:0};for(;t&&!Y4(t);)e.x+=t.scrollLeft,e.y+=t.scrollTop,t=t.parentNode;return e},getOffsetParent:s=>{let n=s.offsetParent;for(;n&&["table","td","th"].includes(n.tagName.toString().toLowerCase());)n=n.offsetParent;return n||document.body},getPosition:(s,n)=>{const t=r.el(s);for(n===window&&(n=document.documentElement);n&&r.getStyle(n,"display")==="contents";)n=n.parentElement;for(;s&&r.getStyle(s,"display")==="contents";)s=s.parentElement;const e=s.getBoundingClientRect(),i=document.documentElement,o=r.getScroll(i),d=r.getScrolls(t),h=r.getStyle(t,"position")==="fixed",u={x:e.left+d.x+(h?0:o.x)-i.clientLeft,y:e.top+d.y+(h?0:o.y)-i.clientTop},m=r.getScrolls(t),f={x:u.x-m.x,y:u.y-m.y};if(n){const w=r.getPosition(n);return{x:f.x-w.x-A7(n),y:f.y-w.y-S7(n)}}return f},setPosition:(s,n)=>{const t=r.el(s);return r.setStyles(t,T7(n.this))},getSize:s=>{const n=r.el(s);if(q4(n))return{x:n.clientWidth,y:n.clientHeight};{const t=n.getBoundingClientRect();return{x:t.width,y:t.height}}},getScrollSize:s=>{const n=r.el(s);if(/^(?:body|html)$/i.test(n.tagName)){const t=document.documentElement,e=document.body;return{x:Math.max(t.scrollWidth,e.scrollWidth),y:Math.max(t.scrollHeight,e.scrollHeight)}}return{x:n.scrollWidth,y:n.scrollHeight}},getStyle:function(s,n){const t=r.el(s),e=F1(n);let i=t.style[e];return i||(i=window.getComputedStyle(t)[e]),i},getStyles:s=>{const n=[...arguments],t=r.el(n.shift()),e={};return n.forEach(i=>{e[i]=r.getStyle(t,i)}),e},setStyle:(s,n,t)=>{const e=r.el(s);return typeof n=="object"?Object.keys(n).forEach(i=>{e.style[F1(i)]=n[i]}):e.style[F1(n)]=t,e},setStyles:(s,n)=>r.setStyle(s,n),isPositioned:s=>{const n=r.el(s),t=r.getStyle(n,"position");return t&&["absolute","fixed","relative","sticky"].includes(t)},show:s=>{const n=r.el(s);return r.getStyle(n,"display")==="none"&&r.setStyle(n,"display",n.dataset.storeDisplay||"block"),n},hide:s=>{const n=r.el(s),t=r.getStyle(n,"display");return t!=="none"&&(n.dataset.storeDisplay=t,r.setStyle(n,"display","none")),n},getParentSrcollNode:s=>{let t=r.el(s).parentElement,e=r.getStyle(t,"overflow"),i=r.getStyle(t,"overflow-y");for(;t&&(r.getScrollSize(t).y<=r.getSize(t).y||!["auto","scroll"].includes(e)&&!["auto","scroll"].includes(i));)t=t.parentElement,t&&(e=r.getStyle(t,"overflow"),i=r.getStyle(t,"overflow-y"));return t||document.documentElement},getParent:function(s,n){if(n){let t=s.parentElement;for(;t&&!t.matches(n);)t=t.parentElement;return t}else return s.parentElement},isBody:s=>Y4(r.el(s)),isHtml:s=>q4(r.el(s)),empty:s=>{const n=r.el(s);for(;n.childNodes.length;)n.removeChild(n.childNodes[0]);return n},peel:(s,n)=>{const{node:t,position:e}=n&&v(n)==="element"?{node:n,position:"beforeend"}:{node:s,position:"beforebegin"};let i=s.firstElementChild;for(;i;)t.insertAdjacentElement(e,i),i=s.firstElementChild;s.remove()},getPositionParent(s){let n=r.el(s).parentElement;for(;n;){const t=n.tagName.toString().toLowerCase();if(t==="application")return n;if(t==="oo-dialog")return n._content;n=n.parentElement}return document.body},overlap(s,n,t=document.body,e){const i=this.getSize(r.el(n)),o=this.getPosition(r.el(n),t),d=r.el(s);this.setStyles(d,{position:"absolute",width:`${i.x}px`,height:`${i.y}px`,top:`${o.y}px`,left:`${o.x}px`}),d.isConnected||t.append(d)},appendTop(s,n){const t=s.firstChild;return t?s.insertBefore(n,t):s.appendChild(n)}}),f7();function v(s){if(s==null)return"null";if(Array.isArray(s))return"array";if(s instanceof Map)return"map";if(s instanceof Set)return"set";if(s===window)return"window";if(s instanceof Date)return"date";if(s instanceof RegExp)return"regexp";if(s instanceof Error)return"error";if(s instanceof Event)return"event";if((typeof s=="function"||typeof s=="object")&&typeof s.then=="function")return"promise";if(s.nodeName){if(s.nodeType===1)return"element";if(s.nodeType===3)return/\S/.test(s.nodeValue)?"textnode":"whitespace";if(s.nodeType===9)return"document";if(s.nodeType||s.nodeType===0)return s.nodeName}else if(typeof s.length=="number"&&s.callee)return"arguments";return typeof s}function d1(s,n,t=null,e=!0){const i=n||this,o=t?Object.values(t):[],d=t?Object.keys(t).join(","):"";return Function("return function("+d+"){"+s+"}")().apply(i,o)}function B(s,n=20,t,e){const i=t;return n&&v(n)!=="number"&&(t=n,n=i&&v(i)==="number"?i:20),s.clear&&s.clear(),s.timerFunction=(o,d)=>{s.clear=()=>{s.timerId&&clearTimeout(s.timerId),s.promise&&(s.promise=null)},s.timerId=setTimeout(function(){s.timerId=null;try{const h=t?s.apply(t,e):s(e);Promise.resolve(h).then(u=>{o(u)})}catch(h){d(h)}},n)},s.promise=new Promise(s.timerFunction),s.promise}function U4(s){if(!s)return s;const n=v(s);return n==="function"?null:n==="array"||n==="object"?X4(s):s}function O7(s){let n=s.length,t=new Array(n);for(;n--;)t[n]=U4(s[n]);return t}function X4(s){if(v(s)==="array")return O7(s);const n={};for(let t in s)n[t]=U4(s[t]);return n}function _(s){return s.replace(/([A-Z])/g,"-$1").toLowerCase()}function F1(s){return s.replace(/-(\w)/g,function(n,t){return t.toUpperCase()})}function P7(s){return s.replace(/\s+/g," ").trim()}function G4(s){return String(s).replace(/\b[a-z]/g,function(n){return n.toUpperCase()})}function Z7(s){return s.replace(/<script(?:\s+[\w-]+(?:=(?:"[^"]*"|'[^']*'))?)*\s*>([\s\S]*?)<\/script\s*>|\s+on\w+\s*=\s*(?:"[^"]*"|'[^']*')|javascript:.*/g,"")}function $1(s,n){const t=s.indexOf(n);t!==-1&&(s.splice(t,1),$1(s,n))}const w3={ms:1,second:1e3,minute:6e4,hour:36e5,day:864e5,week:6084e5};function L2(s){return new Date(s.getTime())}function Ut(s,n){return s?s instanceof Date?n?L2(s):s:new Date(s):null}function j7(s,n){const t=new Date(s,n);return t.setDate(0),t}function D7(s,n){if(!s)return null;const t=Ut(s,n);return t.setHours(23),t.setMinutes(59),t.setSeconds(59),t.setMilliseconds(999),t}function z(s,n){if(!s)return null;const t=Ut(s,n);return t.setHours(0),t.setMinutes(0),t.setSeconds(0),t.setMilliseconds(0),t}function K4(s,n){const t=L2(s),e=(7+s.getDay()-parseInt(n||0))%7;t.setDate(t.getDate()-e+3);const i=t.valueOf();return t.setMonth(0,1),t.getDay()!==4&&t.setMonth(0,1+(4-t.getDay()+7)%7),1+Math.ceil((i-t)/w3.week)}function V(s,n="day",t=1){switch(n){case"year":return V(s,"month",t*12);case"month":const e=Ut(s),i=e.getDate();return e.setMonth(e.getMonth()+t+1,0),i<e.getDate()&&s.setDate(i),e;case"week":return V(s,"day",t*7);case"date":case"day":return s=Ut(s),s.setDate(s.getDate()+t),s}if(!w3[n])throw new Error(n+" is not a supported interval");return s.setTime(this.getTime()+t*w3[n])}function W(s,n){const t={"M+":s.getMonth()+1,"D+":s.getDate(),"h+":s.getHours()%12===0?12:s.getHours()%12,"H+":s.getHours(),"m+":s.getMinutes(),"s+":s.getSeconds(),"q+":Math.floor((s.getMonth()+3)/3),d:s.getDay(),S:s.getMilliseconds(),a:s.getHours()<12?"上午":"下午",A:s.getHours()<12?"AM":"PM"};/(Y+)/.test(n)&&(n=n.replace(RegExp.$1,(s.getFullYear()+"").substr(4-RegExp.$1.length))),/(W+)/.test(n)&&(t["W+"]=K4(s));for(let e in t)new RegExp("("+e+")").test(n)&&(n=n.replace(RegExp.$1,RegExp.$1.length===1?t[e]:("00"+t[e]).substr((""+t[e]).length)));return n}function J4(s,n){const t=`css${W4()}`;let e=s.toString();if(e){if(n&&r.addClass(n,t),e=e.replace(/\/\*(\s|\S)*?\*\//g,""),n){const o=new RegExp("[^{}\\/]+\\s*(?=\\{)","g"),d="."+t+" ";e=e.replace(o,h=>{const u=h.trim();return u.startsWith("@")||u==="from"||u==="to"?u:u.split(/\s*,\s*/g).map(function(f){return d+f}).join(", ")})}const i=r("style");return i.setAttribute("type","text/css"),i.setAttribute("id",t),document.head.appendChild(i),i.appendChild(document.createTextNode(e)),i}return null}const y3={};function Q4(s,n,t,e){if(t&&y3[t])return y3[t];const i=document.createElement("template");i.innerHTML=s;const o=i.content;if(n){const d=document.createElement("style");d.textContent=n,o.prepend(d)}if(e){const d=document.querySelector("#oo-css-skin");if(d){const h=d.cloneNode(!0);h.removeAttribute("id"),o.prepend(h)}}return document.body.appendChild(i),t&&(y3[t]=i.content),i.content}class k extends HTMLElement{constructor(){super();c(this,V1);c(this,s5);c(this,i5);c(this,r5);c(this,r2,null)}_setEvent(){}_afterRender(){}_render(t){}_connected(){}_disconnected(){}_initialize(t,e,i,o){Object.hasOwn(this,"value")&&(this.value&&this.setAttribute("value",this.value),Reflect.deleteProperty(this,"value")),this._props=e?this._getProps(e.prop):{};const d=Q4(i,o,t,!0);this._useTemplate(d),this._render(t),this._setEvent(),this._afterRender(),this._createProperties(e),this.dispatchEvent(new CustomEvent("load"))}_createProperties(t){Object.keys(this._props).forEach(e=>{let i=e;for(;this.hasOwnProperty(i)||t.prototype.hasOwnProperty(i);)i=`_${i}`;Object.hasOwn(this,i)||Object.defineProperty(this,i,{get:()=>this._props[i],set:o=>{o!==this._props[i]&&this.setAttribute(_(i),o)}})})}_getProps(t){const e=X4(t);return this.getAttributeNames().forEach(i=>{const o=F1(i);if(e.hasOwnProperty(o)){const d=this.getAttribute(i);/{{.*}}/g.test(d)||a(this,V1,c4).call(this,e,o,d)}}),e}_useCss(t){const e=document.createElement("style");return e.textContent=t,this._content.insertAdjacentElement("beforebegin",e),e}_useCssLink(t){const e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.charSet="UTF-8",e.href=t,this._content.insertAdjacentElement("beforebegin",e),e}useCss(t){this.styleNode&&(this.styleNode.remove(),this.styleNode=null),t&&(this.styleNode=this._useCss(t))}useCssLink(t){this.styleNode&&(this.styleNode.remove(),this.styleNode=null),t&&(this.styleNode=this._useCssLink(t))}_useTemplate(t,e="open"){(this.shadowRoot||this.attachShadow({mode:e})).appendChild(t.cloneNode(!0)),a(this,s5,k9).call(this)}connectedCallback(){this._connected()}disconnectedCallback(){this._disconnected()}attributeChangedCallback(t,e,i){if(!/{{.*}}/g.test(i)){const o=F1(t),d=this._props[o];a(this,V1,c4).call(this,this._props,o,i),a(this,i5,E9).call(this,o,d,e)}}_setProps(t,e,i){const o=this._props[t];i!==o&&(this._setPropMap[t]?this._setPropMap[t](e,o):this._setPropMap.$default(t,e,o))}_useSkin(t){if(l(this,r2)&&l(this,r2).remove(),p(this,r2,null),t){const e=t.split(/\s*;\s*/g);p(this,r2,r("style"));let i="";e.forEach(o=>{const d=o.split(/\s*:\s*/g);i+=`--${d[0]}: ${d[1]};
	`}),l(this,r2).textContent=`
.content{
	${i}
}
`,this._content.insertAdjacentElement("beforebegin",l(this,r2))}}_fillContent(t){new MutationObserver(function(i){i.forEach(o=>{o.addedNodes.forEach(d=>{d.nodeType===Node.ELEMENT_NODE&&d.setAttribute("slot",t)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,r5,M9).call(this,t)}_canRender(t,e){if(t&&t.length){for(const i of t)if(!this.getAttribute(i))return!1}if(e&&e.length){for(const i of e)if(this.getAttribute(i))return!0}return!0}}r2=new WeakMap,V1=new WeakSet,c4=function(t,e,i){switch(v(t[e])){case"boolean":t[e]=!!i&&i!=="false";break;case"number":t[e]=isNaN(i)?i:parseInt(i);break;case"object":try{t[e]=JSON.parse(i)}catch{t[e]=i}break;case"array":try{t[e]=JSON.parse(i)}catch{t[e]=i?i.split(/\s*,\s*/g):[]}break;default:t[e]=i}},s5=new WeakSet,k9=function(){for(const t in this._elements)this._elements[t]=this.shadowRoot.querySelector(`.${t}`);this._content=this.shadowRoot.querySelector(".content")},i5=new WeakSet,E9=function(t,e,i){(t?[t]:Object.keys(this._props)).forEach(d=>{this._setProps(d,e,i)})},r5=new WeakSet,M9=function(t){let e=this.firstElementChild;for(;e;)e.setAttribute("slot",t),e=e.nextElementSibling};const F7=`<div class="button content">\r
...
`,l5=class l5 extends k{constructor(){super();c(this,o5);c(this,W1);C(this,"_elements",{text:null,prefix:null,suffix:null,button:null});c(this,K,{});C(this,"_setPropMap",{leftIcon:t=>{r.removeClass(this._elements.prefix,`ooicon-${t} icon`),this._props.leftIcon&&r.addClass(this._elements.prefix,`ooicon-${this._props.leftIcon} icon`)},rightIcon:t=>{r.removeClass(this._elements.suffix,`ooicon-${t} icon`),this._props.rightIcon&&r.addClass(this._elements.suffix,`ooicon-${this._props.rightIcon} icon`)},styles:()=>{},disabled:t=>{r.checkClass(this._elements.button,"disabled",this._props.disabled),r.toggleAttr(this._elements.button,"disabled",this._props.disabled),a(this,o5,S9).call(this,this._props.disabled)},type:t=>{this._props.type||(this._props.type="default"),t&&r.removeClass(this._elements.button,t),r.addClass(this._elements.button,this._props.type)},text:()=>{this.innerHTML.trim()||(this._elements.text.textContent=this._props.text)},skin:()=>{this._useSkin(this._props.skin)},$default:t=>{t==="value"&&(this.value=this._props[t]),r.toggleAttr(this._elements.button,t,this._props[t])}})}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_init(t,e,i,o){this._initialize(t,e||l5,i||F7,o||$7)}_render(){const t=this;new MutationObserver(function(){var i;a(i=t,W1,h4).call(i)}).observe(this,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),a(this,W1,h4).call(this)}_connected(){}};K=new WeakMap,o5=new WeakSet,S9=function(t){if(t){p(this,K,l(this,K)||{});for(let e in this)e.startsWith("on")&&this[e]&&(l(this,K)[e]=this[e],this[e]=null);this.style.pointerEvents="none"}else{if(l(this,K))for(let e in l(this,K))l(this,K)[e]&&(this[e]=l(this,K)[e],l(this,K)[e]=null);this.style.pointerEvents="auto"}},W1=new WeakSet,h4=function(){this.innerHTML.trim()&&(r.empty(this._elements.text),this._elements.text.insertAdjacentHTML("beforeend",this.innerHTML))},C(l5,"prop",{leftIcon:"",rightIcon:"",styles:"",disabled:!1,text:"",type:"",skin:""});let Xt=l5;class t9 extends Xt{constructor(){super(),this._init("oo-button")}}const I7=`<div class="content">\r
    <div class="left">\r
        <div class="top">\r
...
`,m5=class m5 extends k{constructor(){super();C(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},isShow:()=>{this._props.isShow&&window.setTimeout(()=>{this.show()},10)}});c(this,k2,null);c(this,E2,null);c(this,M2,null)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_init(t,e,i,o){this._initialize(t,e||m5,i||V7,o||B7)}_setEvent(){super._setEvent(),this.shadowRoot.addEventListener("mousedown",t=>{t.stopPropagation()})}show(t,e){!l(this,k2)&&!l(this,E2)&&(p(this,k2,Object.assign({},{scale:0},t)),p(this,E2,Object.assign({},{scale:1},e)),r.setStyles(this,{scale:0}),r.addClass(this,"show"),window.setTimeout(()=>{r.addClass(this,"transition"),r.setStyles(this,{scale:1})},10),window.setTimeout(()=>{this.dispatchEvent(new Event("show"))},210),this._addHideEvent(),this.isHide=!1)}_addHideEvent(){l(this,M2)||p(this,M2,()=>{this.hide()}),document.addEventListener("mousedown",l(this,M2))}hide(){l(this,k2)&&l(this,E2)&&!this.isHide&&(r.setStyles(this,l(this,k2)),window.setTimeout(()=>{r.removeClass(this,"transition"),r.removeClass(this,"show"),r.setStyles(this,l(this,E2)??{}),p(this,E2,null),p(this,k2,null),this._afterHide(),this.dispatchEvent(new Event("hide"))},200),this._removeHideEvent(),this.isHide=!0)}_afterHide(){}_removeHideEvent(){l(this,M2)&&document.removeEventListener("mousedown",l(this,M2))}};k2=new WeakMap,E2=new WeakMap,M2=new WeakMap,C(m5,"prop",{css:"",cssLink:"",skin:"",isShow:!1});let Gt=m5;class x3 extends Gt{constructor(){super(),this._init("oo-menu",x3)}}customElements.get("oo-menu")||customElements.define("oo-menu",x3);const W7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
...
`,g5=class g5 extends k{constructor(){super();C(this,"_elements",{});C(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},label:()=>{switch(this._props.type){case"command":this._elements.label&&(this._elements.label.textContent=this._props.label);break;case"checkbox":case"radio":this._elements.input&&(this._elements.input.text=this._props.label);break}},disabled:()=>{switch(r.removeClass(this._content,"disabled"),r.addClass(this._content,"enabled"),this._props.type){case"command":this._props.disabled&&(r.removeClass(this._content,"enabled"),r.addClass(this._content,"disabled"));break;case"checkbox":case"radio":this._elements.input.disabled=this._props.disabled,this._props.disabled&&r.removeClass(this._content,"enabled");break}},icon:t=>{this._elements.icon&&(r.removeClass(this._elements.icon,`ooicon-${t}`),this._props.icon&&r.addClass(this._elements.icon,`ooicon-${this._props.icon}`))},radiogroup:t=>{this._elements.radio&&(this._elements.radio.name=this._props.radiogroup)},type:t=>{t!==null&&t!==this._props.type&&this._renderItem()}});this._initialize("oo-menu-item",g5,H7,W7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_setEvent(){super._setEvent(),this.addEventListener("click",()=>{if(this.type==="command"){const t=r.getParent(this,"oo-menu");t&&t.hide()}})}_connected(){this.getAttribute("type")||this.setAttribute("type","command"),r.getParent(this,"oo-menu")&&this.setAttribute("slot","items"),this._renderItem()}_renderItem(){switch(r.empty(this),this._elements.icon=null,this._elements.label=null,this._elements.input=null,this._elements.hr=null,this.checkbox=null,this.radio=null,r.addClass(this._content,"enabled"),this._props.type){case"command":this._elements.icon=r("div.icon",{slot:"item"}),this._elements.label=r("div.label",{text:this._props.label,slot:"item"}),this._props.icon&&r.addClass(this._elements.icon,`ooicon-${this._props.icon}`),this.append(this._elements.icon),this.append(this._elements.label);break;case"checkbox":this._elements.input=r("oo-checkbox",{slot:"item"}),this.append(this._elements.input),this._elements.input.text=this._props.label,this.checkbox=this._elements.input;break;case"radio":this._elements.input=r("oo-radio",{slot:"item"}),this.append(this._elements.input),this._elements.input.text=this._props.label,this._elements.input.name=this._props.radiogroup,this.radio=this._elements.input;break;case"hr":this._elements.hr=r("hr",{slot:"item"}),this.append(this._elements.hr),r.removeClass(this._content,"enabled");break}}};C(g5,"prop",{css:"",cssLink:"",skin:"",icon:"",label:"",type:"command",disabled:!1,checked:!1,radiogroup:""});let k3=g5;customElements.get("oo-menu-item")||customElements.define("oo-menu-item",k3);class e9{constructor(n,t){c(this,f5);c(this,v5);c(this,b5);c(this,L5);C(this,"options",{css:"",cssLink:"",skin:""});this.options=Object.assign(this.options,t),this.target=n,this.container=this.options.container||r.getOffsetParent(n),this.area=this.options.area;const e=this.options.event||"click";this.target.addEventListener(e,()=>{this.show()}),this.target.addEventListener("mousedown",i=>{})}show(){this.menu||a(this,f5,D9).call(this),a(this,L5,I9).call(this),this.menu.show()}hide(){this.menu.hide()}destroy(){this.menu.remove()}}f5=new WeakSet,D9=function(){var n;this.menu=r("oo-menu",(n=this.options)==null?void 0:n.attr),this.container.append(this.menu),this.options.items&&this.options.items.length&&a(this,v5,F9).call(this),this.options.class&&r.addClass(this.menu,this.options.class)},v5=new WeakSet,F9=function(){this.options.items.forEach(n=>{a(this,b5,$9).call(this,n)})},b5=new WeakSet,$9=function(n){const t=document.createElement("oo-menu-item");this.menu.append(t),n==="-"?t.setAttribute("type","hr"):(Object.keys(n).forEach(e=>{e!=="command"?t.setAttribute(_(e),n[e]):t.addEventListener("click",n.command)}),t.addEventListener("click",e=>{this.menu.dispatchEvent(new CustomEvent("command",{detail:n}))}))},L5=new WeakSet,I9=function(){const n=r.getSize(this.target),t=r.getPosition(this.target,this.container),e=r.getSize(this.menu);let i=t.y+n.y,o=t.x,d="left",h="top";if(this.area){const u=r.getSize(this.area),m=r.getPosition(this.container,this.area);m.x+o+e.x>u.x&&(o=o-e.x+n.x,d="right"),m.y+i+e.y>u.y&&(i=i-e.y-n.y,h="bottom")}r.setStyles(this.menu,{top:i+"px",left:o+"px","transform-origin":`${d} ${h}`})};class n9 extends e9{constructor(t,e){super(t,e);c(this,_5);c(this,w5);c(this,y5);c(this,H2,null);c(this,n4,null);c(this,s4,null);C(this,"options",{css:"",cssLink:"",skin:"",view:"date",baseDate:null,yearOnly:!1,monthOnly:!1,dateOnly:!1,timeOnly:!1,weekOnly:!1,secondEnable:!0,cleanEnable:!1,todayEnable:!0,datetimeRange:"",dateRange:"",timeRange:"",format:"",weekBegin:1,value:""});this.options=Object.assign(this.options,e)}reset(t){if(this.options=Object.assign(this.options,t),this.calendar)for(let e in this.options)v(this.options[e])!=="null"&&this.calendar.setAttribute(_(e),this.options[e])}show(){this.menu||a(this,_5,z9).call(this),a(this,y5,R9).call(this),this.menu.show()}}H2=new WeakMap,n4=new WeakMap,s4=new WeakMap,_5=new WeakSet,z9=function(){var t;this.menu=r("oo-menu",(t=this.options)==null?void 0:t.attr),this.container.append(this.menu),p(this,H2,r("div",{slot:"items",styles:{height:"100%"}})),this.menu.append(l(this,H2)),a(this,w5,N9).call(this),this.options.class&&r.addClass(this.menu,this.options.class)},w5=new WeakSet,N9=function(){if(!this.calendar){let t="<oo-calendar";for(let e in this.options)v(this.options[e])!=="null"&&(t+=` ${_(e)}='${this.options[e]}'`);t+="></oo-calendar>",r.set(l(this,H2),"html",t),this.calendar=l(this,H2).firstElementChild,this.calendar.addEventListener("change",e=>{this.target.dispatchEvent(new CustomEvent("change",e))})}},y5=new WeakSet,R9=function(){const t=r.getSize(this.target),e=r.getPosition(this.target,this.container),i=r.getSize(this.menu);let o=e.y+t.y,d=e.x,h="left",u="top";if(this.area){const m=r.getSize(this.area),f=r.getPosition(this.container,this.area);f.x+d+i.x>m.x&&(d=d-i.x+t.x,h="right"),f.y+o+i.y>m.y&&(o=o-i.y-t.y,u="bottom")}r.setStyles(this.menu,{top:o+"px",left:d+"px","transform-origin":`${h} ${u}`})};function s9(s,n){return new n9(s,n)}const ot=class ot extends k{constructor(){super();C(this,"_elements",{content:null,top:null,prev:null,next:null,date:null,dateContent:null});c(this,i4,{});c(this,D,null);c(this,L1,null);C(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)},baseDate:()=>{this.setCurrentDate(),this.setDateContent()},weekBegin:()=>{this.setWeekTitle(),this.setDateContent()},$default:t=>{}});this._initialize("oo-calendar-view",ot,N7,R7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}static parseDate(t,e){return t?v(t)==="date"?e?new Date(t.getTime()):t:new Date(t):null}_render(){this.setCurrentDate()}_connected(){this.setWeekTitle(),this.setDateContent()}_setEvent(){this._elements.prev.addEventListener("click",t=>{V(l(this,D),"month",-1),this.setDateContent(),this.changeDate()}),this._elements.next.addEventListener("click",t=>{V(l(this,D),"month",1),this.setDateContent(),this.changeDate()}),this._elements.date.addEventListener("change",t=>{p(this,D,t.detail.date),this._elements.date.textContent=W(l(this,D),this._props.format),this.setDateContent()})}setCurrentDate(){p(this,D,this._props.baseDate?ot.parseDate(this._props.baseDate,!0):new Date),this.changeDate()}changeDate(){this._elements.date.textContent=W(l(this,D),this._props.format),l(this,L1)?l(this,L1).reset({value:W(l(this,D),"YYYY-MM")}):p(this,L1,s9(this._elements.date,{monthOnly:!0,format:this._props.format,container:document.body,value:W(l(this,D),"YYYY-MM")})),this.dispatchEvent(new CustomEvent("change",{detail:{date:l(this,D),value:W(l(this,D),"YYYY-MM")}}))}setWeekTitle(){const t=this._elements.dateContent.querySelectorAll("th");this._props.daysTitles.forEach((e,i)=>{t[(7+i-this._props.weekBegin)%7].textContent=e})}setDateContent(){const t=z(new Date).getTime(),e=z(l(this,D),!0);e.setDate(1);const i=this._elements.dateContent.querySelectorAll("td"),o=new Date(e.getTime());o.setDate(o.getDate()-1);const d=(7+o.getDay()+1-this._props.weekBegin)%7,h=(u,m)=>{u.querySelectorAll("slot").forEach(p3=>p3.remove());const f=W(m,"YYYY-MM-DD"),w=r("slot",{name:`title-${f}`});u.querySelector("div.cellTitle").appendChild(w);const i1=r("slot",{name:`content-${f}`});u.querySelector("div.cellContent").appendChild(i1),u.querySelector("span:first-child").textContent=W(m,"D"),u.dataset.dateValue=f,r.checkClass(u,"today",m.getTime()===t),r.checkClass(u,"other",m.getMonth()!==l(this,D).getMonth())};for(let u=d-1;u>=0;u--)h(i[u],o),o.setDate(o.getDate()-1);for(let u=d;u<i.length;u++)h(i[u],e),e.setDate(e.getDate()+1)}};i4=new WeakMap,D=new WeakMap,L1=new WeakMap,C(ot,"prop",{baseDate:"",weekBegin:1,format:"YYYY年MM月",months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],daysTitles:["周日","周一","周二","周三","周四","周五","周六"]});let E3=ot;const Y7=`.content {\r
...
`,q7='<div class="capsulae content"></div>',k5=class k5 extends k{constructor(){super();c(this,x5);C(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_init(t,e,i,o){this._initialize(t,e||k5,i||q7,o||Y7)}_render(){new MutationObserver(function(e){e.forEach(i=>{i.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,x5,B9).call(this)}};x5=new WeakSet,B9=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},C(k5,"prop",{skin:""});let M3=k5;const U7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
</div>`,K5=class K5 extends k{constructor(){super();C(this,"_setPropMap",{$default:()=>{},text:()=>{this._elements.text.textContent=this._props.text},label:()=>{this._elements.label.textContent=this._props.label},skin:()=>{this._useSkin(this._props.skin)}});C(this,"_elements",{text:null,label:null});c(this,R,null);c(this,k1,[]);this._initialize("oo-option-group",K5,b0,v0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_render(){this._elements.text.textContent=this._props.text||this._props.label}_connected(){const t=this.parentElement;t.tagName.toLowerCase()==="oo-select"&&p(this,R,t),l(this,R)?(l(this,R)._appendGroup(this),r.show(this)):r.hide(this)}_disconnected(){if(l(this,R)){const t=l(this,R);p(this,R,null),t._removeGroup(this)}}_removeItem(t){l(this,R)&&l(this,R)._removeItem(t),l(this,k1).splice(l(this,k1).indexOf(t),1)}_appendItem(t){l(this,R)&&l(this,R)._appendItem(t),l(this,k1).push(t)}};R=new WeakMap,k1=new WeakMap,C(K5,"prop",{text:"",skin:""});let F3=K5;const L0=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding: 0.1em 0;\r
...
`,pe=class pe extends k{constructor(){super();c(this,vt);c(this,bt);c(this,p2);c(this,E1);c(this,u2);c(this,ce);c(this,Lt);c(this,he);C(this,"_elements",{first:null,last:null,prev:null,next:null,pages:null,jumper:null,jumperTextLeft:null,jumperTextRight:null,jumperPageCount:null,jumperInput:null});C(this,"_setPropMap",{cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},current:(t,e)=>{t!==e&&B(a(this,p2,l1),this)},total:(t,e)=>{t!==e&&B(a(this,p2,l1),this)},pageSize:(t,e)=>{t!==e&&B(a(this,p2,l1),this)},pageCount:()=>{},pages:(t,e)=>{t!==e&&B(a(this,p2,l1),this)},first:()=>{a(this,vt,M4).call(this)},last:()=>{a(this,bt,S4).call(this)},jumper:()=>{r.checkClass(this._elements.jumper,"hide",!this._props.jumper)}});this._initialize("oo-pagination",pe,x0,y0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}async _render(){a(this,E1,v3).call(this),a(this,vt,M4).call(this),a(this,bt,S4).call(this),B(a(this,p2,l1),this),a(this,he,_8).call(this)}_setEvent(){this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.first.addEventListener("click",()=>{this.gotoFirst()}),this._elements.last.addEventListener("click",()=>{this.gotoLast()}),this._elements.jumperInput&&this._elements.jumperInput.addEventListener("keydown",t=>{if(t.key==="Enter"||t.keyCode===13){const e=this._elements.jumperInput;!isNaN(e.value)&&e.value&&(this.gotoPage(parseInt(e.value)),e.value="")}})}setCurrent(t){this._props.current=t,a(this,E1,v3).call(this)}gotoPage(t){this.setCurrent(t),this.dispatchEvent(new CustomEvent("page",{detail:this._props.current})),this.setAttribute("current",this._props.current),B(a(this,p2,l1),this)}pagesForward(){this.gotoPage(this._props.current+(this._props.pages-2))}pagesBack(){this.gotoPage(this._props.current-(this._props.pages-2))}gotoFirst(){this.gotoPage(1)}gotoLast(){this.gotoPage(this._props.pageCount)}gotoPrev(){this.gotoPage(--this._props.current)}gotoNext(){this.gotoPage(++this._props.current)}};vt=new WeakSet,M4=function(){const t=this._props.first;this._elements.first.textContent=t,r.checkClass(this._elements.first,"hide",!t)},bt=new WeakSet,S4=function(){const t=this._props.last;this._elements.last.textContent=t,r.checkClass(this._elements.last,"hide",!t)},p2=new WeakSet,l1=function(t,e,i){if(a(this,E1,v3).call(this),r.empty(this._elements.pages),this._props.pageCount<=this._props.pages)for(let o=1;o<=this._props.pageCount;o++)a(this,u2,a1).call(this,o);else{a(this,u2,a1).call(this,1);const o=this._props.pages-2,d=parseInt(o/2);let h;if(this._props.current-d<=2)for(let u=1;u<=o;u++)h=u+1,a(this,u2,a1).call(this,h);else if(this._props.current+d>=this._props.pageCount-1){a(this,Lt,A4).call(this);for(let u=o;u>=1;u--)h=this._props.pageCount-u,a(this,u2,a1).call(this,h)}else{a(this,Lt,A4).call(this);for(let u=0;u<o;u++)h=this._props.current-(d-u),a(this,u2,a1).call(this,h,i)}h<this._props.pageCount-1&&a(this,ce,L8).call(this),a(this,u2,a1).call(this,this._props.pageCount)}},E1=new WeakSet,v3=function(){this._props.pageCount=Math.ceil(this._props.total/this._props.pageSize),this._props.current<1&&(this._props.current=1),this._props.current>this._props.pageCount&&(this._props.current=this._props.pageCount)},u2=new WeakSet,a1=function(t){const e=document.createElement("div");e.textContent=t,t===this._props.current&&r.addClass(e,"current"),e.addEventListener("click",()=>{this.gotoPage(t)}),this._elements.pages.append(e)},ce=new WeakSet,L8=function(){const t=document.createElement("div");r.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesForward()}),this._elements.pages.append(t)},Lt=new WeakSet,A4=function(){const t=document.createElement("div");r.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesBack()}),this._elements.pages.append(t)},he=new WeakSet,_8=function(){const t=this._props.jumperText.split("{n}");this._elements.jumperTextLeft.textContent=t[0],this._elements.jumperTextRight.textContent=(t==null?void 0:t[1])??"",this._elements.jumperPageCount.textContent=this._props.pageCount},C(pe,"prop",{total:200,pageSize:20,pageCount:0,pages:10,current:1,jumper:!0,first:"第一页",last:"最后一页",jumperText:"到第{n}页",border:!0,cssLink:"",skin:""});let I3=pe;const k0=`.content{\r
    --radius: 100%;\r
}\r
.check{\r
    border-radius: var(--radius);\r
...
`;class E0 extends Qt{constructor(){super(),this._init("oo-radio"),this._useCss(k0)}_unCheckedOther(){this.ownerDocument.querySelectorAll(`oo-radio[name='${this._props.name}']`).forEach(t=>{t!==this&&t.checked&&t._unchecked()})}_render(){this._elements.input.type="radio",this._elements.input.checked&&this._unCheckedOther(),super._render()}}var u9=globalThis&&globalThis.__spreadArray||function(s,n,t){if(t||arguments.length===2)for(var e=0,i=n.length,o;e<i;e++)(o||!(e in n))&&(o||(o=Array.prototype.slice.call(n,0,e)),o[e]=n[e]);return s.concat(o||Array.prototype.slice.call(n))},M0=function(){function s(n,t,e){this.name=n,this.version=t,this.os=e,this.type="browser"}return s}(),S0=function(){function s(n){this.version=n,this.type="node",this.name="node",this.os=process.platform}return s}(),A0=function(){function s(n,t,e,i){this.name=n,this.version=t,this.os=e,this.bot=i,this.type="bot-device"}return s}(),T0=function(){function s(){this.type="bot",this.bot=!0,this.name="bot",this.version=null,this.os=null}return s}(),O0=function(){function s(){this.type="react-native",this.name="react-native",this.version=null,this.os=null}return s}(),P0=/alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/,Z0=/(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask\ Jeeves\/Teoma|ia_archiver)/,C9=3,j0=[["aol",/AOLShield\/([0-9\._]+)/],["edge",/Edge\/([0-9\._]+)/],["edge-ios",/EdgiOS\/([0-9\._]+)/],["yandexbrowser",/YaBrowser\/([0-9\._]+)/],["kakaotalk",/KAKAOTALK\s([0-9\.]+)/],["samsung",/SamsungBrowser\/([0-9\.]+)/],["silk",/\bSilk\/([0-9._-]+)\b/],["miui",/MiuiBrowser\/([0-9\.]+)$/],["beaker",/BeakerBrowser\/([0-9\.]+)/],["edge-chromium",/EdgA?\/([0-9\.]+)/],["chromium-webview",/(?!Chrom.*OPR)wv\).*Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/],["chrome",/(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/],["phantomjs",/PhantomJS\/([0-9\.]+)(:?\s|$)/],["crios",/CriOS\/([0-9\.]+)(:?\s|$)/],["firefox",/Firefox\/([0-9\.]+)(?:\s|$)/],["fxios",/FxiOS\/([0-9\.]+)/],["opera-mini",/Opera Mini.*Version\/([0-9\.]+)/],["opera",/Opera\/([0-9\.]+)(?:\s|$)/],["opera",/OPR\/([0-9\.]+)(:?\s|$)/],["pie",/^Microsoft Pocket Internet Explorer\/(\d+\.\d+)$/],["pie",/^Mozilla\/\d\.\d+\s\(compatible;\s(?:MSP?IE|MSInternet Explorer) (\d+\.\d+);.*Windows CE.*\)$/],["netfront",/^Mozilla\/\d\.\d+.*NetFront\/(\d.\d)/],["ie",/Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/],["ie",/MSIE\s([0-9\.]+);.*Trident\/[4-7].0/],["ie",/MSIE\s(7\.0)/],["bb10",/BB10;\sTouch.*Version\/([0-9\.]+)/],["android",/Android\s([0-9\.]+)/],["ios",/Version\/([0-9\._]+).*Mobile.*Safari.*/],["safari",/Version\/([0-9\._]+).*Safari/],["facebook",/FB[AS]V\/([0-9\.]+)/],["instagram",/Instagram\s([0-9\.]+)/],["ios-webview",/AppleWebKit\/([0-9\.]+).*Mobile/],["ios-webview",/AppleWebKit\/([0-9\.]+).*Gecko\)$/],["curl",/^curl\/([0-9\.]+)$/],["searchbot",P0]],m9=[["iOS",/iP(hone|od|ad)/],["Android OS",/Android/],["BlackBerry OS",/BlackBerry|BB10/],["Windows Mobile",/IEMobile/],["Amazon OS",/Kindle/],["Windows 3.11",/Win16/],["Windows 95",/(Windows 95)|(Win95)|(Windows_95)/],["Windows 98",/(Windows 98)|(Win98)/],["Windows 2000",/(Windows NT 5.0)|(Windows 2000)/],["Windows XP",/(Windows NT 5.1)|(Windows XP)/],["Windows Server 2003",/(Windows NT 5.2)/],["Windows Vista",/(Windows NT 6.0)/],["Windows 7",/(Windows NT 6.1)/],["Windows 8",/(Windows NT 6.2)/],["Windows 8.1",/(Windows NT 6.3)/],["Windows 10",/(Windows NT 10.0)/],["Windows ME",/Windows ME/],["Windows CE",/Windows CE|WinCE|Microsoft Pocket Internet Explorer/],["Open BSD",/OpenBSD/],["Sun OS",/SunOS/],["Chrome OS",/CrOS/],["Linux",/(Linux)|(X11)/],["Mac OS",/(Mac_PowerPC)|(Macintosh)/],["QNX",/QNX/],["BeOS",/BeOS/],["OS/2",/OS\/2/]];function D0(s){return s?g9(s):typeof document>"u"&&typeof navigator<"u"&&navigator.product==="ReactNative"?new O0:typeof navigator<"u"?g9(navigator.userAgent):I0()}function F0(s){return s!==""&&j0.reduce(function(n,t){var e=t[0],i=t[1];if(n)return n;var o=i.exec(s);return!!o&&[e,o]},!1)}function g9(s){var n=F0(s);if(!n)return null;var t=n[0],e=n[1];if(t==="searchbot")return new T0;var i=e[1]&&e[1].split(".").join("_").split("_").slice(0,3);i?i.length<C9&&(i=u9(u9([],i,!0),z0(C9-i.length),!0)):i=[];var o=i.join("."),d=$0(s),h=Z0.exec(s);return h&&h[1]?new A0(t,o,d,h[1]):new M0(t,o,d)}function $0(s){for(var n=0,t=m9.length;n<t;n++){var e=m9[n],i=e[0],o=e[1],d=o.exec(s);if(d)return i}return null}function I0(){var s=typeof process<"u"&&process.version;return s?new S0(process.version.slice(1)):null}function z0(s){for(var n=[],t=0;t<s;t++)n.push("0");return n}const f9=function(s,n,t){const e=n.toLowerCase();e==="text"?s.textContent=t:e==="html"?s.innerHTML=t:e==="styles"?g.setStyles(s,t):s.setAttribute(n,t)},N0=function(s,n){const t=n.toLowerCase();if(t==="text")return s.innerText||s.textContent||"";if(t==="html")return s.innerHTML||"";if(t==="value")switch(s.tagName.toString().toLowerCase()){case"select":return s.options[s.selectedIndex].value;default:return s.value}return s.getAttribute(n)},e5=function(s){const n=H0(s||"").split(" "),t={};return n.filter(function(e){if(e!==""&&!t[e])return t[e]=e})},v9=function(s){return!s.tagName||/^(?:body|html)$/i.test(s.tagName)},b9=function(s){return/html/i.test(s.tagName)},n5=function(s,n){return parseInt(g.getStyle(s,n))||0},R0=function(s){return n5(s,"border-top-width")},B0=function(s){return n5(s,"border-left-width")},V0=function(s,n){return{left:s.x-n5(n,"margin-left"),top:s.y-n5(n,"margin-top")}},g=(s,n)=>{let t;const e=s.replace(/^\S*?(?=\.|#|$)/,h=>(t=h,""));let i="",o;e&&(o=e.split(".").filter(u=>!!u).map(u=>{const m=u.split("#"),f=m.shift();return i=m.pop()||i,f}));const d=document.createElement(t);return i&&d.setAttribute("id",i),o&&o.length&&d.setAttribute("class",o.join(" ")),n&&g.set(d,n),d};Object.assign(g,{el:(s,n)=>L9(s)==="string"&&s?(n||document).querySelector(s):s,els:(s,n)=>(n||document).querySelectorAll(s),addClass:(s,n)=>{const t=g.el(s);return e5(n).forEach(e=>{t.classList.add(e)}),t},removeClass:(s,n)=>{const t=g.el(s);return e5(n).forEach(e=>{t.classList.remove(e)}),t},hasClass:(s,n)=>g.el(s).classList.contains(n),toggleClass:(s,n,t=!1)=>{const e=g.el(s);return e5(n).forEach(i=>{let o=t;(o==null||o===!1)&&(o=!g.hasClass(e,i)),o?g.addClass(e,i):g.removeClass(e,i)}),e},checkClass:(s,n,t)=>{const e=g.el(s);return e5(n).forEach(i=>{t?g.addClass(e,i):g.removeClass(e,i)}),e},mapProps:(s,n)=>{const t=g.el(s);for(const e in n){const i=W0(e);if(typeof n[e]=="boolean")n[e]=t.hasAttribute(e)||t.hasAttribute(i)||!1;else{const o=t.getAttribute(e)||t.getAttribute(i)||"";o!==n[e]&&(n[e]=o)}}return t},toggleAttr:(s,n,t)=>{const e=g.el(s);return t?e.setAttribute(n,t):e.removeAttribute(n),e},set:(s,n,t)=>{const e=g.el(s);return typeof n=="object"?Object.keys(n).forEach(i=>{f9(e,i,n[i])}):f9(e,n,t),e},get:(s,n)=>{const t=g.el(s);return N0(t,n)},setProperty:(s,n,t)=>{const e=g.el(s);return e.setAttribute(n,t),e},getScroll:s=>{const n=g.el(s);return{x:n.scrollLeft,y:n.scrollTop}},getScrolls:s=>{let t=g.el(s).parentNode,e={x:0,y:0};for(;t&&!v9(t);)e.x+=t.scrollLeft,e.y+=t.scrollTop,t=t.parentNode;return e},getOffsetParent:s=>{let n=s.offsetParent;for(;n&&["table","td","th"].includes(n.tagName.toString().toLowerCase());)n=n.offsetParent;return n||document.body},getPosition:(s,n)=>{const t=g.el(s);for(n===window&&(n=document.documentElement);n&&g.getStyle(n,"display")==="contents";)n=n.parentElement;for(;s&&g.getStyle(s,"display")==="contents";)s=s.parentElement;const e=s.getBoundingClientRect(),i=document.documentElement,o=g.getScroll(i),d=g.getScrolls(t),h=g.getStyle(t,"position")==="fixed",u={x:e.left+d.x+(h?0:o.x)-i.clientLeft,y:e.top+d.y+(h?0:o.y)-i.clientTop},m=g.getScrolls(t),f={x:u.x-m.x,y:u.y-m.y};if(n){const w=g.getPosition(n);return{x:f.x-w.x-B0(n),y:f.y-w.y-R0(n)}}return f},setPosition:(s,n)=>{const t=g.el(s);return g.setStyles(t,V0(n.this))},getSize:s=>{const n=g.el(s);if(b9(n))return{x:n.clientWidth,y:n.clientHeight};{const t=n.getBoundingClientRect();return{x:t.width,y:t.height}}},getScrollSize:s=>{const n=g.el(s);if(/^(?:body|html)$/i.test(n.tagName)){const t=document.documentElement,e=document.body;return{x:Math.max(t.scrollWidth,e.scrollWidth),y:Math.max(t.scrollHeight,e.scrollHeight)}}return{x:n.scrollWidth,y:n.scrollHeight}},getStyle:function(s,n){const t=g.el(s),e=z3(n);let i=t.style[e];return i||(i=window.getComputedStyle(t)[e]),i},getStyles:s=>{const n=[...arguments],t=g.el(n.shift()),e={};return n.forEach(i=>{e[i]=g.getStyle(t,i)}),e},setStyle:(s,n,t)=>{const e=g.el(s);return typeof n=="object"?Object.keys(n).forEach(i=>{e.style[z3(i)]=n[i]}):e.style[z3(n)]=t,e},setStyles:(s,n)=>g.setStyle(s,n),isPositioned:s=>{const n=g.el(s),t=g.getStyle(n,"position");return t&&["absolute","fixed","relative","sticky"].includes(t)},show:s=>{const n=g.el(s);return g.getStyle(n,"display")==="none"&&g.setStyle(n,"display",n.dataset.storeDisplay||"block"),n},hide:s=>{const n=g.el(s),t=g.getStyle(n,"display");return t!=="none"&&(n.dataset.storeDisplay=t,g.setStyle(n,"display","none")),n},getParentSrcollNode:s=>{let t=g.el(s).parentElement,e=g.getStyle(t,"overflow"),i=g.getStyle(t,"overflow-y");for(;t&&(g.getScrollSize(t).y<=g.getSize(t).y||!["auto","scroll"].includes(e)&&!["auto","scroll"].includes(i));)t=t.parentElement,t&&(e=g.getStyle(t,"overflow"),i=g.getStyle(t,"overflow-y"));return t||document.documentElement},getParent:function(s,n){if(n){let t=s.parentElement;for(;t&&!t.matches(n);)t=t.parentElement;return t}else return s.parentElement},isBody:s=>v9(g.el(s)),isHtml:s=>b9(g.el(s)),empty:s=>{const n=g.el(s);for(;n.childNodes.length;)n.removeChild(n.childNodes[0]);return n},peel:(s,n)=>{const{node:t,position:e}=n&&L9(n)==="element"?{node:n,position:"beforeend"}:{node:s,position:"beforebegin"};let i=s.firstElementChild;for(;i;)t.insertAdjacentElement(e,i),i=s.firstElementChild;s.remove()},getPositionParent(s){let n=g.el(s).parentElement;for(;n;){const t=n.tagName.toString().toLowerCase();if(t==="application")return n;if(t==="oo-dialog")return n._content;n=n.parentElement}return document.body},overlap(s,n,t=document.body,e){const i=this.getSize(g.el(n)),o=this.getPosition(g.el(n),t),d=g.el(s);this.setStyles(d,{position:"absolute",width:`${i.x}px`,height:`${i.y}px`,top:`${o.y}px`,left:`${o.x}px`}),d.isConnected||t.append(d)},appendTop(s,n){const t=s.firstChild;return t?s.insertBefore(n,t):s.appendChild(n)}}),D0();function L9(s){if(s==null)return"null";if(Array.isArray(s))return"array";if(s instanceof Map)return"map";if(s instanceof Set)return"set";if(s===window)return"window";if(s instanceof Date)return"date";if(s instanceof RegExp)return"regexp";if(s instanceof Error)return"error";if(s instanceof Event)return"event";if((typeof s=="function"||typeof s=="object")&&typeof s.then=="function")return"promise";if(s.nodeName){if(s.nodeType===1)return"element";if(s.nodeType===3)return/\S/.test(s.nodeValue)?"textnode":"whitespace";if(s.nodeType===9)return"document";if(s.nodeType||s.nodeType===0)return s.nodeName}else if(typeof s.length=="number"&&s.callee)return"arguments";return typeof s}function W0(s){return s.replace(/([A-Z])/g,"-$1").toLowerCase()}function z3(s){return s.replace(/-(\w)/g,function(n,t){return t.toUpperCase()})}function H0(s){return s.replace(/\s+/g," ").trim()}class Y0 extends t5{constructor(){super();c(this,ue);c(this,Ce);a(this,ue,w8).call(this),this._init("oo-radio-group")}_appendItemCheckValue(t){this._props.value?t.value===this._props.value&&t.setAttribute("checked",!0):t._unchecked()}_itemChange(t){t.currentTarget.checked?this.value=t.currentTarget.value:this.value="",this._elements.input.value=this.value,this.unInvalidStyle(),this.dispatchEvent(new Event("change",t))}_removeItem(t){super._removeItem(t)}get text(){return a(this,Ce,y8).call(this)}}ue=new WeakSet,w8=function(){this.setPropMap=Object.assign(this._setPropMap,{value:()=>{if(this._props.value){for(const t of this._items)if(t.value===this._props.value){t.setAttribute("checked",!0);break}}this._elements.input.value=this._props.value}})},Ce=new WeakSet,y8=function(){for(const t of this._items)if(t.checked)return t.text;return""};const q0=`.content{\r
...
`,_e=class _e extends k{constructor(){super();c(this,kt);C(this,"_setPropMap",{rows:()=>{a(this,kt,j4).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",_e,J0,K0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_render(){a(this,kt,j4).call(this)}};kt=new WeakSet,j4=function(){r.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(r("div.item"))}catch{}},C(_e,"prop",{rows:"5",cssLink:"",skin:""});let B3=_e;const Q0=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`,o4=class o4 extends Z2{constructor(){super();c(this,Te);a(this,Te,j8).call(this),this._init("oo-textarea"),this._useCss(a6)}_init(t){this._initialize(t,o4,l6,c9)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("input",()=>{this.setHeight()}),r.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()}setHeight(){if(this._props.autoSize){this._elements.input.style.height="auto";const t=this._elements.input.scrollHeight;this._elements.input.style.height=t+"px"}}};Te=new WeakSet,j8=function(){this._setPropMap=Object.assign(this._setPropMap,{autoSize:()=>{r.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()},value:()=>{try{this._elements.input.value=this._props.value}catch{}this._props.value?this._elements.viewText.textContent=this._props.value:this._elements.viewText.innerHTML="&nbsp;",window.setTimeout(()=>{this.setHeight()},10)}})};let q3=o4;const d6=`.content{\r
...
`},Symbol.toStringTag,{value:"Module"})),x9=Object.freeze(Object.defineProperty({__proto__:null,default:`* {\r
    box-sizing: border-box;\r
}\r
.container{\r
    /*position: absolute;*/\r
...
`},Symbol.toStringTag,{value:"Module"}));return L.DatetimePicker=n9,L.Dialog=_9,L.Dragdrop=L6,L.Draggable=y9,L.Menu=e9,L.Notice=R1,L.Tooltip=N1,L.confirm=g6,L.datetimePicker=s9,L.defineComponent=_6,L.dialog=w9,L.mask=v6,L.notice=B1,L.tooltip=p9,L.unmask=b6,Object.defineProperty(L,Symbol.toStringTag,{value:"Module"}),L}({});
