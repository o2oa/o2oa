...
MWF.xApplication.cms.ColumnManager.LP={
	...
	"ignoreTitleSelectText": [
		"Do not fill in the title of the new interface",
		"The title of the new interface needs to be filled in"
	],
	"checkDraftSelectText": [
		"New interface check draft",
		"New interface does not check draft"
	],
	"showAllDocumentSelectText": [
		"Show all document views",
		"Hide all document views"
	],
	"showDelayDocumentSelectText": [
		"Show timed release document view",
		"Hide timed release document view"
	],
	"saveDraftOnClose": [
		"Save the document when closing the draft",
		"Do not save the document when closing the draft"
	],
