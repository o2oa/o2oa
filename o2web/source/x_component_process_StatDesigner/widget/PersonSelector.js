...
MWF.xApplication.process.StatDesigner.widget.PersonSelector = new Class({
            ...
            var options = {
                ...
                "onComplete": function(items){
                    ...
                    MWF.require("MWF.widget.Identity", function(){
                        ...
                        if (this.options.type.toLowerCase()=="duty") {
                            items.each(function(item){
                                new MWF.xApplication.process.StatDesigner.widget.PersonSelector.DutyInput(this, item.data, this.node, explorer, 20000);
                            }.bind(this));
                        }
...
MWF.xApplication.process.StatDesigner.widget.PersonSelector.DutyInput = Class({
    Implements: [Events],
