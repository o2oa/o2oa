MWF.xApplication.ftsearch2.options.multitask = false;
MWF.xApplication.ftsearch2.Main = new Class({
	...
	options: {
		...
		"mvcStyle": "style.css",
		"icon": "icon.png",
		"title": MWF.xApplication.ftsearch2.LP.title,
		"query":""
	},
	onQueryLoad: function(){
		this.lp = MWF.xApplication.ftsearch2.LP;
	},
	...
	openFTSearchView: function( query ){
		...
		o2.requireApp("ftsearch2", "FTSearchView", function () {
			this.view = new MWF.xApplication.ftsearch2.FTSearchView(this.contentArea, this, {
				query: query
			});
		}.bind(this), false);
	},
	openIndexView: function( data ){
		if( this.view && this.view.destroy )this.view.destroy();
		this.contentArea.empty();
		o2.requireApp("ftsearch2", "IndexView", function () {
			this.view = new MWF.xApplication.ftsearch2.IndexView(this.contentArea, this, {}, data);
		}.bind(this), false);
	},
	iconOver: function(e){
