MWF.xApplication.ftsearch2.ElModule = new Class({
...
MWF.xApplication.ftsearch2.Input = new Class({
    Extends: MWF.xApplication.ftsearch2.ElModule,
    options: {
        value: "",
        id: ""
    },
...
MWF.xApplication.ftsearch2.DatePicker = new Class({
    Extends: MWF.xApplication.ftsearch2.ElModule,
    options: {
        start: "",
        end: "",
...
MWF.xApplication.ftsearch2.NumberRange = new Class({
    Extends: MWF.xApplication.ftsearch2.ElModule,
    options: {
        max: "100",
        min: "1",
