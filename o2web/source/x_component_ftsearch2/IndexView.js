...
o2.requireApp("ftsearch2", "Common", null, false);
MWF.xApplication.ftsearch2.IndexView = new Class({
    ...
    initialize: function(node, app, options, tabData){
        ...
        this.path = "../x_component_ftsearch2/$IndexView/";
    ...
    loadCustomConditionItem: function(e, row){
        ...
        switch (row.fieldType) {
            case "string":
                new MWF.xApplication.ftsearch2.Input(e.target, {
                    id: row.name,
                ...
                break;
            case "date":
                new MWF.xApplication.ftsearch2.DatePicker(e.target, {
                    start: row.min,
                    end: row.max,
                    id: row.name,
                    onChange: function (data) {
                ...
                break;
            case "number":
                new MWF.xApplication.ftsearch2.NumberRange(e.target, {
                    min: row.min,
                    max: row.max,
                    id: row.name,
                    onChange: function (data) {
