MWF.xApplication.portal.PageDesigner.Module.Common = MWF.PCCommon = new Class({
	Extends: MWF.FCDiv,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"propertyPath": "/x_component_portal_PageDesigner/Module/Common/common.html"
	},
	
	initialize: function(form, options){
		this.setOptions(options);
		
		this.path = "/x_component_portal_PageDesigner/Module/Common/";
		this.cssPath = "/x_component_portal_PageDesigner/Module/Common/"+this.options.style+"/css.wcss";
