...
MWF.xApplication.query.QueryManager.StatementStatExplorer = new Class({
	Extends: MWF.xApplication.query.QueryManager.StatExplorer,
	Implements: [Options, Events],
    options: {
        "style": "default",
        "tooltip": {
            "create": MWF.xApplication.query.QueryManager.LP.statementStat.create,
            "search": MWF.xApplication.query.QueryManager.LP.statementStat.search,
            "searchText": MWF.xApplication.query.QueryManager.LP.statementStat.searchText,
            "noElement": MWF.xApplication.query.QueryManager.LP.statementStat.noStatNoticeText
        }
    },
        ...
        if (this.selectMarkItems.length){
            ...
            this.selectMarkItems.each(function(item){
                this.app.restActions.getStatement(item.data.id, function(json){
                    json.data.elementType = "statementStat";
    ...
    pasteItem: function(data, i){
        if (i<data.length){
            var item = data[i];
            if (item.elementType==="statementStat"){
...
//                html += "<>"
    ...
    _createElement: function(e){
        ...
        this.app.desktop.openApplication(e, "query.StatementStatDesigner", options);
    },
    ...
    _getItemObject: function(item){
        return new MWF.xApplication.query.QueryManager.StatementStatExplorer.StatementStat(this, item);
    },
...
MWF.xApplication.query.QueryManager.StatementStatExplorer.StatementStat= new Class({
	...
	_open: function(e){
        var _self = this;
        var options = {
            "appId": "query.StatementStatDesigner"+_self.data.id,
            "id": _self.data.id,
        ...
        this.explorer.app.desktop.openApplication(e, "query.StatementStatDesigner", options);
	},
	_getIcon: function(){
	...
	_getLnkPar: function(){
		return {
			...
			"par": "query.StatementStatDesigner#{\"id\": \""+this.data.id+"\", \"applicationId\": \""+this.data.query+"\"}"
		};
	},
