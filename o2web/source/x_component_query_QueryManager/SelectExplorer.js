...
MWF.xApplication.query.QueryManager.SelectExplorer = new Class({
	Extends: MWF.xApplication.process.ProcessManager.Explorer,
	Implements: [Options, Events],
    options: {
        "style": "default",
        "tooltip": {
            "create": MWF.xApplication.query.QueryManager.LP.select.create,
            "search": MWF.xApplication.query.QueryManager.LP.select.search,
            "searchText": MWF.xApplication.query.QueryManager.LP.select.searchText,
            "noElement": MWF.xApplication.query.QueryManager.LP.select.noSelectNoticeText
        }
    },
    ...
    _loadItemDataList: function(callback){
        this.app.restActions.listSelect(this.app.options.application.id,callback);
    },
    _getItemObject: function(item){
        return new MWF.xApplication.query.QueryManager.SelectExplorer.Select(this, item);
    },
...
MWF.xApplication.query.QueryManager.SelectExplorer.Select= new Class({
	...
	deleteSelect: function(callback){
