...
MWF.xApplication.meetingv2.WeekView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_meetingv2/$WeekView/";
        this.cssPath = "../x_component_meetingv2/$WeekView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
    ...
    loadCalendar: function(){
        ...
        this.calendar = new MWF.xApplication.meetingv2.WeekView.Calendar(this, date  );
...
MWF.xApplication.meetingv2.WeekView.Calendar = new Class({
    Implements: [Events],
    ...
    createWeekSelector: function(){
        //this.monthSelector = new MWF.xApplication.meetingv2.WeekView.Calendar.WeekSelector(this.date, this);
        this.weekCalendar = new MWF.xApplication.meetingv2.WeekView.WeekCalendar(this.titleTextNode, {
            "style":"meeting_blue",
    ...
    setBodyNode: function(){
        ...
        this.bulidingData.each( function( buliding ){
            buliding.roomList.each( function( room ){
                ...
                this.rooms[ room.id ] = new MWF.xApplication.meetingv2.WeekView.Room(this, node, room, buliding.name);

                if( buliding.id !== "noRoom" ){
                    this.roomTooltips.push(
                        new MWF.xApplication.meetingv2.RoomTooltip(this.app.content, node, this.app, room, {
                            axis : "x",
                            hiddenDelay : 300,
                            displayDelay : 300
                        })
    ...
    loadDay: function(index, date){
        ...
        this.days[key] = new MWF.xApplication.meetingv2.WeekView.Calendar.Day(index, date, this, type);
    },
    reload : function(){
        this.view.reload();
    },
...
MWF.xApplication.meetingv2.WeekView.Room = new Class({
    Implements: [Events],
    ...
    editRoom : function(){
        var form = new MWF.xApplication.meetingv2.RoomForm(this.app,this.data, {}, {app:this.app});
        form.view = this;
        form.edit();
    },
    openRoom : function(){
...
MWF.xApplication.meetingv2.WeekView.Calendar.Day = new Class({
    Implements: [Events],
        ...
        for( var key in this.roomMeetingObject ) {
            ...
            this.roomMeetingObject[key].each(function (meeting, idx) {
                if (!meeting.myReject) {
                    ...
                    //if (meetingCount<4)
                    var m = new MWF.xApplication.meetingv2.WeekView.Calendar.Day.meetingv2(this, contentNode, meeting, meetingCount);
                    m.parentNode = node;
                    m.parentTd = td;
...
MWF.xApplication.meetingv2.WeekView.Calendar.Day.meetingv2 = new Class({
    ...
    load: function(){
        ...
        //    this.iconNode.setStyle("background", "url(../x_component_meetingv2/$WeekView/"+this.app.options.style+"/icon/invite.png) no-repeat center center");
        //}
...
MWF.xApplication.meetingv2.WeekView.WeekCalendar = new Class({
