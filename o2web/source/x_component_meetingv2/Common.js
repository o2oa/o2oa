...
MWF.xApplication.meetingv2.BuildingForm = new Class({
    Extends: MPopupForm,
...
MWF.xApplication.meetingv2.BuildingTooltip = new Class({
    Extends: MTooltips,
    ...
    editBuilding : function( save_callback ){
        ...
        var form = new MWF.xApplication.meetingv2.BuildingForm(this,this.data, options, {app:this.app});
        form.view = this.view;
        form.edit();
    },
    removeBuilding: function(e) {
...
MWF.xApplication.meetingv2.RoomForm = new Class({
    Extends: MPopupForm,
    Implements: [Options, Events],
    options: {
        "style": "meeting",
...
MWF.xApplication.meetingv2.RoomTooltip = new Class({
    Extends: MTooltips,
    _loadCustom : function( callback ){
...
MWF.xApplication.meetingv2.MeetingForm = new Class({
    Extends: MPopupForm,
    Implements: [Options, Events],
    options: {
        "style": "meeting",
    ...
    _createTableContent: function () {
        ...
        MWF.xDesktop.requireApp("Template", "MForm", function () {
            this.form = new MForm(this.formTableArea, data, {
                ...
                style : "meeting",
                itemTemplate: {
                    applicant : {  label: lp.lapplyPerson, type : "oo-org", orgType : "person", isEdited : false,
                        defaultValue : this.userName
                    },
                    mode: {type: "oo-select", isEdited : isEditing,
                    ...
                    dateInput: {type: "oo-datetime", isEdited : isEditing, defaultValue: defaultDate, label: lp.beginDate,
                        event : {
                            change : function( item, ev ){
                                this.clearRoom();
                            }.bind(this)
                    ...
                    beginTimeInput: { type: "oo-datetime", isEdited : isEditing, label: lp.time,
                    ...
                    endTimeInput: { type: "oo-datetime",  isEdited : isEditing, label: lp.to,
                    ...
                    //     }.bind(this)
                    // }},
                    inviteMemberList: { type: "oo-org", isEdited : isEditing, orgType: ["identity","person","group","unit"], count : 0,
                    ...
                    acceptPersonList: { type: "oo-org", isEdited : false, orgType: ["identity","person","group","unit"], count : 0, orgWidgetOptions : {}},
                    rejectPersonList: { type: "oo-org", isEdited : false, orgType: ["identity","person","group","unit"], count : 0, orgWidgetOptions : {}},
                    inviteDelPersonList: { type: "oo-org", isEdited : false, orgType: ["identity","person"], count : 0},
                    checkinPersonList : { type: "oo-org", isEdited : false, orgType: ["identity","person"], count : 0},
                    subject: { type: "oo-input", label: lp.subject },
                    ...
                    roomLink: {
                        label: lp.meetingUrl,
                        type: this.app.isAutoCreateOnlineRoom() ? ( this.isNew ? "oo-input" : "innerText" ) : "oo-input",
                        attr: {
                    ...
                    hostPerson: { type : "oo-org", label:lp.hostPerson, orgType : "identity",  count: 1, "defaultValue": this.getIdentity(), orgOptions: {"resultType": "person"}  },
    ...
    createRoomSelectNode: function(room, i, building){
        ...
        deviceList.each(function(name){
            if( name ){
                ...
                node.setStyle("background-image", "url(../x_component_meetingv2/$RoomView/default/icon/device/"+name+"_disable.png)");
            }
        }.bind(this));
...
MWF.xApplication.meetingv2.MeetingTooltip = new Class({
    Extends: MTooltips,
    _loadCustom : function( callback ){
        var fun = function () {
    ...
    loadAttachment: function(){
        ...
        if( typeOf(this.data.attachmentList)=="array" && this.data.attachmentList[0] ){
            ...
            var attachmentContentNode = new Element("div", {
                ...
                this.attachmentController = new MWF.xApplication.meetingv2.MeetingTooltip.AttachmentController(attachmentContentNode, this, {
                    "size": "min",
                    "isSizeChange": false,
                    "isReplace": false,
                    "isUpload": false,
...
MWF.xApplication.meetingv2.MeetingTooltip.AttachmentController = new Class({
    ...
    loadMin: function(){
        ...
        while (this.attachments.length){
            ...
            atts.push(new MWF.xApplication.meetingv2.MeetingTooltip.AttachmentMin(att.data, this));
        }
        this.attachments = atts;
    },
    addAttachment: function(data){
        if (this.options.size=="min"){
            this.attachments.push(new MWF.xApplication.meetingv2.MeetingTooltip.AttachmentMin(data, this));
        }else{
...
MWF.xApplication.meetingv2.MeetingTooltip.AttachmentMin = new Class({
...
MWF.xApplication.meetingv2.MeetingArea = new Class({
    initialize: function(container, view, data){
        ...
        this.path = "../x_component_meetingv2/$Common/default/meetingarea/";
        this.cssPath = "../x_component_meetingv2/$Common/default/meetingarea/css.wcss";
        this._loadCss();
        this.load();
    },
    load: function(){
    ...
    loadTooltip : function( isHideAttachment, isResetData ){
        this.tooltip = new MWF.xApplication.meetingv2.MeetingTooltip(this.app.content, this.node, this.app, this.data, {
            axis : "x",
            hiddenDelay : 300,
            displayDelay : 300,
    ...
    showTooltip: function(  ){
        if( this.tooltip ){
            ...
            this.tooltip = new MWF.xApplication.meetingv2.MeetingTooltip(this.app.content, this.viewAction, this.app, this.data);
            this.tooltip.load();
        }
    },
    openMeeting: function(){
        var form = new MWF.xApplication.meetingv2.MeetingForm(this,this.data, {}, {app:this.app});
        form.view = this.view;
        form.open();
    },
...
MWF.xApplication.meetingv2.SideBar = new Class({
    ...
    initialize : function( container, app,  options){
        ...
        this.lp = this.app.lp;
        this.isHidden = false;
        this.cssPath = "../x_component_meetingv2/$Common/"+this.options.style+"/sidebar/css.wcss";
        this._loadCss();
    ...
    loadTodayMeeting : function( callback ){
        ...
        this.app.actions.listMeetingDay(y, m, d, function(json) {
            ...
            data.each( function( d, i ){
                ...
                this.tooltipList.push( new MWF.xApplication.meetingv2.MeetingTooltip(this.app.content, itemNode, this.app, d, {
                        axis : "x",
                        hiddenDelay : 300,
                        displayDelay : 300
                    })
    ...
    openMeeting : function( data ){
        var form = new MWF.xApplication.meetingv2.MeetingForm(this, data, {}, {app:this.app});
        form.view = this.app;
        form.open();
    },
    destory : function(){
