...
MWF.xApplication.meetingv2.ListView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_meetingv2/$ListView/";
        this.cssPath = "../x_component_meetingv2/$ListView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
    ...
    toApplyWait: function(){
        ...
        this.currentView = new MWF.xApplication.meetingv2.ListView.ApplyWait(this,{
            "meetingStatus" : "wait"
        });
    },
    toApplyProcessing: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.ApplyProcessing(this,{
            "meetingStatus" : "processing"
        });
    },
    toApplyCompleted: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.ApplyCompleted(this,{
            "meetingStatus" : "completed"
        });
    },
    toApply: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.Apply(this,{
            "meetingStatus" : "applying"
        });
    },
    toMeetingWait: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.MeetingWait(this);
    },
    toMeetingProcessing: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.MeetingProcessing(this);
    },
    toMeetingCompleted: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.MeetingCompleted(this);
    },
    toMeetingReject: function(){
        if (this.currentView) this.currentView.destroy();
        this.currentView = new MWF.xApplication.meetingv2.ListView.MeetingReject(this);
    },
...
MWF.xApplication.meetingv2.ListView.View = new Class({
    Implements: [Options, Events],
    options: {
        "meetingStatus" : "completed"
    },
    ...
    loadLine: function(item){
        this.items.push(new MWF.xApplication.meetingv2.ListView.View.Line(this, item));
    },
    destroy: function(){
...
MWF.xApplication.meetingv2.ListView.ApplyWait = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View
});
MWF.xApplication.meetingv2.ListView.ApplyProcessing = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View
});
MWF.xApplication.meetingv2.ListView.ApplyCompleted = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View
});

MWF.xApplication.meetingv2.ListView.Apply = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View
});

MWF.xApplication.meetingv2.ListView.MeetingWait = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View,
    loadList: function() {
        this.tableBody.empty();
...
MWF.xApplication.meetingv2.ListView.MeetingProcessing = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View,
    loadList: function() {
        this.tableBody.empty();
...
MWF.xApplication.meetingv2.ListView.MeetingCompleted = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View,
    loadList: function() {
        this.tableBody.empty();
...
MWF.xApplication.meetingv2.ListView.MeetingReject = new Class({
    Extends: MWF.xApplication.meetingv2.ListView.View,
    loadList: function() {
        this.tableBody.empty();
...
MWF.xApplication.meetingv2.ListView.View.Line = new Class({
    ...
    openMeeting: function(e){
        this.form = new MWF.xApplication.meetingv2.MeetingForm(this,this.data, {}, {app:this.app});
