...
MWF.xApplication.meetingv2.MeetingView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_meetingv2/$MeetingView/";
        this.cssPath = "../x_component_meetingv2/$MeetingView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
        this.days = [];
    ...
    loadContent: function(  ){
        ...
        this.app.actions.listMeetingMonths( months , function( json ){
            ...
            for( var d in this.daysData ){
                var day = new MWF.xApplication.meetingv2.MeetingView.Day(this, this.dayContainerNode, d , this.daysData[d]);
                this.days.push( day )
            }
...
MWF.xApplication.meetingv2.MeetingView.Day = new Class({
    Implements: [Events],
    ...
    loadMeetings: function(){
        this.data.each(function(meeting, i){
            this.meetings.push(new MWF.xApplication.meetingv2.MeetingView.meetingv2(this.dayContentNode, this, meeting));
        }.bind(this));
    },
    reload : function(){
        this.view.reload();
...
MWF.xApplication.meetingv2.MeetingView.meetingv2 = new Class({
