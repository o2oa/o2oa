...
MWF.xApplication.meetingv2.RoomView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_meetingv2/$RoomView/";
        this.cssPath = "../x_component_meetingv2/$RoomView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
        this.bulidings = [];
    ...
    loadDate: function(){
        ...
        new MWF.xApplication.meetingv2.RoomView.HelpTooltip( this.app.content, this.helpNode, this.app, {}, {
            hiddenDelay : 300,
            displayDelay : 0,
            nodeStyles : {
                "min-width" : "260px",
    ...
    showBulidingTooltip : function( node ){
        ...
        if( tooltip ){
            ...
            tooltip = new MWF.xApplication.meetingv2.BuildingTooltip( this.app.content, node, this.app, data, {
                hiddenDelay : 300,
                displayDelay : 0,
                nodeStyles : {
                    "min-width" : "100px",
    ...
    loadAllRooms : function(){
        this.bulidingData.each( function( b ){
            b.roomList.each(function(room){
                this.rooms.push(new MWF.xApplication.meetingv2.RoomView.Room(this,  this.roomBuildingsArea ,room, b.name ));
            }.bind(this));
        }.bind(this));
        this.resetNodeSize();
    },
    loadRooms: function( node ){
        ...
        data.roomList.each(function(room){
            this.rooms.push(new MWF.xApplication.meetingv2.RoomView.Room(this,  this.roomBuildingsArea ,room ));
        }.bind(this));
        this.resetNodeSize();
    },
    emptyRooms : function(){
...
MWF.xApplication.meetingv2.RoomView.Room = new Class({
    Implements: [Events],
    ...
    loadTooltip : function(){
        this.tooltip = new MWF.xApplication.meetingv2.RoomTooltip(this.app.content, this.titleNode, this.app, this.data, {
            axis : "x",
            hiddenDelay : 300,
            displayDelay : 300
        });
    ...
    _loadMeetings: function(){
        if( this.data.meetingList.length > 0 ){
            this.data.meetingList.each(function(meeting, i){
                var m = new MWF.xApplication.meetingv2.RoomView.meetingv2( this.contentNode, this, meeting);
...
MWF.xApplication.meetingv2.RoomView.meetingv2 = new Class({
    Extends :  MWF.xApplication.meetingv2.MeetingArea,
    load: function(){
...
MWF.xApplication.meetingv2.RoomView.HelpTooltip = new Class({
    Extends: MTooltips,
    _getHtml : function(){
        var html =
