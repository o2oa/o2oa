MWF.xApplication.meetingv2.MonthView = new Class({
    ...
    initialize: function(node, app, options){
        ...
        this.path = "../x_component_meetingv2/$MonthView/";
        this.cssPath = "../x_component_meetingv2/$MonthView/"+this.options.style+"/css.wcss";
        this._loadCss();
        this.app = app;
        this.container = $(node);
        this.load();
    ...
    loadCalendar: function(){
        ...
        this.calendar = new MWF.xApplication.meetingv2.MonthView.Calendar(this, date  );
...
MWF.xApplication.meetingv2.MonthView.Calendar = new Class({
    Implements: [Events],
    ...
    createMonthSelector: function(){
        this.monthSelector = new MWF.xApplication.meetingv2.MonthView.Calendar.MonthSelector(this.date, this);
    },
    ...
    loadDay: function(td, date){
        ...
        this.days[key] = new MWF.xApplication.meetingv2.MonthView.Calendar.Day(td, date, this, type);
    },
    reload : function(){
        this.view.reload();
    },
...
MWF.xApplication.meetingv2.MonthView.Calendar.Day = new Class({
    Implements: [Events],
        ...
        this.app.actions[ isAll ? "listMeetingDayAll" : "listMeetingDay" ](y, m, d, function(json){
            ...
            json.data.each(function(meeting, i){
                if (!meeting.myReject){
                    ...
                    //if (meetingCount<4)
                        this.meetings.push(new MWF.xApplication.meetingv2.MonthView.Calendar.Day.meetingv2(this, meeting, meetingCount));
                }else{
                    myRejectCount++;
                }
            }.bind(this));
...
MWF.xApplication.meetingv2.MonthView.Calendar.Day.meetingv2 = new Class({
    ...
    load: function(){
        ...
        //    this.iconNode.setStyle("background", "url(../x_component_meetingv2/$MonthView/"+this.app.options.style+"/icon/invite.png) no-repeat center center");
        //}
...
MWF.xApplication.meetingv2.MonthView.Calendar.MonthSelector = new Class({
    Implements: [Events],
