    ...
    load: function(){
        ...
        this.baseOauthsServerInput = new MWF.xApplication.Setting.Document.List(this.explorer, this.node, {
            ...
            "addItem": {
                ...
                "clientSecret": "",
                "authAddress": "",
                "authParameter": "client_id\u003d{$clientId}\u0026redirect_uri\u003d{$redirect_uri}",
                "authMethod": "GET",
                "tokenAddress": "",
                "tokenParameter": "client_id\u003d{$clientId}\u0026client_secret\u003d{$client_secret}\u0026redirect_uri\u003d{$redirect_uri}\u0026grant_type\u003dauthorization_code\u0026code\u003d{$code}",
                "tokenMethod": "POST",
                "tokenType": "json",
                "infoAddress": "",
