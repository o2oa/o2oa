...
MWF.xApplication.Setting.LP={
	...
	"subscribeMpweixin": "Attention reply",
	"subscribeMpweixin_desc": "The official account is automatically transmitted when the new user is concerned.",
	...
	"mobile_mpweixin_menu_form_name_error_max_len_4": "Menu name cannot exceed 4 words!",
	"mobile_mpweixin_menu_form_name_error_max_len_6": "Menu name cannot exceed 6 words!",
	"mobile_mpweixin_menu_form_name_error": "The number of characters exceeds the upper limit",
	"mobile_mpweixin_menu_form_name_tips_4": "Only supports Chinese, English and numbers, and the number of words does not exceed 4",
	"mobile_mpweixin_menu_form_name_tips_6": "Only supports Chinese, English and numbers, and the number of words does not exceed 6",
	...
	"mobile_mpweixin_menu_form_subscribe_content_error_empty": "Reply message content cannot be empty!",
	...
	"mobile_apppack_form_appVersionName": "app Version name",
	"mobile_apppack_form_appVersionName_tip": "The app version name , such as v1 0.0。 This field does not need to be filled in by default!",
	"mobile_apppack_form_appBuildNo": "app Build number",
	"mobile_apppack_form_appBuildNo_tip": "The app Build number，Must be a positive integer, such as 100. This field does not need to be filled in by default!",
	"mobile_apppack_form_urlMapping": "Agent urlMapping",
	"mobile_apppack_form_urlMapping_tip": "It is used when the proxy address is used in the server extranet, for example { \"demo.o2oa.net:20020\": \"demo.o2oa.net/dev/app\" }",
	...
	"list": {
		...
		"ldapUrl": "LdapUrl (LDAP address, such as ldap://111.111.111.111:5389/ )",
		"baseDn": "BaseDn (the root name of an LDAP query, such as DC=zone, DC=COM)",
		"userDn": "UserDn (DN of the authenticated user, for example: uid=*, ou=users,dc=zone,DC=COM， The * in uid=* represents the unique code of the user, which corresponds to the unique code of the O2 user"
	},
	"module": {
