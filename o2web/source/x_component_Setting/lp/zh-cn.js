MWF.xApplication.Setting.LP = {
    ...
    "mobile_apppack_form_urlMapping": "代理urlMapping",
    "mobile_apppack_form_urlMapping_tip": "服务器外网使用代理地址的时候使用，如{ \"demo.o2oa.net:20020\": \"demo.o2oa.net/dev/app\" }",
    "mobile_apppack_form_appVersionName": "app版本名称",
    "mobile_apppack_form_appVersionName_tip": "app的版本名称，如v1.0.0。这个字段默认不需要填写！",
    "mobile_apppack_form_appBuildNo": "app版本编号",
    "mobile_apppack_form_appBuildNo_tip": "app的版本编号，必须是正整数， 如 100。这个字段默认不需要填写！",
