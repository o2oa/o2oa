...
MWF.xApplication.portal.PortalExplorer.Exporter = new Class({
    ...
    loadContent: function(){
        ...
        new Element("div", {"styles": this.css.listTitleNode, "text": this.app.lp.application.page}).inject(listTitleNodeArea);
