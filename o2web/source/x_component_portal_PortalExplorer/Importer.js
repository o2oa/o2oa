//MWF.xDesktop.requireApp("portal.PortalExplorer", "Actions.RestActions", null, false);
MWF.xApplication.portal.PortalExplorer.Importer = new Class({
    ...
    readyProrressBar: function(){
        ...
        this.status = {
            "count": this.applicationJson.pageList.length+this.applicationJson.scriptList.length+1,
            "complete": 0
        }
    },
