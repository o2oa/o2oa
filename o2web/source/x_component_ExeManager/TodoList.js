...
MWF.xApplication.ExeManager.TodoList = new Class({
...
MWF.xApplication.ExeManager.TodoList.View = new Class({
    Extends: MWF.xApplication.Template.Explorer.ComplexView,
    _createDocument: function(data){
        return new MWF.xApplication.ExeManager.TodoList.Document(this.viewNode, data, this.explorer, this);
    },
    ...
    _getCurrentPageData: function(callback, count){
        ...
        this.actions.getTodoListNext(id, count, filter, function (json) {
    ...
    _openDocument: function( documentData ){
        //this.workForm = new MWF.xApplication.ExeManager.TodoList.WorkForm(this.explorer.explorer, this.actions, documentData, {
        //    "isNew": false,
        //    "isEdited": false,
        //    "onPostSave" : function(){
...
MWF.xApplication.ExeManager.TodoList.Document = new Class({
    ...
    action_remove: function(e){
        ...
        this.app.confirm("warn",e,this.lp.warnTitle,this.lp.warnContent,300,120,function(){
            _self.actions.deleteTodoWork(_self.data.id,function(json){
