<template>
  <div class="systemconfig_area">
    <div v-if="appStyle">
      ...
      <div class="item_info" >
        <div class="item_value mainColor_color" style="height:auto;">{{processListText}}</div>
        <button class="mainColor_bg" @click="chooseProcess()" >{{lp._appConfig.appIndexTaskFilterProcessSelectorTitle}}</button>
      </div>
...
import {getAppStyle, loadPortals, saveAppStyle, categoryInfoAction, processAction} from "@/util/acrions";
