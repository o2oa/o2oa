...
MWF.xApplication.systemconfig.LP={
	...
	"_resource": {
		...
		"deployLogInfo": "Deployment logs showing web resources, custom services and upgrades to o2 servers.",
	...
	"_passwordConfig": {
		...
		"fixedPasswordText": "Enter a fixed password",
	...
	"_serversConfig": {
		...
		"deployWarEnableInfo": "This configuration controls whether the custom application is allowed to be uploaded and deployed on the WEB side. ",
		"deployResourceEnable": "Whether to allow front-end deployment of web resources",
		"deployResourceEnableInfo": "This configuration controls front-end components and static resources, and whether to allow uploading and deploying on the WEB side. ",
