...
MWF.xApplication.systemconfig.LP={
	...
	"_systemInfo": {
		...
		"license": "Información autorizada",
		"licenseTo": "Autorización a:",
		"licenseInfo": "Información actual de autorización del sistema"
	},
	"operation": {
		"edit": "Editar ",
		"ok": "Aceptar",
	...
	"_resource": {
		...
		"installTime": "Tiempo de implementación",
	...
	"_passwordConfig": {
		...
		"fixedPasswordText": "Ingrese una contraseña fija",
	...
	"_serversConfig": {
		...
		"deployWarEnableInfo": "Esta configuración controla si las aplicaciones personalizadas (war) están permitidas para cargarse y desplegarse en el lado del cliente (WEB).",
		"deployResourceEnable": "¿Permitir implementar recursos web en el lado del cliente?",
		"deployResourceEnableInfo": "Esta configuración controla si los componentes y recursos estáticos del front-end están permitidos para cargarse y desplegarse en el lado del cliente (WEB). ",
	...
	"_integrationConfig": {
		...
		"mpweixinText": {
			...
			"workUrl": "Acceso a mensajes de la cuenta pública de WeChat Dirección básica de O2OA",
			...
			"copyUrl": "Generar URL de inicio de sesión único",
			"copyUrlBtn": "Haga clic en Generar",
			"copyUrlInfo": "Después de copiar la dirección de inicio de sesión único, puede configurarla en el menú de la cuenta oficial o en el mensaje de seguimiento de la cuenta oficial. Esta dirección permite a los usuarios vincular su OpenID de WeChat a su cuenta de O2OA e implementar el inicio de sesión único.",
