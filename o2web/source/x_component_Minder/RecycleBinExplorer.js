...
MWF.xApplication.Minder.RecycleBinExplorer = new Class({
    ...
    loadList: function( filterData ){
        ...
        this.currentView = new MWF.xApplication.Minder.RecycleBinExplorer.List( this.listNode, this.app, this, {
            templateUrl : this.path + this.options.style + ( this.getViewType() == "list" ? "/listItem_recycle.json" : "/tileItem_recycle.json" ),
            "scrollEnable" : true
        });
...
MWF.xApplication.Minder.RecycleBinExplorer.List = new Class({
    ...
    _getCurrentPageData: function(callback, count){
        ...
        this.actions.listMyRecycledMind(id, count, filter, function(json){
