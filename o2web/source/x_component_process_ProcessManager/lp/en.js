MWF.xApplication.process.ProcessManager.LP = {
	...
	"categoryTitle": "Process Category",
	"description": "描述",
    "deleteItems": "删除选中的内容",
    "copy": "复制",
    "copyto": "复制到...",
    ...
    "view": {
        ...
        "noNoticeText": "此应用现在还没有视图，您可以点击此处创建一个新视图",
        "loaded": "视图加载完毕",
        "deleteViewTitle": "删除视图确认",
        "deleteView": "是否确定要删除当前视图？"
    ...
    "stat": {
        ...
        "noNoticeText": "此应用现在还没有统计配置，您可以点击此处创建一个新统计配置",
        "loaded": "统计加载完毕",
        "deleteViewTitle": "删除统计确认",
        "deleteView": "是否确定要删除当前统计？"
