...
MWF.xApplication.query.Query.LP={
	...
	"and": "and",
	"or": "Or",
	"searchNavTitle": "Please enter a keyword to search",
	"searchNavPlaceholder": "Please enter a keyword to search",
	"form": {
		"exportExcel": "Export Excel"
	},
	"chart": {
	...
	"deleteAllWork": "Do you want to delete the work associated with this job? <br/><br/><input type='radio' value='all' name='deleteWork_check'/>delete the current work and all associated work ;<br/><input type='radio' value='single' name='deleteWork_check'/>delete only the current work<br><div id='deleteWork_checkInfor'></div>",
	...
	"openImportRecordDetail": "View import details",
	"importStatusList": {
		"0": "whole",
		"1": "Import successful",
		"2": "Import failed"
