...
MWF.xApplication.query.Query.Importer.Record = new Class({
    initialize: function( importer, recordId ){
        this.importer = importer;
        this.css = importer.css;
        this.lp = importer.lp;
        this.recordId = recordId
    ...
    load: function () {
        this.importer.lookupAction.getImportModuleRecord(this.recordId, function (json) {
            this.data = json.data;
            this.createNode();
            this.setBaseInfor();
            this.openDlg();
    ...
    createNode: function(){
        this.node = new Element("div", { style : "padding:10px;"});
        this.inforNode = new Element("div", { style : "padding:10px;"}).inject(this.node);
        this.viewNode = new Element("div", { style : "padding:10px;"}).inject(this.node);
    },
    openDlg: function () {
        var dlg = o2.DL.open({
            "style" : "user",
            "title": this.lp.importRecord,
            "content": this.node,
            "offset": {"y": 0},
            "isMax": true,
            "width": 1000,
    ...
    setBaseInfor: function () {
        var objectToString = this.importer.objectToString;
        ...
        htmlArray.push( "<th style='"+titleStyle+"'> "+ this.lp.importerName +"</th>" );
        ...
        htmlArray.push( "<td style='"+contentStyle+"'> "+ this.data.failCount +"</td>" );
