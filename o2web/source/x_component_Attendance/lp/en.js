...
MWF.xApplication.Attendance.LP={
	...
	"schedule": {
		...
		"illegal": {
			"1": [
				"The off-duty time cannot be earlier than the on-duty time"
			],
			"2": [
				"The start time of the lunch break should not be earlier than the working time",
				"The end time of the lunch break should not be earlier than the start time of the lunch break",
				"The end time of the lunch break should not be earlier than the end time of the lunch break"
			],
			"3": [
				"Morning off time shall not be earlier than working hours",
				"Afternoon working hours shall not be earlier than morning off hours",
				"Off working hours shall not be earlier than afternoon working hours"
			]
		},
	...
	"importDataResultThList": [
		...
		"employee name",
		"date",
		"morning clocking time",
		"morning clocking time",
		"afternoon clocking time",
		"afternoon clocking time",
		"check result ",
		"description"
	],
