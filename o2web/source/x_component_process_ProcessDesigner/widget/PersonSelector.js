                ...
                names.each(function(name){
                    ...
                    if (name){
                        ...
                        MWF.require("MWF.widget.O2Identity", function(){
                            ...
                            if (type==="queryimportmodule") this.identitys.push(new MWF.widget.O2QueryImportModule(data, this.node));
                ...
                "onComplete": function(items){
                    ...
                    MWF.require("MWF.widget.O2Identity", function(){
                        items.each(function(item){
                            ...
                            if (type==="queryimportmodule") this.identitys.push(new MWF.widget.O2QueryImportModule(item.data, this.node));
