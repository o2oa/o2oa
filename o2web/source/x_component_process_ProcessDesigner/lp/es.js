MWF.xApplication.process.ProcessDesigner.LP = {
	...
	"serial": {
		"text": ["Texto", "Texto fijo"],
		"year": ["Año", "Año de creación del borrador"],
		"month": ["Mes", "Mes de creación del borrador"],
		"day": ["Día", "Día de creación del borrador"],
		"unit": ["Organización", "Organización directa del autor del borrador"],
		"unitAttribute": ["Atributo de organización", "Atributo de la organización directa del autor del borrador"],
		"script": ["Script", "Script"],
		"number": ["Número de serie", "Número de serie"]
	},
	"propertyTemplate": {
		"base": "Básico",
		"event": "Evento",
