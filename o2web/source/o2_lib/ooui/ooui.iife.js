...
`;customElements.get("oo-calendar")||customElements.define("oo-calendar",j1);const A7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    /*display: contents;*/\r
...
`,F7='<div class="capsulae content"></div>',Lt=class Lt extends y{constructor(){super();d(this,bt);C(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,i,o){this._initialize(t,e||Lt,i||F7,o||D7)}_render(){new MutationObserver(function(e){e.forEach(i=>{i.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,bt,T9).call(this)}};bt=new WeakSet,T9=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},C(Lt,"prop",{skin:""});let w3=Lt;const j7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
`,ve=class ve extends y{constructor(){super();d(this,w5);C(this,"_setPropMap",{rows:()=>{a(this,w5,T4).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",ve,_0,L0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,w5,T4).call(this)}};w5=new WeakSet,T4=function(){s.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(s("div.item"))}catch{}},C(ve,"prop",{rows:"5",cssLink:"",skin:""});let I3=ve;const x0=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`},Symbol.toStringTag,{value:"Module"}));return b.DatetimePicker=K4,b.Dialog=a9,b.Dragdrop=V0,b.Draggable=h9,b.Menu=G4,b.Notice=$1,b.Tooltip=z1,b.confirm=$0,b.datetimePicker=J4,b.defineComponent=W0,b.dialog=d9,b.mask=R0,b.notice=N1,b.tooltip=l9,b.unmask=B0,Object.defineProperty(b,Symbol.toStringTag,{value:"Module"}),b}({});
