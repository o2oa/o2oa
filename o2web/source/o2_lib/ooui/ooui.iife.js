...
`,o5=class o5 extends P{constructor(){super();h(this,r5);h(this,St);m(this,"_elements",{text:null,prefix:null,suffix:null,button:null});h(this,m2,{});m(this,"_setPropMap",{leftIcon:t=>{i.removeClass(this._elements.prefix,`ooicon-${t} icon`),this._props.leftIcon&&i.addClass(this._elements.prefix,`ooicon-${this._props.leftIcon} icon`)},rightIcon:t=>{i.removeClass(this._elements.suffix,`ooicon-${t} icon`),this._props.rightIcon&&i.addClass(this._elements.suffix,`ooicon-${this._props.rightIcon} icon`)},styles:()=>{},disabled:t=>{i.checkClass(this._elements.button,"disabled",this._props.disabled),i.toggleAttr(this._elements.button,"disabled",this._props.disabled),a(this,r5,Js).call(this,this._props.disabled)},type:t=>{this._props.type||(this._props.type="default"),t&&i.removeClass(this._elements.button,t),i.addClass(this._elements.button,this._props.type)},text:()=>{this.innerHTML.trim()||(this._elements.text.textContent=this._props.text)},skin:()=>{this._useSkin(this._props.skin)},$default:t=>{t==="value"&&(this.value=this._props[t]),i.toggleAttr(this._elements.button,t,this._props[t])}})}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||o5,s||x0,o||y0)}_render(){const t=this;new MutationObserver(function(){var s;a(s=t,St,Mn).call(s)}).observe(this,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),a(this,St,Mn).call(this)}_connected(){}};m2=new WeakMap,r5=new WeakSet,Js=function(t){if(t){p(this,m2,l(this,m2)||{});for(let e in this)e.startsWith("on")&&this[e]&&(l(this,m2)[e]=this[e],this[e]=null);this.style.pointerEvents="none"}else{if(l(this,m2))for(let e in l(this,m2))l(this,m2)[e]&&(this[e]=l(this,m2)[e],l(this,m2)[e]=null);this.style.pointerEvents="auto"}},St=new WeakSet,Mn=function(){this.innerHTML.trim()&&(i.empty(this._elements.text),this._elements.text.insertAdjacentHTML("beforeend",this.innerHTML))},m(o5,"prop",{leftIcon:"",rightIcon:"",styles:"",disabled:!1,text:"",type:"",skin:""});let Ge=o5;class Ms extends Ge{constructor(){super(),this._init("oo-button")}}const k0=`<div class="content">\r
    <div class="left">\r
        <div class="top">\r
...
`,z0='<div class="capsulae content"></div>',E5=class E5 extends P{constructor(){super();h(this,k5);m(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||E5,s||z0,o||j0)}_render(){new MutationObserver(function(e){e.forEach(s=>{s.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,k5,m9).call(this)}};k5=new WeakSet,m9=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},m(E5,"prop",{skin:""});let $4=E5;const R0=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
`;function H1(r,n){r.apply(n||this)}const I3=class I3 extends P{constructor(){super();h(this,pe);h(this,ue);h(this,z2);h(this,pt);h(this,R2);h(this,F3);h(this,me);h(this,ut);m(this,"_elements",{first:null,last:null,prev:null,next:null,pages:null,jumper:null,jumperTextLeft:null,jumperTextRight:null,jumperPageCount:null,jumperInput:null});m(this,"_setPropMap",{cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},current:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},total:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},pageSize:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},pageCount:()=>{},pages:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},first:()=>{a(this,pe,Kn).call(this)},last:()=>{a(this,ue,Gn).call(this)},jumper:()=>{i.checkClass(this._elements.jumper,"hide",!this._props.jumper)},jumperText:()=>{this._props.jumperText||(this._props.jumperText="到第{n}页"),a(this,ut,S4).call(this)}});this._initialize("oo-pagination",I3,D7,I7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}async _render(){a(this,pt,M4).call(this),(this._props.pageCount>1||this._props.showSingle)&&(a(this,pe,Kn).call(this),a(this,ue,Gn).call(this),H1(a(this,z2,j1),this),a(this,ut,S4).call(this))}_setEvent(){this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.first.addEventListener("click",()=>{this.gotoFirst()}),this._elements.last.addEventListener("click",()=>{this.gotoLast()}),this._elements.jumperInput&&this._elements.jumperInput.addEventListener("keydown",t=>{if(t.key==="Enter"||t.keyCode===13){const e=this._elements.jumperInput;!isNaN(e.value)&&e.value&&(this.gotoPage(parseInt(e.value)),e.value="")}})}setCurrent(t){this._props.current=t,a(this,pt,M4).call(this)}gotoPage(t){this.setCurrent(t),this.dispatchEvent(new CustomEvent("page",{detail:this._props.current})),this.setAttribute("current",this._props.current),H1(a(this,z2,j1),this)}pagesForward(){this.gotoPage(this._props.current+(this._props.pages-2))}pagesBack(){this.gotoPage(this._props.current-(this._props.pages-2))}gotoFirst(){this.gotoPage(1)}gotoLast(){this.gotoPage(this._props.pageCount)}gotoPrev(){this.gotoPage(--this._props.current)}gotoNext(){this.gotoPage(++this._props.current)}};pe=new WeakSet,Kn=function(){const t=this._props.first;this._elements.first.textContent=t,i.checkClass(this._elements.first,"hide",!t)},ue=new WeakSet,Gn=function(){const t=this._props.last;this._elements.last.textContent=t,i.checkClass(this._elements.last,"hide",!t)},z2=new WeakSet,j1=function(t,e,s){if(a(this,pt,M4).call(this),i.empty(this._elements.pages),this._props.pageCount>1||this._props.showSingle)if(this._props.pageCount<=this._props.pages)for(let o=1;o<=this._props.pageCount;o++)a(this,R2,z1).call(this,o);else{a(this,R2,z1).call(this,1);const o=this._props.pages-2,d=parseInt(o/2);let c;if(this._props.current-d<=2)for(let u=1;u<=o;u++)c=u+1,a(this,R2,z1).call(this,c);else if(this._props.current+d>=this._props.pageCount-1){a(this,me,Jn).call(this);for(let u=o;u>=1;u--)c=this._props.pageCount-u,a(this,R2,z1).call(this,c)}else{a(this,me,Jn).call(this);for(let u=0;u<o;u++)c=this._props.current-(d-u),a(this,R2,z1).call(this,c,s)}c<this._props.pageCount-1&&a(this,F3,c8).call(this),a(this,R2,z1).call(this,this._props.pageCount)}a(this,ut,S4).call(this)},pt=new WeakSet,M4=function(){this._props.pageCount=Math.ceil(this._props.total/this._props.pageSize),this._props.pageCount<1&&(this._props.pageCount=1),this._props.current<1&&(this._props.current=1),this._props.current>this._props.pageCount&&(this._props.current=this._props.pageCount)},R2=new WeakSet,z1=function(t){const e=document.createElement("div");e.textContent=t,t===this._props.current&&i.addClass(e,"current"),e.addEventListener("click",()=>{this.gotoPage(t)}),this._elements.pages.append(e)},F3=new WeakSet,c8=function(){const t=document.createElement("div");i.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesForward()}),this._elements.pages.append(t)},me=new WeakSet,Jn=function(){const t=document.createElement("div");i.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesBack()}),this._elements.pages.append(t)},ut=new WeakSet,S4=function(){const t=this._props.jumperText.split("{n}");this._elements.jumperTextLeft.textContent=t[0],this._elements.jumperTextRight.textContent=(t==null?void 0:t[1])??"",this._elements.jumperPageCount.textContent=this._props.pageCount},m(I3,"prop",{total:200,pageSize:20,pageCount:0,pages:10,current:1,showSingle:!0,jumper:!1,first:"第一页",last:"最后一页",jumperText:"到第{n}页",border:!0,cssLink:"",skin:""});let G4=I3;const O7=`.content{\r
    --radius: 100%;\r
}\r
.check{\r
    border-radius: var(--radius);\r
...
.check.checked{\r
    ...
    height: 0.4em;\r
    background-color: var(--checked);\r
}`;class N7 extends e5{constructor(){super(),this._init("oo-radio"),this._useCss(O7)}_unCheckedOther(){this.ownerDocument.querySelectorAll(`oo-radio[name='${this._props.name}']`).forEach(t=>{t!==this&&t.checked&&t._unchecked()})}_render(){this._elements.input.type="radio",this._elements.input.checked&&this._unCheckedOther(),super._render()}}class $7 extends n5{constructor(){super();h(this,D3);h(this,O3);a(this,D3,p8).call(this),this._init("oo-radio-group")}_appendItemCheckValue(t){this._props.value?t.value===this._props.value&&t.setAttribute("checked",!0):t._unchecked()}_itemChange(t){t.currentTarget.checked?this.value=t.currentTarget.value:this.value="",this._elements.input.value=this.value,this.unInvalidStyle()}_removeItem(t){super._removeItem(t)}get text(){return a(this,O3,u8).call(this)}}D3=new WeakSet,p8=function(){this.setPropMap=Object.assign(this._setPropMap,{value:()=>{if(this._props.value){for(const t of this._items)if(t.value===this._props.value){t.setAttribute("checked",!0);break}}this._elements.input.value=this._props.value,this._fillEmptyReadmode()}})},O3=new WeakSet,u8=function(){for(const t of this._items)if(t.checked)return t.text;return""};const Z7=`.content{\r
...
`,B3=class B3 extends P{constructor(){super();h(this,be);m(this,"_setPropMap",{rows:()=>{a(this,be,ss).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",B3,V7,B7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,be,ss).call(this)}};be=new WeakSet,ss=function(){i.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(i("div.item"))}catch{}},m(B3,"prop",{rows:"5",cssLink:"",skin:""});let tn=B3;const H7=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label hide">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`,q3=class q3 extends P{constructor(){super();h(this,W3);h(this,Y3);m(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},label:()=>{this.label&&(this.label.querySelector(".text").textContent=this._props.label,this.tabs.showSlider())},icon:t=>{if(this.label){const e=this.label.querySelector(".icon");this._props.icon?e?(i.removeClass(e,`ooicon-${t}`),i.addClass(e,`ooicon-${this._props.icon}`)):this.label.insertAdjacentElement("afterbegin",i(`div.icon.ooicon-${this._props.icon}`)):e&&e.remove(),this.tabs&&this.tabs.showSlider()}},rightIcon:t=>{if(this.label){const e=this.label.querySelector(".rightIcon");this._props.rightIcon?e?(i.removeClass(e,`ooicon-${t}`),i.addClass(e,`ooicon-${this._props.rightIcon}`)):this.label.insertAdjacentElement("beforeend",i(`div.rightIcon.ooicon-${this._props.rightIcon}`)):e&&e.remove(),this.tabs&&this.tabs.showSlider()}}});m(this,"label",null);m(this,"tabs",null);this._initialize("oo-tab",q3,q7,Y7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){this._fillContent("content")}_connected(){this.tabs=i.getParent(this,"oo-tabs"),this.tabs&&a(this,W3,_8).call(this)}_disconnected(){this.label&&this.label.remove()}selected(){this.label&&i.addClass(this.label,"current"),i.removeClass(this,"hide"),this.dispatchEvent(new CustomEvent("current"))}unselected(){this.label&&i.removeClass(this.label,"current"),i.addClass(this,"hide"),this.dispatchEvent(new CustomEvent("uncurrent"))}};W3=new WeakSet,_8=function(){this.label||a(this,Y3,L8).call(this);const t=this.previousElementSibling;t&&t.label?t.label.insertAdjacentElement("afterend",this.label):this.tabs._elements.labels.insertAdjacentElement("afterbegin",this.label),this.setAttribute("slot","pane"),this!==this.tabs.currentTab&&i.addClass(this,"hide"),this.tabs._checkCurrentTab()},Y3=new WeakSet,L8=function(){this.label=i("div.label"),this._props.icon&&this.label.append(i(`div.icon.ooicon-${this._props.icon}`)),this.label.append(i("div.text",{text:this._props.label||"New Tab"})),this._props.rightIcon&&this.label.append(i(`div.rightIcon.ooicon-${this._props.rightIcon}`)),this.label.addEventListener("click",()=>{this.tabs.setCurrent(this)})},m(q3,"prop",{css:"",cssLink:"",skin:"",label:"",icon:"",rightIcon:""});let nn=q3;const U7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    display: block;\r
...
/* ---------------------------------------------- */`,_n=class _n extends i2{constructor(){super();h(this,G3);a(this,G3,y8).call(this),this._init("oo-textarea"),this._useCss(Q7)}_init(t){this._initialize(t,_n,J7,zs)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("input",()=>{this.setHeight()}),i.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()}setHeight(){if(this._props.autoSize){this._elements.input.style.height="auto";const t=this._elements.input.scrollHeight;this._elements.input.style.height=t+"px"}}};G3=new WeakSet,y8=function(){this._setPropMap=Object.assign(this._setPropMap,{autoSize:()=>{i.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()},value:()=>{try{this._elements.input.value=this._props.value}catch{}this._props.value?this._elements.viewText.textContent=this._props.value:this._elements.viewText.innerHTML="-",window.setTimeout(()=>{this.setHeight()},10)}})};let on=_n;const ti=`.content{\r
...
`},Symbol.toStringTag,{value:"Module"}));return _.DatetimePicker=Fs,_.Dialog=Bs,_.Dragdrop=li,_.Draggable=qs,_.Menu=Ps,_.Notice=kt,_.Tooltip=Et,_.confirm=Hs,_.datetimePicker=Is,_.defineComponent=ai,_.dialog=Vs,_.mask=ri,_.notice=T2,_.tooltip=Ws,_.unmask=oi,Object.defineProperty(_,Symbol.toStringTag,{value:"Module"}),_}({});
