...
`,V0='<div class="capsulae content"></div>',S5=class S5 extends P{constructor(){super();h(this,M5);m(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||S5,s||V0,o||B0)}_render(){new MutationObserver(function(e){e.forEach(s=>{s.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,M5,f9).call(this)}};M5=new WeakSet,f9=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},m(S5,"prop",{skin:""});let j4=S5;const H0=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
.check.checked{\r
    ...
    height: 0.4em;\r
    background-color: var(--checked);\r
}`;class $7 extends s5{constructor(){super(),this._init("oo-radio"),this._useCss(N7)}_unCheckedOther(){this.ownerDocument.querySelectorAll(`oo-radio[name='${this._props.name}']`).forEach(t=>{t!==this&&t.checked&&t._unchecked()})}_render(){this._elements.input.type="radio",this._elements.input.checked&&this._unCheckedOther(),super._render()}}class j7 extends i5{constructor(){super();h(this,N3);h(this,$3);a(this,N3,C8).call(this),this._init("oo-radio-group")}_appendItemCheckValue(t){this._props.value?t.value===this._props.value&&t.setAttribute("checked",!0):t._unchecked()}_itemChange(t){t.currentTarget.checked?this.value=t.currentTarget.value:this.value="",this._elements.input.value=this.value,this.unInvalidStyle()}_removeItem(t){super._removeItem(t)}get text(){return a(this,$3,g8).call(this)}}N3=new WeakSet,C8=function(){this.setPropMap=Object.assign(this._setPropMap,{value:()=>{if(this._props.value){for(const t of this._items)if(t.value===this._props.value){t.setAttribute("checked",!0);break}}this._elements.input.value=this._props.value,this._fillEmptyReadmode()}})},$3=new WeakSet,g8=function(){for(const t of this._items)if(t.checked)return t.text;return""};const Z7=`.content{\r
...
`,H3=class H3 extends P{constructor(){super();h(this,_e);m(this,"_setPropMap",{rows:()=>{a(this,_e,ss).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",H3,H7,V7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,_e,ss).call(this)}};_e=new WeakSet,ss=function(){i.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(i("div.item"))}catch{}},m(H3,"prop",{rows:"5",cssLink:"",skin:""});let tn=H3;const W7=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label hide">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`,Le=class Le extends Qe{constructor(){super();h(this,J3);m(this,"_elements",{text:null,prefix:null,suffix:null,button:null,close:null,menu:null});a(this,J3,E8).call(this),this._init("oo-tag",Le,G7,J7)}_setEvent(){this._elements.close&&this._elements.close.addEventListener("click",t=>{this.shadowRoot.dispatchEvent(new MouseEvent("close",t)),t.stopPropagation()}),this._elements.menu&&this._elements.menu.addEventListener("click",t=>{this.shadowRoot.dispatchEvent(new MouseEvent("menu",t)),t.stopPropagation()})}};J3=new WeakSet,E8=function(){this.setPropMap=Object.assign(this._setPropMap,{close:()=>{this._props.close==="on"?i.removeClass(this._elements.close,"hide"):i.addClass(this._elements.close,"hide")},menu:()=>{this._props.menu==="on"?i.removeClass(this._elements.menu,"hide"):i.addClass(this._elements.menu,"hide")},type:t=>{this._props.type||(this._props.type="default"),t&&i.removeClass(this._elements.button,t),i.addClass(this._elements.button,this._props.type)}})},m(Le,"prop",{leftIcon:"",rightIcon:"",style:"",disabled:!1,text:"",type:"default",close:"on",menu:"off",skin:""}),m(Le,"events",{close:new Event("close",{composed:!0}),menu:new Event("menu",{composed:!0})});let rn=Le;const Q7=`<div class="content">\r
	<label>\r
		<slot name="before-outer"></slot>\r
		<div class="label hide">\r
			<div class="labelText hide"></div>\r
