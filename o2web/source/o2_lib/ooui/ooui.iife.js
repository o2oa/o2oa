...
`,gt=class gt extends i2{constructor(){super();h(this,j3);h(this,ge);h(this,fe);h(this,Z3);h(this,ve);h(this,z3);h(this,T1);h(this,a2,!1);h(this,S2,[]);h(this,mt,null);h(this,Ct,[]);h(this,O,null);h(this,d2,null);h(this,B2,0);h(this,h2,null);a(this,j3,f8).call(this),this._init("oo-select"),this._useCss(Z7)}static get observedAttributes(){return gt.prop=Object.assign({},i2.prop,gt.prop),Object.keys(gt.prop).map(t=>L(t))}_checkSelectedValue(t){for(const e of l(this,S2))if(e.value===t)return e;return null}_render(){p(this,a2,!1),this._elements.drop=i("div.drop.ooicon-drop_down"),this._elements.view.insertAdjacentElement("afterend",this._elements.drop),p(this,d2,this.querySelector("div.options-position-node")),l(this,d2)||(p(this,d2,i("div.options-position-node.hide")),this._elements.body.insertAdjacentElement("afterbegin",l(this,d2)),l(this,d2).addEventListener("click",()=>{a(this,T1,Re).call(this)})),p(this,O,this.querySelector("div.options-area")),l(this,O)||(p(this,O,i("div.options-area.invisible")),i.set(l(this,O),"html",'<div class="arrow"></div><div class="options-content"><slot name="items"></slot></div>'),l(this,d2).append(l(this,O))),this._props.allowInput?this._elements.input.removeAttribute("readonly"):this._elements.input.setAttribute("readonly",!0)}_removeItem(t){l(this,S2).splice(l(this,S2).indexOf(t),1),t.removeAttribute("slot")}_appendItem(t){l(this,S2).push(t),t.setAttribute("slot","items"),t.setAttribute("skin",this._props.skin);const e=i.getSize(this._elements.view),s=i.getSize(t._elements.text),o=Math.max(s.x,e.x);o>l(this,B2)&&(p(this,B2,o),a(this,ge,Qn).call(this)),this._props.size&&t.setAttribute("size",this._props.size),this._appendItemCheckValue(t),this._setPropMap.$default("value")}checkMaxWidth(t){t>l(this,B2)&&(p(this,B2,t),a(this,ge,Qn).call(this))}_appendItemCheckValue(t){var s;const e=Array.isArray(this.value)?(s=this.value)==null?void 0:s[0]:this.value;e&&t.value===e&&(t.selected=!0)}_removeGroup(t){l(this,Ct).splice(l(this,Ct).indexOf(t),1),t.removeAttribute("slot")}_appendGroup(t){l(this,Ct).push(t),t.setAttribute("slot","items"),t.setAttribute("skin",this._props.skin),this._props.size&&option.setAttribute("size",this._props.size)}_selected(t){if(t.selected){l(this,h2)&&l(this,h2)!==t&&(l(this,h2).selected=!1);const e=this.value!==(t.value||t.text);p(this,h2,t);const s=t.text;this.value=t.value||s,this.text=s;const o=Array.isArray(s)?s.join(","):s;this._elements.input.value=o,this._elements.viewText.textContent=o,s||(this._elements.viewText.innerHTML="-"),this.unInvalidStyle(),this._elements.view.title=this._elements.view.textContent,e&&this.dispatchEvent(new CustomEvent("change"))}a(this,T1,Re).call(this)}_setInputValue(t,e){this._elements.input.value=e||t||" ",this._elements.viewText.textContent=e||t||"-"}_inputValue(){l(this,h2)&&(l(this,h2).selected=!1),p(this,h2,null),this.value=this._elements.input.value,this._elements.viewText.textContent=this.value??" ",this.text=this.value,this.value||(this._elements.viewText.innerHTML="-")}_setEvent(){super._setEvent(),this._elements.box.addEventListener("click",()=>{!this._props.disabled&&!this._props.readmode&&!this._props.read&&!this._props.readonly&&a(this,fe,ts).call(this)}),this._elements.input.addEventListener("click",t=>{!this._props.disabled&&!this._props.readmode&&!this._props.read&&!this._props.readonly&&(this._props.allowInput||a(this,fe,ts).call(this),t.stopPropagation())}),this._elements.input.addEventListener("input",t=>{this._inputValue(t)}),l(this,O).addEventListener("click",t=>{t.stopPropagation()}),l(this,O).addEventListener("mousedown",t=>{t.stopPropagation()}),this._content.firstElementChild.addEventListener("mousedown",t=>{t.stopPropagation()})}get value(){return this._props.value}set value(t){this.setAttribute("value",t)}get text(){return this._props.text}set text(t){this._props.text=t}};j3=new WeakSet,f8=function(){this._setPropMap=Object.assign(this._setPropMap,{disabled:()=>{i.toggleAttr(this._elements.input,"disabled",this._props.disabled),i.checkClass(this._elements.box,"disabled",this._props.disabled),i.checkClass(this._elements.label,"disabled",this._props.disabled),i.checkClass(this._elements.drop,"disabled",this._props.disabled)},optionWidth:()=>{this._props.optionWidth==="auto"&&l(this,O)&&i.setStyle(l(this,O),"min-width","unset")},value:()=>{var t;if(this._props.hasOwnProperty("value")){let e=!1;const s=Array.isArray(this._props.value)?(t=this._props.value)==null?void 0:t[0]:this._props.value;let o="";for(const d of l(this,S2))if(d.value===s){d.selected||(d.selected=!0),o=d.text,e=!0;break}e||(this._elements.input.value=this._props.value),this._props.allowInput&&this._setInputValue(s,o)}},readonly:()=>{},readmode:()=>{i.checkClass(this._elements.box,"readmode",this._props.readmode),i.checkClass(this._elements.label,"readmode",this._props.readmode),this._props.readmode?i.toggleAttr(this._elements.body,"style",this._props.viewStyle):i.toggleAttr(this._elements.body,"style",""),this._setPropMap.viewStyle(),this._setPropMap.required()},autoSize:()=>{this._props.autoSize?i.setStyle(this._elements.view,"width",`calc(${l(this,B2)}px + 1rem)`):i.setStyle(this._elements.view,"width","auto")},read:()=>{},allowInput:()=>{this._props.allowInput?(this._elements.input.removeAttribute("readonly"),this._elements.input.value=this._props.value,this._inputValue()):this._elements.input.setAttribute("readonly",!0)},viewStyle:()=>{this._props.readmode&&i.toggleAttr(this._elements.body,"style",this._props.viewStyle)}})},a2=new WeakMap,S2=new WeakMap,mt=new WeakMap,Ct=new WeakMap,O=new WeakMap,d2=new WeakMap,B2=new WeakMap,ge=new WeakSet,Qn=function(){this._props.autoSize&&(this.setMinWidthTimer&&window.clearTimeout(this.setMinWidthTimer),this.setMinWidthTimer=setTimeout(()=>{i.setStyle(this._elements.view,"width",`calc(${l(this,B2)}px + 1rem)`),this.setMinWidthTimer=null},10))},h2=new WeakMap,fe=new WeakSet,ts=function(){p(this,a2,!l(this,a2)),l(this,a2)?a(this,z3,b8).call(this):a(this,T1,Re).call(this)},Z3=new WeakSet,v8=function(){const t=i.getSize(this._elements.box),e=t.y+6+t.y*.2,s=this._props.optionWidth==="auto"?i.getSize(l(this,O)).x:t.x,o=i.getPosition(this._elements.box,i.getOffsetParent(this._elements.box));i.setStyles(l(this,d2),{left:o.x+"px"}),i.setStyles(l(this,O),{top:e+"px","min-width":this._props.optionWidth==="auto"?"unset":s+"px"});const d=s/2-6;i.setStyles(l(this,O).querySelector(".arrow"),{left:d+"px"})},ve=new WeakSet,es=function(){i.checkClass(this._elements.drop,"down",l(this,a2)),i.checkClass(this._elements.box,"focus",l(this,a2)),i.checkClass(this._elements.label,"focus",l(this,a2))},z3=new WeakSet,b8=function(){this._props.readmode||(p(this,a2,!0),a(this,ve,es).call(this),a(this,Z3,v8).call(this),i.removeClass(l(this,d2),"hide"),i.removeClass(l(this,O),"invisible"),i.addClass(document.body,"ooui-select-visible"),i.addClass(l(this,O),"visible"),this.ownerDocument.dispatchEvent(new MouseEvent("mousedown")),this.dispatchEvent(new CustomEvent("show")),p(this,mt,a(this,T1,Re).bind(this)),this.ownerDocument.addEventListener("mousedown",l(this,mt)),l(this,S2).forEach(t=>{t._hideOptions()}),window.setTimeout(()=>{l(this,h2)&&l(this,h2)._checkSelected()},20),this.unInvalidStyle())},T1=new WeakSet,Re=function(){p(this,a2,!1),a(this,ve,es).call(this),i.removeClass(l(this,O),"visible"),i.addClass(l(this,O),"invisible"),i.removeClass(document.body,"ooui-select-visible"),this.ownerDocument.removeEventListener("mousedown",l(this,mt)),l(this,S2).forEach(t=>{t._hideOptions()}),i.addClass(l(this,d2),"hide"),this.dispatchEvent(new CustomEvent("hide"))},C(gt,"prop",{read:!1,allowInput:!1,optionWidth:"fixed"});let J4=gt;const z7=`<div class="content">\r
	<slot name="before-outer"></slot>\r
