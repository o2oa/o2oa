...
`;function u2(o,i){o.apply(i||this)}const ui=class ui extends F{constructor(){super();d(this,O1);d(this,F1);d(this,Jt);d(this,N2);d(this,Qt);d(this,pi);d(this,$1);d(this,O2);m(this,"_elements",{first:null,last:null,prev:null,next:null,pages:null,jumper:null,jumperTextLeft:null,jumperTextRight:null,jumperPageCount:null,jumperInput:null});m(this,"_setPropMap",{cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},current:(t,e)=>{t!==e&&u2(h(this,Jt,a2),this)},total:(t,e)=>{t!==e&&u2(h(this,Jt,a2),this)},pageSize:(t,e)=>{t!==e&&u2(h(this,Jt,a2),this)},pageCount:()=>{},pages:(t,e)=>{t!==e&&u2(h(this,Jt,a2),this)},first:()=>{h(this,O1,R3).call(this)},last:()=>{h(this,F1,V3).call(this)},jumper:()=>{n.checkClass(this._elements.jumper,"hide",!this._props.jumper)},jumperText:()=>{this._props.jumperText||(this._props.jumperText="到第{n}页"),h(this,O2,a5).call(this)}});this._initialize("oo-pagination",ui,O9,N9)}static get observedAttributes(){return Object.keys(this.prop).map(t=>b(t))}async _render(){h(this,N2,l5).call(this),(this._props.pageCount>1||this._props.showSingle)&&(h(this,O1,R3).call(this),h(this,F1,V3).call(this),u2(h(this,Jt,a2),this),h(this,O2,a5).call(this))}_setEvent(){this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.first.addEventListener("click",()=>{this.gotoFirst()}),this._elements.last.addEventListener("click",()=>{this.gotoLast()}),this._elements.jumperInput&&this._elements.jumperInput.addEventListener("keydown",t=>{if(t.key==="Enter"||t.keyCode===13){const e=this._elements.jumperInput;!isNaN(e.value)&&e.value&&(this.gotoPage(parseInt(e.value)),e.value="")}})}setCurrent(t){this._props.current=t,h(this,N2,l5).call(this)}gotoPage(t){this.setCurrent(t),this.dispatchEvent(new CustomEvent("page",{detail:this._props.current})),this.setAttribute("current",this._props.current),u2(h(this,Jt,a2),this)}pagesForward(){this.gotoPage(this._props.current+(this._props.pages-2))}pagesBack(){this.gotoPage(this._props.current-(this._props.pages-2))}gotoFirst(){this.gotoPage(1)}gotoLast(){this.gotoPage(this._props.pageCount)}gotoPrev(){this.gotoPage(--this._props.current)}gotoNext(){this.gotoPage(++this._props.current)}};O1=new WeakSet,R3=function(){const t=this._props.first;this._elements.first.textContent=t,n.checkClass(this._elements.first,"hide",!t)},F1=new WeakSet,V3=function(){const t=this._props.last;this._elements.last.textContent=t,n.checkClass(this._elements.last,"hide",!t)},Jt=new WeakSet,a2=function(t,e,s){if(h(this,N2,l5).call(this),n.empty(this._elements.pages),this._props.pageCount>1||this._props.showSingle)if(this._props.pageCount<=this._props.pages)for(let r=1;r<=this._props.pageCount;r++)h(this,Qt,d2).call(this,r);else{h(this,Qt,d2).call(this,1);const r=this._props.pages-2,a=parseInt(r/2);let c;if(this._props.current-a<=2)for(let p=1;p<=r;p++)c=p+1,h(this,Qt,d2).call(this,c);else if(this._props.current+a>=this._props.pageCount-1){h(this,$1,H3).call(this);for(let p=r;p>=1;p--)c=this._props.pageCount-p,h(this,Qt,d2).call(this,c)}else{h(this,$1,H3).call(this);for(let p=0;p<r;p++)c=this._props.current-(a-p),h(this,Qt,d2).call(this,c,s)}c<this._props.pageCount-1&&h(this,pi,ro).call(this),h(this,Qt,d2).call(this,this._props.pageCount)}h(this,O2,a5).call(this)},N2=new WeakSet,l5=function(){this._props.pageCount=Math.ceil(this._props.total/this._props.pageSize),this._props.pageCount<1&&(this._props.pageCount=1),this._props.current<1&&(this._props.current=1),this._props.current>this._props.pageCount&&(this._props.current=this._props.pageCount)},Qt=new WeakSet,d2=function(t){const e=document.createElement("div");e.textContent=t,t===this._props.current&&n.addClass(e,"current"),e.addEventListener("click",()=>{this.gotoPage(t)}),this._elements.pages.append(e)},pi=new WeakSet,ro=function(){const t=document.createElement("div");n.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesForward()}),this._elements.pages.append(t)},$1=new WeakSet,H3=function(){const t=document.createElement("div");n.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesBack()}),this._elements.pages.append(t)},O2=new WeakSet,a5=function(){const t=this._props.jumperText.split("{n}");this._elements.jumperTextLeft.textContent=t[0],this._elements.jumperTextRight.textContent=(t==null?void 0:t[1])??"",this._elements.jumperPageCount.textContent=this._props.pageCount},m(ui,"prop",{total:200,pageSize:20,pageCount:0,pages:10,current:1,showSingle:!0,jumper:!1,first:"第一页",last:"最后一页",jumperText:"到第{n}页",border:!0,cssLink:"",skin:""});let U5=ui;const F9=`.content{\r
    --radius: 100%;\r
}\r
.check{\r
    border-radius: var(--radius);\r
