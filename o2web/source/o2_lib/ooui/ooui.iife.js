var e6=Object.defineProperty;var n6=(w,x,M)=>x in w?e6(w,x,{enumerable:!0,configurable:!0,writable:!0,value:M}):w[x]=M;var u=(w,x,M)=>(n6(w,typeof x!="symbol"?x+"":x,M),M),Z4=(w,x,M)=>{if(!x.has(w))throw TypeError("Cannot "+M)};var l=(w,x,M)=>(Z4(w,x,"read from private field"),M?M.call(w):x.get(w)),c=(w,x,M)=>{if(x.has(w))throw TypeError("Cannot add the same private member more than once");x instanceof WeakSet?x.add(w):x.set(w,M)},h=(w,x,M,i5)=>(Z4(w,x,"write to private field"),i5?i5.call(w,M):x.set(w,M),M);var a=(w,x,M)=>(Z4(w,x,"access private method"),M);var $OOUI=function(w){var Q,u1,F4,u5,_9,m5,w9,v5,x9,Y,g5,y9,m1,D4,U,b2,N,X,G,g,y,S,D,T,Z,P,v1,g1,f1,L1,b1,_1,w1,V2,c2,W2,_2,t2,w2,x2,y2,h2,Y2,x1,y1,H2,q2,U2,y4,k1,P4,L5,M1,j4,E1,I4,b5,k9,p2,d1,S1,$4,k2,K1,T1,z4,_5,M9,X2,B3,w5,E9,C2,c1,k4,s6,G2,V3,M4,r6,M2,J1,e2,$2,E2,Q1,K2,W3,J2,Y3,H,a2,A1,R4,x5,S9,S2,t5,y5,T9,T2,e5,k5,A9,A2,n5,u2,m2,v2,S5,O9,T5,Z9,A5,F9,O5,D9,O2,E4,S4,Z5,P9,F5,j9,D5,I9,T4,F,Q2,P5,$9,Z1,N4,g2,$5,z9,t1,e1,H3,z5,R9,R5,N9,F1,B4,N5,B9,B5,V9,V5,W9,Y5,Y9,H5,H9,q5,q9,U5,U9,X5,X9,G5,G9,q,A,n1,B,K5,K9,P1,V4,J5,J9,j1,W4,Q5,Q9,I1,F2,s5,t3,t8,e3,e8,n3,n8,s3,s8,r3,r8,$1,Y4,V,n2,$,s1,d3,i8,c3,o8,h3,l8,p3,a8,C3,d8,z1,H4,R1,q4,u3,c8,m3,h8,N1,U4,v3,p8,B1,X4,g3,C8,f2,h1,f3,u8,r2,z2,L3,m8,V1,G4,W1,K4,i2,R2,r1,q3,o2,N2,_3,v8,Y1,J4,w3,g8,y3,f8,k3,L8,M3,b8,W,D2,O,i1,o1,l2,H1,Q4,P2,E3,_8,S3,w8,q1,t9,T3,x8,l1,U3,U1,e9,j2,r5,X1,n9,Z3,y8,D3,k8,P3,M8,I3,E8,z3,S8,R3,T8;"use strict";var x=globalThis&&globalThis.__spreadArray||function(n,i,t){if(t||arguments.length===2)for(var e=0,s=i.length,o;e<s;e++)(o||!(e in i))&&(o||(o=Array.prototype.slice.call(i,0,e)),o[e]=i[e]);return n.concat(o||Array.prototype.slice.call(i))},M=function(){function n(i,t,e){this.name=i,this.version=t,this.os=e,this.type="browser"}return n}(),i5=function(){function n(i){this.version=i,this.type="node",this.name="node",this.os=process.platform}return n}(),A8=function(){function n(i,t,e,s){this.name=i,this.version=t,this.os=e,this.bot=s,this.type="bot-device"}return n}(),O8=function(){function n(){this.type="bot",this.bot=!0,this.name="bot",this.version=null,this.os=null}return n}(),Z8=function(){function n(){this.type="react-native",this.name="react-native",this.version=null,this.os=null}return n}(),F8=/alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/,D8=/(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask\ Jeeves\/Teoma|ia_archiver)/,s9=3,P8=[["aol",/AOLShield\/([0-9\._]+)/],["edge",/Edge\/([0-9\._]+)/],["edge-ios",/EdgiOS\/([0-9\._]+)/],["yandexbrowser",/YaBrowser\/([0-9\._]+)/],["kakaotalk",/KAKAOTALK\s([0-9\.]+)/],["samsung",/SamsungBrowser\/([0-9\.]+)/],["silk",/\bSilk\/([0-9._-]+)\b/],["miui",/MiuiBrowser\/([0-9\.]+)$/],["beaker",/BeakerBrowser\/([0-9\.]+)/],["edge-chromium",/EdgA?\/([0-9\.]+)/],["chromium-webview",/(?!Chrom.*OPR)wv\).*Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/],["chrome",/(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/],["phantomjs",/PhantomJS\/([0-9\.]+)(:?\s|$)/],["crios",/CriOS\/([0-9\.]+)(:?\s|$)/],["firefox",/Firefox\/([0-9\.]+)(?:\s|$)/],["fxios",/FxiOS\/([0-9\.]+)/],["opera-mini",/Opera Mini.*Version\/([0-9\.]+)/],["opera",/Opera\/([0-9\.]+)(?:\s|$)/],["opera",/OPR\/([0-9\.]+)(:?\s|$)/],["pie",/^Microsoft Pocket Internet Explorer\/(\d+\.\d+)$/],["pie",/^Mozilla\/\d\.\d+\s\(compatible;\s(?:MSP?IE|MSInternet Explorer) (\d+\.\d+);.*Windows CE.*\)$/],["netfront",/^Mozilla\/\d\.\d+.*NetFront\/(\d.\d)/],["ie",/Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/],["ie",/MSIE\s([0-9\.]+);.*Trident\/[4-7].0/],["ie",/MSIE\s(7\.0)/],["bb10",/BB10;\sTouch.*Version\/([0-9\.]+)/],["android",/Android\s([0-9\.]+)/],["ios",/Version\/([0-9\._]+).*Mobile.*Safari.*/],["safari",/Version\/([0-9\._]+).*Safari/],["facebook",/FB[AS]V\/([0-9\.]+)/],["instagram",/Instagram\s([0-9\.]+)/],["ios-webview",/AppleWebKit\/([0-9\.]+).*Mobile/],["ios-webview",/AppleWebKit\/([0-9\.]+).*Gecko\)$/],["curl",/^curl\/([0-9\.]+)$/],["searchbot",F8]],r9=[["iOS",/iP(hone|od|ad)/],["Android OS",/Android/],["BlackBerry OS",/BlackBerry|BB10/],["Windows Mobile",/IEMobile/],["Amazon OS",/Kindle/],["Windows 3.11",/Win16/],["Windows 95",/(Windows 95)|(Win95)|(Windows_95)/],["Windows 98",/(Windows 98)|(Win98)/],["Windows 2000",/(Windows NT 5.0)|(Windows 2000)/],["Windows XP",/(Windows NT 5.1)|(Windows XP)/],["Windows Server 2003",/(Windows NT 5.2)/],["Windows Vista",/(Windows NT 6.0)/],["Windows 7",/(Windows NT 6.1)/],["Windows 8",/(Windows NT 6.2)/],["Windows 8.1",/(Windows NT 6.3)/],["Windows 10",/(Windows NT 10.0)/],["Windows ME",/Windows ME/],["Windows CE",/Windows CE|WinCE|Microsoft Pocket Internet Explorer/],["Open BSD",/OpenBSD/],["Sun OS",/SunOS/],["Chrome OS",/CrOS/],["Linux",/(Linux)|(X11)/],["Mac OS",/(Mac_PowerPC)|(Macintosh)/],["QNX",/QNX/],["BeOS",/BeOS/],["OS/2",/OS\/2/]];function j8(n){return n?i9(n):typeof document>"u"&&typeof navigator<"u"&&navigator.product==="ReactNative"?new Z8:typeof navigator<"u"?i9(navigator.userAgent):z8()}function I8(n){return n!==""&&P8.reduce(function(i,t){var e=t[0],s=t[1];if(i)return i;var o=s.exec(n);return!!o&&[e,o]},!1)}function i9(n){var i=I8(n);if(!i)return null;var t=i[0],e=i[1];if(t==="searchbot")return new O8;var s=e[1]&&e[1].split(".").join("_").split("_").slice(0,3);s?s.length<s9&&(s=x(x([],s,!0),R8(s9-s.length),!0)):s=[];var o=s.join("."),d=$8(n),p=D8.exec(n);return p&&p[1]?new A8(t,o,d,p[1]):new M(t,o,d)}function $8(n){for(var i=0,t=r9.length;i<t;i++){var e=r9[i],s=e[0],o=e[1],d=o.exec(n);if(d)return s}return null}function z8(){var n=typeof process<"u"&&process.version;return n?new i5(process.version.slice(1)):null}function R8(n){for(var i=[],t=0;t<n;t++)i.push("0");return i}var o5,N8=new Uint8Array(16);function B8(){if(!o5&&(o5=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||typeof msCrypto<"u"&&typeof msCrypto.getRandomValues=="function"&&msCrypto.getRandomValues.bind(msCrypto),!o5))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return o5(N8)}const V8=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;function W8(n){return typeof n=="string"&&V8.test(n)}for(var E=[],X3=0;X3<256;++X3)E.push((X3+256).toString(16).substr(1));function Y8(n){var i=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,t=(E[n[i+0]]+E[n[i+1]]+E[n[i+2]]+E[n[i+3]]+"-"+E[n[i+4]]+E[n[i+5]]+"-"+E[n[i+6]]+E[n[i+7]]+"-"+E[n[i+8]]+E[n[i+9]]+"-"+E[n[i+10]]+E[n[i+11]]+E[n[i+12]]+E[n[i+13]]+E[n[i+14]]+E[n[i+15]]).toLowerCase();if(!W8(t))throw TypeError("Stringified UUID is invalid");return t}function o9(n,i,t){n=n||{};var e=n.random||(n.rng||B8)();if(e[6]=e[6]&15|64,e[8]=e[8]&63|128,i){t=t||0;for(var s=0;s<16;++s)i[t+s]=e[s];return i}return Y8(e)}const l9=function(n,i,t){const e=i.toLowerCase();e==="text"?n.textContent=t:e==="html"?n.innerHTML=t:e==="styles"?r.setStyles(n,t):n.setAttribute(i,t)},H8=function(n,i){const t=i.toLowerCase();if(t==="text")return n.innerText||n.textContent||"";if(t==="html")return n.innerHTML||"";if(t==="value")switch(n.tagName.toString().toLowerCase()){case"select":return n.options[n.selectedIndex].value;default:return n.value}return n.getAttribute(i)},l5=function(n){const i=K8(n||"").split(" "),t={};return i.filter(function(e){if(e!==""&&!t[e])return t[e]=e})},a9=function(n){return!n.tagName||/^(?:body|html)$/i.test(n.tagName)},d9=function(n){return/html/i.test(n.tagName)},a5=function(n,i){return parseInt(r.getStyle(n,i))||0},q8=function(n){return a5(n,"border-top-width")},U8=function(n){return a5(n,"border-left-width")},X8=function(n,i){return{left:n.x-a5(i,"margin-left"),top:n.y-a5(i,"margin-top")}},r=(n,i)=>{let t;const e=n.replace(/^\S*?(?=\.|#|$)/,p=>(t=p,""));let s="",o;e&&(o=e.split(".").filter(C=>!!C).map(C=>{const m=C.split("#"),f=m.shift();return s=m.pop()||s,f}));const d=document.createElement(t);return s&&d.setAttribute("id",s),o&&o.length&&d.setAttribute("class",o.join(" ")),i&&r.set(d,i),d};Object.assign(r,{el:(n,i)=>v(n)==="string"&&n?(i||document).querySelector(n):n,els:(n,i)=>(i||document).querySelectorAll(n),addClass:(n,i)=>{const t=r.el(n);return l5(i).forEach(e=>{t.classList.add(e)}),t},removeClass:(n,i)=>{const t=r.el(n);return l5(i).forEach(e=>{t.classList.remove(e)}),t},hasClass:(n,i)=>r.el(n).classList.contains(i),toggleClass:(n,i,t=!1)=>{const e=r.el(n);return l5(i).forEach(s=>{let o=t;(o==null||o===!1)&&(o=!r.hasClass(e,s)),o?r.addClass(e,s):r.removeClass(e,s)}),e},checkClass:(n,i,t)=>{const e=r.el(n);return l5(i).forEach(s=>{t?r.addClass(e,s):r.removeClass(e,s)}),e},mapProps:(n,i)=>{const t=r.el(n);for(const e in i){const s=L(e);if(typeof i[e]=="boolean")i[e]=t.hasAttribute(e)||t.hasAttribute(s)||!1;else{const o=t.getAttribute(e)||t.getAttribute(s)||"";o!==i[e]&&(i[e]=o)}}return t},toggleAttr:(n,i,t)=>{const e=r.el(n);return t?e.setAttribute(i,t):e.removeAttribute(i),e},set:(n,i,t)=>{const e=r.el(n);return typeof i=="object"?Object.keys(i).forEach(s=>{l9(e,s,i[s])}):l9(e,i,t),e},get:(n,i)=>{const t=r.el(n);return H8(t,i)},setProperty:(n,i,t)=>{const e=r.el(n);return e.setAttribute(i,t),e},getScroll:n=>{const i=r.el(n);return{x:i.scrollLeft,y:i.scrollTop}},getScrolls:n=>{let t=r.el(n).parentNode,e={x:0,y:0};for(;t&&!a9(t);)e.x+=t.scrollLeft,e.y+=t.scrollTop,t=t.parentNode;return e},getOffsetParent:n=>{let i=n.offsetParent;for(;i&&["table","td","th"].includes(i.tagName.toString().toLowerCase());)i=i.offsetParent;return i||document.body},getPosition:(n,i)=>{const t=r.el(n);for(i===window&&(i=document.documentElement);i&&r.getStyle(i,"display")==="contents";)i=i.parentElement;for(;n&&r.getStyle(n,"display")==="contents";)n=n.parentElement;const e=n.getBoundingClientRect(),s=document.documentElement,o=r.getScroll(s),d=r.getScrolls(t),p=r.getStyle(t,"position")==="fixed",C={x:e.left+d.x+(p?0:o.x)-s.clientLeft,y:e.top+d.y+(p?0:o.y)-s.clientTop},m=r.getScrolls(t),f={x:C.x-m.x,y:C.y-m.y};if(i){const _=r.getPosition(i);return{x:f.x-_.x-U8(i),y:f.y-_.y-q8(i)}}return f},setPosition:(n,i)=>{const t=r.el(n);return r.setStyles(t,X8(i.this))},getSize:n=>{const i=r.el(n);if(d9(i))return{x:i.clientWidth,y:i.clientHeight};{const t=i.getBoundingClientRect();return{x:t.width,y:t.height}}},getScrollSize:n=>{const i=r.el(n);if(/^(?:body|html)$/i.test(i.tagName)){const t=document.documentElement,e=document.body;return{x:Math.max(t.scrollWidth,e.scrollWidth),y:Math.max(t.scrollHeight,e.scrollHeight)}}return{x:i.scrollWidth,y:i.scrollHeight}},getStyle:function(n,i){const t=r.el(n),e=p1(i);let s=t.style[e];return s||(s=window.getComputedStyle(t)[e]),s},getStyles:n=>{const i=[...arguments],t=r.el(i.shift()),e={};return i.forEach(s=>{e[s]=r.getStyle(t,s)}),e},setStyle:(n,i,t)=>{const e=r.el(n);return typeof i=="object"?Object.keys(i).forEach(s=>{e.style[p1(s)]=i[s]}):e.style[p1(i)]=t,e},setStyles:(n,i)=>r.setStyle(n,i),isPositioned:n=>{const i=r.el(n),t=r.getStyle(i,"position");return t&&["absolute","fixed","relative","sticky"].includes(t)},show:n=>{const i=r.el(n);return r.getStyle(i,"display")==="none"&&r.setStyle(i,"display",i.dataset.storeDisplay||"block"),i},hide:n=>{const i=r.el(n),t=r.getStyle(i,"display");return t!=="none"&&(i.dataset.storeDisplay=t,r.setStyle(i,"display","none")),i},getParentSrcollNode:n=>{let t=r.el(n).parentElement,e=r.getStyle(t,"overflow"),s=r.getStyle(t,"overflow-y");for(;t&&(r.getScrollSize(t).y<=r.getSize(t).y||!["auto","scroll"].includes(e)&&!["auto","scroll"].includes(s));)t=t.parentElement,t&&(e=r.getStyle(t,"overflow"),s=r.getStyle(t,"overflow-y"));return t||document.documentElement},getParent:function(n,i){if(i){let t=n.parentElement;for(;t&&!t.matches(i);)t=t.parentElement;return t}else return n.parentElement},isBody:n=>a9(r.el(n)),isHtml:n=>d9(r.el(n)),empty:n=>{const i=r.el(n);for(;i.childNodes.length;)i.removeChild(i.childNodes[0]);return i},peel:(n,i)=>{const{node:t,position:e}=i&&v(i)==="element"?{node:i,position:"beforeend"}:{node:n,position:"beforebegin"};let s=n.firstElementChild;for(;s;)t.insertAdjacentElement(e,s),s=n.firstElementChild;n.remove()},getPositionParent(n){let i=r.el(n).parentElement;for(;i;){const t=i.tagName.toString().toLowerCase();if(t==="application")return i;if(t==="oo-dialog")return i._content;i=i.parentElement}return document.body},overlap(n,i,t=document.body,e){const s=this.getSize(r.el(i)),o=this.getPosition(r.el(i),t),d=r.el(n);this.setStyles(d,{position:"absolute",width:`${s.x}px`,height:`${s.y}px`,top:`${o.y}px`,left:`${o.x}px`}),d.isConnected||t.append(d)},appendTop(n,i){const t=n.firstChild;return t?n.insertBefore(i,t):n.appendChild(i)}}),j8();function v(n){if(n==null)return"null";if(Array.isArray(n))return"array";if(n instanceof Map)return"map";if(n instanceof Set)return"set";if(n===window)return"window";if(n instanceof Date)return"date";if(n instanceof RegExp)return"regexp";if(n instanceof Error)return"error";if(n instanceof Event)return"event";if((typeof n=="function"||typeof n=="object")&&typeof n.then=="function")return"promise";if(n.nodeName){if(n.nodeType===1)return"element";if(n.nodeType===3)return/\S/.test(n.nodeValue)?"textnode":"whitespace";if(n.nodeType===9)return"document";if(n.nodeType||n.nodeType===0)return n.nodeName}else if(typeof n.length=="number"&&n.callee)return"arguments";return typeof n}function B2(n,i,t=null,e=!0){const s=i||this,o=t?Object.values(t):[],d=t?Object.keys(t).join(","):"";return Function("return function("+d+"){"+n+"}")().apply(s,o)}function J(n,i=20,t,e){const s=t;return i&&v(i)!=="number"&&(t=i,i=s&&v(s)==="number"?s:20),n.clear&&n.clear(),n.timerFunction=(o,d)=>{n.clear=()=>{n.timerId&&clearTimeout(n.timerId),n.promise&&(n.promise=null)},n.timerId=setTimeout(function(){n.timerId=null;try{const p=t?n.apply(t,e):n(e);Promise.resolve(p).then(C=>{o(C)})}catch(p){d(p)}},i)},n.promise=new Promise(n.timerFunction),n.promise}function c9(n){if(!n)return n;const i=v(n);return i==="function"?null:i==="array"||i==="object"?h9(n):n}function G8(n){let i=n.length,t=new Array(i);for(;i--;)t[i]=c9(n[i]);return t}function h9(n){if(v(n)==="array")return G8(n);const i={};for(let t in n)i[t]=c9(n[t]);return i}function L(n){return n.replace(/([A-Z])/g,"-$1").toLowerCase()}function p1(n){return n.replace(/-(\w)/g,function(i,t){return t.toUpperCase()})}function K8(n){return n.replace(/\s+/g," ").trim()}function p9(n,i){const t=n.indexOf(i);t!==-1&&(n.splice(t,1),p9(n,i))}const G3={ms:1,second:1e3,minute:6e4,hour:36e5,day:864e5,week:6084e5};function d2(n){return new Date(n.getTime())}function d5(n,i){return n?n instanceof Date?i?d2(n):n:new Date(n):null}function J8(n,i){const t=new Date(n,i);return t.setDate(0),t}function Q8(n,i){if(!n)return null;const t=d5(n,i);return t.setHours(23),t.setMinutes(59),t.setSeconds(59),t.setMilliseconds(999),t}function j(n,i){if(!n)return null;const t=d5(n,i);return t.setHours(0),t.setMinutes(0),t.setSeconds(0),t.setMilliseconds(0),t}function C9(n,i){const t=d2(n),e=(7+n.getDay()-parseInt(i||0))%7;t.setDate(t.getDate()-e+3);const s=t.valueOf();return t.setMonth(0,1),t.getDay()!==4&&t.setMonth(0,1+(4-t.getDay()+7)%7),1+Math.ceil((s-t)/G3.week)}function z(n,i="day",t=1){switch(i){case"year":return z(n,"month",t*12);case"month":const e=d5(n),s=e.getDate();return e.setMonth(e.getMonth()+t+1,0),s<e.getDate()&&n.setDate(s),e;case"week":return z(n,"day",t*7);case"date":case"day":return n=d5(n),n.setDate(n.getDate()+t),n}if(!G3[i])throw new Error(i+" is not a supported interval");return n.setTime(this.getTime()+t*G3[i])}function R(n,i){const t={"M+":n.getMonth()+1,"D+":n.getDate(),"h+":n.getHours()%12===0?12:n.getHours()%12,"H+":n.getHours(),"m+":n.getMinutes(),"s+":n.getSeconds(),"q+":Math.floor((n.getMonth()+3)/3),d:n.getDay(),S:n.getMilliseconds(),a:n.getHours()<12?"上午":"下午",A:n.getHours()<12?"AM":"PM"};/(Y+)/.test(i)&&(i=i.replace(RegExp.$1,(n.getFullYear()+"").substr(4-RegExp.$1.length))),/(W+)/.test(i)&&(t["W+"]=C9(n));for(let e in t)new RegExp("("+e+")").test(i)&&(i=i.replace(RegExp.$1,RegExp.$1.length===1?t[e]:("00"+t[e]).substr((""+t[e]).length)));return i}function t7(n){var i;return typeof n=="object"&&n.dn||((i=n==null?void 0:n.includes)==null?void 0:i.call(n,"@"))}function e7(n){const i=typeof n=="object"?n.id||"":n,[t,e]=i.split("--");return t.replace("-","").length===32&&e?e:""}const n7={Person:"P",Identity:"I",Unit:"U",Group:"G",Role:"R",UnitDuty:"UD",UnitAttribute:"UA",PersonAttribute:"PA",PersonParameter:"PP",UnitPost:"UP"};function K3(n){if(t7(n)){const e=(typeof n=="object"?n.dn||"":n).split("@"),s=(e==null?void 0:e[1])||"unknown";return["I","P","U","G","R","UD","UA","PA","PP","UP"].includes(s)?s:"unknown"}const i=e7(n);if(i)return n7[i]||"unknown"}function J3(n){if(Array.isArray(n))return n.flat(1/0).map(i=>J3(i));{const i=n.split("@");return(i==null?void 0:i[2])||n}}function s7(n,i){const t=`css${o9()}`;let e=n.toString();if(e){if(i&&r.addClass(i,t),e=e.replace(/\/\*(\s|\S)*?\*\//g,""),i){const o=new RegExp("[^{}\\/]+\\s*(?=\\{)","g"),d="."+t+" ";e=e.replace(o,p=>{const C=p.trim();return C.startsWith("@")||C==="from"||C==="to"?C:C.split(/\s*,\s*/g).map(function(f){return d+f}).join(", ")})}const s=r("style");return s.setAttribute("type","text/css"),s.setAttribute("id",t),document.head.appendChild(s),s.appendChild(document.createTextNode(e)),s}return null}const Q3={};function u9(n,i,t,e){if(t&&Q3[t])return Q3[t];const s=document.createElement("template");s.innerHTML=n;const o=s.content;if(i){const d=document.createElement("style");d.textContent=i,o.prepend(d)}if(e){const d=document.querySelector("#oo-css-skin");if(d){const p=d.cloneNode(!0);p.removeAttribute("id"),o.prepend(p)}}return document.body.appendChild(s),t&&(Q3[t]=s.content),s.content}class k extends HTMLElement{constructor(){super();c(this,u1);c(this,u5);c(this,m5);c(this,v5);c(this,Q,null)}_setEvent(){}_afterRender(){}_render(t){}_connected(){}_disconnected(){}_initialize(t,e,s,o){Object.hasOwn(this,"value")&&(this.value&&this.setAttribute("value",this.value),Reflect.deleteProperty(this,"value")),this._props=e?this._getProps(e.prop):{};const d=u9(s,o,t,!0);this._useTemplate(d),this._render(t),this._setEvent(),this._afterRender(),this._createProperties(e),this.dispatchEvent(new CustomEvent("load"))}_createProperties(t){Object.keys(this._props).forEach(e=>{let s=e;for(;this.hasOwnProperty(s)||t.prototype.hasOwnProperty(s);)s=`_${s}`;Object.hasOwn(this,s)||Object.defineProperty(this,s,{get:()=>this._props[s],set:o=>{o!==this._props[s]&&this.setAttribute(L(s),o)}})})}_getProps(t){const e=h9(t);return this.getAttributeNames().forEach(s=>{const o=p1(s);if(e.hasOwnProperty(o)){const d=this.getAttribute(s);/{{.*}}/g.test(d)||a(this,u1,F4).call(this,e,o,d)}}),e}_useCss(t){const e=document.createElement("style");return e.textContent=t,this._content.insertAdjacentElement("beforebegin",e),e}_useCssLink(t){const e=document.createElement("link");return e.rel="stylesheet",e.type="text/css",e.charSet="UTF-8",e.href=t,this._content.insertAdjacentElement("beforebegin",e),e}useCss(t){this.styleNode&&(this.styleNode.remove(),this.styleNode=null),t&&(this.styleNode=this._useCss(t))}useCssLink(t){this.styleNode&&(this.styleNode.remove(),this.styleNode=null),t&&(this.styleNode=this._useCssLink(t))}_useTemplate(t,e="open"){(this.shadowRoot||this.attachShadow({mode:e})).appendChild(t.cloneNode(!0)),a(this,u5,_9).call(this)}connectedCallback(){this._connected()}disconnectedCallback(){this._disconnected()}attributeChangedCallback(t,e,s){if(!/{{.*}}/g.test(s)){const o=p1(t),d=this._props[o];a(this,u1,F4).call(this,this._props,o,s),a(this,m5,w9).call(this,o,d,e)}}_setProps(t,e,s){const o=this._props[t];s!==o&&(this._setPropMap[t]?this._setPropMap[t](e,o):this._setPropMap.$default(t,e,o))}_useSkin(t){if(l(this,Q)&&l(this,Q).remove(),h(this,Q,null),t){const e=t.split(/\s*;\s*/g);h(this,Q,r("style"));let s="";e.forEach(o=>{const d=o.split(/\s*:\s*/g);s+=`--${d[0]}: ${d[1]};
	`}),l(this,Q).textContent=`
.content{
	${s}
}
`,this._content.insertAdjacentElement("beforebegin",l(this,Q))}}_fillContent(t){new MutationObserver(function(s){s.forEach(o=>{o.addedNodes.forEach(d=>{d.nodeType===Node.ELEMENT_NODE&&d.setAttribute("slot",t)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,v5,x9).call(this,t)}_canRender(t,e){if(t&&t.length){for(const s of t)if(!this.getAttribute(s))return!1}if(e&&e.length){for(const s of e)if(this.getAttribute(s))return!0}return!0}}Q=new WeakMap,u1=new WeakSet,F4=function(t,e,s){switch(v(t[e])){case"boolean":t[e]=!!s&&s!=="false";break;case"number":t[e]=isNaN(s)?s:parseInt(s);break;case"object":try{t[e]=JSON.parse(s)}catch{t[e]=s}break;case"array":try{t[e]=JSON.parse(s)}catch{t[e]=s?s.split(/\s*,\s*/g):[]}break;default:t[e]=s}},u5=new WeakSet,_9=function(){for(const t in this._elements)this._elements[t]=this.shadowRoot.querySelector(`.${t}`);this._content=this.shadowRoot.querySelector(".content")},m5=new WeakSet,w9=function(t,e,s){(t?[t]:Object.keys(this._props)).forEach(d=>{this._setProps(d,e,s)})},v5=new WeakSet,x9=function(t){let e=this.firstElementChild;for(;e;)e.setAttribute("slot",t),e=e.nextElementSibling};const r7=`<div class="button content">\r
...
`,f5=class f5 extends k{constructor(){super();c(this,g5);c(this,m1);u(this,"_elements",{text:null,prefix:null,suffix:null,button:null});c(this,Y,{});u(this,"_setPropMap",{leftIcon:t=>{r.removeClass(this._elements.prefix,`ooicon-${t} icon`),this._props.leftIcon&&r.addClass(this._elements.prefix,`ooicon-${this._props.leftIcon} icon`)},rightIcon:t=>{r.removeClass(this._elements.suffix,`ooicon-${t} icon`),this._props.rightIcon&&r.addClass(this._elements.suffix,`ooicon-${this._props.rightIcon} icon`)},styles:()=>{},disabled:t=>{r.checkClass(this._elements.button,"disabled",this._props.disabled),r.toggleAttr(this._elements.button,"disabled",this._props.disabled),a(this,g5,y9).call(this,this._props.disabled)},type:t=>{this._props.type||(this._props.type="default"),t&&r.removeClass(this._elements.button,t),r.addClass(this._elements.button,this._props.type)},text:()=>{this.innerHTML.trim()||(this._elements.text.textContent=this._props.text)},skin:()=>{this._useSkin(this._props.skin)},$default:t=>{t==="value"&&(this.value=this._props[t]),r.toggleAttr(this._elements.button,t,this._props[t])}})}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||f5,s||r7,o||i7)}_render(){const t=this;new MutationObserver(function(){var s;a(s=t,m1,D4).call(s)}).observe(this,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),a(this,m1,D4).call(this)}_connected(){}};Y=new WeakMap,g5=new WeakSet,y9=function(t){if(t){h(this,Y,l(this,Y)||{});for(let e in this)e.startsWith("on")&&this[e]&&(l(this,Y)[e]=this[e],this[e]=null);this.style.pointerEvents="none"}else{if(l(this,Y))for(let e in l(this,Y))l(this,Y)[e]&&(this[e]=l(this,Y)[e],l(this,Y)[e]=null);this.style.pointerEvents="auto"}},m1=new WeakSet,D4=function(){this.innerHTML.trim()&&(r.empty(this._elements.text),this._elements.text.insertAdjacentHTML("beforeend",this.innerHTML))},u(f5,"prop",{leftIcon:"",rightIcon:"",styles:"",disabled:!1,text:"",type:"",skin:""});let c5=f5;class m9 extends c5{constructor(){super(),this._init("oo-button")}}const o7=`<div class="content">\r
    <div class="left">\r
        <div class="top">\r
...
</div>`,l7=`*{box-sizing:border-box}.content{display:flex;height:100%;padding:1em;overflow:auto;-webkit-user-select:none;user-select:none}.left{flex:8;display:grid;grid-template-rows:2em 1fr 1.5em}.right{flex:5;height:100%}.top{background-color:var(--oo-color-gray2);height:2em;display:flex;line-height:2em}.middle{flex:1}.bottom{line-height:1em;display:flex;justify-content:space-between}.title{cursor:pointer;color:var(--oo-color-text);font-weight:700;flex:1;padding-left:.8em}.title:hover{color:var(--oo-color-main)}.prev{height:2em;line-height:2em;cursor:pointer;padding-left:1em}.prev:hover{color:var(--oo-color-main)}.next{height:2em;line-height:2em;cursor:pointer;padding-left:1em}.next:hover{color:var(--oo-color-main)}.time{display:flex;height:100%}.timeWithClean{height:calc(100% - 1.5em)}.cleanTime{height:1.5em;text-align:center;color:var(--oo-color-main);cursor:pointer}table{width:100%;height:100%}th{color:var(--oo-color-text);font-weight:700;line-height:2em;height:2em}td{cursor:pointer;text-align:center;color:var(--oo-color-text)}td.other{color:var(--oo-color-text3)}td div{display:flex;justify-content:center}td span{display:block;border:1px solid transparent}.yearContent td span,.monthContent td span{height:2.5em;line-height:2.5em;padding:0 .2em;border-radius:.25em}.dateContent td span{height:1.6em;line-height:1.6em;width:1.6em;border-radius:.25em}td:hover span{border-color:var(--oo-color-over);background-color:var(--oo-color-over)}td.today span{color:var(--oo-color-main);border-color:var(--oo-color-main);background-color:var(--oo-color-bg-white)}td.selected span{color:var(--oo-color-text-white);border-color:var(--oo-color-main);background-color:var(--oo-color-main)}.week-row-over span,.week-row-selected span{border-color:var(--oo-color-over)!important;background-color:var(--oo-color-over)!important}.week-row-selected>td:first-child>div>span{color:var(--oo-color-text-white)!important;border-color:var(--oo-color-main)!important;background-color:var(--oo-color-main)!important}.line{height:100%;width:1em;border-right:1px solid var(--oo-color-gray1)}ul{padding:0;margin:0;list-style:none;overflow:auto;flex:1;min-width:2em}ul::-webkit-scrollbar{display:none;width:0;height:0}li{text-align:center;height:2em;line-height:2em;cursor:pointer;display:flex;justify-content:center}li span{height:1.6em;display:block;line-height:1.6em;width:1.6em;border-radius:.25em;border:1px solid transparent}li:hover span{border-color:var(--oo-color-over);background-color:var(--oo-color-over)}li.selected span{color:var(--oo-color-text-white);border-color:var(--oo-color-main);background-color:var(--oo-color-main)}.week{color:var(--oo-color-main)}.disabled{color:var(--oo-color-text4)!important}.disabled span{border-color:transparent!important;background-color:transparent!important}.today,.clean{color:var(--oo-color-main);cursor:pointer}.hide{display:none}ul::-webkit-scrollbar{display:unset;background-color:transparent;cursor:pointer;width:4px;height:4px}ul::-webkit-scrollbar-thumb{width:4px;border-radius:4px;background-color:var(--oo-color-text3);cursor:pointer}ul::-webkit-scrollbar-thumb:hover{width:4px;border-radius:4px;background-color:var(--oo-color-text2);cursor:pointer}
`,b=class b extends k{constructor(){super();c(this,k1);c(this,M1);c(this,E1);c(this,b5);c(this,p2);c(this,S1);c(this,k2);c(this,T1);c(this,_5);c(this,X2);c(this,w5);c(this,C2);c(this,k4);c(this,G2);c(this,M4);c(this,M2);c(this,e2);c(this,E2);c(this,K2);c(this,J2);c(this,H);c(this,A1);c(this,x5);c(this,S2);c(this,y5);c(this,T2);c(this,k5);c(this,A2);c(this,U,void 0);c(this,b2,void 0);c(this,N,void 0);c(this,X,void 0);c(this,G,void 0);c(this,g,void 0);c(this,y,void 0);c(this,S,void 0);c(this,D,void 0);c(this,T,void 0);c(this,Z,void 0);c(this,P,void 0);c(this,v1,void 0);c(this,g1,void 0);c(this,f1,void 0);c(this,L1,void 0);c(this,b1,void 0);c(this,_1,void 0);c(this,w1,void 0);c(this,V2,void 0);c(this,c2,void 0);c(this,W2,void 0);c(this,_2,void 0);c(this,t2,void 0);c(this,w2,void 0);c(this,x2,void 0);c(this,y2,void 0);c(this,h2,void 0);c(this,Y2,void 0);c(this,x1,void 0);c(this,y1,void 0);c(this,H2,void 0);c(this,q2,void 0);c(this,U2,void 0);u(this,"_elements",{content:null,top:null,title:null,prev:null,next:null,middle:null,bottom:null,left:null,yearContent:null,monthContent:null,dateContent:null,right:null,time:null,hourContent:null,minuteContent:null,secondContent:null,line:null,clean:null,cleanTime:null,today:null});c(this,y4,{});u(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)},view:()=>{this.currentView=this._props.view,this.showView()},value:()=>{this._props.value!==l(this,h2)&&(a(this,M1,j4).call(this),this.showView(),a(this,S1,$4).call(this))},baseDate:()=>{a(this,E1,I4).call(this),this.showView()},yearOnly:()=>{this._changeType()},monthOnly:()=>{this._changeType()},dateOnly:()=>{this._changeType()},weekOnly:()=>{this._changeType()},timeOnly:()=>{this._changeType()},secondEnable:()=>{a(this,p2,d1).call(this),this.setContentEvent()},cleanEnable:()=>{a(this,p2,d1).call(this)},todayEnable:()=>{a(this,p2,d1).call(this)},datetimeRange:()=>{this.setRange()},dateRange:()=>{this.setRange()},timeRange:()=>{this.setRange()},weekBegin:()=>{this.currentView==="date"&&this.showView()},$default:t=>{}});c(this,L5,[t=>this._props.yearOnly&&a(this,K2,W3).call(this,t)&&h(this,y,parseInt(t)||!0),t=>this._props.monthOnly&&a(this,J2,Y3).call(this,t)&&((()=>{const[e,s]=t.split("-");h(this,y,parseInt(e)),h(this,S,parseInt(s)-1)})()||!0),t=>this._props.dateOnly&&a(this,H,a2).call(this,t)&&((()=>{const[e,s,o]=t.split("-");h(this,y,parseInt(e)),h(this,S,parseInt(s)-1),h(this,D,parseInt(o))})()||!0),t=>this._props.weekOnly&&((()=>{const[e,s]=t.split(" ");h(this,y,parseInt(e)),h(this,V2,parseInt(s))})()||!0),t=>this._props.timeOnly&&((()=>{const[e,s,o]=t.split(":");a(this,S2,t5).call(this,e)&&h(this,T,parseInt(e)),a(this,T2,e5).call(this,s)&&h(this,Z,parseInt(s)),o&&a(this,A2,n5).call(this,o)&&h(this,P,parseInt(o))})()||!0),t=>{const e=b.parseDate(t,!0);a(this,H,a2).call(this,e)&&(h(this,y,e.getFullYear()),h(this,S,e.getMonth()),h(this,D,e.getDate())),a(this,S2,t5).call(this,e.getHours())&&h(this,T,e.getHours()),a(this,T2,e5).call(this,e.getMinutes())&&h(this,Z,e.getMinutes()),a(this,A2,n5).call(this,e.getSeconds())&&h(this,P,e.getSeconds())}]);this._initialize("oo-calendar",b,o7,l7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}static parseDate(t,e){return t?v(t)==="date"?e?new Date(t.getTime()):t:new Date(t):null}static antiShake(t,e){let s=null;return o=>{s&&clearTimeout(s),s=setTimeout(t,e)}}_setProps(t,e){const s=this._props[t];e!==s&&(this._setPropMap[t]?this._setPropMap[t](e,s):this._setPropMap.$default(t,e,s))}_render(){this.currentView=a(this,k1,P4).call(this),this.setRange(),a(this,p2,d1).call(this),a(this,E1,I4).call(this),a(this,M1,j4).call(this),this.showView(),a(this,S1,$4).call(this),(!this._props.yearOnly||!this._props.monthOnly||!this._props.dateOnly||!this._props.weekOnly)&&(a(this,T1,z4).call(this),a(this,X2,B3).call(this),a(this,C2,c1).call(this))}_changeType(){this.currentView=a(this,k1,P4).call(this),a(this,p2,d1).call(this),this.setContentEvent(),this.showView()}_setEvent(){this._elements.title.addEventListener("click",()=>{this.changeView()}),this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.today.addEventListener("click",()=>{this.gotoToday()}),this._elements.clean.addEventListener("click",()=>{this.clear()}),this._elements.cleanTime.addEventListener("click",()=>{this.clear()}),this.setContentEvent()}setContentEvent(){this._props.timeOnly||this.setYearEvent(),!this._props.timeOnly&&!this._props.yearOnly&&this.setMonthEvent(),!this._props.timeOnly&&!this._props.yearOnly&&!this._props.monthOnly&&(this._props.weekOnly?this.setWeekEvent():this.setDateEvent()),!this._props.yearOnly&&!this._props.monthOnly&&!this._props.dateOnly&&!this._props.weekOnly&&(this.setHourEvent(),this.setMinuteEvent(),this._props.secondEnable&&this.setSecondEvent())}getDate(){const t=d2(l(this,g));return v(l(this,y))!=="null"&&t.setFullYear(l(this,y)),v(l(this,S))!=="null"&&t.setMonth(l(this,S)),v(l(this,D))!=="null"&&t.setDate(l(this,D)),t.setHours(l(this,T)||0),t.setMinutes(l(this,Z)||0),t.setSeconds(l(this,P)||0),t}getSelectedDate(){return v(l(this,y))!=="null"&&v(l(this,S))!=="null"&&v(l(this,D))!=="null"?new Date(l(this,y),l(this,S),l(this,D)):null}selectDate(t){const e=t.parentNode.parentNode.querySelector("td.selected");e&&r.removeClass(e,"selected"),r.addClass(t,"selected"),this.dispatchChangeEvent()}selectTime(t){const e=t.parentNode.querySelector("li.selected");e&&r.removeClass(e,"selected"),r.addClass(t,"selected"),this.dispatchChangeEvent()}getDefaultFormat(){return this._props.yearOnly&&"YYYY"||this._props.monthOnly&&"YYYY-MM"||this._props.dateOnly&&"YYYY-MM-DD"||this._props.weekOnly&&"YYYY ww"||this._props.timeOnly&&(this._props.secondEnable?"HH:mm:ss":"HH:mm")||"YYYY-MM-DD HH:mm:ss"}dispatchChangeEvent(){const t=this.getDate(),e=this._props.format||this.getDefaultFormat();h(this,h2,R(t,e)),this.dispatchEvent(new CustomEvent("change",{detail:{date:t,value:l(this,h2)}}))}dispatchWeekEvent(t,e,s){const o=this._props.format||this.getDefaultFormat(),d=b.parseDate(e),p=b.parseDate(s);h(this,h2,R(d,o)),this.dispatchEvent(new CustomEvent("change",{detail:{date:d,value:l(this,h2),startDate:d,endDate:p,weekNumber:t}}))}clear(){h(this,y,null),h(this,S,null),h(this,D,null),h(this,T,null),h(this,Z,null),h(this,P,null);var t=this._elements.content.querySelectorAll(".selected");t.forEach(e=>{r.removeClass(e,"selected")}),this.dispatchEvent(new CustomEvent("change",{detail:{date:null,value:""}}))}gotoToday(){const t=new Date;l(this,g).setFullYear(t.getFullYear()),l(this,g).setMonth(t.getMonth()),l(this,g).setDate(t.getDate()),this.showView()}gotoPrev(){switch(this.currentView){case"year":z(l(this,g),"year",-16),this.changeViewToYear();break;case"month":z(l(this,g),"year",-1),this.changeViewToMonth();break;case"date":z(l(this,g),"month",-1),this.changeViewToDate();break;case"week":z(l(this,g),"month",-1),this.changeViewToWeek();break}}gotoNext(){switch(this.currentView){case"year":z(l(this,g),"year",16),this.changeViewToYear();break;case"month":z(l(this,g),"year",1),this.changeViewToMonth();break;case"date":z(l(this,g),"month",1),this.changeViewToDate();break;case"week":z(l(this,g),"month",1),this.changeViewToWeek();break}}setTitle(t){let e;switch(this.currentView){case"year":t&&(this._elements.title.textContent=t);return;case"month":e={year:"numeric"};break;case"date":case"week":e={year:"numeric",month:"long"};break;default:e={year:"numeric",month:"long",day:"numeric"}}this._elements.title.textContent=new Intl.DateTimeFormat("zh-CN",e).format(l(this,g))}showView(){switch(this.currentView){case"year":this.changeViewToYear();break;case"month":this.changeViewToMonth();break;case"date":this.setWeekTitle(),this.changeViewToDate();break;case"week":this.setWeekTitle(),this.changeViewToWeek();break}}changeView(){switch(this.currentView){case"date":case"week":this.changeViewToMonth();break;case"month":this.changeViewToYear();break;case"year":if(this._props.yearOnly)break;this._props.monthOnly?this.changeViewToMonth():this._props.weekOnly?this.changeViewToWeek():this.changeViewToDate();break}}changeViewToYear(t){this.currentView="year",a(this,k2,K1).call(this,"year"),this.setYearContent(t)}setYearContent(){this.setYearEvent();const t=this._elements.yearContent.querySelectorAll("td"),e=new Date().getFullYear(),s=l(this,y),o=l(this,g).getFullYear();let d=new Date(o,1,1);d.setFullYear(d.getFullYear()-2);const p=d.getFullYear();d.setFullYear(d.getFullYear()+t.length-1);const C=d.getFullYear();this.setTitle(p+"-"+C),t.forEach((m,f)=>{const _=p+f;m.querySelector("span").textContent=_,m.dataset.year=_.toString(),r.checkClass(m,"selected",s===_),r.checkClass(m,"today",e===_),this._props.enableYear&&r.checkClass(m,"disabled",!a(this,K2,W3).call(this,_))})}setYearEvent(){l(this,v1)||(this._elements.yearContent.querySelectorAll("td").forEach(t=>{t.addEventListener("click",()=>{let e=t.dataset.year;a(this,K2,W3).call(this,e)&&(l(this,g).setFullYear(e),this._props.yearOnly?(h(this,y,parseInt(e)),this.selectDate(t)):this.changeViewToMonth())})}),h(this,v1,!0))}changeViewToMonth(){this.currentView="month",this.setTitle(),a(this,k2,K1).call(this,"month"),this.setMonthContent()}setMonthContent(){const t=new Date().getFullYear(),e=new Date().getMonth(),s=l(this,y),o=l(this,S),d=l(this,g).getFullYear();this._elements.monthContent.querySelectorAll("td").forEach((C,m)=>{if(C.querySelector("span").textContent=this._props.months[m].substr(0,2),C.dataset.year=d.toString(),C.dataset.month=(m+1).toString(),r.checkClass(C,"selected",s===d&&o===m),r.checkClass(C,"today",t===d&&e===m),l(this,_2)){const f=C.dataset.month;r.checkClass(C,"disabled",!a(this,J2,Y3).call(this,d+"-"+f))}})}setMonthEvent(){l(this,g1)||(this._elements.monthContent.querySelectorAll("td").forEach(t=>{t.addEventListener("click",()=>{let e=t.dataset.year,s=t.dataset.month;a(this,J2,Y3).call(this,e+"-"+s)&&(l(this,g).setFullYear(e),l(this,g).setMonth(parseInt(s)-1),this._props.monthOnly?(h(this,y,parseInt(e)),h(this,S,parseInt(s)-1),this.selectDate(t)):this._props.weekOnly?this.changeViewToWeek(e,s):this.changeViewToDate(e,s))})}),h(this,g1,!0))}changeViewToDate(){this.currentView="date",this.setTitle(),a(this,k2,K1).call(this,"date"),this.setDateContent()}setWeekTitle(){this._elements.dateContent.querySelectorAll("th").forEach((e,s)=>{s===0?r.checkClass(e,"hide",!this._props.weekOnly):e.textContent=this._props.daysTitles[(s-1+this._props.weekBegin)%7]})}setDateContent(){const t=j(new Date).getTime(),e=this.getSelectedDate(),s=e?e.getTime():null,o=j(l(this,g),!0);o.setDate(1);const d=d2(o),p=(7+d.getDay()+1-this._props.weekBegin)%7;d.setDate(d.getDate()-p),this._elements.dateContent.querySelectorAll("td").forEach((m,f)=>{f%8!==0&&(d.setDate(d.getDate()+1),m.querySelector("span").textContent=d.getDate().toString(),m.dataset.dateValue=R(d,"YYYY-MM-DD"),r.checkClass(m,"selected",d.getTime()===s),r.checkClass(m,"today",d.getTime()===t),r.checkClass(m,"other",d.getMonth()!==l(this,g).getMonth()),l(this,t2)&&r.checkClass(m,"disabled",!a(this,H,a2).call(this,d)))})}setDateEvent(){l(this,f1)||(this._elements.dateContent.querySelectorAll("td").forEach((t,e)=>{e%8!==0&&t.addEventListener("click",()=>{let s=t.dataset.dateValue;if(a(this,H,a2).call(this,s)){const o=s.split("-");l(this,g).setFullYear(o[0]),l(this,g).setMonth(parseInt(o[1])-1),l(this,g).setDate(o[2]),h(this,y,parseInt(o[0])),h(this,S,parseInt(o[1])-1),h(this,D,parseInt(o[2])),this._props.dateOnly||(a(this,T1,z4).call(this),a(this,X2,B3).call(this),a(this,C2,c1).call(this)),this.selectDate(t)}})}),h(this,f1,!0))}changeViewToWeek(){this.currentView="week",this.setTitle(),a(this,k2,K1).call(this,"week"),this.setWeekContent()}setWeekContent(){const t=j(new Date).getTime(),e=j(l(this,g),!0);e.setDate(1);const s=d2(e),o=(7+s.getDay()+1-this._props.weekBegin)%7;s.setDate(s.getDate()-o),this._elements.dateContent.querySelectorAll("td").forEach((p,C)=>{if(C%8===0){const m=d2(s);m.setDate(m.getDate()+1);const f=m.getFullYear(),_=C9(m,this._props.weekBegin);p.querySelector("span").textContent=_,p.parentNode.dataset.weekNumber=_,p.parentNode.dataset.year=f,r.removeClass(p,"hide"),r.checkClass(p.parentNode,"week-row-selected",f===l(this,y)&&_===l(this,V2))}else s.setDate(s.getDate()+1),p.querySelector("span").textContent=s.getDate().toString(),p.dataset.dateValue=R(s,"YYYY-MM-DD"),r.checkClass(p,"today",s.getTime()===t),r.checkClass(p,"other",s.getMonth()!==l(this,g).getMonth()),l(this,t2)&&r.checkClass(p,"disabled",!a(this,H,a2).call(this,s))})}setWeekEvent(){l(this,w1)||(this._elements.dateContent.querySelectorAll("tr").forEach((t,e)=>{t.addEventListener("mouseenter",()=>{if(l(this,c2)){const s=t.querySelector("td:nth-child(2)").dataset.dateValue,o=t.querySelector("td:last-child").dataset.dateValue;a(this,A1,R4).call(this,s,o)&&r.addClass(t,"week-row-over")}else r.addClass(t,"week-row-over")}),t.addEventListener("mouseleave",()=>{r.removeClass(t,"week-row-over")}),t.addEventListener("click",()=>{const s=t.querySelector("td:nth-child(2)").dataset.dateValue,o=t.querySelector("td:last-child").dataset.dateValue;l(this,c2)?a(this,A1,R4).call(this,s,o)&&this.selectWeek(t,s,o):this.selectWeek(t,s,o)})}),h(this,w1,!0))}selectWeek(t,e,s){const o=t.parentNode.querySelector("tr.week-row-selected");o&&r.removeClass(o,"week-row-selected"),r.addClass(t,"week-row-selected");const[d,p,C]=e.split("-");l(this,g).setFullYear(d),l(this,g).setMonth(parseInt(p)-1),l(this,g).setDate(C),h(this,y,parseInt(d)),h(this,S,parseInt(p)-1),h(this,D,parseInt(C));const m=t.dataset.weekNumber;h(this,V2,parseInt(m)),this.dispatchWeekEvent(m,e,s)}setHourEvent(){if(l(this,L1))return;const t=b.antiShake(()=>{l(this,H2)||a(this,G2,V3).call(this,this._elements.hourContent),h(this,H2,!1)},100);this._elements.hourContent.addEventListener("scroll",()=>{t()}),this._elements.hourContent.querySelectorAll("li").forEach((e,s)=>{const o=s.toString().padStart(2,"0");e.dataset.hour=o,e.addEventListener("click",()=>{a(this,S2,t5).call(this,o)&&(l(this,g).setHours(o),h(this,T,parseInt(o)),a(this,X2,B3).call(this),a(this,C2,c1).call(this),this.selectTime(e))})}),h(this,L1,!0)}setMinuteEvent(){if(l(this,b1))return;const t=b.antiShake(()=>{l(this,q2)||a(this,G2,V3).call(this,this._elements.minuteContent),h(this,q2,!1)},100);this._elements.minuteContent.addEventListener("scroll",()=>{t()}),this._elements.minuteContent.querySelectorAll("li").forEach((e,s)=>{const o=s.toString().padStart(2,"0");e.dataset.minute=o,e.addEventListener("click",()=>{a(this,T2,e5).call(this,o)&&(l(this,g).setMinutes(o),h(this,Z,parseInt(o)),a(this,C2,c1).call(this),this.selectTime(e))})}),h(this,b1,!0)}setSecondEvent(){if(l(this,_1))return;const t=b.antiShake(()=>{l(this,U2)||a(this,G2,V3).call(this,this._elements.secondContent),h(this,U2,!1)},100);this._elements.secondContent.addEventListener("scroll",()=>{t()}),this._elements.secondContent.querySelectorAll("li").forEach((e,s)=>{const o=s.toString().padStart(2,"0");e.dataset.second=o,e.addEventListener("click",()=>{a(this,A2,n5).call(this,o)&&(l(this,g).setSeconds(o),h(this,P,parseInt(o)),this.selectTime(e))})}),h(this,_1,!0)}setRange(){h(this,W2,null),h(this,_2,null),h(this,t2,null),h(this,c2,null),h(this,w2,null),h(this,x2,null),h(this,y2,null),this._props.datetimeRange&&this._props.datetimeRange.length?(h(this,Y2,B2(`return ${this._props.datetimeRange}`)),this.setDatetimeRange()):(this._props.dateRange&&this._props.dateRange.length&&(h(this,x1,B2(`return ${this._props.dateRange}`)),this.setDateRange()),this._props.timeRange&&this._props.timeRange.length&&(h(this,y1,B2(`return ${this._props.timeRange}`)),this.setTimeRange()))}setDatetimeRange(){const t=l(this,Y2),e=v(t[0])!=="array"?[t]:t;!e[0][0]&&!e[0][1]||(this.setDateRange(l(this,Y2)),h(this,X,e.map(s=>[b.parseDate(s[0]),b.parseDate(s[1])])),h(this,G,e.map(s=>[j(s[0],!0),j(s[1],!0)])),h(this,w2,s=>{if(!s)return[0,23];const o=j(s,!0),d=[];for(let p=0;p<l(this,G).length;p++){const C=l(this,G)[p],m=a(this,e2,$2).call(this,C[0],o),f=a(this,e2,$2).call(this,o,C[1]);(m||f)&&d.push([m?l(this,X)[p][0].getHours():0,f?l(this,X)[p][1].getHours():23])}return d.length?b.RangeArrayUtils.union(d):[0,23]}),h(this,x2,(s,o)=>{if(!s)return[0,59];const d=j(s,!0),p=[];for(let C=0;C<l(this,G).length;C++){const m=l(this,G)[C],f=l(this,X)[C],_=a(this,e2,$2).call(this,m[0],d)&&o===f[0].getHours(),I2=a(this,e2,$2).call(this,d,m[1])&&o===f[1].getHours();(_||I2)&&p.push([_?f[0].getMinutes():0,I2?f[1].getMinutes():59])}return p.length?b.RangeArrayUtils.union(p):[0,59]}),h(this,y2,(s,o,d)=>{if(!s)return[0,59];const p=j(s,!0),C=[];for(let m=0;m<l(this,G).length;m++){const f=l(this,G)[m],_=l(this,X)[m],I2=a(this,e2,$2).call(this,f[0],p)&&o===_[0].getHours()&&d===_[0].getMinutes(),N3=a(this,e2,$2).call(this,p,f[1])&&o===_[1].getHours()&&d===_[1].getMinutes();(I2||N3)&&C.push([I2?_[0].getSeconds():0,N3?_[1].getSeconds():59])}return C.length?b.RangeArrayUtils.union(C):[0,59]}))}setDateRange(t=l(this,x1)){const e=v(t[0])!=="array"?[t]:t;!e[0][0]&&!e[0][1]||(h(this,N,e.map(s=>[j(s[0],!0),Q8(s[1],!0)])),h(this,W2,s=>{const o=new Date(s+"-01-01"),d=new Date(s+"-12-31");for(let p=0;p<l(this,N).length;p++){const C=l(this,N)[p];if(b.RangeArrayUtils.isIntersection(C,[o,d]))return!0}return!1}),h(this,_2,s=>{const o=new Date(s+"-01"),d=J8(...s.split("-"));for(let p=0;p<l(this,N).length;p++){const C=l(this,N)[p];if(b.RangeArrayUtils.isIntersection(C,[o,d]))return!0}return!1}),h(this,t2,s=>{const o=j(s,!0);for(let d=0;d<l(this,N).length;d++){const p=l(this,N)[d];if(!p[0]&&a(this,M2,J1).call(this,o,p[1])||!p[1]&&a(this,M2,J1).call(this,p[0],o)||a(this,M2,J1).call(this,p[0],o)&&a(this,M2,J1).call(this,o,p[1]))return!0}return!1}),h(this,c2,(s,o)=>{do{if(l(this,t2).call(this,s))return!0;s=s.setDate(s.getDate()+1)}while(s<=o);return!1}))}setTimeRange(){const t=l(this,y1),e=v(t[0])!=="array"?[t]:t;!e[0][0]&&!e[0][1]||(h(this,U,e.map(s=>[s[0]?new Date("2020-01-01 "+s[0]):null,s[1]?new Date("2020-01-01 "+s[1]):null])),h(this,w2,s=>{if(l(this,b2))return l(this,b2);const o=[];for(let d=0;d<l(this,U).length;d++){const p=l(this,U)[d];o.push([p[0]?p[0].getHours():0,p[1]?p[1].getHours():23])}return h(this,b2,b.RangeArrayUtils.union(o)),l(this,b2)}),h(this,x2,(s,o)=>{const d=[];for(let p=0;p<l(this,U).length;p++){const C=l(this,U)[p],m=C[0]&&o===C[0].getHours(),f=C[1]&&o===C[1].getHours();(m||f)&&d.push([m?C[0].getMinutes():0,f?C[1].getMinutes():59])}return d.length?b.RangeArrayUtils.union(d):[0,59]}),h(this,y2,(s,o,d)=>{const p=[];for(let C=0;C<l(this,U).length;C++){const m=l(this,U)[C],f=m[0]&&o===m[0].getHours()&&d===m[0].getMinutes(),_=m[1]&&o===m[1].getHours()&&d===m[1].getMinutes();(f||_)&&p.push([f?m[0].getSeconds():0,_?m[1].getSeconds():59])}return p.length?b.RangeArrayUtils.union(p):[0,59]}))}};U=new WeakMap,b2=new WeakMap,N=new WeakMap,X=new WeakMap,G=new WeakMap,g=new WeakMap,y=new WeakMap,S=new WeakMap,D=new WeakMap,T=new WeakMap,Z=new WeakMap,P=new WeakMap,v1=new WeakMap,g1=new WeakMap,f1=new WeakMap,L1=new WeakMap,b1=new WeakMap,_1=new WeakMap,w1=new WeakMap,V2=new WeakMap,c2=new WeakMap,W2=new WeakMap,_2=new WeakMap,t2=new WeakMap,w2=new WeakMap,x2=new WeakMap,y2=new WeakMap,h2=new WeakMap,Y2=new WeakMap,x1=new WeakMap,y1=new WeakMap,H2=new WeakMap,q2=new WeakMap,U2=new WeakMap,y4=new WeakMap,k1=new WeakSet,P4=function(){return this._props.yearOnly&&"year"||this._props.monthOnly&&"month"||this._props.dateOnly&&"date"||this._props.weekOnly&&"week"||this._props.timeOnly&&"time"||this._props.view},L5=new WeakMap,M1=new WeakSet,j4=function(){if(!this._props.value)return;const t=v(this._props.value)==="date"?R(this._props.value,this.getDefaultFormat()):this._props.value;l(this,L5).some(e=>e(t)),isNaN(l(this,y))||l(this,g).setFullYear(l(this,y)),isNaN(l(this,S))||l(this,g).setMonth(l(this,S)),isNaN(l(this,D))||l(this,g).setDate(l(this,D)),isNaN(l(this,T))||l(this,g).setHours(l(this,T)),isNaN(l(this,Z))||l(this,g).setMinutes(l(this,Z)),isNaN(l(this,P))||l(this,g).setSeconds(l(this,P))},E1=new WeakSet,I4=function(){h(this,g,a(this,b5,k9).call(this))},b5=new WeakSet,k9=function(){var t,e;if(this._props.baseDate&&a(this,H,a2).call(this,this._props.baseDate))return b.parseDate(this._props.baseDate,!0);if(a(this,H,a2).call(this,new Date))return new Date;if((t=this._props)!=null&&t.datetimeRange.length)return d2(l(this,X)[0][0]||l(this,X)[0][1]);if((e=this._props)!=null&&e.dateRange.length)return d2(l(this,N)[0][0]||l(this,N)[0][1])},p2=new WeakSet,d1=function(){r.checkClass(this._elements.left,"hide",this._props.timeOnly),r.checkClass(this._elements.yearContent,"hide",this.currentView!=="year"),r.checkClass(this._elements.monthContent,"hide",this.currentView!=="month"),r.checkClass(this._elements.dateContent,"hide",this.currentView!=="date"),r.checkClass(this._elements.right,"hide",this._props.yearOnly||this._props.monthOnly||this._props.dateOnly||this._props.weekOnly),r.checkClass(this._elements.time,"timeWithClean",this._props.cleanEnable&&this._props.timeOnly),r.checkClass(this._elements.secondContent,"hide",!this._props.secondEnable),r.checkClass(this._elements.line,"hide",this._props.yearOnly||this._props.monthOnly||this._props.dateOnly||this._props.weekOnly||this._props.timeOnly),r.checkClass(this._elements.clean,"hide",!this._props.cleanEnable),r.checkClass(this._elements.cleanTime,"hide",!this._props.cleanEnable||!this._props.timeOnly),r.checkClass(this._elements.today,"hide",!this._props.todayEnable||!a(this,H,a2).call(this,new Date))},S1=new WeakSet,$4=function(){a(this,_5,M9).call(this),a(this,w5,E9).call(this),a(this,C2,c1).call(this)},k2=new WeakSet,K1=function(t){r.checkClass(this._elements.yearContent,"hide",t!=="year"),r.checkClass(this._elements.monthContent,"hide",t!=="month"),r.checkClass(this._elements.dateContent,"hide",!["date","week"].includes(t))},T1=new WeakSet,z4=function(){this._elements.hourContent.querySelectorAll("li").forEach((t,e)=>{const s=a(this,S2,t5).call(this,e);r.checkClass(t,"disabled",!s),!s&&l(this,T)===e&&(h(this,T,null),r.removeClass(t,"selected"))})},_5=new WeakSet,M9=function(){this._elements.hourContent.querySelectorAll("li").forEach((t,e)=>{r.checkClass(t,"selected",l(this,T)===e),l(this,T)===e&&setTimeout(()=>{e!==0&&h(this,H2,!0),t.scrollIntoView({block:"start"})},100)})},X2=new WeakSet,B3=function(){this._elements.minuteContent.querySelectorAll("li").forEach((t,e)=>{const s=a(this,T2,e5).call(this,e);r.checkClass(t,"disabled",!s),!s&&l(this,Z)===e&&(h(this,Z,null),r.removeClass(t,"selected"))})},w5=new WeakSet,E9=function(){this._elements.minuteContent.querySelectorAll("li").forEach((t,e)=>{r.checkClass(t,"selected",l(this,Z)===e),l(this,Z)===e&&setTimeout(()=>{e!==0&&h(this,q2,!0),t.scrollIntoView({block:"start"})},100)})},C2=new WeakSet,c1=function(){this._props.secondEnable&&this._elements.secondContent.querySelectorAll("li").forEach((t,e)=>{const s=a(this,A2,n5).call(this,e);r.checkClass(t,"disabled",!s),!s&&l(this,P)===e&&(h(this,P,null),r.removeClass(t,"selected"))})},k4=new WeakSet,s6=function(){this._props.secondEnable&&this._elements.secondContent.querySelectorAll("li").forEach((t,e)=>{r.checkClass(t,"selected",l(this,P)===e),l(this,P)===e&&setTimeout(()=>{e!==0&&h(this,U2,!0),t.scrollIntoView({block:"start"})},100)})},G2=new WeakSet,V3=function(t){const e=t.querySelector("li"),s=r.getSize(e).y;t.scrollTop%s<s/2?t.scrollTop=Math.floor(t.scrollTop/s)*s:t.scrollTop=Math.ceil(t.scrollTop/s)*s},M4=new WeakSet,r6=function(t,e){return t>e||t-e===0},M2=new WeakSet,J1=function(t,e){return t<e||t-e===0},e2=new WeakSet,$2=function(t,e){return t-e===0},E2=new WeakSet,Q1=function(t,...e){return!t||v(t)!=="function"||t(...e)},K2=new WeakSet,W3=function(t){return a(this,E2,Q1).call(this,l(this,W2),t)},J2=new WeakSet,Y3=function(t){return a(this,E2,Q1).call(this,l(this,_2),t)},H=new WeakSet,a2=function(t){return a(this,E2,Q1).call(this,l(this,t2),b.parseDate(t))},A1=new WeakSet,R4=function(t,e){return a(this,E2,Q1).call(this,l(this,c2),b.parseDate(t),b.parseDate(e))},x5=new WeakSet,S9=function(t){const e=l(this,w2);return e&&v(e)==="function"?e(b.parseDate(t)):[0,23]},S2=new WeakSet,t5=function(t,e){t=parseInt(t);const s=a(this,x5,S9).call(this,e||this.getSelectedDate());if(!s||!s.length||s[0]===0&&s[1]===23)return!0;if(v(s[0])==="array")for(let o=0;o<s.length;o++){const d=s[o];if(d[0]<=t&&t<=d[1])return!0}else if(s[0]<=t&&t<=s[1])return!0;return!1},y5=new WeakSet,T9=function(t,e){const s=l(this,x2);return s&&v(s)==="function"?s(b.parseDate(t),e):[0,59]},T2=new WeakSet,e5=function(t,e=l(this,T),s){t=parseInt(t);const o=a(this,y5,T9).call(this,s||this.getSelectedDate(),e);if(!o||!o.length||o[0]===0&&o[1]===59)return!0;if(v(o[0])==="array")for(let d=0;d<o.length;d++){const p=o[d];if(p[0]<=t&&t<=p[1])return!0}else if(o[0]<=t&&t<=o[1])return!0;return!1},k5=new WeakSet,A9=function(t,e,s){const o=l(this,y2);return o&&v(o)==="function"?o(b.parseDate(t),e,s):[0,59]},A2=new WeakSet,n5=function(t,e=l(this,Z),s=l(this,T),o){t=parseInt(t);const d=a(this,k5,A9).call(this,o||this.getSelectedDate(),s,e);if(!d||!d.length||d[0]===0&&d[1]===59)return!0;if(v(d[0])==="array")for(let p=0;p<d.length;p++){const C=d[p];if(C[0]<=t&&t<=C[1])return!0}else if(d[0]<=t&&t<=d[1])return!0;return!1},u(b,"prop",{view:"datetime",baseDate:null,yearOnly:!1,monthOnly:!1,dateOnly:!1,weekOnly:!1,timeOnly:!1,secondEnable:!0,cleanEnable:!0,todayEnable:!0,datetimeRange:"",dateRange:"",timeRange:"",value:"",format:"",weekBegin:1,months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],daysTitles:["日","一","二","三","四","五","六"],clean:"清除",year:"年",month:"月",date:"日",hour:"时",minute:"分",second:"秒",week:"周"});let C1=b;C1.RangeArrayUtils={complementary(n,i,t){if(!n)return n;const e=this.getRangeObject(n);if(!i||i.length===0)return this.parse([e],t);const s=this.union(i),o={};if(s[0][0]>e.start)o.start=e.start;else if(e.end>s[0][1])o.start=s[0][1],s.shift();else return[];const d=[];for(;s.length>0;){if(s[0][0]>=e.end)return o.end=e.end,d.push({...o}),this.parse(d,t);if(e.end<=s[0][1])return o.end=s[0][0],d.push({...o}),this.parse(d,t);o.end=s[0][0],d.push({...o}),o.start=s[0][1],s.shift()}return o.end=e.end,d.push({...o}),this.parse(d,t)},union(n,i){if(!n||n.length===0)return n;const t=n.map(d=>this.getRangeObject(d)).sort((d,p)=>d.start-p.start),e=[];let s=t.shift(),o;for(;t.length>0;)o=t.shift(),this.isIntersection(s,o)?s.end=Math.max(s.end,o.end):(e.push({...s}),s=o);return o?this.isIntersection(s,o)?(s.end=Math.max(s.end,o.end),e.push({...s})):e.push({...s}):e.push({...s}),this.parse(e,i)},intersection(n,i){if(!n||n.length===0)return n;if(n.length===1)return n[1];const t=n.map(s=>this.getRangeObject(s)).sort((s,o)=>s.start-o.start),e=t.shift();for(;t.length>0;){const s=t.shift();if(this.isIntersection(e,s))e.start=s.start,e.end=Math.min(e.end,s.end);else return[]}return i&&i==="date"?[new Date(e.start),new Date(e.end)]:[e.start,e.end]},isIntersection(n,i){const t=v(n)==="object"?n:this.getRangeObject(n),e=v(i)==="object"?i:this.getRangeObject(i);return!(t.start>e.end||e.start>t.end)},parse(n,i){return n.map(t=>i&&i==="date"?[new Date(t.start),new Date(t.end)]:[t.start,t.end])},getRangeObject(n){if(n[0]&&n[1])return{start:Math.min(n[0],n[1]),end:Math.max(n[0],n[1])};if(!n[0]&&n[1])return{start:-1/0,end:n[1]};if(n[0]&&!n[1])return{start:n[0],end:1/0}}};const a7=`<div class="content">\r
    <div class="top">\r
...
`;customElements.get("oo-calendar")||customElements.define("oo-calendar",C1);const c7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    /*display: contents;*/\r
...
`,M5=class M5 extends k{constructor(){super();u(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},isShow:()=>{this._props.isShow&&window.setTimeout(()=>{this.show()},10)}});c(this,u2,null);c(this,m2,null);c(this,v2,null)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||M5,s||h7,o||c7)}_setEvent(){super._setEvent(),this.shadowRoot.addEventListener("mousedown",t=>{t.stopPropagation()})}show(t,e){!l(this,u2)&&!l(this,m2)&&(h(this,u2,Object.assign({},{scale:0},t)),h(this,m2,Object.assign({},{scale:1},e)),r.setStyles(this,{scale:0}),r.addClass(this,"show"),window.setTimeout(()=>{r.addClass(this,"transition"),r.setStyles(this,{scale:1})},10),window.setTimeout(()=>{this.dispatchEvent(new Event("show"))},210),this._addHideEvent(),this.isHide=!1)}_addHideEvent(){l(this,v2)||h(this,v2,()=>{this.hide()}),document.addEventListener("mousedown",l(this,v2))}hide(){l(this,u2)&&l(this,m2)&&!this.isHide&&(r.setStyles(this,l(this,u2)),window.setTimeout(()=>{r.removeClass(this,"transition"),r.removeClass(this,"show"),r.setStyles(this,l(this,m2)??{}),h(this,m2,null),h(this,u2,null),this._afterHide(),this.dispatchEvent(new Event("hide"))},200),this._removeHideEvent(),this.isHide=!0)}_afterHide(){}_removeHideEvent(){l(this,v2)&&document.removeEventListener("mousedown",l(this,v2))}};u2=new WeakMap,m2=new WeakMap,v2=new WeakMap,u(M5,"prop",{css:"",cssLink:"",skin:"",isShow:!1});let t4=M5;class e4 extends t4{constructor(){super(),this._init("oo-menu",e4)}}customElements.get("oo-menu")||customElements.define("oo-menu",e4);const p7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
...
`,E5=class E5 extends k{constructor(){super();u(this,"_elements",{});u(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},label:()=>{switch(this._props.type){case"command":this._elements.label&&(this._elements.label.textContent=this._props.label);break;case"checkbox":case"radio":this._elements.input&&(this._elements.input.text=this._props.label);break}},disabled:()=>{switch(r.removeClass(this._content,"disabled"),r.addClass(this._content,"enabled"),this._props.type){case"command":this._props.disabled&&(r.removeClass(this._content,"enabled"),r.addClass(this._content,"disabled"));break;case"checkbox":case"radio":this._elements.input.disabled=this._props.disabled,this._props.disabled&&r.removeClass(this._content,"enabled");break}},icon:t=>{this._elements.icon&&(r.removeClass(this._elements.icon,`ooicon-${t}`),this._props.icon&&r.addClass(this._elements.icon,`ooicon-${this._props.icon}`))},radiogroup:t=>{this._elements.radio&&(this._elements.radio.name=this._props.radiogroup)},type:t=>{t!==null&&t!==this._props.type&&this._renderItem()}});this._initialize("oo-menu-item",E5,C7,p7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_setEvent(){super._setEvent(),this.addEventListener("click",()=>{if(this.type==="command"){const t=r.getParent(this,"oo-menu");t&&t.hide()}})}_connected(){this.getAttribute("type")||this.setAttribute("type","command"),r.getParent(this,"oo-menu")&&this.setAttribute("slot","items"),this._renderItem()}_renderItem(){switch(r.empty(this),this._elements.icon=null,this._elements.label=null,this._elements.input=null,this._elements.hr=null,this.checkbox=null,this.radio=null,r.addClass(this._content,"enabled"),this._props.type){case"command":this._elements.icon=r("div.icon",{slot:"item"}),this._elements.label=r("div.label",{text:this._props.label,slot:"item"}),this._props.icon&&r.addClass(this._elements.icon,`ooicon-${this._props.icon}`),this.append(this._elements.icon),this.append(this._elements.label);break;case"checkbox":this._elements.input=r("oo-checkbox",{slot:"item"}),this.append(this._elements.input),this._elements.input.text=this._props.label,this.checkbox=this._elements.input;break;case"radio":this._elements.input=r("oo-radio",{slot:"item"}),this.append(this._elements.input),this._elements.input.text=this._props.label,this._elements.input.name=this._props.radiogroup,this.radio=this._elements.input;break;case"hr":this._elements.hr=r("hr",{slot:"item"}),this.append(this._elements.hr),r.removeClass(this._content,"enabled");break}}};u(E5,"prop",{css:"",cssLink:"",skin:"",icon:"",label:"",type:"command",disabled:!1,checked:!1,radiogroup:""});let n4=E5;customElements.get("oo-menu-item")||customElements.define("oo-menu-item",n4);class u7{constructor(i,t){c(this,S5);c(this,T5);c(this,A5);c(this,O5);u(this,"options",{css:"",cssLink:"",skin:""});this.options=Object.assign(this.options,t),this.target=i,this.container=this.options.container||r.getOffsetParent(i),this.area=this.options.area;const e=this.options.event||"click";this.target.addEventListener(e,()=>{this.show()}),this.target.addEventListener("mousedown",s=>{})}show(){this.menu||a(this,S5,O9).call(this),a(this,O5,D9).call(this),this.menu.show()}hide(){this.menu.hide()}destroy(){this.menu.remove()}}S5=new WeakSet,O9=function(){var i;this.menu=r("oo-menu",(i=this.options)==null?void 0:i.attr),this.container.append(this.menu),this.options.items&&this.options.items.length&&a(this,T5,Z9).call(this),this.options.class&&r.addClass(this.menu,this.options.class)},T5=new WeakSet,Z9=function(){this.options.items.forEach(i=>{a(this,A5,F9).call(this,i)})},A5=new WeakSet,F9=function(i){const t=document.createElement("oo-menu-item");this.menu.append(t),i==="-"?t.setAttribute("type","hr"):(Object.keys(i).forEach(e=>{e!=="command"?t.setAttribute(L(e),i[e]):t.addEventListener("click",i.command)}),t.addEventListener("click",e=>{this.menu.dispatchEvent(new CustomEvent("command",{detail:i}))}))},O5=new WeakSet,D9=function(){const i=r.getSize(this.target),t=r.getPosition(this.target,this.container),e=r.getSize(this.menu);let s=t.y+i.y,o=t.x,d="left",p="top";if(this.area){const C=r.getSize(this.area),m=r.getPosition(this.container,this.area);m.x+o+e.x>C.x&&(o=o-e.x+i.x,d="right"),m.y+s+e.y>C.y&&(s=s-e.y-i.y,p="bottom")}r.setStyles(this.menu,{top:s+"px",left:o+"px","transform-origin":`${d} ${p}`})};class m7 extends u7{constructor(t,e){super(t,e);c(this,Z5);c(this,F5);c(this,D5);c(this,O2,null);c(this,E4,null);c(this,S4,null);u(this,"options",{css:"",cssLink:"",skin:"",view:"date",baseDate:null,yearOnly:!1,monthOnly:!1,dateOnly:!1,timeOnly:!1,weekOnly:!1,secondEnable:!0,cleanEnable:!1,todayEnable:!0,datetimeRange:"",dateRange:"",timeRange:"",format:"",weekBegin:1,value:""});this.options=Object.assign(this.options,e)}reset(t){if(this.options=Object.assign(this.options,t),this.calendar)for(let e in this.options)v(this.options[e])!=="null"&&this.calendar.setAttribute(L(e),this.options[e])}show(){this.menu||a(this,Z5,P9).call(this),a(this,D5,I9).call(this),this.menu.show()}}O2=new WeakMap,E4=new WeakMap,S4=new WeakMap,Z5=new WeakSet,P9=function(){var t;this.menu=r("oo-menu",(t=this.options)==null?void 0:t.attr),this.container.append(this.menu),h(this,O2,r("div",{slot:"items",styles:{height:"100%"}})),this.menu.append(l(this,O2)),a(this,F5,j9).call(this),this.options.class&&r.addClass(this.menu,this.options.class)},F5=new WeakSet,j9=function(){if(!this.calendar){let t="<oo-calendar";for(let e in this.options)v(this.options[e])!=="null"&&(t+=` ${L(e)}='${this.options[e]}'`);t+="></oo-calendar>",r.set(l(this,O2),"html",t),this.calendar=l(this,O2).firstElementChild,this.calendar.addEventListener("change",e=>{this.target.dispatchEvent(new CustomEvent("change",e))})}},D5=new WeakSet,I9=function(){const t=r.getSize(this.target),e=r.getPosition(this.target,this.container),s=r.getSize(this.menu);let o=e.y+t.y,d=e.x,p="left",C="top";if(this.area){const m=r.getSize(this.area),f=r.getPosition(this.container,this.area);f.x+d+s.x>m.x&&(d=d-s.x+t.x,p="right"),f.y+o+s.y>m.y&&(o=o-s.y-t.y,C="bottom")}r.setStyles(this.menu,{top:o+"px",left:d+"px","transform-origin":`${p} ${C}`})};function v7(n,i){return new m7(n,i)}const O1=class O1 extends k{constructor(){super();u(this,"_elements",{content:null,top:null,prev:null,next:null,date:null,dateContent:null});c(this,T4,{});c(this,F,null);c(this,Q2,null);u(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)},baseDate:()=>{this.setCurrentDate(),this.setDateContent()},weekBegin:()=>{this.setWeekTitle(),this.setDateContent()},$default:t=>{}});this._initialize("oo-calendar-view",O1,a7,d7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}static parseDate(t,e){return t?v(t)==="date"?e?new Date(t.getTime()):t:new Date(t):null}_render(){this.setCurrentDate()}_connected(){this.setWeekTitle(),this.setDateContent()}_setEvent(){this._elements.prev.addEventListener("click",t=>{z(l(this,F),"month",-1),this.setDateContent(),this.changeDate()}),this._elements.next.addEventListener("click",t=>{z(l(this,F),"month",1),this.setDateContent(),this.changeDate()}),this._elements.date.addEventListener("change",t=>{h(this,F,t.detail.date),this._elements.date.textContent=R(l(this,F),this._props.format),this.setDateContent()})}setCurrentDate(){h(this,F,this._props.baseDate?O1.parseDate(this._props.baseDate,!0):new Date),this.changeDate()}changeDate(){this._elements.date.textContent=R(l(this,F),this._props.format),l(this,Q2)?l(this,Q2).reset({value:R(l(this,F),"YYYY-MM")}):h(this,Q2,v7(this._elements.date,{monthOnly:!0,format:this._props.format,container:document.body,value:R(l(this,F),"YYYY-MM")})),this.dispatchEvent(new CustomEvent("change",{detail:{date:l(this,F),value:R(l(this,F),"YYYY-MM")}}))}setWeekTitle(){const t=this._elements.dateContent.querySelectorAll("th");this._props.daysTitles.forEach((e,s)=>{t[(7+s-this._props.weekBegin)%7].textContent=e})}setDateContent(){const t=j(new Date).getTime(),e=j(l(this,F),!0);e.setDate(1);const s=this._elements.dateContent.querySelectorAll("td"),o=new Date(e.getTime());o.setDate(o.getDate()-1);const d=(7+o.getDay()+1-this._props.weekBegin)%7,p=(C,m)=>{C.querySelectorAll("slot").forEach(N3=>N3.remove());const f=R(m,"YYYY-MM-DD"),_=r("slot",{name:`title-${f}`});C.querySelector("div.cellTitle").appendChild(_);const I2=r("slot",{name:`content-${f}`});C.querySelector("div.cellContent").appendChild(I2),C.querySelector("span:first-child").textContent=R(m,"D"),C.dataset.dateValue=f,r.checkClass(C,"today",m.getTime()===t),r.checkClass(C,"other",m.getMonth()!==l(this,F).getMonth())};for(let C=d-1;C>=0;C--)p(s[C],o),o.setDate(o.getDate()-1);for(let C=d;C<s.length;C++)p(s[C],e),e.setDate(e.getDate()+1)}};T4=new WeakMap,F=new WeakMap,Q2=new WeakMap,u(O1,"prop",{baseDate:"",weekBegin:1,format:"YYYY年MM月",months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],daysTitles:["周日","周一","周二","周三","周四","周五","周六"]});let s4=O1;const g7=`.content {\r
...
`,f7='<div class="capsulae content"></div>',j5=class j5 extends k{constructor(){super();c(this,P5);u(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||j5,s||f7,o||g7)}_render(){new MutationObserver(function(e){e.forEach(s=>{s.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,P5,$9).call(this)}};P5=new WeakSet,$9=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},u(j5,"prop",{skin:""});let r4=j5;const L7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
`;function i6(){}function o6(){}function l6(){}function a6(){}function d6(){}function c6(){}function h6(){}function i4(){}const v9={I_html:`
<div class="content">
    <div class="line">
        <div class="icon"></div>
        <div class="nameArea">
...
`},Z2=class Z2 extends k{constructor(){super();c(this,Z1);u(this,"_elements",{icon:null,name:null,unitName:null,unit:null,duty:null,levelName:null,description:null,phone:null,application:null});u(this,"isAsync",!0);u(this,"_setPropMap",{value:()=>{this._canRender()&&a(this,Z1,N4).call(this)},data:()=>{this._canRender()&&a(this,Z1,N4).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._canRender()&&this._useSkin(this._props.skin)}});this._props=this._getProps(Z2.prop),this._createProperties(Z2)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_canRender(){return super._canRender(null,["value","data"])}async _render(){if(this._props.value||Object.keys(this._props.data).length){const t=this._props.value||this._props.data,e=K3(t);await(this[`create${e}Card`]||this.createOtherCard).call(this,t),r.addClass(this._content,"show"),this.dispatchEvent(new CustomEvent("loaded"))}}async createICard(t){var o;this._props.value||this._props.data.dn;const e=await void 0,s=(e.person.dn||e.person.id||e.dn,void 0);r.setStyle(this._elements.icon,"background-image",`url('${s}')`),this._elements.name.textContent=e.name,this._elements.unitName.textContent=e.unit.name,this._elements.unit.textContent=e.unit.levelName,this._elements.duty.textContent=(o=e.unitDutyList)==null?void 0:o.map(d=>`${d.name}(${d.unit.name})`).join(", ")}async createPCard(t){this._props.value||this._props.data.dn;const e=await void 0,s=(e.dn||e.id,void 0);r.setStyle(this._elements.icon,"background-image",`url('${s}')`),this._elements.name.textContent=e.name,this._elements.unitName.textContent=e.identityList.map(o=>o.unit.name).join(", "),this._elements.unit.innerHTML=e.identityList.map(o=>`<div>${o.unit.levelName}</div>`).join(""),this._elements.duty.textContent=e.identityList.map(o=>o.unitDutyList&&o.unitDutyList.length?o.unitDutyList.map(d=>`${d.name}(${o.unit.name})`).join(", "):null).filter(o=>o!=null&&o!=="").join(", ")}async createUCard(t){const e=v(t)==="object"?await Promise.resolve(t):await void 0;this._elements.name.textContent=e.name,this._elements.levelName.textContent=e.levelName,this._elements.description.textContent=e.description}async createUDCard(t){const e=v(t)==="object"?await Promise.resolve(t):await void 0;this._elements.name.textContent=e.name,this._elements.levelName.textContent=e.levelName,this._elements.description.textContent=e.description}async createGCard(t){const e=v(t)==="object"?await Promise.resolve(t):await void 0;this._elements.name.textContent=e.name,this._elements.description.textContent=e.description}async createRCard(t){const e=v(t)==="object"?await Promise.resolve(t):await void 0;this._elements.name.textContent=e.name,this._elements.description.textContent=e.description}async createPROCESSCard(t){const e=v(t)==="object"?await(async()=>(v(t.application)==="object"||(t.application=await i4.getApplication(t.application)),t))():await i4.getProcessWithApp(t);r.addClass(this._elements.icon,"process-icon"),r.addClass(this._elements.icon,"ooicon-process"),this._elements.name.textContent=e.name,this._elements.description.textContent=e.description,this._elements.application.textContent=e.application.name}async createAPPCard(t){const e=await i4.getApplication(t.id||t);e.icon?r.setStyle(this._elements.icon,"background-image",`url('data:image/png;base64,${e.icon}')`):(r.addClass(this._elements.icon,"process-icon"),r.addClass(this._elements.icon,"ooicon-computer")),this._elements.name.textContent=e.name,this._elements.application.textContent=e.applicationCategory||"未分类应用",this._elements.description.textContent=e.description}async createOtherCard(t){this._elements.name.textContent=v(t)==="object"?t.name:t}};Z1=new WeakSet,N4=function(){const t=this.shadowRoot||this.attachShadow({mode:"open"});r.empty(t);const e=K3(this._props.value||this._props.data),s=Z2.cardTypys.includes(e)?v9[e+"_html"]:v9.other_html,o=u9(s,L7,"oo-card"+e,!0);this._useTemplate(o),this._render()},u(Z2,"prop",{value:"",data:{},border:"",cssLink:"",skin:""}),u(Z2,"cardTypys",["I","P","U","UD","G","R","PROCESS","APP"]);let o4=Z2;const b7=`<label class="content">\r
	<div class="button">\r
...
`,I5=class I5 extends k{constructor(){super();u(this,"_elements",{label:null,button:null,text:null,slot:null,check:null,input:null,checkIcon:null});u(this,"_setPropMap",{text:()=>{this._elements.text.textContent=this._props.text},value:()=>{this._elements.input.value=this._props.value,this._elements.input.setAttribute("value",this._props.value)},name:t=>{t!==this._props.name&&(this._elements.input.name=this._props.name,this._elements.input.setAttribute("name",this._props.name),this.setAttribute("name",this._props.name))},checked:()=>{this._elements.input.checked=!!this._props.checked,this._render()},disabled:()=>{this._elements.input.disabled=!!this._props.disabled,this._render()},size:()=>{this._props.size?r.setStyle(this._elements.button,"font-size",this._props.size):r.setStyle(this._elements.button,"font-size","auto")},skin:()=>{this._useSkin(this._props.skin)},readmode:()=>{this._props.readmode?(this.checked||r.addClass(this,"hide"),r.addClass(this._elements.button,"hide"),r.addClass(this._elements.label,"readmode"),this._elements.input.disabled=!0):(r.removeClass(this,"hide"),r.removeClass(this._elements.button,"hide"),r.removeClass(this._elements.label,"readmode"),this._props.disabled||(this._elements.input.disabled=!1))},$default:()=>{}});u(this,"group",null)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||I5,s||b7,o||_7)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("change",t=>{this.checked=this._elements.input.checked,this.dispatchEvent(new Event("change",t))})}_unchecked(){this._elements.input.checked=!1,this._props.checked=!1,this._render()}_render(){let t=this.firstChild;for(;t;)this._elements.slot.appendChild(t),t=this.firstChild;const e=this._elements.input.checked;r.checkClass(this._elements.button,"checked",e),r.checkClass(this._elements.check,"checked",e),r.checkClass(this._elements.label,"checked",e),r.checkClass(this._content,"checked",e),r.checkClass(this,"checked",e);const s=this._elements.input.disabled;r.checkClass(this._elements.button,"disabled",s),r.checkClass(this._elements.check,"disabled",s),r.checkClass(this._elements.label,"disabled",s),this._setPropMap.text()}_connected(){this._render();const t=this.tagName.toLowerCase()+"-group",e=r.getParent(this,t);e&&(this.group=e,setTimeout(()=>{var s;(s=e._appendItem)==null||s.call(e,this)},10))}_disconnected(){if(this.group){const t=this.group;this.group=null,t._removeItem(this)}}get checked(){return this._elements.input.checked}set checked(t){const e=this.checked!==t;this._elements.input.checked=!!t,this._render(),e&&this.dispatchEvent(new Event("change"))}};u(I5,"prop",{checked:!1,disabled:!1,text:"",value:"",name:"",size:"",skin:"",readmode:!1});let h5=I5;class w7 extends h5{constructor(){super(),this._init("oo-checkbox")}_render(){this._elements.input.type="checkbox",r.addClass(this._elements.checkIcon,"ooicon-checkmark"),super._render()}}const x7=`<div class="group content">\r
...
`,W5=class W5 extends k{constructor(){super();c(this,$5);c(this,e1);c(this,z5);c(this,R5);c(this,F1);c(this,N5);c(this,B5);c(this,V5);u(this,"_items",[]);c(this,g2,0);u(this,"_elements",{label:null,group:null,labelText:null,items:null,invalidHint:null,input:null});u(this,"_setPropMap",{name:()=>{this._props.name&&this._items.forEach(t=>{t.setAttribute("name",this._props.name)})},skin:()=>{this._items.forEach(t=>{t.setAttribute("skin",this._props.skin)})},disabled:()=>{this._items.forEach(t=>{this._props.disabled?t.setAttribute("disabled",!0):t.disabled||t.removeAttribute("disabled")})},size:()=>{this._props.size&&this._items.forEach(t=>{t.setAttribute("size",this._props.size)})},col:()=>{this.rerender()},label:()=>{this._props.label?(this._elements.labelText.textContent=this._props.label,r.removeClass(this._elements.labelText,"hide")):(this._elements.labelText.textContent="",r.addClass(this._elements.labelText,"hide"))},count:()=>{this.rerender()},readmode:t=>{this.rerender()},max:()=>{this._props.max===0?this._elements.input.removeAttribute("max"):this._elements.input.setAttribute("max",this._props.max)},maxlength:()=>{this._props.maxlength===0?this._elements.input.removeAttribute("maxlength"):this._elements.input.setAttribute("maxlength",this._props.maxlength)},min:()=>{this._props.min===0?this._elements.input.removeAttribute("min"):this._elements.input.setAttribute("min",this._props.min)},minlength:()=>{this._props.minlength===0?this._elements.input.removeAttribute("minlength"):this._elements.input.setAttribute("minlength",this._props.minlength)},pattern:()=>{this._props.pattern?this._elements.input.setAttribute("pattern",this._props.pattern):this._elements.input.removeAttribute("pattern")},required:()=>{this._props.required?this._elements.input.setAttribute("required",this._props.required):this._elements.input.removeAttribute("required")},step:()=>{this._props.step===1?this._elements.input.removeAttribute("step"):this._elements.input.setAttribute("step",this._props.step)},$default:()=>{}});c(this,t1,null)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}rerender(){a(this,F1,B4).call(this),a(this,N5,B9).call(this),a(this,e1,H3).call(this)}_init(t,e,s,o){this._initialize(t,e||W5,s||x7,o||y7)}_render(){this._props.name||(this._props.name=o9()),parseInt(this._props.col)||r.removeClass(this._elements.items,"hide-items"),parseInt(this._props.label)||r.addClass(this._elements.labelText,"hide"),this._itemChangeFun=this._itemChange.bind(this)}_removeItem(t){this._items.splice(this._items.indexOf(t),1),t.removeAttribute("slot"),t.removeEventListener("change",this._itemChangeFun),r.setStyle(t,"width","auto"),a(this,e1,H3).call(this)}_appendItem(t){this._items.push(t),t.setAttribute("slot","items"),t.setAttribute("name",this._props.name),t.setAttribute("skin",this._props.skin),this._props.disabled?t.setAttribute("disabled",!0):t.disabled||t.removeAttribute("disabled"),this._props.size&&t.setAttribute("size",this._props.size),t.addEventListener("change",this._itemChangeFun),this._appendItemCheckValue(t),a(this,e1,H3).call(this,!0),this._props.count&&(this._props.values?this._props.values.length:0)>=this._props.count&&!t.checked&&(t.disabled=!0),this._props.readmode&&(t.readmode=!0)}_appendItemCheckValue(t){this._props.values&&this._props.values.length&&this._props.values.includes(t.value)&&(t.checked=!0)}_itemChange(t){t.currentTarget.checked?(this._props.values||(this._props.values=[]),this._props.values.includes(t.currentTarget.value)||this._props.values.push(t.currentTarget.value),this._props.disabled||(t.currentTarget.disabled=!1)):this._props.values&&p9(this._props.values,t.currentTarget.value),this._elements.input.value=this._props.values.join(","),this.unInvalidStyle(),this._props.validityBlur&&this.checkValidity(),a(this,F1,B4).call(this),this.dispatchEvent(new Event("change",t))}_setEvent(){super._setEvent(),this._elements.input.addEventListener("invalid",t=>{a(this,V5,W9).call(this,t.target.validity)})}setCustomValidity(){return this._elements.input.setCustomValidity(...arguments)}checkValidity(){return this.dispatchEvent(new CustomEvent("validity")),this._elements.input.checkValidity(...arguments)}reportValidity(){return this.dispatchEvent(new CustomEvent("validity")),this._elements.input.reportValidity(...arguments)}unInvalidStyle(){this._elements.input.setCustomValidity(""),r.removeClass(this._elements.input,"invalid"),this._elements.invalidHint.textContent="",r.removeClass(this._elements.invalidHint,"show")}};g2=new WeakMap,$5=new WeakSet,z9=function(){h(this,g2,0),this._items.forEach(t=>{r.setStyle(t,"width","auto");const e=r.getSize(t);e.x>l(this,g2)&&h(this,g2,e.x)})},t1=new WeakMap,e1=new WeakSet,H3=function(){l(this,t1)&&clearTimeout(l(this,t1)),h(this,t1,setTimeout(()=>{a(this,z5,R9).call(this)},10))},z5=new WeakSet,R9=function(){if(!this._props.readmode){a(this,R5,N9).call(this);const t=parseInt(this._props.col);t&&(a(this,$5,z9).call(this),this._items.forEach((e,s)=>{l(this,g2)&&r.setStyle(e,"width",l(this,g2)+"px"),(s+1)%t===0&&e.insertAdjacentElement("afterend",r("br.group-col-separator",{slot:"items"}))}))}r.removeClass(this._elements.items,"hide-items")},R5=new WeakSet,N9=function(){this.querySelectorAll("br.group-col-separator").forEach(e=>{e.remove()})},F1=new WeakSet,B4=function(){if(this._props.count)if((this._props.values?this._props.values.length:0)>=this._props.count)for(const e of this._items)e.checked||(e.disabled=!0);else for(const e of this._items)e.disabled=!1},N5=new WeakSet,B9=function(){if(this._props.readmode){r.addClass(this._elements.group,"readmode");const t=this.querySelectorAll("br");t.length&&t.forEach(e=>{r.addClass(e,"hide")});for(const e of this._items)e.style.width="unset",e.readmode=!!this._props.readmode}else{r.removeClass(this._elements.group,"readmode");for(const t of this._items)t.readmode=!!this._props.readmode}},B5=new WeakSet,V9=function(){return this._elements.input.validity.customError||this._props.validity&&this._elements.input.setCustomValidity(this._props.validity),this._elements.invalidHint&&(this._elements.invalidHint.textContent=this._elements.input.validationMessage),this._elements.input.validationMessage},V5=new WeakSet,W9=function(t){this.dispatchEvent(new CustomEvent("invalid",{detail:t})),r.addClass(this._elements.input,"invalid"),a(this,B5,V9).call(this)&&r.addClass(this._elements.invalidHint,"show")},u(W5,"prop",{disabled:!1,value:"",name:"",size:"",col:"",label:"",skin:"",count:0,readmode:!1,max:0,maxlength:0,min:0,minlength:0,pattern:"",required:!1,step:1,validity:"",validityBlur:!1});let p5=W5;const A4=class A4 extends p5{constructor(){super();c(this,Y5);c(this,H5);c(this,q5);a(this,Y5,Y9).call(this),this._init("oo-checkbox-group",A4)}get value(){return a(this,H5,H9).call(this)}set value(t){this._props.values!==t&&(this._props.values=t,this._setPropMap.values())}get text(){return a(this,q5,q9).call(this)}};Y5=new WeakSet,Y9=function(){this._setPropMap=Object.assign(this._setPropMap,{value:()=>{this._props.values=this._props.value?this._props.value.split(/\s*,\s*/g):[],this._setPropMap.values(),this.rerender()},values:()=>{if(this._props.values&&this._props.values.length)for(const t of this._items)this._props.values.includes(t.value)?t.checked=!0:t._unchecked();else for(const t of this._items)t._unchecked()}})},H5=new WeakSet,H9=function(){return this._props.values},q5=new WeakSet,q9=function(){const t=[];return this._items.forEach(e=>{e.checked&&t.push(e.text)}),t};let l4=A4;const k7={title:"O2OA",error:{http:{title:"发送HTTP请求错误",text:"发送{method}请求 '{url}' 状态: {status} ({statusText})"},loadIndexError:"加载首页出错",loadIndexNotSet:"未指定要加载的首页应用！您应该从O2OA的应用项目中运行。",action:{title:"O2ActionError"},failCode:{BROADCAST_LISTENED_LOOP_BROADCAST:"广播事件监听到另一个循环的广播事件:{$}",ENTITY_EXISTS:"实体对象已存在，对象类型：{$0}，标识：{$1}",ENTITY_FLAG_CONFLICT:"实体对象标识冲突,对象类型:{$0},标识:{$1}",ENTITY_NOT_FOUND:"实体对象不存在,对象类型:{$0},标识:{S1}",FIELD_EMPTY:"字段不能为空,字段:{$0}",FIELD_EXISTS:"字段已存在,字段:{$0},值:{$1}",FIELD_NOT_EXISTS:"字段值不存在,字段:{$0}",FIELD_VERIFICATION_FAIL:"字段校验失败,字段:{$0},值:{$1}",MISSING_PARAMETER:"缺少参数",OBJECT_EXIST:"对象已存在",OBJECT_NOT_FOUND:"对象不存在",PARAMETER_VERIFICATION_FAIL:"参数校验不通过,参数:{$}",APPLICATION_HAS_PROCESS:"应用中已存在名为“{$}”的流程。",MANUAL_PARSE_TASK_TARGET_EMPTY:"无法为活动“{$0}”解析到待办对象，工作：{$1}",PROCESSVERSION_ACTIVE:"流程版不是激活流程版本",PROCESSVERSION_HAS_PROCESSING_JOB:"流程版本存在流转中的任务",PROCESS_HAS_PROCESSVERSION:"流程中存在流程版本",ROUTE_NOT_FOUND_ACTIVITY:"路由没有找到对应的活动:{}",UPLOAD_FILE_EMPTY:"上传文件为空.",UPLOAD_FILE_TOO_LARGE:"上传文件过大,文件长度:{}.",WORK_NOT_FOUND_ROUTE:"工作没有找到任何路由, 工作:{}",WORK_TASK_EMPTY:"工作的待办对象为空, 工作:{}",FORBIDDEN:"未授权访问",LOGIN_CODE_ERROR:"验证码错误",LOGIN_ERROR:"用户不存在或密码错误",PASSWORD_EXPIRED:"密码已过期",PERMISSION_DENIED:"权限不足",PERSON_BAN:"用户被禁用",PERSON_LOCKED:"用户被锁定",UNAUTHORIZED:"未认证",GROUP_NOT_FOUND:"群组“{$0}”不存在。",IDENTITY_NOT_FOUND:"身份“{$0}”不存在。",PERSON_MAJOR_IDENTITY_NOT_FOUND:"用户主身份不存在, 用户:{$0}",PERSON_NOT_FOUND:"用户不存在, 标识:{$0}",PERSON_NOT_FOUND_WITH_IDENTITY:"无法通过身份查找到用户, 身份:{$0}",PERSON_NOT_MATCH_IDENTITY:"用户和身份不匹配, 用户:{$0}, 身份:{$1}",ROLE_NOT_FOUND:"角色不存在,标识:{$0}",SYSTEM_ROLE_CAN_NOT_DELETE:"系统角色不能删除,标识:{}",UNITDUTY_NOT_FOUND:"组织职务不存在,标识:{}",UNITPOST_NOT_FOUND:"职务不存在,标识:{}",UNIT_NOT_FOUND:"组织不存在,标识:{}",OTHER:"其他错误"}},login:{passwordLogin:"密码登录",codeLogin:"短信验证码登录",login:"登录",username:"用户名",password:"密码",captcha:"验证码",code:"短信验证码",sendCode:"发送验证码",reSendCode:"重发",forget:"忘记密码？",findPassword:"找回密码",register:"注册",wechat:"微信",official:"官网",forum:"论坛",support:"支持",changeCaptcha:"换一张",usernameEmpty:"用户名不能为空",sendCodeError:"您填写的信息有误",bindLoginInfo1:"手机扫码，安全登陆",bindLoginInfo2:"打开APP扫一扫",bindLoginInfo3:"登陆网页版",codeVerify:"短信验证",setNewPassword:"设置新密码",complete:"完成",next:"下一步",confirm:"确认",codeAnswerEmpty:"短信验证码不能为空",newPassword:"请输入新密码",confirmPassword:"请确认新密码",checkConfirmPassword:"新密码与确认密码不一致",resetPasswordSuccess:"您的密码修改成功！请重新登陆",loginResetSuccessInfo:"{seconds}S后自动跳转至登陆页面",resetPasswordError:"重置密码失败！",loginResetErrorInfo:"请核对您的用户名和短信验证码。",resetModify:"返回修改"},index:{homepage:"首页",searchKey:"请输入搜索关键字",menu:{app:"应用",process:"流程",cms:"信息",query:"数据"}},common:{clear:"清空",ok:"确定",cancel:"取消",yes:"是",no:"否",selectAll:"全选",delete:"删除",disable:"禁用",selectCountLimit:"选择数量限制",selectCountInfo:"您最多可以选择 {n} 个值"},component:{selectFile:"选择文件",notSelectedFile:"未选择文件"}};window.oo=window.oo||{I18n:{instances:{}}};const I=class I{constructor(i,t={}){u(this,"res",null);u(this,"defaultRes",{});this.name=i,this.defaultRes=t,i&&(window.oo.I18n.instances[i]=this)}static detect(){const i=new URL(window.location).searchParams,t=(i.get("lng")||i.get("lp")||localStorage.getItem("o2.language")||navigator.language||I.defaultLng).toLocaleLowerCase();return I.supportedLanguages.includes(t)?t:I.supportedLanguages.find(e=>t.substring(0,t.indexOf("-"))===e)||I.defaultLng}async load(){return this}t(i,t){return g9(i,t,this.res||this.defaultRes)}o(i){return f9(i,this.res||this.defaultRes)}};u(I,"supportedLanguages",["zh-cn","en"]),u(I,"defaultLng","zh-cn"),u(I,"lng",I.detect()),u(I,"instances",{}),u(I,"get",(i="index",t={})=>window.oo.I18n.instances[i]||(window.oo.I18n.instances[i]=new I(i,t)));let C5=I;function g9(n,i,t){let e=(B2(`return this.${n}`,t)||n).toString();return i&&Object.keys(i).forEach(s=>{const o=new RegExp(`{${s}}`,"g");e=e.replace(o,i[s])}),e}function f9(n,i){const t=n?B2(`return this.${n}`,i)||{}:i;return Object.defineProperties(t,{t:{get(){return function(o,d){return g9(o,d,this)}},enumerable:!0,configurable:!0},o:{get(){return function(o){return f9(o,this)}},enumerable:!0,configurable:!0}}),t}C5.get("index",k7);const M7=`<div class="content">\r
	<label>\r
...
`,D1=class D1 extends k{constructor(){super();c(this,U5);c(this,X5);u(this,"_elements",{label:null,input:null,file:null,box:null,prefix:null,suffix:null,labelText:null,fileList:null,invalidHint:null,viewText:null,view:null});u(this,"_setPropMap",{leftIcon:t=>{r.removeClass(this._elements.prefix,`ooicon-${t} left-icon`),this._props.leftIcon&&r.addClass(this._elements.prefix,`ooicon-${this._props.leftIcon} left-icon`)},rightIcon:t=>{r.removeClass(this._elements.suffix,`ooicon-${t} right-icon`),this._props.rightIcon&&r.addClass(this._elements.suffix,`ooicon-${this._props.rightIcon} right-icon`)},width:()=>{this._props.width&&(this._elements.box.style.width=this._props.width,this._elements.box.parentElement.style.minWidth=this._props.width)},height:()=>{this._props.height&&(this._elements.box.style.height=this._props.height,this._elements.box.parentElement.style.minHeight=this._props.height)},style:()=>{this._setPropMap.width(),this._setPropMap.height()},inputStyle:()=>{r.toggleAttr(this._elements.input,"style",this._props.inputStyle)},labelStyle:()=>{r.toggleAttr(this._elements.label,"style",this._props.labelStyle)},bgcolor:()=>{this._props.bgcolor?r.setStyle(this._elements.box,"background-color",this._props.bgcolor):r.setStyle(this._elements.box,"background-color","transparent")},disabled:()=>{r.toggleAttr(this._elements.input,"disabled",this._props.disabled),r.checkClass(this._elements.box,"disabled",this._props.disabled),r.checkClass(this._elements.label,"disabled",this._props.disabled)},readmode:()=>{r.toggleAttr(this._elements.input,"readonly",this._props.readmode),r.checkClass(this._elements.box,"readmode",this._props.readmode),r.checkClass(this._elements.label,"readmode",this._props.readmode)},label:()=>{this._props.label?(this._elements.labelText.textContent=this._props.label,r.removeClass(this._elements.labelText,"hide")):(this._elements.labelText.textContent="",r.addClass(this._elements.labelText,"hide"))},skin:()=>{this._useSkin(this._props.skin)},value:()=>{try{this._elements.input.value=this._props.value}catch{}this._elements.viewText.textContent=this._props.value},appearance:()=>{r.checkClass(this._elements.input,"appearance",this._props.appearance==="none")},validity:()=>{},type:()=>{this._elements.file&&r.checkClass(this._elements.file,"hide",this._props.type!=="file"),r.toggleAttr(this._elements.input,"type",this._props.type)},autoSize:()=>{},resize:()=>{r.toggleClass(this._elements.input,"resize",this._props.resize)},$default:t=>{t==="value"?this.value=this._props[t]:r.toggleAttr(this._elements.input,t,this._props[t])}});const t=C5.get("index").o("component");["selectFile","notSelectedFile"].forEach(e=>D1.prop[e]=t[e])}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||D1,s||M7,o||L9)}_setEvent(){super._setEvent(),this.shadowRoot.addEventListener("click",t=>{}),this._elements.input.addEventListener("focus",()=>{this._props.readmode||(r.addClass(this._elements.box,"focus"),r.addClass(this._elements.label,"focus"))}),this._elements.input.addEventListener("blur",()=>{this._props.validityBlur&&this.checkValidity(),r.removeClass(this._elements.box,"focus"),r.removeClass(this._elements.label,"focus")}),this._elements.input.addEventListener("input",()=>{this.value=this._elements.input.value,this._elements.viewText.textContent=this._elements.input.value,this.unInvalidStyle()}),this._elements.input.addEventListener("change",t=>{this.dispatchEvent(new Event("change",t))}),this._elements.input.addEventListener("change",t=>{if(this._props.type==="file")if(console.log(t.target.value),t.target.files.length){r.empty(this._elements.fileList);for(const e of t.target.files){const s=r("oo-file",{filename:e.name,size:e.size});this._elements.fileList.append(s)}}else r.empty(this._elements.fileList),this._elements.fileList.textContent=this._props.notSelectedFile}),this._elements.input.addEventListener("invalid",t=>{a(this,X5,X9).call(this,t.target.validity)})}unInvalidStyle(t){this._elements.input.setCustomValidity(""),r.removeClass(this._elements.input,"invalid"),this._elements.invalidHint.textContent="",r.removeClass(this._elements.invalidHint,"show")}setCustomValidity(){return this._elements.input.setCustomValidity(...arguments)}checkValidity(){return this.dispatchEvent(new CustomEvent("validity")),this._elements.input.checkValidity(...arguments)}reportValidity(){return this.dispatchEvent(new CustomEvent("validity")),this._elements.input.reportValidity(...arguments)}_render(){this._setPropMap.value(),this._setPropMap.type()}focus(){this._elements.input.focus()}blur(){this._elements.input.blur()}get files(){return this._elements.input.files}get value(){return this._elements.input.value}set value(t){this.setAttribute("value",t)}};U5=new WeakSet,U9=function(){return this._elements.input.validity.customError||this._props.validity&&this._elements.input.setCustomValidity(this._props.validity),this._elements.invalidHint&&(this._elements.invalidHint.textContent=this._elements.input.validationMessage),this._elements.input.validationMessage},X5=new WeakSet,X9=function(t){this.dispatchEvent(new CustomEvent("invalid",{detail:t})),r.addClass(this._elements.input,"invalid"),a(this,U5,U9).call(this)&&r.addClass(this._elements.invalidHint,"show")},u(D1,"prop",{leftIcon:"",rightIcon:"",width:"",height:"",inputStyle:"",labelStyle:"",disabled:!1,readmode:!1,label:"",bgcolor:"#ffffff",skin:"",appearance:"",selectFile:"Select File",notSelectedFile:"Not Selected Files",validity:"",validityBlur:!1,autoSize:!1,resize:!1,id:"",placeholder:"",readonly:!1,type:"text",autofocus:!1,form:"",max:"",maxlength:"",min:"",minlength:"",name:"",pattern:"",size:"",spellcheck:"",src:"",step:"",tabindex:"",value:"",title:"",list:"",autocomplete:"",accept:"",alt:"",capture:"",checked:"",dirname:"",formaction:"",formenctype:"",formmethod:"",formnovalidate:"",formtarget:"",multiple:"",required:!1,cols:"",rows:""});let L2=D1;const E7=`.content{--option-bg: var(--oo-color-text-white);--option-over: var(--oo-color-text2);--option-over-bg: var(--oo-color-gray-e);--option-select: var(--oo-color-main);--option-select-bg: var(--oo-color-text-white);--option-shadow-color: var(--oo-color-gray-d);--option-shadow: 0 0 10px 1px var(--option-shadow-color);--option-border: var(--oo-color-gray-d);--option-selected: var(--oo-color-main);--option-selected-bg: var(--oo-color-light);--option-group-bg: var(--oo-color-text-white);--option-group-color: var(--oo-color-gray-9)}.drop{text-align:left;transition:color .2s;font-size:.8em;margin-right:.6em;color:var(--label);cursor:pointer;transform-origin:center}.drop.disabled,.suffix.disabled{opacity:.8;cursor:not-allowed}.box.focus .drop{color:var(--focus)}.calendar-area{position:absolute;border:1px solid var(--option-border);background-color:var(--option-bg);border-radius:var(--oo-area-radius);box-shadow:var(--option-shadow);z-index:100;transform-origin:top;transition:height .2s,opacity .2s,transform .2s}.calendar-area.visible{transform:scale(1);opacity:1}.calendar-area.invisible{transform:scaleY(0);opacity:0}.input,div.right-icon{cursor:pointer}
`,K=class K extends L2{constructor(){super();c(this,G5);c(this,K5);c(this,P1);c(this,J5);c(this,j1);c(this,Q5);c(this,q,!1);c(this,A,null);c(this,n1,null);c(this,B,null);a(this,G5,G9).call(this),this._init("oo-datetime",K),this._useCss(E7)}static get observedAttributes(){return K.prop=Object.assign({},K.prop,K.calendarProp),Object.keys(K.prop).map(t=>L(t))}_render(){h(this,q,!1),this._elements.input.setAttribute("readonly","readonly"),h(this,A,this.querySelector("div.calendar-area")),l(this,A)||(h(this,A,r("div.calendar-area.invisible")),this._content.insertAdjacentElement("beforeend",l(this,A))),this._props.readonly=!0,this._setPropMap.value()}_setEvent(){super._setEvent(),this._elements.input.addEventListener("click",()=>{debugger;this._props.read||(h(this,q,!l(this,q)),l(this,q)?a(this,J5,J9).call(this):a(this,j1,W4).call(this))}),l(this,A).addEventListener("click",t=>{t.stopPropagation()}),l(this,A).addEventListener("mousedown",t=>{t.stopPropagation()}),this._content.firstElementChild.addEventListener("mousedown",t=>{t.stopPropagation()})}_connected(){this.hasAttribute("right-icon")||this.setAttribute("right-icon","calendar")}};G5=new WeakSet,G9=function(){this._setPropMap=Object.assign(this._setPropMap,{disabled:()=>{r.toggleAttr(this._elements.input,"disabled",this._props.disabled),r.checkClass(this._elements.box,"disabled",this._props.disabled),r.checkClass(this._elements.label,"disabled",this._props.disabled),r.checkClass(this._elements.suffix,"disabled",this._props.disabled)},value:()=>{l(this,B)&&l(this,B).setAttribute("value",this._props.value),this._elements.input.value=this._props.value},timeRange:()=>{l(this,B)&&l(this,B).setAttribute("time-range",this._props.timeRange)},read:()=>{debugger;console.log(this._props.read)},$default:t=>{K.calendarProp.hasOwnProperty(t)?l(this,B)&&l(this,B).setAttribute(L(t),this._props[t]):r.toggleAttr(this._elements.input,t,this._props[t])}})},q=new WeakMap,A=new WeakMap,n1=new WeakMap,B=new WeakMap,K5=new WeakSet,K9=function(){const t=r.getPosition(this._elements.box,this._content),e=r.getSize(this._elements.box),s=t.x,o=t.y+e.y+6+e.y*.2;e.x,r.setStyles(l(this,A),{top:o+"px",left:s+"px"})},P1=new WeakSet,V4=function(){r.checkClass(this._elements.box,"focus",l(this,q)),r.checkClass(this._elements.label,"focus",l(this,q))},J5=new WeakSet,J9=function(){h(this,q,!0),a(this,P1,V4).call(this),a(this,K5,K9).call(this),r.removeClass(l(this,A),"invisible"),r.addClass(l(this,A),"visible"),this.ownerDocument.dispatchEvent(new MouseEvent("mousedown")),a(this,Q5,Q9).call(this),h(this,n1,a(this,j1,W4).bind(this)),this.ownerDocument.addEventListener("mousedown",l(this,n1)),this.unInvalidStyle()},j1=new WeakSet,W4=function(){h(this,q,!1),a(this,P1,V4).call(this),r.removeClass(l(this,A),"visible"),r.addClass(l(this,A),"invisible"),this.ownerDocument.removeEventListener("mousedown",l(this,n1))},Q5=new WeakSet,Q9=function(){if(!l(this,B)){let t="<oo-calendar";for(let e in K.calendarProp)v(this._props[e])!=="null"&&(t+=` ${L(e)}='${this._props[e]}'`);t+="></oo-calendar>",r.set(l(this,A),"html",t),h(this,B,l(this,A).firstElementChild),l(this,B).addEventListener("change",e=>{this.setAttribute("value",e.detail.value),this.dispatchEvent(new CustomEvent("change",e))})}},u(K,"calendarProp",{view:"date",baseDate:null,yearOnly:!1,monthOnly:!1,dateOnly:!1,weekOnly:!1,timeOnly:!1,secondEnable:!1,cleanEnable:!0,todayEnable:!0,datetimeRange:"",dateRange:"",timeRange:"",weekBegin:1,value:"",format:"",rightIcon:"calendar",read:!1});let a4=K;const S7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    display: flex;\r
...
`,i3=class i3 extends k{constructor(){super();c(this,F2);c(this,t3);c(this,e3);c(this,n3);c(this,s3);c(this,r3);u(this,"_elements",{icon:null,name:null,size:null,preview:null});u(this,"_setPropMap",{filename:()=>{a(this,F2,s5).call(this)},size:()=>{a(this,F2,s5).call(this)},url:()=>{a(this,F2,s5).call(this)},preview:()=>{a(this,F2,s5).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});c(this,I1,null);this._initialize("oo-file",i3,T7,S7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}async _render(){if(this._props.filename){const t=this._props.size?a(this,r3,r8).call(this,parseFloat(this._props.size)):"";this.extension=this._props.filename.substring(this._props.filename.lastIndexOf(".")+1),r.empty(this._elements.icon);const e=r("oo-icon");e.setAttribute("type",b9[this.extension]||b9.unknown),this._elements.icon.append(e),this._elements.name.textContent=this._props.filename,this._elements.size.textContent=t}}_setEvent(){super._setEvent(),this._elements.icon.addEventListener("click",t=>{t.stopPropagation(),this._props.preview&&this._props.url&&a(this,t3,t8).call(this)})}_previewImage(t){const e=r("img.preview");e.addEventListener("click",s=>{s.stopPropagation()}),t.append(e),e.src=this._props.url}_previewVideo(t){const e=r("video.preview",{controls:"play"});e.addEventListener("click",s=>{s.stopPropagation()}),t.append(e),e.src=this._props.url}_previewAudio(t){const e=r("audio.preview",{controls:"play"});e.addEventListener("click",s=>{s.stopPropagation()}),t.append(e),e.src=this._props.url}};I1=new WeakMap,F2=new WeakSet,s5=function(){l(this,I1)||setTimeout(()=>{this._render(),h(this,I1,null)},5)},t3=new WeakSet,t8=function(){const t=a(this,e3,e8).call(this,this.extension)?"Image":a(this,n3,n8).call(this,this.extension)?"Video":a(this,s3,s8).call(this,this.extension)?"Audio":"";if(t){const e=r("div.preview_mask"),s=r("div.preview_area"),o=r.getPosition(this._elements.icon);r.setStyles(e,{top:o.y+"px",left:o.x+"px"}),r.setStyles(s,{top:o.y+"px",left:o.x+"px"}),document.body.append(e),document.body.append(s),setTimeout(()=>{r.addClass(e,"show"),r.addClass(s,"show")},5),s.addEventListener("click",()=>{e.remove(),s.remove()}),this[`_preview${t}`](s)}},e3=new WeakSet,e8=function(t){return["apng","avif","bmp","gif","ico","cur","jpg","jpeg","jfif","pjpeg","pjp","png","svg","tif","tiff","webp"].includes(t)},n3=new WeakSet,n8=function(t){return["avi","mkv","mov","ogg","mp4","mpa","mpe","mpeg","mpg","rmvb","rm"].includes(t)},s3=new WeakSet,s8=function(t){return["mp3","wav","wma","wmv"].includes(t)},r3=new WeakSet,r8=function(t){if(!t)return"";const e=["B","KB","MB","GB"];let s=0;for(;t>=1024&&s<e.length-1;)t/=1024,s++;return t.toFixed(2)+" "+e[s]},u(i3,"prop",{filename:"",size:"",preview:!1,url:"",cssLink:"",skin:""});let d4=i3;const A7=`
<div class="content">
</div>
`,O7=Object.assign({"../../assets/icons/ai.svg":()=>Promise.resolve().then(()=>d0).then(n=>n.default),"../../assets/icons/arch.svg":()=>Promise.resolve().then(()=>c0).then(n=>n.default),"../../assets/icons/att.svg":()=>Promise.resolve().then(()=>h0).then(n=>n.default),"../../assets/icons/au.svg":()=>Promise.resolve().then(()=>p0).then(n=>n.default),"../../assets/icons/avi.svg":()=>Promise.resolve().then(()=>C0).then(n=>n.default),"../../assets/icons/cad.svg":()=>Promise.resolve().then(()=>u0).then(n=>n.default),"../../assets/icons/cdr.svg":()=>Promise.resolve().then(()=>m0).then(n=>n.default),"../../assets/icons/css.svg":()=>Promise.resolve().then(()=>v0).then(n=>n.default),"../../assets/icons/eps.svg":()=>Promise.resolve().then(()=>g0).then(n=>n.default),"../../assets/icons/excel.svg":()=>Promise.resolve().then(()=>f0).then(n=>n.default),"../../assets/icons/exe.svg":()=>Promise.resolve().then(()=>L0).then(n=>n.default),"../../assets/icons/flash.svg":()=>Promise.resolve().then(()=>b0).then(n=>n.default),"../../assets/icons/folder.svg":()=>Promise.resolve().then(()=>_0).then(n=>n.default),"../../assets/icons/gif.svg":()=>Promise.resolve().then(()=>w0).then(n=>n.default),"../../assets/icons/html.svg":()=>Promise.resolve().then(()=>x0).then(n=>n.default),"../../assets/icons/ico.svg":()=>Promise.resolve().then(()=>y0).then(n=>n.default),"../../assets/icons/img.svg":()=>Promise.resolve().then(()=>k0).then(n=>n.default),"../../assets/icons/iso.svg":()=>Promise.resolve().then(()=>M0).then(n=>n.default),"../../assets/icons/java.svg":()=>Promise.resolve().then(()=>E0).then(n=>n.default),"../../assets/icons/jpeg.svg":()=>Promise.resolve().then(()=>S0).then(n=>n.default),"../../assets/icons/js.svg":()=>Promise.resolve().then(()=>T0).then(n=>n.default),"../../assets/icons/link.svg":()=>Promise.resolve().then(()=>A0).then(n=>n.default),"../../assets/icons/mp3.svg":()=>Promise.resolve().then(()=>O0).then(n=>n.default),"../../assets/icons/mp4.svg":()=>Promise.resolve().then(()=>Z0).then(n=>n.default),"../../assets/icons/ofd.svg":()=>Promise.resolve().then(()=>F0).then(n=>n.default),"../../assets/icons/pdf.svg":()=>Promise.resolve().then(()=>D0).then(n=>n.default),"../../assets/icons/png.svg":()=>Promise.resolve().then(()=>P0).then(n=>n.default),"../../assets/icons/ppt.svg":()=>Promise.resolve().then(()=>j0).then(n=>n.default),"../../assets/icons/psd.svg":()=>Promise.resolve().then(()=>I0).then(n=>n.default),"../../assets/icons/rar.svg":()=>Promise.resolve().then(()=>$0).then(n=>n.default),"../../assets/icons/rm.svg":()=>Promise.resolve().then(()=>z0).then(n=>n.default),"../../assets/icons/svg.svg":()=>Promise.resolve().then(()=>R0).then(n=>n.default),"../../assets/icons/tiff.svg":()=>Promise.resolve().then(()=>N0).then(n=>n.default),"../../assets/icons/tmp.svg":()=>Promise.resolve().then(()=>B0).then(n=>n.default),"../../assets/icons/txt.svg":()=>Promise.resolve().then(()=>V0).then(n=>n.default),"../../assets/icons/unknown.svg":()=>Promise.resolve().then(()=>W0).then(n=>n.default),"../../assets/icons/wav.svg":()=>Promise.resolve().then(()=>Y0).then(n=>n.default),"../../assets/icons/wma.svg":()=>Promise.resolve().then(()=>H0).then(n=>n.default),"../../assets/icons/wmv.svg":()=>Promise.resolve().then(()=>q0).then(n=>n.default),"../../assets/icons/word.svg":()=>Promise.resolve().then(()=>U0).then(n=>n.default),"../../assets/icons/xml.svg":()=>Promise.resolve().then(()=>X0).then(n=>n.default),"../../assets/icons/xsl.svg":()=>Promise.resolve().then(()=>G0).then(n=>n.default),"../../assets/icons/zip.svg":()=>Promise.resolve().then(()=>K0).then(n=>n.default)}),o3=class o3 extends k{constructor(){super();u(this,"_setPropMap",{type:()=>{this._render()}});this._initialize("oo-icon",o3,A7,"svg{width:100%; height: 100%}")}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}async _render(){if(r.empty(this._content),this._props.type){const t=await O7[`../../assets/icons/${this._props.type}.svg`]();r.empty(this._content),this._content.insertAdjacentHTML("afterbegin",t)}}};u(o3,"prop",{type:""});let c4=o3;class Z7 extends L2{constructor(){super(),this._init("oo-input")}}const F7=`.content{\r
...
`,D7='<div class="content"><div class="area"><div class="text"></div><div class="label"></div></div></div>',l3=class l3 extends k{constructor(){super();c(this,$1);u(this,"_setPropMap",{value:()=>{},$default:()=>{},text:()=>{a(this,$1,Y4).call(this)},disabled:()=>{r.checkClass(this._content,"disabled",!!this._props.disabled)},selected:()=>{r.checkClass(this._content,"selected",this._props.selected),l(this,V)._selected(this)},skin:()=>{this._useSkin(this._props.skin)}});u(this,"_elements",{text:null,label:null,area:null});c(this,V,null);c(this,n2,null);this._initialize("oo-option",l3,D7,F7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,$1,Y4).call(this),this._setPropMap.disabled()}_connected(){const t=this.parentElement;t.tagName.toLowerCase()==="oo-option-group"?(h(this,n2,t),t.parentElement.tagName.toLowerCase()==="oo-select"&&h(this,V,t.parentElement)):t.tagName.toLowerCase()==="oo-select"&&h(this,V,t),l(this,n2)||l(this,V)?((l(this,n2)||l(this,V))._appendItem(this),r.show(this)):r.hide(this)}_disconnected(){if(l(this,n2)||l(this,V)){const t=l(this,n2)||l(this,V);h(this,V,null),h(this,n2,null),t._removeItem(this)}}_setEvent(){this._content.addEventListener("click",()=>{this._props.disabled||(this.selected=!0)});const t=()=>{var o;const s=r.getSize(this._elements.area);(o=l(this,V))==null||o.checkMaxWidth(s.x)};new MutationObserver(t).observe(this._content,{subtree:!0,childList:!0,attributes:!0,characterData:!0})}};$1=new WeakSet,Y4=function(){if(this.innerHTML.trim()){let t=this.firstChild;for(;t;)this._elements.label.appendChild(t),t=this.firstChild}this._elements.label.innerHTML.trim()||(this._elements.text.textContent=this._props.text)},V=new WeakMap,n2=new WeakMap,u(l3,"prop",{value:"",text:"",selected:!1,disabled:!1,skin:""});let h4=l3;const P7=`.content{\r
    padding: 0 1em;\r
...
</div>`,a3=class a3 extends k{constructor(){super();u(this,"_setPropMap",{$default:()=>{},text:()=>{this._elements.text.textContent=this._props.text},label:()=>{this._elements.label.textContent=this._props.label},skin:()=>{this._useSkin(this._props.skin)}});u(this,"_elements",{text:null,label:null});c(this,$,null);c(this,s1,[]);this._initialize("oo-option-group",a3,j7,P7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){this._elements.text.textContent=this._props.text||this._props.label}_connected(){const t=this.parentElement;t.tagName.toLowerCase()==="oo-select"&&h(this,$,t),l(this,$)?(l(this,$)._appendGroup(this),r.show(this)):r.hide(this)}_disconnected(){if(l(this,$)){const t=l(this,$);h(this,$,null),t._removeGroup(this)}}_removeItem(t){l(this,$)&&l(this,$)._removeItem(t),l(this,s1).splice(l(this,s1).indexOf(t),1)}_appendItem(t){l(this,$)&&l(this,$)._appendItem(t),l(this,s1).push(t)}};$=new WeakMap,s1=new WeakMap,u(a3,"prop",{text:"",skin:""});let p4=a3;const I7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding: 0.1em 0;\r
...
`,$7=Object.assign({"./styles/tooltip/deep.css":()=>Promise.resolve().then(()=>J0),"./styles/tooltip/default.css":()=>Promise.resolve().then(()=>Q0),"./styles/tooltip/toolbar.css":()=>Promise.resolve().then(()=>t6)}),s2=class s2{constructor(i,t,e){c(this,d3);c(this,c3);c(this,h3);c(this,p3);c(this,C3);c(this,z1);c(this,R1);c(this,u3);c(this,m3);c(this,N1);c(this,v3);c(this,B1);c(this,g3);this.content=i,this.target=t,this.options=Object.assign({},s2.option,e),a(this,d3,i8).call(this),a(this,g3,C8).call(this),this.options.events?a(this,N1,U4).call(this):this.show()}close(){r.setStyles(this.node,{opacity:0}),this.hideTimeout=window.setTimeout(()=>{this.container.remove()},600)}hide(){r.setStyles(this.node,{opacity:0}),this.hideTimeout=window.setTimeout(()=>{r.addClass(this.node,"hide"),r.removeClass(this.node,"show"),this.p&&r.setStyles(this.node,{left:this.p.fromX+"px",top:this.p.fromY+"px"}),a(this,h3,l8).call(this)},600)}async show(){if(!this.target||!this.target.isConnected)return null;this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=null),r.removeClass(this.node,"hide"),r.addClass(this.node,"show"),a(this,c3,o8).call(this),await a(this,N1,U4).call(this),await a(this,v3,p8).call(this),this.contentNode.childNodes.length&&(r.removeClass(this.node,"hide"),r.addClass(this.node,"show"),this.p=a(this,C3,d8).call(this),r.setStyles(this.node,{left:this.p.fromX+"px",top:this.p.fromY+"px"}),r.setStyles(this.triangle,{left:this.p.flagX+"px",top:this.p.flagY+"px"}),window.setTimeout(()=>{r.setStyles(this.node,{opacity:1,left:this.p.x+"px",top:this.p.y+"px"}),a(this,u3,c8).call(this)},5)),(!this.target||!this.target.isConnected)&&this.hide()}};d3=new WeakSet,i8=async function(){this.container=r("div.ootooltip_container"),this.node=r("div.ootooltip"),this.triangle=r(`div.ootooltip_triangle.${this.options.position}`),this.contentNode=r("div.ootooltip_content"),this.node.append(this.triangle),this.node.append(this.contentNode),this.container.append(this.node),a(this,p3,a8).call(this)},c3=new WeakSet,o8=function(){document.body.append(this.container)},h3=new WeakSet,l8=function(){this.container.remove()},p3=new WeakSet,a8=function(){this.options.events&&(this.showFun||(this.showFun=this.show.bind(this)),this.hideFun||(this.hideFun=this.hide.bind(this)),this.options.events.show&&(this.options.events.show.split(/\s*,\s*/g).forEach(t=>{this.target.addEventListener(t,e=>{this.hideFun.clear&&this.hideFun.clear(),J(this.showFun,this.options.defer,this)})}),this.options.showOnEnterCotent&&this.container.addEventListener("mouseenter",()=>{this.hideFun.clear&&this.hideFun.clear()})),this.options.events.hide&&(this.options.events.hide.split(/\s*,\s*/g).forEach(t=>{this.target.addEventListener(t,()=>{this.showFun.clear&&this.showFun.clear(),J(this.hideFun,100,this)})}),this.options.showOnEnterCotent&&this.container.addEventListener("mouseleave",()=>{this.showFun.clear&&this.showFun.clear(),J(this.hideFun,100,this)})))},C3=new WeakSet,d8=function(){const i=r.getPosition(this.target),t=r.getSize(this.target),e=r.getSize(this.node),s=r.getSize(this.triangle).x/2;let o=a(this,R1,q4).call(this,this.options.position,i,t,e,s);switch(this.options.position){case"top":o.y<0&&(o=a(this,z1,H4).call(this,"bottom",i,t,e,s));break;case"left":o.x<0&&(o=a(this,z1,H4).call(this,"right",i,t,e,s));break}if((this.options.position==="top"||this.options.position==="bottom")&&o.x<0){const d=o.x;o.flagX+=d,o.x=0,o.fromX=0}if((this.options.position==="left"||this.options.position==="right")&&o.y<0){const d=o.y;o.flagY+=d,o.y=0,o.fromY=0}return o},z1=new WeakSet,H4=function(i,t,e,s,o){return r.removeClass(this.triangle,this.options.position),r.addClass(this.triangle,i),this.options.position=i,a(this,R1,q4).call(this,this.options.position,t,e,s,o)},R1=new WeakSet,q4=function(i,t,e,s,o){const d={},p=this.options.emerge||0,C=this.options.offset||this.options.offset===0?this.options.offset:3;switch(i){case"bottom":d.x=d.fromX=t.x+e.x/2-s.x/2,d.y=t.y+e.y+o+C,d.fromY=d.y-p,d.flagX=s.x/2-o,d.flagY=0-o;break;case"left":d.x=t.x-s.x-o-C,d.fromX=d.x+p,d.y=d.fromY=t.y+e.y/2-s.y/2,d.flagX=s.x-o,d.flagY=s.y/2-o;break;case"right":d.x=t.x+e.x+o+C,d.fromX=d.x-p,d.y=d.fromY=t.y+e.y/2-s.y/2,d.flagX=0-o,d.flagY=s.y/2-o;break;default:d.x=d.fromX=t.x+e.x/2-s.x/2,d.y=t.y-s.y-o-C,d.fromY=d.y+p,d.flagX=s.x/2-o,d.flagY=s.y-o}return d},u3=new WeakSet,c8=function(){this.options.autoClose>0&&window.setTimeout(()=>{this[this.options.events?"hide":"close"]()},this.options.autoClose)},m3=new WeakSet,h8=async function(i){const t=await $7[`./styles/tooltip/${i}.css`]();return s7(t.default,this.container)},N1=new WeakSet,U4=async function(){const i=s2.loadedStyles[this.options.style||"default"];if(i){const t=await Promise.resolve(i);r.addClass(this.container,t.id)}else{const t=this.options.style||"default";s2.loadedStyles[t]=a(this,m3,h8).call(this,t),s2.loadedStyles[t]=await s2.loadedStyles[t]}},v3=new WeakSet,p8=async function(){if(this.options.resetContentOnShow||!this.contentLoaded)return this.target.dispatchEvent(new MouseEvent("tooltip")),r.empty(this.contentNode),this.contentLoaded=!0,await a(this,B1,X4).call(this,this.content),""},B1=new WeakSet,X4=async function(i){switch(v(i)){case"string":r.set(this.contentNode,"html",i);break;case"element":this.contentNode.append(i);break;case"function":const t=await Promise.resolve(i());await a(this,B1,X4).call(this,t)}},g3=new WeakSet,C8=function(){this.observerNode=this.observerNode||this.target.parentElement;var i=new MutationObserver((t,e)=>{if(t[0].removedNodes&&t[0].removedNodes.length){for(let s of t[0].removedNodes)if(s===this.target){this.hide(),e.disconnect();break}}});this.observerNode&&i.observe(this.observerNode,{childList:!0})},u(s2,"option",{position:"top",style:"default",autoClose:0,emerge:-8,offset:6,defer:600,events:{show:"mouseover",hide:"mouseout, mousedown"},showOnEnterCotent:!1,resetContentOnShow:!1}),u(s2,"loadedStyles",{});let C4=s2;function z7(n,i,t){return new C4(n,i,t)}const R7=`
<div class="content">
    <div class="icon"></div>
    <div class="text"></div>
</div>
`,b3=class b3 extends k{constructor(){super();c(this,f2);c(this,f3);c(this,r2);c(this,L3);u(this,"_elements",{icon:null,text:null});u(this,"_setPropMap",{type:()=>{this._canRender()&&a(this,r2,z2).call(this)},value:()=>{this._canRender()&&(a(this,r2,z2).call(this),a(this,f2,h1).call(this))},data:()=>{this._canRender()&&(a(this,r2,z2).call(this),a(this,f2,h1).call(this))},text:()=>{this._props.text?this._elements.text.textContent=this._props.text:a(this,f2,h1).call(this)},entity:()=>{this._canRender()&&(a(this,r2,z2).call(this),a(this,f2,h1).call(this))},isTooltip:()=>{this.tooltip=this._props.isTooltip!==!1?this.tooltip||this.defaultTooltip:null},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-org",b3,R7,I7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_canRender(){return super._canRender(null,["value","data"])}_render(){this._canRender()&&a(this,r2,z2).call(this)}_connected(){this._canRender()&&(a(this,r2,z2).call(this),a(this,f2,h1).call(this)),this.tooltip=this._props.isTooltip!==!1?this.defaultTooltip:null,this.tip||(this.tip=z7(async()=>v(this.tooltip)==="function"?await this.tooltip():this.tooltip,this))}defaultTooltip(){const t=r("oo-card",{value:this.value,data:JSON.stringify(this.data),skin:"border: 0; shadow: 0"});return new Promise(e=>{t.addEventListener("loaded",()=>{e(t)})})}};f2=new WeakSet,h1=function(){this._props.text?this._elements.text.textContent=this._props.text:this._props.value?this._elements.text.textContent=J3(this._props.value):this._elements.text.textContent=a(this,f3,u8).call(this,this._props.data)},f3=new WeakSet,u8=function(t){return t.dn?J3(t.dn):t.name},r2=new WeakSet,z2=function(){switch(this._props.type){case"text":r.addClass(this._elements.icon,"hide");break;default:const t=a(this,L3,m8).call(this,this._props.entity||K3(this._props.value||this._props.data));v(t)==="function"?r.setStyle(this._elements.icon,"background-image",`url('${t(this._props.value||this._props.data)}')`):r.addClass(this._elements.icon,t),r.removeClass(this._elements.icon,"hide")}},L3=new WeakSet,m8=function(t){return{I:e=>{var s;return(s=e.person)!=null&&s.dn||e.dn,void 0},P:e=>(e.dn,void 0),U:"ooicon-unit",G:"ooicon-group",R:"ooicon-role",UD:"ooicon-duty",UA:"ooicon-attribute",PA:"ooicon-attribute",PROCESS:"ooicon-process",APP:"ooicon-computer"}[t]},u(b3,"prop",{type:"simple",value:"",text:"",data:{},entity:"",cssLink:"",skin:"",isTooltip:!0});let u4=b3;const N7=`*{box-sizing:border-box}.content{--gap: .5em;--color: var(--oo-color-text2);--bg: var(--oo-default-radius);--radius: var(--oo-default-radius);--border: 1px solid var(--oo-color-gray-d);--hover-bg: var(--oo-color-light);--current-color: var(--oo-color-text-white);--current-bg: var(--oo-color-main)}.content{display:flex;gap:var(--gap);align-items:center}.prev,.next,.pages>div{padding:.2em;color:var(--color);background:var(--bg);border-radius:var(--radius);border:var(--border);cursor:pointer;display:flex;align-items:center;justify-content:center;min-width:1.788em;height:1.788em;transition:background .3s}.prev:hover,.next:hover,.pages>div:hover{background:var(--hover-bg)}.pages{display:flex;gap:var(--gap);align-items:center}.pages>.current{color:var(--current-color);background:var(--current-bg)}.pages>.current:hover{background:var(--current-bg)}.point3{transform:rotate(90deg);color:var(--color)}.jumper{margin-left:1em;display:flex;align-items:center;gap:.3em}.jumper oo-input{width:3.5em;text-align:center;-webkit-appearance:none;-moz-appearance:none;appearance:none}oo-input::-webkit-inner-spin-button,oo-input::-webkit-outer-spin-button{-webkit-appearance:none;-moz-appearance:none;appearance:none;margin:0}.hide{display:none}
`;customElements.get("oo-button")||customElements.define("oo-button",m9);const B7=`
<div class="content">
...
`,x3=class x3 extends k{constructor(){super();c(this,V1);c(this,W1);c(this,i2);c(this,r1);c(this,o2);c(this,_3);c(this,Y1);c(this,w3);u(this,"_elements",{first:null,last:null,prev:null,next:null,pages:null,jumper:null,jumperTextLeft:null,jumperTextRight:null,jumperPageCount:null,jumperInput:null});u(this,"_setPropMap",{cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},current:(t,e)=>{t!==e&&J(a(this,i2,R2),this)},total:(t,e)=>{t!==e&&J(a(this,i2,R2),this)},pageSize:(t,e)=>{t!==e&&J(a(this,i2,R2),this)},pageCount:()=>{},pages:(t,e)=>{t!==e&&J(a(this,i2,R2),this)},first:()=>{a(this,V1,G4).call(this)},last:()=>{a(this,W1,K4).call(this)},jumper:()=>{r.checkClass(this._elements.jumper,"hide",!this._props.jumper)}});this._initialize("oo-pagination",x3,B7,N7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}async _render(){a(this,r1,q3).call(this),a(this,V1,G4).call(this),a(this,W1,K4).call(this),J(a(this,i2,R2),this),a(this,w3,g8).call(this)}_setEvent(){this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.first.addEventListener("click",()=>{this.gotoFirst()}),this._elements.last.addEventListener("click",()=>{this.gotoLast()}),this._elements.jumperInput&&this._elements.jumperInput.addEventListener("keydown",t=>{if(t.key==="Enter"||t.keyCode===13){const e=this._elements.jumperInput;!isNaN(e.value)&&e.value&&(this.gotoPage(parseInt(e.value)),e.value="")}})}setCurrent(t){this._props.current=t,a(this,r1,q3).call(this)}gotoPage(t){this.setCurrent(t),this.dispatchEvent(new CustomEvent("page",{detail:this._props.current})),this.setAttribute("current",this._props.current),J(a(this,i2,R2),this)}pagesForward(){this.gotoPage(this._props.current+(this._props.pages-2))}pagesBack(){this.gotoPage(this._props.current-(this._props.pages-2))}gotoFirst(){this.gotoPage(1)}gotoLast(){this.gotoPage(this._props.pageCount)}gotoPrev(){this.gotoPage(--this._props.current)}gotoNext(){this.gotoPage(++this._props.current)}};V1=new WeakSet,G4=function(){const t=this._props.first;this._elements.first.textContent=t,r.checkClass(this._elements.first,"hide",!t)},W1=new WeakSet,K4=function(){const t=this._props.last;this._elements.last.textContent=t,r.checkClass(this._elements.last,"hide",!t)},i2=new WeakSet,R2=function(t,e,s){if(a(this,r1,q3).call(this),r.empty(this._elements.pages),this._props.pageCount<=this._props.pages)for(let o=1;o<=this._props.pageCount;o++)a(this,o2,N2).call(this,o);else{a(this,o2,N2).call(this,1);const o=this._props.pages-2,d=parseInt(o/2);let p;if(this._props.current-d<=2)for(let C=1;C<=o;C++)p=C+1,a(this,o2,N2).call(this,p);else if(this._props.current+d>=this._props.pageCount-1){a(this,Y1,J4).call(this);for(let C=o;C>=1;C--)p=this._props.pageCount-C,a(this,o2,N2).call(this,p)}else{a(this,Y1,J4).call(this);for(let C=0;C<o;C++)p=this._props.current-(d-C),a(this,o2,N2).call(this,p,s)}p<this._props.pageCount-1&&a(this,_3,v8).call(this),a(this,o2,N2).call(this,this._props.pageCount)}},r1=new WeakSet,q3=function(){this._props.pageCount=Math.ceil(this._props.total/this._props.pageSize),this._props.current<1&&(this._props.current=1),this._props.current>this._props.pageCount&&(this._props.current=this._props.pageCount)},o2=new WeakSet,N2=function(t){const e=document.createElement("div");e.textContent=t,t===this._props.current&&r.addClass(e,"current"),e.addEventListener("click",()=>{this.gotoPage(t)}),this._elements.pages.append(e)},_3=new WeakSet,v8=function(){const t=document.createElement("div");r.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesForward()}),this._elements.pages.append(t)},Y1=new WeakSet,J4=function(){const t=document.createElement("div");r.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesBack()}),this._elements.pages.append(t)},w3=new WeakSet,g8=function(){const t=this._props.jumperText.split("{n}");this._elements.jumperTextLeft.textContent=t[0],this._elements.jumperTextRight.textContent=(t==null?void 0:t[1])??"",this._elements.jumperPageCount.textContent=this._props.pageCount},u(x3,"prop",{total:200,pageSize:20,pageCount:0,pages:10,current:1,jumper:!0,first:"第一页",last:"最后一页",jumperText:"到第{n}页",border:!0,cssLink:"",skin:""});let m4=x3;const V7=`.content{\r
    --radius: 100%;\r
}\r
.check{\r
    border-radius: var(--radius);\r
...
`;class W7 extends h5{constructor(){super(),this._init("oo-radio"),this._useCss(V7)}_unCheckedOther(){this.ownerDocument.querySelectorAll(`oo-radio[name='${this._props.name}']`).forEach(t=>{t!==this&&t.checked&&t._unchecked()})}_render(){this._elements.input.type="radio",this._elements.input.checked&&this._unCheckedOther(),super._render()}}class Y7 extends p5{constructor(){super();c(this,y3);c(this,k3);a(this,y3,f8).call(this),this._init("oo-radio-group")}_appendItemCheckValue(t){this._props.value?t.value===this._props.value&&t.setAttribute("checked",!0):t._unchecked()}_itemChange(t){t.currentTarget.checked?this.value=t.currentTarget.value:this.value="",this._elements.input.value=this.value,this.unInvalidStyle(),this.dispatchEvent(new Event("change",t))}_removeItem(t){super._removeItem(t)}get text(){return a(this,k3,L8).call(this)}}y3=new WeakSet,f8=function(){this.setPropMap=Object.assign(this._setPropMap,{value:()=>{if(this._props.value){for(const t of this._items)if(t.value===this._props.value){t.setAttribute("checked",!0);break}}}})},k3=new WeakSet,L8=function(){for(const t of this._items)if(t.checked)return t.text;return""};const H7=`.content{\r
...
`,a1=class a1 extends L2{constructor(){super();c(this,M3);c(this,H1);c(this,E3);c(this,S3);c(this,q1);c(this,T3);c(this,l1);c(this,W,!1);c(this,D2,[]);c(this,O,null);c(this,i1,null);c(this,o1,[]);c(this,l2,0);c(this,P2,null);a(this,M3,b8).call(this),this._init("oo-select"),this._useCss(H7)}static get observedAttributes(){return a1.prop=Object.assign({},L2.prop,a1.prop),Object.keys(a1.prop).map(t=>L(t))}_render(){h(this,W,!1),this._elements.drop=r("div.drop.ooicon-drop_down"),this._elements.view.insertAdjacentElement("afterend",this._elements.drop),h(this,O,this.querySelector("div.options-area")),l(this,O)||(h(this,O,r("div.options-area.invisible")),r.set(l(this,O),"html",'<div class="arrow"></div><div class="options-content"><slot name="items"></slot></div>'),this._elements.box.insertAdjacentElement("beforeend",l(this,O))),this._elements.input.setAttribute("readonly",!0)}_removeItem(t){l(this,D2).splice(l(this,D2).indexOf(t),1),t.removeAttribute("slot")}_appendItem(t){l(this,D2).push(t),t.setAttribute("slot","items"),t.setAttribute("skin",this._props.skin);const e=r.getSize(this._elements.view),s=r.getSize(t._elements.area),o=Math.max(s.x,e.x);o>l(this,l2)&&(h(this,l2,o),a(this,H1,Q4).call(this)),this._props.size&&t.setAttribute("size",this._props.size),this._appendItemCheckValue(t),this._setPropMap.$default("value")}checkMaxWidth(t){t>l(this,l2)&&(h(this,l2,t),a(this,H1,Q4).call(this))}_appendItemCheckValue(t){this._props.value&&t.value===this._props.value&&(t.selected=!0)}_removeGroup(t){l(this,o1).splice(l(this,o1).indexOf(t),1),t.removeAttribute("slot")}_appendGroup(t){l(this,o1).push(t),t.setAttribute("slot","items"),t.setAttribute("skin",this._props.skin),this._props.size&&option.setAttribute("size",this._props.size)}_selected(t){if(t.selected){l(this,P2)&&l(this,P2)!==t&&(l(this,P2).selected=!1),h(this,P2,t);const e=t._props.text||t._elements.label.textContent;this._elements.viewText.textContent=e,this.value=t._props.value||e,this.text=e,this.unInvalidStyle(),this.dispatchEvent(new CustomEvent("change"))}a(this,l1,U3).call(this)}_setEvent(){super._setEvent(),this._elements.box.addEventListener("click",()=>{!this._props.disabled&&!this._props.readmode&&!this._props.read&&a(this,E3,_8).call(this)}),this._elements.input.addEventListener("click",t=>{t.stopPropagation()}),l(this,O).addEventListener("click",t=>{t.stopPropagation()}),l(this,O).addEventListener("mousedown",t=>{t.stopPropagation()}),this._content.firstElementChild.addEventListener("mousedown",t=>{t.stopPropagation()})}checkValidity(){this._elements.input.removeAttribute("readonly"),this.dispatchEvent(new CustomEvent("validity"));const t=this._elements.input.checkValidity(...arguments);return this._elements.input.setAttribute("readonly",!0),t}reportValidity(){this._elements.input.removeAttribute("readonly"),this.dispatchEvent(new CustomEvent("validity"));const t=this._elements.input.reportValidity(...arguments);return this._elements.input.setAttribute("readonly",!0),t}get value(){return this._props.value}set value(t){this.setAttribute("value",t)}get text(){return this._props.text}set text(t){this._props.text=t}};M3=new WeakSet,b8=function(){this._setPropMap=Object.assign(this._setPropMap,{disabled:()=>{r.toggleAttr(this._elements.input,"disabled",this._props.disabled),r.checkClass(this._elements.box,"disabled",this._props.disabled),r.checkClass(this._elements.label,"disabled",this._props.disabled),r.checkClass(this._elements.drop,"disabled",this._props.disabled)},value:()=>{if(this._props.value){for(const t of l(this,D2))if(t.value===this._props.value){t.selected=!0;break}}},readonly:()=>{},readmode:()=>{r.checkClass(this._elements.box,"readmode",this._props.readmode),r.checkClass(this._elements.label,"readmode",this._props.readmode)},autoSize:()=>{r.setStyle(this._elements.view,"width",`${l(this,l2)}px`)},read:()=>{}})},W=new WeakMap,D2=new WeakMap,O=new WeakMap,i1=new WeakMap,o1=new WeakMap,l2=new WeakMap,H1=new WeakSet,Q4=function(){this._props.autoSize&&(this.setMinWidthTimer&&window.clearTimeout(this.setMinWidthTimer),this.setMinWidthTimer=setTimeout(()=>{r.setStyle(this._elements.view,"width",`${l(this,l2)}px`),this.setMinWidthTimer=null},10))},P2=new WeakMap,E3=new WeakSet,_8=function(){h(this,W,!l(this,W)),l(this,W)?a(this,T3,x8).call(this):a(this,l1,U3).call(this)},S3=new WeakSet,w8=function(){const t=r.getPosition(this._elements.box,this._content),e=r.getSize(this._elements.box);t.x;const s=t.y+e.y+6+e.y*.2,o=e.x;r.setStyles(l(this,O),{top:s+"px",width:"100%"});const d=o/2-6;r.setStyles(l(this,O).querySelector(".arrow"),{left:d+"px"})},q1=new WeakSet,t9=function(){r.checkClass(this._elements.drop,"down",l(this,W)),r.checkClass(this._elements.box,"focus",l(this,W)),r.checkClass(this._elements.label,"focus",l(this,W))},T3=new WeakSet,x8=function(){this._props.readmode||(h(this,W,!0),a(this,q1,t9).call(this),a(this,S3,w8).call(this),r.removeClass(l(this,O),"invisible"),r.addClass(l(this,O),"visible"),this.ownerDocument.dispatchEvent(new MouseEvent("mousedown")),h(this,i1,a(this,l1,U3).bind(this)),this.ownerDocument.addEventListener("mousedown",l(this,i1)),this.unInvalidStyle())},l1=new WeakSet,U3=function(){h(this,W,!1),a(this,q1,t9).call(this),r.removeClass(l(this,O),"visible"),r.addClass(l(this,O),"invisible"),this.ownerDocument.removeEventListener("mousedown",l(this,i1))},u(a1,"prop",{read:!1});let v4=a1;const q7=`<div class="content">\r
	<slot name="before-outer"></slot>\r
...
`,A3=class A3 extends k{constructor(){super();c(this,U1);c(this,j2);u(this,"_elements",{label:null,input:null,box:null,prefix:null,suffix:null,labelText:null,placeholder:null,inputContent:null});u(this,"_setPropMap",{leftIcon:t=>{r.removeClass(this._elements.prefix,`ooicon-${t} left-icon`),this._props.leftIcon&&r.addClass(this._elements.prefix,`ooicon-${this._props.leftIcon} left-icon`)},rightIcon:t=>{r.removeClass(this._elements.suffix,`ooicon-${t} right-icon`),this._props.rightIcon&&r.addClass(this._elements.suffix,`ooicon-${this._props.rightIcon} right-icon`)},itemType:t=>{this._props.itemType||(this._props.itemType="simple"),t!==this._props.itemType&&this._elements.inputContent.querySelectorAll("oo-org").forEach(s=>{s.setAttribute("type",this._props.itemType)})},isTooltip:()=>{const t=this._props.isTooltip!==!1;this._elements.inputContent.querySelectorAll("oo-org").forEach(s=>{s.setAttribute("is-tooltip",t)})},disabled:()=>{r.toggleAttr(this._elements.input,"disabled",this._props.disabled),r.checkClass(this._elements.box,"disabled",this._props.disabled),r.checkClass(this._elements.label,"disabled",this._props.disabled)},label:()=>{this._props.label?(this._elements.labelText.textContent=this._props.label,r.removeClass(this._elements.label,"hide")):(this._elements.labelText.textContent="",r.addClass(this._elements.label,"hide"))},skin:()=>{this._useSkin(this._props.skin)},value:()=>{a(this,U1,e9).call(this,this._props.value)},placeholder:()=>{this.value&&this.value.length?(r.addClass(this._elements.placeholder,"hide"),r.removeClass(this._elements.inputContent,"hide")):(r.removeClass(this._elements.placeholder,"hide"),r.addClass(this._elements.inputContent,"hide"),this._props.placeholder&&!this._props.readonly?this._elements.placeholder.textContent=this._props.placeholder:this._elements.placeholder.innerHTML="&nbsp")},readonly:()=>{this._setPropMap.placeholder()},$default:()=>{}})}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}addValue(t){const e=t.dn||t;switch(this._props.value){case"string":(!this._props.count||this._props.value.split(/\s*,\s*/g).length<this._props.count)&&(this._props.value+=", "+e);break;case"array":(!this._props.count||this._props.value.length<this._props.count)&&this._props.value.push(e);break}a(this,j2,r5).call(this,e)}setTooltip(t,e){const s=t.detail.target;s.tooltip=e}_init(t,e,s,o){this._initialize(t,e||A3,s||q7,o||U7)}_setEvent(){super._setEvent(),this._elements.box.addEventListener("mouseover",()=>{!this._props.disabled&&!this._props.readonly&&(r.addClass(this._elements.box,"focus"),r.addClass(this._elements.label,"focus"))}),this._elements.box.addEventListener("mouseout",()=>{!this._props.disabled&&!this._props.readonly&&(r.removeClass(this._elements.box,"focus"),r.removeClass(this._elements.label,"focus"))}),this._elements.box.addEventListener("click",()=>{!this._props.disabled&&!this._props.readonly&&(this.dispatchEvent(new MouseEvent("select")),(this._props.selConfig||this._props.selOptions)&&this.select())})}select(){const t=this._props.selOptions?B2("return "+this._props.selOptions):{};this._props.selConfig&&(t.config=this._props.selConfig),t.selected=this.value,t.count=this._props.count,r.getPositionParent(this),(this._props.selTitle,void 0).then(e=>{if(e.type==="ok"){const s=e.data.map(o=>o.dn||o.id||o);a(this,U1,e9).call(this,s),this.dispatchEvent(new MouseEvent("change"))}else this.dispatchEvent(new MouseEvent("cancel"))})}focus(){this._elements.input.focus()}blur(){this._elements.input.blur()}};U1=new WeakSet,e9=function(t){let e=t;e=Array.isArray(e)?e:[e],e=this._props.count?e.slice(0,this._props.count):e,this._props.value=e,e&&e.length?(r.addClass(this._elements.placeholder,"hide"),r.removeClass(this._elements.inputContent,"hide")):(r.removeClass(this._elements.placeholder,"hide"),r.addClass(this._elements.inputContent,"hide")),r.empty(this._elements.inputContent),a(this,j2,r5).call(this,e)},j2=new WeakSet,r5=function(t){switch(v(t)){case"string":const e=t.split(/\s*,\s*/g);if(e.length===1){if(e[0]){const s=r("oo-org",{value:e[0],type:this._props.itemType});this._props.itemType==="text"&&s.setAttribute("type","text"),this._props.isTooltip===!1&&s.setAttribute("is-tooltip",!1),s.addEventListener("tooltip",o=>{this.dispatchEvent(new CustomEvent("tooltip",{detail:{target:o.target}}))}),this._elements.inputContent.append(s)}}else a(this,j2,r5).call(this,e);break;case"array":t.forEach(s=>{a(this,j2,r5).call(this,s)});break}},u(A3,"prop",{leftIcon:"",rightIcon:"create",itemType:"text",isTooltip:!0,label:"",skin:"",placeholder:"",disabled:!1,readonly:!1,value:[],selConfig:"",selOptions:"",selTitle:"",count:0});let g4=A3;class X7 extends g4{constructor(){super(),this._init("oo-selector")}get value(){const i=typeOf(this._props.value)==="string"&&this._props.value?this._props.value.split(/\s*,\s*/g):this._props.value;return this._props.count===1?i[0]:this._props.count?i.slice(0,this._props.count):i}set value(i){this.setAttribute("value",i)}}const G7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    display: block;\r
...
`,O3=class O3 extends k{constructor(){super();c(this,X1);u(this,"_setPropMap",{rows:()=>{a(this,X1,n9).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",O3,K7,G7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,X1,n9).call(this)}};X1=new WeakSet,n9=function(){r.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(r("div.item"))}catch{}},u(O3,"prop",{rows:"5",cssLink:"",skin:""});let f4=O3;const J7=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`,j3=class j3 extends k{constructor(){super();c(this,D3);c(this,P3);u(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},label:()=>{this.label&&(this.label.querySelector(".text").textContent=this._props.label,this.tabs.showSlider())},icon:t=>{if(this.label){const e=this.label.querySelector(".icon");this._props.icon?e?(r.removeClass(e,`ooicon-${t}`),r.addClass(e,`ooicon-${this._props.icon}`)):this.label.insertAdjacentElement("afterbegin",r(`div.icon.ooicon-${this._props.icon}`)):e&&e.remove(),this.tabs&&this.tabs.showSlider()}},rightIcon:t=>{if(this.label){const e=this.label.querySelector(".rightIcon");this._props.rightIcon?e?(r.removeClass(e,`ooicon-${t}`),r.addClass(e,`ooicon-${this._props.rightIcon}`)):this.label.insertAdjacentElement("beforeend",r(`div.rightIcon.ooicon-${this._props.rightIcon}`)):e&&e.remove(),this.tabs&&this.tabs.showSlider()}}});u(this,"label",null);u(this,"tabs",null);this._initialize("oo-tab",j3,e0,t0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){this._fillContent("content")}_connected(){this.tabs=r.getParent(this,"oo-tabs"),this.tabs&&a(this,D3,k8).call(this)}_disconnected(){this.label&&this.label.remove()}selected(){this.label&&r.addClass(this.label,"current"),r.removeClass(this,"hide"),this.dispatchEvent(new CustomEvent("current"))}unselected(){this.label&&r.removeClass(this.label,"current"),r.addClass(this,"hide"),this.dispatchEvent(new CustomEvent("uncurrent"))}};D3=new WeakSet,k8=function(){this.label||a(this,P3,M8).call(this);const t=this.previousElementSibling;t&&t.label?t.label.insertAdjacentElement("afterend",this.label):this.tabs._elements.labels.insertAdjacentElement("afterbegin",this.label),this.setAttribute("slot","pane"),this!==this.tabs.currentTab&&r.addClass(this,"hide"),this.tabs._checkCurrentTab()},P3=new WeakSet,M8=function(){this.label=r("div.label"),this._props.icon&&this.label.append(r(`div.icon.ooicon-${this._props.icon}`)),this.label.append(r("div.text",{text:this._props.label||"New Tab"})),this._props.rightIcon&&this.label.append(r(`div.rightIcon.ooicon-${this._props.rightIcon}`)),this.label.addEventListener("click",()=>{this.tabs.setCurrent(this)})},u(j3,"prop",{css:"",cssLink:"",skin:"",label:"",icon:"",rightIcon:""});let b4=j3;const n0=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    display: block;\r
...
`,$3=class $3 extends k{constructor(){super();c(this,I3);u(this,"_elements",{labels:null,panes:null,slider:null});u(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},position:t=>{r.removeClass(this._content,t),r.addClass(this._content,this._props.position),r.removeClass(this._elements.labels,t),r.addClass(this._elements.labels,this._props.position),r.removeClass(this._elements.slider,t),r.addClass(this._elements.slider,this._props.position)},current:()=>{this._checkCurrentTab()}});u(this,"currentTab",null);this._initialize("oo-tabs",$3,s0,n0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_checkCurrentTab(){const e=this.querySelectorAll("oo-tab").item(this._props.current);e&&e!==this.currentTab&&this.setCurrent(e)}setCurrent(t){if(this.currentTab&&(this.currentTab.unselected(),this.currentTab=null),t){const e=this.querySelectorAll("oo-tab");let s=0;for(const o of e){if(o===t)break;s++}this._props.current=s,this.currentTab=t,t.selected(),this.showSlider()}else a(this,I3,E8).call(this)}showSlider(){const t=r.getPosition(this.currentTab.label,this._elements.labels),e=r.getSize(this.currentTab.label);if(this._props.position==="top"||this._props.position==="bottom"){const s=this._elements.labels.scrollLeft,o=t.x+s;r.setStyles(this._elements.slider,{left:o+"px",width:e.x+"px"})}else{const s=this._elements.labels.scrollTop,o=t.y+s;r.setStyles(this._elements.slider,{top:o+"px",height:e.y+"px"})}}};I3=new WeakSet,E8=function(){r.setStyles(this._elements.slider,{left:0,width:0})},u($3,"prop",{css:"",cssLink:"",skin:"",position:"top",current:0});let _4=$3;const r0=`<div class="button content">\r
	<div class="box">\r
...
`,G1=class G1 extends c5{constructor(){super();c(this,z3);u(this,"_elements",{text:null,prefix:null,suffix:null,button:null,close:null,menu:null});a(this,z3,S8).call(this),this._init("oo-tag",G1,r0,i0)}_setEvent(){this._elements.close&&this._elements.close.addEventListener("click",t=>{this.shadowRoot.dispatchEvent(new MouseEvent("close",t)),t.stopPropagation()}),this._elements.menu&&this._elements.menu.addEventListener("click",t=>{this.shadowRoot.dispatchEvent(new MouseEvent("menu",t)),t.stopPropagation()})}};z3=new WeakSet,S8=function(){this.setPropMap=Object.assign(this._setPropMap,{close:()=>{this._props.close==="on"?r.removeClass(this._elements.close,"hide"):r.addClass(this._elements.close,"hide")},menu:()=>{this._props.menu==="on"?r.removeClass(this._elements.menu,"hide"):r.addClass(this._elements.menu,"hide")},type:t=>{this._props.type||(this._props.type="default"),t&&r.removeClass(this._elements.button,t),r.addClass(this._elements.button,this._props.type)}})},u(G1,"prop",{leftIcon:"",rightIcon:"",style:"",disabled:!1,text:"",type:"default",close:"on",menu:"off",skin:""}),u(G1,"events",{close:new Event("close",{composed:!0}),menu:new Event("menu",{composed:!0})});let w4=G1;const o0=`<div class="content">\r
	<label>\r
		<slot name="before-outer"></slot>\r
		<div class="label">\r
			<div class="labelText hide"></div>\r
...
`,O4=class O4 extends L2{constructor(){super();c(this,R3);a(this,R3,T8).call(this),this._init("oo-textarea"),this._useCss(l0)}_init(t){this._initialize(t,O4,o0,L9)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("input",()=>{this.setHeight()}),r.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()}setHeight(){if(this._props.autoSize){this._elements.input.style.height="auto";const t=this._elements.input.scrollHeight;this._elements.input.style.height=t+"px"}}};R3=new WeakSet,T8=function(){this._setPropMap=Object.assign(this._setPropMap,{autoSize:()=>{r.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()},value:()=>{try{this._elements.input.value=this._props.value}catch{}this._elements.viewText.textContent=this._props.value,window.setTimeout(()=>{this.setHeight()},10)}})};let x4=O4;function a0(){if(customElements.get("oo-button")||customElements.define("oo-button",m9),customElements.get("oo-calendar")||customElements.define("oo-calendar",C1),customElements.get("oo-calendar-view")||customElements.define("oo-calendar-view",s4),customElements.get("oo-capsulae")||customElements.define("oo-capsulae",r4),customElements.get("oo-card")||customElements.define("oo-card",o4),customElements.get("oo-checkbox")||customElements.define("oo-checkbox",w7),customElements.get("oo-checkbox-group")||customElements.define("oo-checkbox-group",l4),customElements.get("oo-datetime")||customElements.define("oo-datetime",a4),customElements.get("oo-file")||customElements.define("oo-file",d4),customElements.get("oo-icon")||customElements.define("oo-icon",c4),customElements.get("oo-input")||customElements.define("oo-input",Z7),HTMLFormElement&&HTMLFormElement.prototype.reportValidity&&!HTMLFormElement.prototype.reportValidity.OOInputAdded){const n=HTMLFormElement.prototype.reportValidity;HTMLFormElement.prototype.reportValidity=function(){const i=n.apply(this);if(!i)return i;const t=this.querySelectorAll("oo-input, oo-radio-group");for(const e of t)if(e.reportValidity&&!e.reportValidity())return!1;return!0},HTMLFormElement.prototype.reportValidity.OOInputAdded=!0}customElements.get("oo-option")||customElements.define("oo-option",h4),customElements.get("oo-option-group")||customElements.define("oo-option-group",p4),customElements.get("oo-org")||customElements.define("oo-org",u4),customElements.get("oo-pagination")||customElements.define("oo-pagination",m4),customElements.get("oo-radio")||customElements.define("oo-radio",W7),customElements.get("oo-radio-group")||customElements.define("oo-radio-group",Y7),customElements.get("oo-select")||customElements.define("oo-select",v4),customElements.get("oo-selector")||customElements.define("oo-selector",X7),customElements.get("oo-skeleton")||customElements.define("oo-skeleton",f4),customElements.get("oo-switch")||customElements.define("oo-switch",L4),customElements.get("oo-tab")||customElements.define("oo-tab",b4),customElements.get("oo-tabs")||customElements.define("oo-tabs",_4),customElements.get("oo-tab")||customElements.define("oo-tag",w4),customElements.get("oo-textarea")||customElements.define("oo-textarea",x4)}const d0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),g0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),w0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),y0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),k0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),E0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),O0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Z0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),$0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),N0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Y0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),q0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),U0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),G0=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),K0=Object.freeze(Object.defineProperty({__proto__:null,default:`<?xml version="1.0" encoding="UTF-8"?>\r
...
`},Symbol.toStringTag,{value:"Module"}));return w.defineComponent=a0,Object.defineProperty(w,Symbol.toStringTag,{value:"Module"}),w}({});
