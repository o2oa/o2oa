...
`;customElements.get("oo-calendar")||customElements.define("oo-calendar",wt);const D0=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    /*display: contents;*/\r
...
`;function H1(r,n){r.apply(n||this)}const I3=class I3 extends P{constructor(){super();h(this,ce);h(this,pe);h(this,z2);h(this,pt);h(this,R2);h(this,F3);h(this,ue);h(this,me);m(this,"_elements",{first:null,last:null,prev:null,next:null,pages:null,jumper:null,jumperTextLeft:null,jumperTextRight:null,jumperPageCount:null,jumperInput:null});m(this,"_setPropMap",{cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},current:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},total:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},pageSize:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},pageCount:()=>{},pages:(t,e)=>{t!==e&&H1(a(this,z2,j1),this)},first:()=>{a(this,ce,Xn).call(this)},last:()=>{a(this,pe,Kn).call(this)},jumper:()=>{i.checkClass(this._elements.jumper,"hide",!this._props.jumper)},jumperText:()=>{this._props.jumperText||(this._props.jumperText="到第{n}页"),a(this,me,Jn).call(this)}});this._initialize("oo-pagination",I3,I7,F7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}async _render(){a(this,pt,M4).call(this),(this._props.pageCount>1||this._props.showSingle)&&(a(this,ce,Xn).call(this),a(this,pe,Kn).call(this),H1(a(this,z2,j1),this),a(this,me,Jn).call(this))}_setEvent(){this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.first.addEventListener("click",()=>{this.gotoFirst()}),this._elements.last.addEventListener("click",()=>{this.gotoLast()}),this._elements.jumperInput&&this._elements.jumperInput.addEventListener("keydown",t=>{if(t.key==="Enter"||t.keyCode===13){const e=this._elements.jumperInput;!isNaN(e.value)&&e.value&&(this.gotoPage(parseInt(e.value)),e.value="")}})}setCurrent(t){this._props.current=t,a(this,pt,M4).call(this)}gotoPage(t){this.setCurrent(t),this.dispatchEvent(new CustomEvent("page",{detail:this._props.current})),this.setAttribute("current",this._props.current),H1(a(this,z2,j1),this)}pagesForward(){this.gotoPage(this._props.current+(this._props.pages-2))}pagesBack(){this.gotoPage(this._props.current-(this._props.pages-2))}gotoFirst(){this.gotoPage(1)}gotoLast(){this.gotoPage(this._props.pageCount)}gotoPrev(){this.gotoPage(--this._props.current)}gotoNext(){this.gotoPage(++this._props.current)}};ce=new WeakSet,Xn=function(){const t=this._props.first;this._elements.first.textContent=t,i.checkClass(this._elements.first,"hide",!t)},pe=new WeakSet,Kn=function(){const t=this._props.last;this._elements.last.textContent=t,i.checkClass(this._elements.last,"hide",!t)},z2=new WeakSet,j1=function(t,e,s){if(a(this,pt,M4).call(this),i.empty(this._elements.pages),this._props.pageCount>1||this._props.showSingle)if(this._props.pageCount<=this._props.pages)for(let o=1;o<=this._props.pageCount;o++)a(this,R2,z1).call(this,o);else{a(this,R2,z1).call(this,1);const o=this._props.pages-2,d=parseInt(o/2);let c;if(this._props.current-d<=2)for(let u=1;u<=o;u++)c=u+1,a(this,R2,z1).call(this,c);else if(this._props.current+d>=this._props.pageCount-1){a(this,ue,Gn).call(this);for(let u=o;u>=1;u--)c=this._props.pageCount-u,a(this,R2,z1).call(this,c)}else{a(this,ue,Gn).call(this);for(let u=0;u<o;u++)c=this._props.current-(d-u),a(this,R2,z1).call(this,c,s)}c<this._props.pageCount-1&&a(this,F3,p8).call(this),a(this,R2,z1).call(this,this._props.pageCount)}},pt=new WeakSet,M4=function(){this._props.pageCount=Math.ceil(this._props.total/this._props.pageSize),this._props.pageCount<1&&(this._props.pageCount=1),this._props.current<1&&(this._props.current=1),this._props.current>this._props.pageCount&&(this._props.current=this._props.pageCount)},R2=new WeakSet,z1=function(t){const e=document.createElement("div");e.textContent=t,t===this._props.current&&i.addClass(e,"current"),e.addEventListener("click",()=>{this.gotoPage(t)}),this._elements.pages.append(e)},F3=new WeakSet,p8=function(){const t=document.createElement("div");i.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesForward()}),this._elements.pages.append(t)},ue=new WeakSet,Gn=function(){const t=document.createElement("div");i.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesBack()}),this._elements.pages.append(t)},me=new WeakSet,Jn=function(){const t=this._props.jumperText.split("{n}");this._elements.jumperTextLeft.textContent=t[0],this._elements.jumperTextRight.textContent=(t==null?void 0:t[1])??"",this._elements.jumperPageCount.textContent=this._props.pageCount},m(I3,"prop",{total:200,pageSize:20,pageCount:0,pages:10,current:1,showSingle:!0,jumper:!1,first:"第一页",last:"最后一页",jumperText:"到第{n}页",border:!0,cssLink:"",skin:""});let K4=I3;const O7=`.content{\r
    --radius: 100%;\r
}\r
.check{\r
    border-radius: var(--radius);\r
...
`;class D7 extends e5{constructor(){super(),this._init("oo-radio"),this._useCss(O7)}_unCheckedOther(){this.ownerDocument.querySelectorAll(`oo-radio[name='${this._props.name}']`).forEach(t=>{t!==this&&t.checked&&t._unchecked()})}_render(){this._elements.input.type="radio",this._elements.input.checked&&this._unCheckedOther(),super._render()}}class $7 extends n5{constructor(){super();h(this,O3);h(this,D3);a(this,O3,u8).call(this),this._init("oo-radio-group")}_appendItemCheckValue(t){this._props.value?t.value===this._props.value&&t.setAttribute("checked",!0):t._unchecked()}_itemChange(t){t.currentTarget.checked?this.value=t.currentTarget.value:this.value="",this._elements.input.value=this.value,this.unInvalidStyle()}_removeItem(t){super._removeItem(t)}get text(){return a(this,D3,m8).call(this)}}O3=new WeakSet,u8=function(){this.setPropMap=Object.assign(this._setPropMap,{value:()=>{if(this._props.value){for(const t of this._items)if(t.value===this._props.value){t.setAttribute("checked",!0);break}}this._elements.input.value=this._props.value,this._fillEmptyReadmode()}})},D3=new WeakSet,m8=function(){for(const t of this._items)if(t.checked)return t.text;return""};const N7=`.content{\r
...
`,B3=class B3 extends P{constructor(){super();h(this,be);m(this,"_setPropMap",{rows:()=>{a(this,be,ss).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",B3,B7,R7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,be,ss).call(this)}};be=new WeakSet,ss=function(){i.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(i("div.item"))}catch{}},m(B3,"prop",{rows:"5",cssLink:"",skin:""});let Q4=B3;const V7=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label hide">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`,X3=class X3 extends P{constructor(){super();h(this,U3);m(this,"_elements",{labels:null,panes:null,slider:null});m(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},position:t=>{i.removeClass(this._content,t),i.addClass(this._content,this._props.position),i.removeClass(this._elements.labels,t),i.addClass(this._elements.labels,this._props.position),i.removeClass(this._elements.slider,t),i.addClass(this._elements.slider,this._props.position)},current:()=>{this._checkCurrentTab()}});m(this,"currentTab",null);this._initialize("oo-tabs",X3,U7,q7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_checkCurrentTab(){const e=this.querySelectorAll("oo-tab").item(this._props.current);e&&e!==this.currentTab&&this.setCurrent(e)}setCurrent(t){if(this.currentTab&&(this.currentTab.unselected(),this.currentTab=null),t){const e=this.querySelectorAll("oo-tab");let s=0;for(const o of e){if(o===t)break;s++}this._props.current=s,this.currentTab=t,t.selected(),this.showSlider()}else a(this,U3,w8).call(this)}showSlider(){const t=i.getPosition(this.currentTab.label,this._elements.labels),e=i.getSize(this.currentTab.label);if(this._props.position==="top"||this._props.position==="bottom"){const s=this._elements.labels.scrollLeft,o=t.x+s;i.setStyles(this._elements.slider,{left:o+"px",width:e.x+"px"})}else{const s=this._elements.labels.scrollTop,o=t.y+s;i.setStyles(this._elements.slider,{top:o+"px",height:e.y+"px"})}}};U3=new WeakSet,w8=function(){i.setStyles(this._elements.slider,{left:0,width:0})},m(X3,"prop",{css:"",cssLink:"",skin:"",position:"top",current:0});let nn=X3;const X7=`<div class="button content">\r
	<div class="box">\r
...
/* ---------------------------------------------- */`,bn=class bn extends i2{constructor(){super();h(this,G3);a(this,G3,k8).call(this),this._init("oo-textarea"),this._useCss(J7)}_init(t){this._initialize(t,bn,G7,Rs)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("input",()=>{this.setHeight()}),i.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()}setHeight(){if(this._props.autoSize){this._elements.input.style.height="auto";const t=this._elements.input.scrollHeight;this._elements.input.style.height=t+"px"}}};G3=new WeakSet,k8=function(){this._setPropMap=Object.assign(this._setPropMap,{autoSize:()=>{i.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()},value:()=>{try{this._elements.input.value=this._props.value}catch{}this._props.value?this._elements.viewText.textContent=this._props.value:this._elements.viewText.innerHTML="-",window.setTimeout(()=>{this.setHeight()},10)}})};let rn=bn;const Q7=`.content{\r
...
`},Symbol.toStringTag,{value:"Module"})),ai=Object.freeze(Object.defineProperty({__proto__:null,default:`* {\r
    box-sizing: border-box;\r
}\r
.container{\r
    /*position: fixed;*/\r
...
`},Symbol.toStringTag,{value:"Module"})),yi=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),Mi=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Si=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),Ii=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),zi=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Ri=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Hi=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Wi=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Ui=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
`},Symbol.toStringTag,{value:"Module"})),Xi=Object.freeze(Object.defineProperty({__proto__:null,default:`<svg width="36px" height="36px" viewBox="0 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\r
...
</svg>`},Symbol.toStringTag,{value:"Module"})),Gi=Object.freeze(Object.defineProperty({__proto__:null,default:`<?xml version="1.0" encoding="UTF-8"?>\r
...
`},Symbol.toStringTag,{value:"Module"})),e6=Object.freeze(Object.defineProperty({__proto__:null,default:`.maskNode{opacity:0;background-color:var(--oo-color-gray-d);transition:.2s;position:absolute}.maskNode.show{opacity:.3}
`},Symbol.toStringTag,{value:"Module"}));return _.DatetimePicker=Is,_.Dialog=Vs,_.Dragdrop=oi,_.Draggable=Us,_.Menu=Fs,_.Notice=yt,_.Tooltip=kt,_.confirm=Ws,_.datetimePicker=Os,_.defineComponent=li,_.dialog=Hs,_.mask=ii,_.notice=T2,_.tooltip=Ys,_.unmask=ri,Object.defineProperty(_,Symbol.toStringTag,{value:"Module"}),_}({});
