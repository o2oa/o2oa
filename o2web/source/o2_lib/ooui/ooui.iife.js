...
`,Wr='<div class="capsulae content"></div>',xn=class xn extends P{constructor(){super();d(this,yn);m(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_init(t,e,n,o){this._initialize(t,e||xn,n||Wr,o||Yr)}_render(){new MutationObserver(function(e){e.forEach(n=>{n.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),c(this,yn,f4).call(this)}};yn=new WeakSet,f4=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},m(xn,"prop",{skin:""});let Ns=xn;const qr=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
/* ---------------------------------------------- */`,kn=class kn extends P{constructor(){super();m(this,"_elements",{label:null,button:null,text:null,slot:null,check:null,input:null,checkIcon:null});m(this,"_setPropMap",{text:()=>{this._elements.text.textContent=this._props.text},value:()=>{this._elements.input.value=this._props.value,this._elements.input.setAttribute("value",this._props.value)},name:t=>{t!==this._props.name&&(this._elements.input.name=this._props.name,this._elements.input.setAttribute("name",this._props.name),this.setAttribute("name",this._props.name))},checked:()=>{this._elements.input.checked=!!this._props.checked,this._render()},disabled:()=>{this._elements.input.disabled=!!this._props.disabled,this._render()},size:()=>{this._props.size?i.setStyle(this._elements.button,"font-size",this._props.size):i.setStyle(this._elements.button,"font-size","auto")},skin:()=>{this._useSkin(this._props.skin)},skinMode:t=>{t&&i.removeClass(this._content,t),this._props.skinMode&&i.addClass(this._content,this._props.skinMode)},readmode:()=>{this._props.readmode?(this.checked?i.removeClass(this,"hide"):i.addClass(this,"hide"),i.addClass(this._elements.button,"hide"),i.addClass(this._elements.label,"readmode")):(i.removeClass(this,"hide"),i.removeClass(this._elements.button,"hide"),i.removeClass(this._elements.label,"readmode"),this._props.disabled||(this._elements.input.disabled=!1))},$default:()=>{}});m(this,"group",null)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_init(t,e,n,o){this._initialize(t,e||kn,n||r9,o||o9)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("change",t=>{t.stopPropagation(),this.checked=this._elements.input.checked,this.dispatchEvent(new Event("change",t))})}_unchecked(){this._elements.input.checked=!1,this._props.checked=!1,this._render()}_render(){let t=this.firstChild;for(;t;)this._elements.slot.appendChild(t),t=this.firstChild;const e=this._elements.input.checked;i.checkClass(this._elements.button,"checked",e),i.checkClass(this._elements.check,"checked",e),i.checkClass(this._elements.label,"checked",e),i.checkClass(this._content,"checked",e),i.checkClass(this,"checked",e);const n=this._elements.input.disabled;i.checkClass(this._elements.button,"disabled",n),i.checkClass(this._elements.check,"disabled",n),i.checkClass(this._elements.label,"disabled",n),this._setPropMap.text(),this._setPropMap.readmode()}_connected(){var n;this._render();const t=this.tagName.toLowerCase()+"-group",e=i.getParent(this,t);e&&(this.group=e,(n=e._appendItem)==null||n.call(e,this))}_disconnected(){if(this.group){const t=this.group;this.group=null,t._removeItem(this)}}get checked(){return this._elements.input.checked}set checked(t){const e=this.checked!==t;this._elements.input.checked=!!t,this._render(),e&&this.dispatchEvent(new Event("change"))}};m(kn,"prop",{checked:!1,disabled:!1,text:"",value:"",name:"",size:"",skin:"",readmode:!1,skinMode:""});let G1=kn;class l9 extends G1{constructor(){super(),this._init("oo-checkbox")}_render(){this._elements.input.type="checkbox",i.addClass(this._elements.checkIcon,"ooicon-checkmark"),super._render()}}const a9=`<div class="group content">\r
...
`,j5=class j5 extends P{constructor(){super();d(this,g1);m(this,"_setPropMap",{rows:()=>{c(this,g1,r3).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",j5,q9,W9)}static get observedAttributes(){return Object.keys(this.prop).map(t=>_(t))}_render(){c(this,g1,r3).call(this)}};g1=new WeakSet,r3=function(){i.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(i("div.item"))}catch{}},m(j5,"prop",{rows:"5",cssLink:"",skin:""});let li=j5;const U9=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label hide">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
