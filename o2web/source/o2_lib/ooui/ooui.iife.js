...
`,l5=class l5 extends P{constructor(){super();h(this,o5);h(this,At);m(this,"_elements",{text:null,prefix:null,suffix:null,button:null});h(this,m2,{});m(this,"_setPropMap",{leftIcon:t=>{i.removeClass(this._elements.prefix,`ooicon-${t} icon`),this._props.leftIcon&&i.addClass(this._elements.prefix,`ooicon-${this._props.leftIcon} icon`)},rightIcon:t=>{i.removeClass(this._elements.suffix,`ooicon-${t} icon`),this._props.rightIcon&&i.addClass(this._elements.suffix,`ooicon-${this._props.rightIcon} icon`)},styles:()=>{},disabled:t=>{i.checkClass(this._elements.button,"disabled",this._props.disabled),i.toggleAttr(this._elements.button,"disabled",this._props.disabled),a(this,o5,Gs).call(this,this._props.disabled)},type:t=>{this._props.type||(this._props.type="default"),t&&i.removeClass(this._elements.button,t),i.addClass(this._elements.button,this._props.type)},text:()=>{this.innerHTML.trim()||(this._elements.text.textContent=this._props.text)},skin:()=>{this._useSkin(this._props.skin)},$default:t=>{t==="value"&&(this.value=this._props[t]),i.toggleAttr(this._elements.button,t,this._props[t])}})}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||l5,s||x0,o||w0)}_render(){const t=this;new MutationObserver(function(){var s;a(s=t,At,Mn).call(s)}).observe(this,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),a(this,At,Mn).call(this)}_connected(){}};m2=new WeakMap,o5=new WeakSet,Gs=function(t){if(t){p(this,m2,l(this,m2)||{});for(let e in this)e.startsWith("on")&&this[e]&&(l(this,m2)[e]=this[e],this[e]=null);this.style.pointerEvents="none"}else{if(l(this,m2))for(let e in l(this,m2))l(this,m2)[e]&&(this[e]=l(this,m2)[e],l(this,m2)[e]=null);this.style.pointerEvents="auto"}},At=new WeakSet,Mn=function(){this.innerHTML.trim()&&(i.empty(this._elements.text),this._elements.text.insertAdjacentHTML("beforeend",this.innerHTML))},m(l5,"prop",{leftIcon:"",rightIcon:"",styles:"",disabled:!1,text:"",type:"",skin:""});let Je=l5;class Ms extends Je{constructor(){super(),this._init("oo-button")}}const y0=`<div class="content">\r
    <div class="left">\r
        <div class="top">\r
...
`,v5=class v5 extends P{constructor(){super();m(this,"_elements",{});m(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},label:()=>{switch(this._props.type){case"command":this._elements.label&&(this._elements.label.textContent=this._props.label);break;case"checkbox":case"radio":this._elements.input&&(this._elements.input.text=this._props.label);break}},disabled:()=>{switch(i.removeClass(this._content,"disabled"),i.addClass(this._content,"enabled"),this._props.type){case"command":this._props.disabled&&(i.removeClass(this._content,"enabled"),i.addClass(this._content,"disabled"));break;case"checkbox":case"radio":this._elements.input.disabled=this._props.disabled,this._props.disabled&&i.removeClass(this._content,"enabled");break}},icon:t=>{this._elements.icon&&(i.removeClass(this._elements.icon,`ooicon-${t}`),this._props.icon&&i.addClass(this._elements.icon,`ooicon-${this._props.icon}`))},radiogroup:t=>{this._elements.radio&&(this._elements.radio.name=this._props.radiogroup)},type:t=>{t!==null&&t!==this._props.type&&this._renderItem()}});this._initialize("oo-menu-item",v5,$0,N0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_setEvent(){super._setEvent(),this.addEventListener("click",()=>{if(this.type==="command"){const t=i.getParent(this,"oo-menu");t&&t.hide()}})}_connected(){this.getAttribute("type")||this.setAttribute("type","command"),i.getParent(this,"oo-menu")&&this.setAttribute("slot","items"),this._renderItem()}_renderItem(){switch(i.empty(this),this._elements.icon=null,this._elements.label=null,this._elements.input=null,this._elements.hr=null,this.checkbox=null,this.radio=null,i.addClass(this._content,"enabled"),this._props.type){case"command":this._elements.icon=i("div.icon",{slot:"item"}),this._elements.label=i("div.label",{text:this._props.label,slot:"item"}),this._props.icon&&i.addClass(this._elements.icon,`ooicon-${this._props.icon}`),this.append(this._elements.icon),this.append(this._elements.label);break;case"checkbox":this._elements.input=i("oo-checkbox",{slot:"item"}),this.append(this._elements.input),this._elements.input.text=this._props.label,this.checkbox=this._elements.input;break;case"radio":this._elements.input=i("oo-radio",{slot:"item"}),this.append(this._elements.input),this._elements.input.text=this._props.label,this._elements.input.name=this._props.radiogroup,this.radio=this._elements.input;break;case"hr":this._elements.hr=i("hr",{slot:"item"}),this.append(this._elements.hr),i.removeClass(this._content,"enabled");break}}};m(v5,"prop",{css:"",cssLink:"",skin:"",icon:"",label:"",type:"command",disabled:!1,checked:!1,radiogroup:""});let N4=v5;customElements.get("oo-menu-item")||customElements.define("oo-menu-item",N4);class Ps{constructor(n,t){h(this,b5);h(this,_5);h(this,L5);h(this,x5);m(this,"options",{css:"",cssLink:"",skin:""});this.options=Object.assign(this.options,t),this.target=n,this.container=this.options.container||i.getOffsetParent(n),this.area=this.options.area;const e=this.options.event||"click";this.target.addEventListener(e,()=>{this.show()}),this.target.addEventListener("mousedown",s=>{})}show(){this.menu||a(this,b5,o9).call(this),a(this,x5,d9).call(this),this.menu.show()}hide(){this.menu.hide()}destroy(){this.menu.remove()}}b5=new WeakSet,o9=function(){var n;this.menu=i("oo-menu",(n=this.options)==null?void 0:n.attr),this.container.append(this.menu),this.options.items&&this.options.items.length&&a(this,_5,l9).call(this),this.options.class&&i.addClass(this.menu,this.options.class)},_5=new WeakSet,l9=function(){this.options.items.forEach(n=>{a(this,L5,a9).call(this,n)})},L5=new WeakSet,a9=function(n){const t=document.createElement("oo-menu-item");this.menu.append(t),n==="-"?t.setAttribute("type","hr"):(Object.keys(n).forEach(e=>{e!=="command"?t.setAttribute(L(e),n[e]):t.addEventListener("click",n.command)}),t.addEventListener("click",e=>{this.menu.dispatchEvent(new CustomEvent("command",{detail:n}))}))},x5=new WeakSet,d9=function(){const n=i.getSize(this.target),t=i.getPosition(this.target,this.container),e=i.getSize(this.menu);let s=t.y+n.y,o=t.x,d="left",c="top";if(this.area){const u=i.getSize(this.area),C=i.getPosition(this.container,this.area);C.x+o+e.x>u.x&&(o=o-e.x+n.x,d="right"),C.y+s+e.y>u.y&&(s=s-e.y-n.y,c="bottom")}i.setStyles(this.menu,{top:s+"px",left:o+"px","transform-origin":`${d} ${c}`})};class Fs extends Ps{constructor(t,e){super(t,e);h(this,w5);h(this,y5);h(this,k5);h(this,x1,null);h(this,mn,null);h(this,Cn,null);m(this,"options",{css:"",cssLink:"",skin:"",view:"date",mode:"datetime",baseDate:null,secondEnable:!0,cleanEnable:!1,todayEnable:!0,datetimeRange:"",dateRange:"",timeRange:"",format:"",weekBegin:1,value:""});this.options=Object.assign(this.options,e)}reset(t){if(this.options=Object.assign(this.options,t),this.calendar)for(let e in this.options)v(this.options[e])!=="null"&&this.calendar.setAttribute(L(e),this.options[e])}show(){this.menu||a(this,w5,h9).call(this),a(this,k5,p9).call(this),this.menu.show()}}x1=new WeakMap,mn=new WeakMap,Cn=new WeakMap,w5=new WeakSet,h9=function(){var t;this.menu=i("oo-menu",(t=this.options)==null?void 0:t.attr),this.container.append(this.menu),p(this,x1,i("div",{slot:"items",styles:{height:"100%"}})),this.menu.append(l(this,x1)),a(this,y5,c9).call(this),this.options.class&&i.addClass(this.menu,this.options.class)},y5=new WeakSet,c9=function(){if(!this.calendar){let t="<oo-calendar";for(let e in this.options)v(this.options[e])!=="null"&&(t+=` ${L(e)}='${this.options[e]}'`);t+="></oo-calendar>",i.set(l(this,x1),"html",t),this.calendar=l(this,x1).firstElementChild,this.calendar.addEventListener("change",e=>{this.target.dispatchEvent(new CustomEvent("change",e))})}},k5=new WeakSet,p9=function(){const t=i.getSize(this.target),e=i.getPosition(this.target,this.container),s=i.getSize(this.menu);let o=e.y+t.y,d=e.x,c="left",u="top";if(this.area){const C=i.getSize(this.area),g=i.getPosition(this.container,this.area);g.x+d+s.x>C.x&&(d=d-s.x+t.x,c="right"),g.y+o+s.y>C.y&&(o=o-s.y-t.y,u="bottom")}i.setStyles(this.menu,{top:o+"px",left:d+"px","transform-origin":`${c} ${u}`})};function Is(r,n){return new Fs(r,n)}const Wt=class Wt extends P{constructor(){super();m(this,"_elements",{content:null,top:null,prev:null,next:null,date:null,dateContent:null});h(this,gn,{});h(this,Y,null);h(this,et,null);m(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)},baseDate:()=>{this.setCurrentDate(),this.setDateContent()},weekBegin:()=>{this.setWeekTitle(),this.setDateContent()},$default:t=>{}});this._initialize("oo-calendar-view",Wt,F0,I0)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}static parseDate(t,e){return t?v(t)==="date"?e?new Date(t.getTime()):t:new Date(t):null}_render(){this.setCurrentDate()}_connected(){this.setWeekTitle(),this.setDateContent()}_setEvent(){this._elements.prev.addEventListener("click",t=>{K(l(this,Y),"month",-1),this.setDateContent(),this.changeDate()}),this._elements.next.addEventListener("click",t=>{K(l(this,Y),"month",1),this.setDateContent(),this.changeDate()}),this._elements.date.addEventListener("change",t=>{p(this,Y,t.detail.date),this._elements.date.textContent=j(l(this,Y),this._props.format),this.setDateContent()})}setCurrentDate(){p(this,Y,this._props.baseDate?Wt.parseDate(this._props.baseDate,!0):new Date),this.changeDate()}changeDate(){this._elements.date.textContent=j(l(this,Y),this._props.format),l(this,et)?l(this,et).reset({value:j(l(this,Y),"YYYY-MM")}):p(this,et,Is(this._elements.date,{mode:"month",format:this._props.format,container:document.body,value:j(l(this,Y),"YYYY-MM")})),this.dispatchEvent(new CustomEvent("change",{detail:{date:l(this,Y),value:j(l(this,Y),"YYYY-MM")}}))}setWeekTitle(){const t=this._elements.dateContent.querySelectorAll("th");this._props.daysTitles.forEach((e,s)=>{t[(7+s-this._props.weekBegin)%7].textContent=e})}setDateContent(){const t=D(new Date).getTime(),e=D(l(this,Y),!0);e.setDate(1);const s=this._elements.dateContent.querySelectorAll("td"),o=new Date(e.getTime());o.setDate(o.getDate()-1);const d=(7+o.getDay()+1-this._props.weekBegin)%7,c=(u,C)=>{u.querySelectorAll("slot").forEach(A=>A.remove());const g=j(C,"YYYY-MM-DD"),f=i("slot",{name:`title-${g}`});u.querySelector("div.cellTitle").appendChild(f);const x=i("slot",{name:`content-${g}`});u.querySelector("div.cellContent").appendChild(x),u.querySelector("span:first-child").textContent=j(C,"D"),u.dataset.dateValue=g,i.checkClass(u,"today",C.getTime()===t),i.checkClass(u,"other",C.getMonth()!==l(this,Y).getMonth())};for(let u=d-1;u>=0;u--)c(s[u],o),o.setDate(o.getDate()-1);for(let u=d;u<s.length;u++)c(s[u],e),e.setDate(e.getDate()+1)}};gn=new WeakMap,Y=new WeakMap,et=new WeakMap,m(Wt,"prop",{baseDate:"",weekBegin:1,format:"YYYY年MM月",months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],daysTitles:["周日","周一","周二","周三","周四","周五","周六"]});let $4=Wt;const j0=`.content {\r
...
`,Z0='<div class="capsulae content"></div>',M5=class M5 extends P{constructor(){super();h(this,E5);m(this,"_setPropMap",{skin:()=>{this._useSkin(this._props.skin)}});this._init("oo-capsulae")}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_init(t,e,s,o){this._initialize(t,e||M5,s||Z0,o||j0)}_render(){new MutationObserver(function(e){e.forEach(s=>{s.addedNodes.forEach(o=>{o.nodeType===Node.ELEMENT_NODE&&this._content.appendChild(o)})})}).observe(this,{subtree:!1,childList:!0,attributes:!1,characterData:!1}),a(this,E5,u9).call(this)}};E5=new WeakSet,u9=function(){let t=this.firstElementChild;for(;t;)this._content.appendChild(t),t=this.firstElementChild},m(M5,"prop",{skin:""});let j4=M5;const z0=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    --padding:  0.8rem;\r
...
`,J5=class J5 extends P{constructor(){super();h(this,K5);h(this,G5);m(this,"_elements",{container:null,content:null,icon:null,title:null,text:null,close:null});h(this,$2,null);m(this,"_setPropMap",{title:()=>{this._elements.title.textContent=this._props.title},text:()=>{this._elements.text.textContent=this._props.text},icon:()=>{i.toggleClass(this._elements.icon,`ooicon-${this._props.icon}`,this._props.icon)},titleStyle:()=>{this._elements.title.setAttribute("style",this._props.titleStyle)},textStyle:()=>{this._elements.text.setAttribute("style",this._props.textStyle)},type:()=>{a(this,G5,O9).call(this)},skin:()=>{a(this,K5,D9).call(this).then()},showClose:()=>{i[this._props.showClose?"removeClass":"addClass"](this._elements.close,"hide")},width:()=>{this._props.width&&i.setStyle(this._elements.container,"width",this._props.width)},height:()=>{this._props.width&&i.setStyle(this._elements.container,"height",this._props.height)},contentAlign:()=>{this._props.contentAlign?i.addClass(this._elements.content,"align_"+this._props.contentAlign):i.removeClass(this._elements.content,"align_left align_right align_center")},contentValign:()=>{this._props.contentValign?i.addClass(this._elements.content,"align_"+this._props.contentValign):i.removeClass(this._elements.content,"valign_left valign_right valign_center")},style:()=>{i.toggleAttr(this._elements.container,"style",this._props.style)},$default:t=>{i.toggleAttr(this._elements.container,t,this._props[t])}});this._initialize("oo-notice",J5,x7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_setEvent(){this._elements.close.addEventListener("click",()=>{this.style.opacity=0,window.setTimeout(()=>{this.remove()},200)})}};$2=new WeakMap,K5=new WeakSet,D9=async function(){l(this,$2)&&(l(this,$2).remove(),p(this,$2,null)),p(this,$2,document.createElement("style")),l(this,$2).textContent=!this._props.skin||this._props.skin==="default"?(await Promise.resolve().then(()=>qs)).default:(await L7(Object.assign({"./template/notice.banner.scope.css":()=>Promise.resolve().then(()=>hi),"./template/notice.default.scope.css":()=>Promise.resolve().then(()=>qs)}),`./template/notice.${this._props.skin}.scope.css`)).default,this.shadowRoot.prepend(l(this,$2)),this.dispatchEvent(new CustomEvent("skinLoaded"))},G5=new WeakSet,O9=function(){const t="container "+this._props.type||"info";if(this._elements.container.setAttribute("class",t),!this._props.icon){const s="icon "+{info:"ooicon-info",error:"ooicon-error",warn:"ooicon-help",success:"ooicon-check"}[this._props.type]||"ooicon-info";this._elements.icon.setAttribute("class",s)}},m(J5,"prop",{title:"",text:"",icon:"",titleStyle:"",textStyle:"",showClose:!0,type:"info",skin:"default",contentAlign:"",contentValign:"",width:"",height:""});let H4=J5;customElements.get("oo-notice")||customElements.define("oo-notice",H4);const q=class q{constructor(n){h(this,Q5);h(this,se);h(this,t3);h(this,e3);h(this,ie);h(this,n3);h(this,at);h(this,s3);h(this,i3);h(this,l3);m(this,"options",{title:"",text:"",icon:"",type:"info",skin:"default",style:"",showClose:!0,contentAlign:"",contentValign:"",width:"",height:"",container:"",duration:5e3,location:"topCenter",position:"absolute",marginTop:10,marginBottom:10,marginLeft:10,marginRight:10});m(this,"where",{x:"center",y:"top"});m(this,"location",{fromTop:null,toTop:null,fromBottom:null,toBottom:null,fromLeft:null,toLeft:null,fromRight:null,toRight:null});h(this,r3,{bottom:(n,t)=>{const e=i.getSize(this.node);this.location.toBottom=q.env.height+this.options.marginTop+this.options.marginBottom+t.y,this.location.fromBottom=this.location.toBottom-e.y,q.env.height+=e.y+this.options.marginTop+this.options.marginBottom},top:(n,t)=>{const e=i.getSize(this.node);this.location.toTop=q.env.height+this.options.marginTop+t.y,this.location.fromTop=this.location.toTop-e.y,q.env.height+=e.y+this.options.marginTop+this.options.marginBottom},middle:()=>{}});h(this,o3,{left:(n,t)=>{this.location.fromLeft=this.location.toLeft=t.x+this.options.marginLeft+this.options.marginRight},right:(n,t)=>{const e=i.getSize(n),o=i.getSize(i.getOffsetParent(n)).x-e.x-t.x;this.location.fromRight=this.location.toRight=o+this.options.marginRight},center:(n,t)=>{if(i.isHtml(n))i.addClass(this.node,"body-center");else{i.removeClass(this.node,"body-center");const e=i.getSize(n),s=i.getSize(this.node);this.location.fromLeft=this.location.toLeft=t.x+e.x/2-s.x/2}}});this.options=Object.assign(this.options,n),this.container=this.options.container&&i.el(this.options.container)||document.body;const t=i.isBody(this.container)?"fixed":this.options.position||"absolute";this.node=i("oo-notice."+this.options.skin+(t==="fixed"?".fixed":".absolute")),["title","text","icon","type","skin","style","showClose","contentAlign","contentValign","width","height"].forEach(e=>{this.node.setAttribute(e,this.options[e])}),this.container.append(this.node),this.node.addEventListener("skinLoaded",()=>{a(this,e3,j9).call(this)})}resetPosition(n){const t=n+this.options.marginTop+this.options.marginBottom,e=bs(this.where.y);this.location[`to${e}`]=this.location[`to${e}`]-t,this.location[`from${e}`]=this.location[`from${e}`]-t;const s={};s[this.where.y]=this.location[`to${e}`]+"px",a(this,at,M4).call(this,s,!0)}};Q5=new WeakSet,N9=function(){return q.env.notices.includes(this)||(q.env.notices.push(this),a(this,s3,z9).call(this),this.node._elements.close&&this.node._elements.close.addEventListener("click",()=>{a(this,ie,Vn).call(this)})),a(this,se,Bn).call(this)},se=new WeakSet,Bn=function(n){return a(this,at,M4).call(this,{top:this.location.fromTop+"px",left:this.location.fromLeft+"px",bottom:this.location.fromBottom+"px",right:this.location.fromRight+"px",opacity:0},n)},t3=new WeakSet,$9=function(n){return a(this,at,M4).call(this,{top:this.location.toTop+"px",left:this.location.toLeft+"px",bottom:this.location.toBottom+"px",right:this.location.toRight+"px",opacity:"1"},n)},e3=new WeakSet,j9=async function(){await a(this,Q5,N9).call(this),await a(this,t3,$9).call(this,!0)&&this.options.duration&&setTimeout(()=>{a(this,ie,Vn).call(this)},this.options.duration||3e3)},ie=new WeakSet,Vn=async function(){if(!this.isHidden){this.isHidden=!0,a(this,n3,Z9).call(this);const n=await a(this,se,Bn).call(this,!0);n&&n.propertyName==="opacity"&&(this.node.remove(),this.node=null)}},n3=new WeakSet,Z9=function(){const n=q.env.notices.indexOf(this),t=bs(this.where.y),e=Math.abs(this.location[`to${t}`]-this.location[`from${t}`]);q.env.height=q.env.height-e-this.options.marginTop-this.options.marginBottom;for(let s=n+1;s<q.env.notices.length;s++)q.env.notices[s].resetPosition(e);q.env.notices.splice(n,1)},at=new WeakSet,M4=function(n,t){return new Promise(e=>{if(t){i.addClass(this.node,"transition");const s=o=>{i.removeClass(this.node,"transition"),this.node.removeEventListener("transitionend",s),e(o)};this.node.addEventListener("transitionend",s),setTimeout(()=>{i.setStyles(this.node,n)},10)}else i.removeClass(this.node,"transition"),setTimeout(()=>{i.setStyles(this.node,n),e()},10)})},s3=new WeakSet,z9=function(){const n=a(this,l3,B9).call(this),t=i.isBody(this.container)?document.documentElement:this.container,e=a(this,i3,R9).call(this,t);l(this,r3)[n.y](t,e),l(this,o3)[n.x](t,e)},i3=new WeakSet,R9=function(n,t,e){const s=i("div");n.append(s);const o=i.getOffsetParent(s);return s.remove(),o===n?{x:0,y:0}:(()=>i.getPosition(n,i.getOffsetParent(n)))()},r3=new WeakMap,o3=new WeakMap,l3=new WeakSet,B9=function(){const n={left:"x",right:"x",center:"x",top:"y",bottom:"y",middle:"y"};return L(this.options.location).split("-").forEach(t=>{n[t]&&(this.where[n[t]]=t)}),this.where},m(q,"env",{notices:[],height:0});let Et=q;const T2={error:(r,n,t={},e)=>{e&&(t=Object.assign(t,{skin:"default",location:"topRight",marginTop:10,duration:5e3}));const o=Object.assign({title:r,text:n,duration:0,skin:"banner",marginTop:0,type:"error"},t);new Et(o);let d;throw d=new Error(n,{cause:o.err}),d.name=r,d},msg:(r,n,t,e={})=>{const s=Object.assign({title:r,text:n,duration:5e3,type:t,location:"topRight",marginTop:10},e);new Et(s)},failed:(r,n,t={})=>{const e=Object.assign({duration:8e3},t);T2.msg(r,n,"error",e)},success:(r,n,t={})=>{T2.msg(r,n,"success",t)},info:(r,n,t={})=>{T2.msg(r,n,"info",t)},warn:(r,n,t={})=>{T2.msg(r,n,"warn",t)}},w7=`
...
`,F7=Object.assign({"./styles/tooltip/deep.css":()=>Promise.resolve().then(()=>t6),"./styles/tooltip/default.css":()=>Promise.resolve().then(()=>e6),"./styles/tooltip/toolbar.css":()=>Promise.resolve().then(()=>n6)}),j2=class j2{constructor(n,t,e){h(this,L3);h(this,x3);h(this,w3);h(this,y3);h(this,k3);h(this,de);h(this,he);h(this,E3);h(this,M3);h(this,ce);h(this,S3);h(this,pe);h(this,A3);this.content=n,this.target=t,this.options=Object.assign({},j2.option,e),a(this,L3,Q9).call(this),a(this,A3,l8).call(this),this.showFun||(this.showFun=this.show.bind(this)),this.hideFun||(this.hideFun=this.hide.bind(this)),this.options.events?a(this,ce,Un).call(this):z(this.showFun,this.options.defer,this)}close(){i.setStyles(this.node,{opacity:0}),this.hideTimeout=window.setTimeout(()=>{this.container.remove()},600)}hide(){i.setStyles(this.node,{opacity:0}),this.hideTimeout=window.setTimeout(()=>{i.addClass(this.node,"hide"),i.removeClass(this.node,"show"),this.p&&i.setStyles(this.node,{left:this.p.fromX+"px",top:this.p.fromY+"px"}),a(this,w3,e8).call(this)},600)}async show(){if(!this.target||!this.target.isConnected)return null;this.hideTimeout&&(clearTimeout(this.hideTimeout),this.hideTimeout=null),i.removeClass(this.node,"hide"),i.addClass(this.node,"show"),a(this,x3,t8).call(this),await a(this,ce,Un).call(this),await a(this,S3,o8).call(this),this.contentNode.childNodes.length&&(i.removeClass(this.node,"hide"),i.addClass(this.node,"show"),this.p=a(this,k3,s8).call(this),i.setStyles(this.node,{left:this.p.fromX+"px",top:this.p.fromY+"px"}),i.setStyles(this.triangle,{left:this.p.flagX+"px",top:this.p.flagY+"px"}),window.setTimeout(()=>{i.setStyles(this.node,{opacity:1,left:this.p.x+"px",top:this.p.y+"px"}),a(this,E3,i8).call(this)},5)),(!this.target||!this.target.isConnected)&&this.hide()}};L3=new WeakSet,Q9=async function(){this.container=i("div.ootooltip_container"),this.node=i("div.ootooltip"),this.triangle=i(`div.ootooltip_triangle.${this.options.position}`),this.contentNode=i("div.ootooltip_content"),this.node.append(this.triangle),this.node.append(this.contentNode),this.container.append(this.node),a(this,y3,n8).call(this)},x3=new WeakSet,t8=function(){(this.options.container||document.body).append(this.container)},w3=new WeakSet,e8=function(){this.container.remove()},y3=new WeakSet,n8=function(){this.options.events&&(this.options.events.show&&(this.options.events.show.split(/\s*,\s*/g).forEach(t=>{this.target.addEventListener(t,e=>{this.hideFun.clear&&this.hideFun.clear(),z(this.showFun,this.options.defer,this)})}),this.options.showOnEnterCotent&&this.container.addEventListener("mouseenter",()=>{this.hideFun.clear&&this.hideFun.clear()})),this.options.events.hide&&(this.options.events.hide.split(/\s*,\s*/g).forEach(t=>{this.target.addEventListener(t,()=>{this.showFun.clear&&this.showFun.clear(),z(this.hideFun,100,this)})}),this.options.showOnEnterCotent&&this.container.addEventListener("mouseleave",()=>{this.showFun.clear&&this.showFun.clear(),z(this.hideFun,100,this)})))},k3=new WeakSet,s8=function(){const n=this.options.container?{x:this.target.offsetLeft,y:this.target.offsetTop}:i.getPosition(this.target),t=i.getSize(this.target),e=i.getSize(this.node),s=i.getSize(this.triangle).x/2;let o=a(this,he,qn).call(this,this.options.position,n,t,e,s);switch(this.options.position){case"top":o.y<0&&(o=a(this,de,Yn).call(this,"bottom",n,t,e,s));break;case"left":o.x<0&&(o=a(this,de,Yn).call(this,"right",n,t,e,s));break}if((this.options.position==="top"||this.options.position==="bottom")&&o.x<0){const d=o.x;o.flagX+=d,o.x=0,o.fromX=0}if((this.options.position==="left"||this.options.position==="right")&&o.y<0){const d=o.y;o.flagY+=d,o.y=0,o.fromY=0}return o},de=new WeakSet,Yn=function(n,t,e,s,o){return i.removeClass(this.triangle,this.options.position),i.addClass(this.triangle,n),this.options.position=n,a(this,he,qn).call(this,this.options.position,t,e,s,o)},he=new WeakSet,qn=function(n,t,e,s,o){const d={},c=this.options.emerge||0,u=this.options.offset||this.options.offset===0?this.options.offset:3;switch(n){case"bottom":d.x=d.fromX=t.x+e.x/2-s.x/2,d.y=t.y+e.y+o+u,d.fromY=d.y-c,d.flagX=s.x/2-o,d.flagY=0-o;break;case"left":d.x=t.x-s.x-o-u,d.fromX=d.x+c,d.y=d.fromY=t.y+e.y/2-s.y/2,d.flagX=s.x-o,d.flagY=s.y/2-o;break;case"right":d.x=t.x+e.x+o+u,d.fromX=d.x-c,d.y=d.fromY=t.y+e.y/2-s.y/2,d.flagX=0-o,d.flagY=s.y/2-o;break;default:d.x=d.fromX=t.x+e.x/2-s.x/2,d.y=t.y-s.y-o-u,d.fromY=d.y+c,d.flagX=s.x/2-o,d.flagY=s.y-o}return d},E3=new WeakSet,i8=function(){this.options.autoClose>0&&window.setTimeout(()=>{this[this.options.events?"hide":"close"]()},this.options.autoClose)},M3=new WeakSet,r8=async function(n){const t=await F7[`./styles/tooltip/${n}.css`]();return ks(t.default,this.container)},ce=new WeakSet,Un=async function(){const n=j2.loadedStyles[this.options.style||"default"];if(n){const t=await Promise.resolve(n);i.addClass(this.container,t.id)}else{const t=this.options.style||"default";j2.loadedStyles[t]=a(this,M3,r8).call(this,t),j2.loadedStyles[t]=await j2.loadedStyles[t]}},S3=new WeakSet,o8=async function(){if(this.options.resetContentOnShow||!this.contentLoaded)return this.target.dispatchEvent(new MouseEvent("tooltip")),i.empty(this.contentNode),this.contentLoaded=!0,await a(this,pe,Xn).call(this,this.content),""},pe=new WeakSet,Xn=async function(n){switch(v(n)){case"string":i.set(this.contentNode,"html",n);break;case"element":this.contentNode.append(n);break;case"function":const t=await Promise.resolve(n());await a(this,pe,Xn).call(this,t)}},A3=new WeakSet,l8=function(){this.observerNode=this.observerNode||this.target.parentElement;var n=new MutationObserver((t,e)=>{if(t[0].removedNodes&&t[0].removedNodes.length){for(let s of t[0].removedNodes)if(s===this.target){this.hide(),e.disconnect();break}}});this.observerNode&&n.observe(this.observerNode,{childList:!0})},m(j2,"option",{position:"top",style:"default",autoClose:0,emerge:-8,offset:6,defer:600,events:{show:"mouseover",hide:"mouseout, mousedown"},showOnEnterCotent:!1,resetContentOnShow:!1,container:null}),m(j2,"loadedStyles",{});let Mt=j2;function Hs(r,n,t){return new Mt(r,n,t)}const I7=`
<div class="content">
    <div class="icon"></div>
    <div class="text"></div>
</div>
`,F3=class F3 extends P{constructor(){super();h(this,t1);h(this,T3);h(this,Z2);h(this,P3);m(this,"_elements",{icon:null,text:null});m(this,"_setPropMap",{type:()=>{this._canRender()&&a(this,Z2,j1).call(this)},value:()=>{this._canRender()&&(a(this,Z2,j1).call(this),a(this,t1,Lt).call(this))},data:()=>{this._canRender()&&(a(this,Z2,j1).call(this),a(this,t1,Lt).call(this))},text:()=>{this._props.text?this._elements.text.textContent=this._props.text:a(this,t1,Lt).call(this)},entity:()=>{this._canRender()&&(a(this,Z2,j1).call(this),a(this,t1,Lt).call(this))},isTooltip:()=>{this.tooltip=this._props.isTooltip!==!1?this.tooltip||this.defaultTooltip:null},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-org",F3,I7,P7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_canRender(){return super._canRender(null,["value","data"])}_render(){this._canRender()&&a(this,Z2,j1).call(this)}_connected(){this._canRender()&&(a(this,Z2,j1).call(this),a(this,t1,Lt).call(this)),this.tooltip=this._props.isTooltip!==!1?this.defaultTooltip:null,this.tip||(this.tip=Hs(async()=>v(this.tooltip)==="function"?await this.tooltip():this.tooltip,this))}defaultTooltip(){const t=i("oo-card",{value:this.value,data:JSON.stringify(this.data),skin:"border: 0; shadow: 0"});return new Promise(e=>{t.addEventListener("loaded",()=>{e(t)})})}};t1=new WeakSet,Lt=function(){this._props.text?this._elements.text.textContent=this._props.text:this._props.value?this._elements.text.textContent=t5(this._props.value):this._elements.text.textContent=a(this,T3,a8).call(this,this._props.data)},T3=new WeakSet,a8=function(t){return t.dn?t5(t.dn):t.name},Z2=new WeakSet,j1=function(){switch(this._props.type){case"text":i.addClass(this._elements.icon,"hide");break;case"text-border":i.checkClass(this._content,"border",this._props.type==="text-border"),i.addClass(this._elements.icon,"hide");break;default:i.checkClass(this._content,"border",this._props.type==="border");const t=a(this,P3,d8).call(this,this._props.entity||Z4(this._props.value||this._props.data));v(t)==="function"?i.setStyle(this._elements.icon,"background-image",`url('${t(this._props.value||this._props.data)}')`):i.addClass(this._elements.icon,t),i.removeClass(this._elements.icon,"hide")}},P3=new WeakSet,d8=function(t){return{I:e=>{var s;return e5(((s=e.person)==null?void 0:s.dn)||e.dn||e)},P:e=>e5(e.dn||e),U:"ooicon-unit",G:"ooicon-group",R:"ooicon-role",UD:"ooicon-duty",UA:"ooicon-attribute",PA:"ooicon-attribute",PROCESS:"ooicon-process",APP:"ooicon-computer",A:"ooicon-activities",unknown:"ooicon-notes"}[t]},m(F3,"prop",{type:"simple",value:"",text:"",data:{},entity:"",cssLink:"",skin:"",isTooltip:!0});let K4=F3;const D7=`*{box-sizing:border-box}.content{--gap: .5em;--color: var(--oo-color-text2);--bg: var(--oo-default-radius);--radius: var(--oo-default-radius);--border: 1px solid var(--oo-color-gray-d);--hover-bg: var(--oo-color-light);--current-color: var(--oo-color-text-white);--current-bg: var(--oo-color-main)}.content{display:flex;gap:var(--gap);align-items:center}.prev,.next,.pages>div{padding:.2em;color:var(--color);background:var(--bg);border-radius:var(--radius);border:var(--border);cursor:pointer;display:flex;align-items:center;justify-content:center;min-width:1.788em;height:1.788em;transition:background .3s}.prev:hover,.next:hover,.pages>div:hover{background:var(--hover-bg)}.pages{display:flex;gap:var(--gap);align-items:center}.pages>.current{color:var(--current-color);background:var(--current-bg)}.pages>.current:hover{background:var(--current-bg)}.point3{transform:rotate(90deg);color:var(--color)}.jumper{margin-left:1em;display:flex;align-items:center;gap:.3em}.jumper oo-input{width:3.5em;text-align:center;-webkit-appearance:none;-moz-appearance:none;appearance:none}oo-input::-webkit-inner-spin-button,oo-input::-webkit-outer-spin-button{-webkit-appearance:none;-moz-appearance:none;appearance:none;margin:0}.hide{display:none}
...
`;function H1(r,n){r.apply(n||this)}const D3=class D3 extends P{constructor(){super();h(this,ue);h(this,me);h(this,z2);h(this,pt);h(this,R2);h(this,I3);h(this,Ce);h(this,ut);m(this,"_elements",{first:null,last:null,prev:null,next:null,pages:null,jumper:null,jumperTextLeft:null,jumperTextRight:null,jumperPageCount:null,jumperInput:null});m(this,"_setPropMap",{cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},current:(t,e)=>{t!==e&&H1(a(this,z2,Z1),this)},total:(t,e)=>{t!==e&&H1(a(this,z2,Z1),this)},pageSize:(t,e)=>{t!==e&&H1(a(this,z2,Z1),this)},pageCount:()=>{},pages:(t,e)=>{t!==e&&H1(a(this,z2,Z1),this)},first:()=>{a(this,ue,Kn).call(this)},last:()=>{a(this,me,Gn).call(this)},jumper:()=>{i.checkClass(this._elements.jumper,"hide",!this._props.jumper)},jumperText:()=>{this._props.jumperText||(this._props.jumperText="到第{n}页"),a(this,ut,A4).call(this)}});this._initialize("oo-pagination",D3,O7,D7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}async _render(){a(this,pt,S4).call(this),(this._props.pageCount>1||this._props.showSingle)&&(a(this,ue,Kn).call(this),a(this,me,Gn).call(this),H1(a(this,z2,Z1),this),a(this,ut,A4).call(this))}_setEvent(){this._elements.prev.addEventListener("click",()=>{this.gotoPrev()}),this._elements.next.addEventListener("click",()=>{this.gotoNext()}),this._elements.first.addEventListener("click",()=>{this.gotoFirst()}),this._elements.last.addEventListener("click",()=>{this.gotoLast()}),this._elements.jumperInput&&this._elements.jumperInput.addEventListener("keydown",t=>{if(t.key==="Enter"||t.keyCode===13){const e=this._elements.jumperInput;!isNaN(e.value)&&e.value&&(this.gotoPage(parseInt(e.value)),e.value="")}})}setCurrent(t){this._props.current=t,a(this,pt,S4).call(this)}gotoPage(t){this.setCurrent(t),this.dispatchEvent(new CustomEvent("page",{detail:this._props.current})),this.setAttribute("current",this._props.current),H1(a(this,z2,Z1),this)}pagesForward(){this.gotoPage(this._props.current+(this._props.pages-2))}pagesBack(){this.gotoPage(this._props.current-(this._props.pages-2))}gotoFirst(){this.gotoPage(1)}gotoLast(){this.gotoPage(this._props.pageCount)}gotoPrev(){this.gotoPage(--this._props.current)}gotoNext(){this.gotoPage(++this._props.current)}};ue=new WeakSet,Kn=function(){const t=this._props.first;this._elements.first.textContent=t,i.checkClass(this._elements.first,"hide",!t)},me=new WeakSet,Gn=function(){const t=this._props.last;this._elements.last.textContent=t,i.checkClass(this._elements.last,"hide",!t)},z2=new WeakSet,Z1=function(t,e,s){if(a(this,pt,S4).call(this),i.empty(this._elements.pages),this._props.pageCount>1||this._props.showSingle)if(this._props.pageCount<=this._props.pages)for(let o=1;o<=this._props.pageCount;o++)a(this,R2,z1).call(this,o);else{a(this,R2,z1).call(this,1);const o=this._props.pages-2,d=parseInt(o/2);let c;if(this._props.current-d<=2)for(let u=1;u<=o;u++)c=u+1,a(this,R2,z1).call(this,c);else if(this._props.current+d>=this._props.pageCount-1){a(this,Ce,Jn).call(this);for(let u=o;u>=1;u--)c=this._props.pageCount-u,a(this,R2,z1).call(this,c)}else{a(this,Ce,Jn).call(this);for(let u=0;u<o;u++)c=this._props.current-(d-u),a(this,R2,z1).call(this,c,s)}c<this._props.pageCount-1&&a(this,I3,h8).call(this),a(this,R2,z1).call(this,this._props.pageCount)}a(this,ut,A4).call(this)},pt=new WeakSet,S4=function(){this._props.pageCount=Math.ceil(this._props.total/this._props.pageSize),this._props.pageCount<1&&(this._props.pageCount=1),this._props.current<1&&(this._props.current=1),this._props.current>this._props.pageCount&&(this._props.current=this._props.pageCount)},R2=new WeakSet,z1=function(t){const e=document.createElement("div");e.textContent=t,t===this._props.current&&i.addClass(e,"current"),e.addEventListener("click",()=>{this.gotoPage(t)}),this._elements.pages.append(e)},I3=new WeakSet,h8=function(){const t=document.createElement("div");i.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesForward()}),this._elements.pages.append(t)},Ce=new WeakSet,Jn=function(){const t=document.createElement("div");i.addClass(t,"ooicon-point3 point3"),t.addEventListener("click",()=>{this.pagesBack()}),this._elements.pages.append(t)},ut=new WeakSet,A4=function(){const t=this._props.jumperText.split("{n}");this._elements.jumperTextLeft.textContent=t[0],this._elements.jumperTextRight.textContent=(t==null?void 0:t[1])??"",this._elements.jumperPageCount.textContent=this._props.pageCount},m(D3,"prop",{total:200,pageSize:20,pageCount:0,pages:10,current:1,showSingle:!0,jumper:!1,first:"第一页",last:"最后一页",jumperText:"到第{n}页",border:!0,cssLink:"",skin:""});let G4=D3;const N7=`.content{\r
    --radius: 100%;\r
}\r
.check{\r
    border-radius: var(--radius);\r
...
.check.checked{\r
    ...
    height: 0.4em;\r
    background-color: var(--checked);\r
}`;class $7 extends n5{constructor(){super(),this._init("oo-radio"),this._useCss(N7)}_unCheckedOther(){this.ownerDocument.querySelectorAll(`oo-radio[name='${this._props.name}']`).forEach(t=>{t!==this&&t.checked&&t._unchecked()})}_render(){this._elements.input.type="radio",this._elements.input.checked&&this._unCheckedOther(),super._render()}}class j7 extends s5{constructor(){super();h(this,O3);h(this,N3);a(this,O3,c8).call(this),this._init("oo-radio-group")}_appendItemCheckValue(t){this._props.value?t.value===this._props.value&&t.setAttribute("checked",!0):t._unchecked()}_itemChange(t){t.currentTarget.checked?this.value=t.currentTarget.value:this.value="",this._elements.input.value=this.value,this.unInvalidStyle()}_removeItem(t){super._removeItem(t)}get text(){return a(this,N3,p8).call(this)}}O3=new WeakSet,c8=function(){this.setPropMap=Object.assign(this._setPropMap,{value:()=>{if(this._props.value){for(const t of this._items)if(t.value===this._props.value){t.setAttribute("checked",!0);break}}this._elements.input.value=this._props.value,this._fillEmptyReadmode()}})},N3=new WeakSet,p8=function(){for(const t of this._items)if(t.checked)return t.text;return""};const Z7=`.content{\r
...
`,V3=class V3 extends P{constructor(){super();h(this,_e);m(this,"_setPropMap",{rows:()=>{a(this,_e,ss).call(this)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)}});this._initialize("oo-skeleton",V3,H7,V7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){a(this,_e,ss).call(this)}};_e=new WeakSet,ss=function(){i.empty(this._content);try{const t=parseInt(this._props.rows);for(let e=0;e<t;e++)this._content.append(i("div.item"))}catch{}},m(V3,"prop",{rows:"5",cssLink:"",skin:""});let tn=V3;const W7=`<div class="content">\r
		<slot name="before-outer"></slot>\r
		<div class="label hide">\r
			<div class="labelText hide"></div>\r
			<slot name="label"></slot>\r
...
`,U3=class U3 extends P{constructor(){super();h(this,Y3);h(this,q3);m(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},label:()=>{this.label&&(this.label.querySelector(".text").textContent=this._props.label,this.tabs.showSlider())},icon:t=>{if(this.label){const e=this.label.querySelector(".icon");this._props.icon?e?(i.removeClass(e,`ooicon-${t}`),i.addClass(e,`ooicon-${this._props.icon}`)):this.label.insertAdjacentElement("afterbegin",i(`div.icon.ooicon-${this._props.icon}`)):e&&e.remove(),this.tabs&&this.tabs.showSlider()}},rightIcon:t=>{if(this.label){const e=this.label.querySelector(".rightIcon");this._props.rightIcon?e?(i.removeClass(e,`ooicon-${t}`),i.addClass(e,`ooicon-${this._props.rightIcon}`)):this.label.insertAdjacentElement("beforeend",i(`div.rightIcon.ooicon-${this._props.rightIcon}`)):e&&e.remove(),this.tabs&&this.tabs.showSlider()}}});m(this,"label",null);m(this,"tabs",null);this._initialize("oo-tab",U3,U7,q7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_render(){this._fillContent("content")}_connected(){this.tabs=i.getParent(this,"oo-tabs"),this.tabs&&a(this,Y3,b8).call(this)}_disconnected(){this.label&&this.label.remove()}selected(){this.label&&i.addClass(this.label,"current"),i.removeClass(this,"hide"),this.dispatchEvent(new CustomEvent("current"))}unselected(){this.label&&i.removeClass(this.label,"current"),i.addClass(this,"hide"),this.dispatchEvent(new CustomEvent("uncurrent"))}};Y3=new WeakSet,b8=function(){this.label||a(this,q3,_8).call(this);const t=this.previousElementSibling;t&&t.label?t.label.insertAdjacentElement("afterend",this.label):this.tabs._elements.labels.insertAdjacentElement("afterbegin",this.label),this.setAttribute("slot","pane"),this!==this.tabs.currentTab&&i.addClass(this,"hide"),this.tabs._checkCurrentTab()},q3=new WeakSet,_8=function(){this.label=i("div.label"),this._props.icon&&this.label.append(i(`div.icon.ooicon-${this._props.icon}`)),this.label.append(i("div.text",{text:this._props.label||"New Tab"})),this._props.rightIcon&&this.label.append(i(`div.rightIcon.ooicon-${this._props.rightIcon}`)),this.label.addEventListener("click",()=>{this.tabs.setCurrent(this)})},m(U3,"prop",{css:"",cssLink:"",skin:"",label:"",icon:"",rightIcon:""});let nn=U3;const X7=`* {\r
    box-sizing: border-box;\r
}\r
.content{\r
    display: block;\r
...
`,K3=class K3 extends P{constructor(){super();h(this,X3);m(this,"_elements",{labels:null,panes:null,slider:null});m(this,"_setPropMap",{css:()=>{this.useCss(this._props.css)},cssLink:()=>{this.useCssLink(this._props.cssLink)},skin:()=>{this._useSkin(this._props.skin)},position:t=>{i.removeClass(this._content,t),i.addClass(this._content,this._props.position),i.removeClass(this._elements.labels,t),i.addClass(this._elements.labels,this._props.position),i.removeClass(this._elements.slider,t),i.addClass(this._elements.slider,this._props.position)},current:()=>{this._checkCurrentTab()}});m(this,"currentTab",null);this._initialize("oo-tabs",K3,K7,X7)}static get observedAttributes(){return Object.keys(this.prop).map(t=>L(t))}_checkCurrentTab(){const e=this.querySelectorAll("oo-tab").item(this._props.current);e&&e!==this.currentTab&&this.setCurrent(e)}setCurrent(t){if(this.currentTab&&(this.currentTab.unselected(),this.currentTab=null),t){const e=this.querySelectorAll("oo-tab");let s=0;for(const o of e){if(o===t)break;s++}this._props.current=s,this.currentTab=t,t.selected(),this.showSlider()}else a(this,X3,L8).call(this)}showSlider(){const t=i.getPosition(this.currentTab.label,this._elements.labels),e=i.getSize(this.currentTab.label);if(this._props.position==="top"||this._props.position==="bottom"){const s=this._elements.labels.scrollLeft,o=t.x+s;i.setStyles(this._elements.slider,{left:o+"px",width:e.x+"px"})}else{const s=this._elements.labels.scrollTop,o=t.y+s;i.setStyles(this._elements.slider,{top:o+"px",height:e.y+"px"})}}};X3=new WeakSet,L8=function(){i.setStyles(this._elements.slider,{left:0,width:0})},m(K3,"prop",{css:"",cssLink:"",skin:"",position:"top",current:0});let sn=K3;const G7=`<div class="button content">\r
	<div class="box">\r
...
/* ---------------------------------------------- */`,_n=class _n extends i2{constructor(){super();h(this,J3);a(this,J3,w8).call(this),this._init("oo-textarea"),this._useCss(ti)}_init(t){this._initialize(t,_n,Q7,Zs)}_setEvent(){super._setEvent(),this._elements.input.addEventListener("input",()=>{this.setHeight()}),i.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()}setHeight(){if(this._props.autoSize){this._elements.input.style.height="auto";const t=this._elements.input.scrollHeight;this._elements.input.style.height=t+"px"}}};J3=new WeakSet,w8=function(){this._setPropMap=Object.assign(this._setPropMap,{autoSize:()=>{i.toggleClass(this._elements.input,"autosize",this._props.autoSize),this.setHeight()},value:()=>{try{this._elements.input.value=this._props.value}catch{}this._props.value?this._elements.viewText.textContent=this._props.value:this._elements.viewText.innerHTML="-",window.setTimeout(()=>{this.setHeight()},10)}})};let on=_n;const ei=`.content{\r
...
`},Symbol.toStringTag,{value:"Module"}));return _.DatetimePicker=Fs,_.Dialog=Rs,_.Dragdrop=ai,_.Draggable=Ys,_.Menu=Ps,_.Notice=Et,_.Tooltip=Mt,_.confirm=Vs,_.datetimePicker=Is,_.defineComponent=di,_.dialog=Bs,_.mask=oi,_.notice=T2,_.tooltip=Hs,_.unmask=li,Object.defineProperty(_,Symbol.toStringTag,{value:"Module"}),_}({});
