...
(function () {
    ...
    var read = function (normalizeCss, image) {
        ...
        return {
            ...
            "data-filename": getAttrib(image, 'data-filename'),
    ...
    var write = function (normalizeCss, newData, image) {
        ...
        updateProp(image, oldData, newData, 'data-filename', updateAttrib);
    };
    ...
    var toImageData = function (data, removeEmptyAlt) {
        return {
            ...
            "data-filename": data["data-filename"],
    ...
    var formFillFromMeta2 = function (info, data, meta) {
        ...
        if (isString(meta["data-filename"])) {
            data["data-filename"] = meta["data-filename"];
        }
