...
(function () {
        ...
        return ir.toBlob().then(function (blob) {
            ...
            editor.undoManager.transact(function () {
                ...
                if( images_upload_handler ) {
                    ...
                    var name = editor.$(selectedImage).attr("alt") || blobInfo.name();
        ...
        return function () {
            ...
            originalImgOpt.each(function (img) {
                getEditableImage(editor, img.dom).each(function (_) {
                    var id = img.dom.getAttribute("data-orgid") || img.dom.getAttribute("data-id");
                    if( id ) {
                        new Element("img", {
                            src: MWF.xDesktop.getImageSrc(id),
                            events: {
                                "load": function () {
                                    //this.naturalWidth && this.naturalHeight
                                    findBlob(editor, this).then(function (blob) {
    ...
    function Plugin () {
        global$4.add('o2imagetools', function (editor) {
