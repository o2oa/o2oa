...
( function() {
	...
	CKEDITOR.plugins.add( 'o2image', {
		...
		init: function( editor ) {
			...
			var allowed = 'img[alt,!src,onerror,data-originalid,data-enablepreview,data-id]{border-style,border-width,float,height,margin,margin-bottom,margin-left,margin-right,margin-top,width}',
				required = 'img[alt,src]';

			if ( CKEDITOR.dialog.isTabEnabled( editor, pluginName, 'advanced' ) )
				allowed = 'img[alt,dir,id,lang,longdesc,!src,title,onerror,data-originalid,data-enablepreview,data-id]{*}(*)';
