...
<template>
    <div class="im-chat-row">
            ...
            <div class="im-chat-footer">
                ...
                <div class="im-chat-footer-input" v-else>
                    ...
                    <div class="im-chat-footer-input-text">
                        <textarea id="chatMsgNode" v-model="inputMsg" :placeholder="lp.enterMessage" @keydown="inputKeyupEvent"></textarea>
                    </div>
        ...
        <!--  聊天信息 -->
        <ChatInfo v-if="showChatInfo && conversation" :conversation="conversation" @closeChatInfo="showChatInfo = false"></ChatInfo>
    </div>
</template>
