...
MWF.xApplication.ProcessTool.TaskDone = new Class({
    ...
    loadOperate: function () {
        ...
        this.fileterForm = new MForm(this.fileterNode, {}, {
            ...
            itemTemplate: {
                        ...
                        click: function (e) {
                            ...
                            this.form.app.confirm("warn", e.node, "提示", "您确定要删除吗？", 350, 120, function () {
                                ...
                                checkedItems.each(function (item){
                                    ...
                                    _self.view._removeTaskDone(item.data);
                                }.bind(this));
                ...
                back: {
                    "value": "撤回", type: "button", className: "filterButtonGrey", event: {
                        click: function (e) {

                            var checkedItems = this.view.getCheckedItems();
                            var _self = this;
                            this.form.app.confirm("warn", e.node, "提示", "您确定要撤回吗？", 350, 120, function () {

                                checkedItems.each(function (item){
                                    //item.node.setStyles(item.css.documentNode_remove);
                                    _self.view._retract(item.data);
                                }.bind(this));

                                this.close();
                                _self.form.app.notice("撤回成功","success");
                                _self.loadView();
...
MWF.xApplication.ProcessTool.TaskDone.View = new Class({
    ...
    _getCurrentPageData: function (callback, count, pageNum) {
        ...
        this.app.action.TaskCompletedAction.manageListFilterPaging(pageNum, count, filter, function (json) {
    ...
    _setTaskDoneOpinion : function (id,opinion){
        this.app.action.TaskCompletedAction.manageOpinion(id,{"opinion":opinion},function(json){
        },null,false);
    },
    _removeTaskDone : function (data){
        this.app.action.TaskCompletedAction.manageDelete(data.id,function (){},null,false);
    },
    _create: function () {

    },
    _retract : function (data){
        this.app.action.WorkAction.V2ManageRetract(data.work,data.person,function (){},null,false);
    },
    _open: function (data) {
...
MWF.xApplication.ProcessTool.TaskDone.Document = new Class({
            ...
            "buttonList": [
                {
                    "text": "确认",
                    "action": function () {
                        this.view._setTaskDoneOpinion(this.data.id,textareaNode.get("value"));
    ...
    remove : function (e){
        ...
        this.explorer.app.confirm("warn", e, "提示", "确认是否删除", 350, 120, function () {
            ...
            _self.view._removeTaskDone(_self.data);
