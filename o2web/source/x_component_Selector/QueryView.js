...
MWF.xApplication.Selector.QueryView = new Class({
    ...
    _newItemCategory: function(data, selector, item, level){
        return new MWF.xApplication.Selector.QueryView.ItemCategory(data, selector, item, level)
    },
    ...
    _newItemSelected: function(data, selector, item){
        return new MWF.xApplication.Selector.QueryView.ItemSelected(data, selector, item)
    },
...
MWF.xApplication.Selector.QueryView.ItemCategory = new Class({
