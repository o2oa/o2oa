...
MWF.xApplication.Selector.Agent = new Class({
    ...
    setInitTitle: function(){
        this.setOptions({"title": MWF.xApplication.Selector.LP.selectAgent});
    },
    _init : function(){
        this.selectType = "agent";
        this.className = "Agent";
    },
    loadSelectItems: function(addToNext){
        o2.Actions.load('x_program_center').AgentAction.list(function(json){
    ...
    _newItemSelected: function(data, selector, item){
        return new MWF.xApplication.Selector.Agent.ItemSelected(data, selector, item)
    },
    _listItemByPinyin: function(callback, failure, key){
        return false;
    },
    _newItem: function(data, selector, container, level){
        return new MWF.xApplication.Selector.Agent.Item(data, selector, container, level);
    }
});
MWF.xApplication.Selector.Agent.Item = new Class({
...
MWF.xApplication.Selector.Agent.ItemSelected = new Class({
