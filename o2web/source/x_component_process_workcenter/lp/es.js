MWF.xApplication.process.workcenter.LP = {
	...
	"filterCategoryList": [
		{"key": "applicationList", "name": "Nombre de la aplicación"},
		{"key": "processList", "name": "Nombre del flujo de trabajo"},
		{"key": "activityNameList", "name": "Actividad de procesamiento"},
		{"key": "creatorUnitList", "name": "Departamento creador"},
		{"key": "startTimeMonthList", "name": "Mes de recepción"},
		{"key": "completedTimeMonthList", "name": "Mes de procesamiento"},
		{"key": "completedList", "name": "Completado o no"},
		{"key": "key", "name": "Palabra clave"}
	],
	"filterCategoryShortList": [
		{"key": "applicationList", "name": "Aplicación"},
		{"key": "processList", "name": "Flujo de trabajo"},
		{"key": "activityNameList", "name": "Actividad"},
		{"key": "creatorUnitList", "name": "Departamento"},
		{"key": "startTimeMonthList", "name": "Recepción mensual"},
		{"key": "completedTimeMonthList", "name": "Procesamiento mensual"},
		{"key": "completedList", "name": "Completado"},
		{"key": "key", "name": "Palabra clave"}
	],
