MWF.xApplication.WorkApplication.options.multitask = false;
o2.xDesktop.requireApp("Selector", "package", null, false);
MWF.xDesktop.requireApp("Template", "MPopupForm", null, false);
MWF.xDesktop.requireApp("Template", "MForm", null, false);
MWF.xApplication.WorkApplication.Main = new Class({
	...
	options: {
		...
		"application": "",
		"id": "",
		"title": MWF.xApplication.WorkApplication.LP.title
	},
	onQueryLoad: function(){
		this.lp = MWF.xApplication.WorkApplication.LP;
	...
	loadApplicationIcon : function (e){
		...
		if (this.application.icon){
			...
			node.setStyle("background-image", "url("+"../x_component_WorkApplication/$Main/default/icon/application.png)");
		}
	},
	...
	_loadListContent: function(type){
		this.mainNode.empty();
		list = new MWF.xApplication.WorkApplication[type.capitalize() +"List"](this.mainNode,this, {
			"onLoadData": function (){
				this.hideSkeleton();
			},
			"type" : type,
...
MWF.xApplication.WorkApplication.List = new Class({
	Implements: [Options, Events],
	options: {
		"type": "all",
		"itemHeight": 40,
	...
	loadToolBar : function (availableTool){
		...
		this.toolbar = new MWF.xApplication.WorkApplication.Toolbar(this.toolBarNode, this, {
...
MWF.xApplication.WorkApplication.AllList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.TaskList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.TaskDoneList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.ReadList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.ReadDoneList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.DraftList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.WorkList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.WorkCompletedList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.SnapList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.DictList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.SerialList = new Class({
	Extends: MWF.xApplication.WorkApplication.List,
	loadData: function(){
		var _self = this;
...
MWF.xApplication.WorkApplication.Toolbar = new Class({
	...
	addSerial: function(){
		...
		var form = new MWF.xApplication.WorkApplication.AddSerSialForm(this.explorer, data, {
		}, {
			app: this.app
		});
		form.edit()
	...
	setSerial : function(){
		...
		if (this.explorer.selectedList && this.explorer.selectedList.length){
			var data = this.explorer.selectedList[0];
			var form = new MWF.xApplication.WorkApplication.SetSerSialForm(this.explorer, data, {
			}, {
				app: this.app
			});
			form.edit()
	...
	manage : function (){
		...
		if(this.type === "workCompleted"){
			form = new MWF.xApplication.WorkApplication.ManageWorkCompletedForm({app: this.app}, this.explorer.selectedList[0] );
		}else{
			form = new MWF.xApplication.WorkApplication.ManageWorkForm({app: this.app}, this.explorer.selectedList[0] );
		}
		form.open();
	},
	jump: function(){
...
MWF.xApplication.WorkApplication.AddSerSialForm = new Class({
	Extends: MPopupForm,
	Implements: [Options, Events],
	options: {
		"style": "attendanceV2",
...
MWF.xApplication.WorkApplication.SetSerSialForm = new Class({
	Extends: MPopupForm,
	Implements: [Options, Events],
	options: {
		"style": "attendanceV2",
...
MWF.xApplication.WorkApplication.ManageWorkForm = new Class({
	Extends: MPopupForm,
	Implements: [Options, Events],
	options: {
		"style": "attendanceV2",
		...
		"resizeable" : true,
		"closeAction": true,
		"title": MWF.xApplication.WorkApplication.LP.adminwork,
...
MWF.xApplication.WorkApplication.ManageWorkCompletedForm = new Class({
	Extends: MWF.xApplication.WorkApplication.ManageWorkForm,
	loadTab : function (){
