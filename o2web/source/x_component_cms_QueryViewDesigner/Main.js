...
MWF.xDesktop.requireApp("cms.QueryViewDesigner", "View", null, false);
MWF.xApplication.cms.QueryViewDesigner.Main = new Class({
	Extends: MWF.xApplication.Common.Main,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"name": "cms.QueryViewDesigner",
		"icon": "icon.png",
		"title": MWF.CMSQVD.LP.title,
		"appTitle": MWF.CMSQVD.LP.title,
		"id": "",
        "tooltip": {
            "unCategory": MWF.CMSQVD.LP.unCategory
        },
		"actions": null,
		"category": null,
		"processData": null
	...
	onQueryLoad: function(){
		...
		if (!this.options.id){
			...
			this.options.title = this.options.title + "-"+MWF.CMSQVD.LP.newView;
		}
		if (!this.actions) this.actions =  MWF.Actions.get("x_cms_assemble_control"); //new MWF.xApplication.cms.ColumnManager.Actions.RestActions();
		
		this.lp = MWF.xApplication.cms.QueryViewDesigner.LP;
    ...
    getApplication:function(callback){
        ...
        if (!this.application){
            this.actions.getColumn( (typeOf( application )=="object" ? application.id : application) , function(json){
	...
	loadNodes: function(){
        this.viewListNode = new Element("div.viewListNode", {
            "styles": this.css.viewListNode
        }).inject(this.node);
		this.propertyNode = new Element("div.propertyNode", {
    ...
    loadViewListNodes: function(){
        this.viewListTitleNode = new Element("div.viewListTitleNode", {
            "styles": this.css.viewListTitleNode,
            "text": MWF.CMSQVD.LP.view
        }).inject(this.viewListNode);

        this.viewListResizeNode = new Element("div.viewListResizeNode", {"styles": this.css.viewListResizeNode}).inject(this.viewListNode);
        this.viewListAreaSccrollNode = new Element("div.viewListAreaSccrollNode", {"styles": this.css.viewListAreaSccrollNode}).inject(this.viewListNode);
        this.viewListAreaNode = new Element("div.viewListAreaNode", {"styles": this.css.viewListAreaNode}).inject(this.viewListAreaSccrollNode);
...
//				var y = e.event.y;
    ...
    loadViewList: function(){
        this.actions.listQueryView(this.application.id, function (json) {
    ...
    loadViewByData: function(node, e){
        ...
        if (openNew){
            ...
            //    var view = new MWF.xApplication.cms.QueryViewDesigner.View(this, vdata);
            //    view.load();
            //}.bind(this));
            ...
            this.desktop.openApplication(e, "cms.QueryViewDesigner", options);
        }
    },
	...
	loadProperty: function(){
		this.propertyTitleNode = new Element("div.propertyTitleNode", {
            ...
            "text": MWF.CMSQVD.LP.property
        }).inject(this.propertyNode);

        this.propertyResizeBar = new Element("div.propertyResizeBar", {
        ...
        this.propertyDomArea = new Element("div.propertyDomArea", {
			"styles": this.css.propertyDomArea
		}).inject(this.propertyContentNode);
		
		this.propertyDomPercent = 0.3;
		this.propertyContentResizeNode = new Element("div.propertyContentResizeNode", {
...
//				var y = e.event.y;
    ...
    loadView: function(callback){
		this.getViewData(this.options.id, function(vdata){
            ...
            //}else{
                this.view = new MWF.xApplication.cms.QueryViewDesigner.View(this, vdata);
            //}
    ...
    loadViewData: function(id, callback){
		this.actions.getQueryView(id, function(json){
			if (json){
				var data = json.data;
        ...
        //if (this.tab.showPage){
            ...
            this.view.save(function(){
                //if (view==this.view){
                    ...
                    this.setTitle(MWF.CMSQVD.LP.title + "-"+name);
