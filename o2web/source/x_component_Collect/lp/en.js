...
MWF.xApplication.Collect.LP={
	...
	"disconnectInfo": "The O2 platform requires your O2 central server to be able to access the O2 cloud to use all the cool features. This requires your server to be able to access the Internet, but this is not mandatory.You can use the O2 platform in a closed private network environment, but you cannot use functions such as mobile office and short message service.",
