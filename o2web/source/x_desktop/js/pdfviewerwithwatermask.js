...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: '../o2_lib/pdfjs/web/debugger.js'
  };
}
...
{
  webViewerOpenFileViaURL = async function webViewerOpenFileViaURL(file) {
    ...
    if (file) {
      // 使用pdf-lib 添加水印
      const watermaskPdf = await addWatermask(file);
      PDFViewerApplication.open(watermaskPdf);
    }
  };
}
...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('../o2_lib/pdfjs/build/pdf.js');
}
...
var defaultOptions = {
  ...
  workerSrc: {
    value: '../o2_lib/pdfjs/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
...
function o2GetCanvasTextWidth(text, font) {
  // re-use canvas object for better performance
  var canvas = o2GetCanvasTextWidth.canvas || (o2GetCanvasTextWidth.canvas = document.createElement("canvas"));
