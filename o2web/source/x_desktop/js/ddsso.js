            ...
            (function(){
                layout.load = function(){
                    ...
                    MWF.require("MWF.xDesktop.Actions.RestActions", function(){
                        ...
                        action.invoke({"name": "info","async": true, "data": {"url": href},"success": function(json){
                                ...
                                dd.runtime.permission.requestAuthCode({
                                    ...
                                    corpId : _config.corpId,
                                    onSuccess : function(info) {
                                        action.invoke({"name": "auth","async": true, "parameter": {"code": info.code},"success": function(json){
