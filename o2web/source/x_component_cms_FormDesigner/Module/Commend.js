...
MWF.xApplication.cms.FormDesigner.Module.Commend = MWF.CMSFCCommend = new Class({
	Extends: MWF.FC$Element,
	Implements: [Options, Events],
	options: {
		"style": "default",
		"propertyPath": "../x_component_cms_FormDesigner/Module/Commend/commend.html"
	},

	initialize: function(form, options){
		this.setOptions(options);

		this.path = "../x_component_cms_FormDesigner/Module/Commend/";
		this.cssPath = "../x_component_cms_FormDesigner/Module/Commend/"+this.options.style+"/css.wcss";

		this._loadCss();
		this.moduleType = "element";
		this.moduleName = "commend";
