...
MWF.xApplication.cms.FormDesigner.Module.Authorfield = MWF.CMSFCAuthorfield = new Class({
	Extends: MWF.FC$Element,
	Implements : [MWF.CMSFCMI],
	options: {
		"style": "default",
		"propertyPath": "/x_component_cms_FormDesigner/Module/Authorfield/authorfield.html"
	},
	initialize: function(form, options){
		this.setOptions(options);

		this.path = "/x_component_cms_FormDesigner/Module/Authorfield/";
		this.cssPath = "/x_component_cms_FormDesigner/Module/Authorfield/"+this.options.style+"/css.wcss";

		this._loadCss();
		this.moduleType = "element";
		this.moduleName = "authorfield";
	...
	_createMoveNode: function(){
		...
		var icon = new Element("div", {
			"styles": this.css.authorfieldIcon
	...
	_loadNodeStyles: function(){
		...
		icon.setStyles(this.css.authorfieldIcon);
