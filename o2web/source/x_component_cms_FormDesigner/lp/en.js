...
MWF.xApplication.cms.FormDesigner.LP={
	...
	"propertyTemplate": {
		...
		"allowJumper": "Allow page skipping",
		"usePagination": "Use pagination",
		"itemCount": "Total number of articles",
		...
		"calculationView": "Calculate View",
		"viewScript": "View Script",
		"nameAliasID": "Name, alias, and ID",
		"calculation": "count",
		...
		"power": "permission",
		"enableHour": "Effective hours",
		"enableMinute": "Effective minutes",
		"enableSecond": "Effective seconds",
		"enableYear": "Effective year",
		"enableMonth": "Effective months",
		"usePreset": "Use preset settings",
		"custom": "customize",
		"currency": "currency",
		"prefixUse": "Prefix usage",
		"isoCode": "ISO coding",
		"symbol": "currency symbol",
		"thousands": "thousandth",
		"allowBlank": "Allow Nulls",
		"disableNegative": "Prohibition of negative numbers",
		"round": "round off",
		"precision2": "Number of decimal places",
		"readConfig": "Readable configuration",
		"readConfigInfo": "Set the readable range of this element. If not set, it means that all users who have permission to view this document can read it. Note: When determining whether the current element is readable, it will check whether its parent element is readable. If the parent element is unreadable, the current element will also be unreadable; If the parent element is readable, then determine the readable configuration of the current element.",
		"readConfig_activity": "The specified activity is readable",
		"readConfig_org": "Designated person or organization readable",
		"readConfig_script": "Judging readability through scripts",
		"readActivity": "Visible activities",
		"readOrg": "personnel organization",
		"readScript": "Readable script",
		"readScriptInfo": "Return a Boolean value, true indicates readability, false indicates unreadability",
		"hideCannotRead": "Hide unreadable elements",
		"editConfig": "Edit Configuration",
		"editConfigInfo": "Set the editable range of this element. If not set, it means that users with editing permissions for this document (usually the current handler) can edit this element. Note: When determining whether the current element is editable, it will check whether its parent element is editable. If the parent element is not editable, the current element is also not editable; If the parent element is editable, then determine the editable configuration of the current element. If the current element is editable, then it must be readable. Ignore the readable configuration at this time.",
		"editConfig_activity": "Editable during designated activities",
		"editConfig_org": "Designated person or organization editable",
		"editConfig_script": "Judging editable through scripts",
		"editActivity": "Editable activity",
