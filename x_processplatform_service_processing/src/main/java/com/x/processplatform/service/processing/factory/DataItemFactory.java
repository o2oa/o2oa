...
public class DataItemFactory extends AbstractFactory {
	...
	public DataItemFactory(Business business) throws Exception {
		super(business);
	}
	...
	public DataItem getWithJobWithPath(String job, String path0, String path1, String path2, String path3, String path4, String path5, String path6, String path7)
			throws Exception {
		EntityManager em = this.entityManagerContainer().get(DataItem.class);
		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<DataItem> cq = cb.createQuery(DataItem.class);
		...
		throw new Exception("error mulit dataItem{job:" + job + ", path0:" + path0 + ", path1:" + path1 + ", path2:" + path2 + ", path3:" + path3 + ", path4:" + path4 + ", path5:"
	...
	public List<DataItem> listWithJobWithPathWithAfterLocation(String job, Integer index, String... paths) throws Exception {
		EntityManager em = this.entityManagerContainer().get(DataItem.class);
		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<DataItem> cq = cb.createQuery(DataItem.class);
		Root<DataItem> root = cq.from(DataItem.class);
