package com.x.processplatform.service.processing.processor.condition;
...
public class ConditionProcessor extends AbstractProcessor {
	...
	private static Logger logger = LoggerFactory.getLogger(ConditionProcessor.class);

	public ConditionProcessor(EntityManagerContainer entityManagerContainer) throws Exception {
