...
public class ExcuteListDelegatedPrevWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListDelegatedPrevWithFilter.class );
