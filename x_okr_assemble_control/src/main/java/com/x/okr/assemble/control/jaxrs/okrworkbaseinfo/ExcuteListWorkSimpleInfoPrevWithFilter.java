...
public class ExcuteListWorkSimpleInfoPrevWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListWorkSimpleInfoPrevWithFilter.class );
