...
public class ExcuteListWorkSimpleInfoNextWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListWorkSimpleInfoNextWithFilter.class );
