...
public class ExcuteListProcessWorkInCenterForForm extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListProcessWorkInCenterForForm.class );
			...
			try{		
				...
				if( okrWorkBaseInfoList != null ){
					for( OkrWorkBaseInfo okrWorkBaseInfo : okrWorkBaseInfoList ){
						...
						wrapOutOkrWorkBaseInfo = wrapout_copier_worksimple.copy( okrWorkBaseInfo );
