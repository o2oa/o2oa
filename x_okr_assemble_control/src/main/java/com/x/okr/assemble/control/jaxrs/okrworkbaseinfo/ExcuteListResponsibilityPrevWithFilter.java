...
public class ExcuteListResponsibilityPrevWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListResponsibilityPrevWithFilter.class );
