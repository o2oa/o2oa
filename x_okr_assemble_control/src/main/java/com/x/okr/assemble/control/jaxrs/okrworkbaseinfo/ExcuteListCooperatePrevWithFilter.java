...
public class ExcuteListCooperatePrevWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListCooperatePrevWithFilter.class );
