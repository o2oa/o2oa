...
public class ExcuteListByProcessIdentityPrevWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListByProcessIdentityPrevWithFilter.class );
