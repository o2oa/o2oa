...
import com.x.okr.assemble.control.jaxrs.okrworkreportpersonlink.WrapInOkrWorkReportPersonLink;
...
public class OkrWorkReportPersonLinkService{
	private Logger logger = LoggerFactory.getLogger( OkrWorkReportPersonLinkService.class );
	private BeanCopyTools<WrapInOkrWorkReportPersonLink, OkrWorkReportPersonLink> wrapin_copier = BeanCopyToolsBuilder.create( WrapInOkrWorkReportPersonLink.class, OkrWorkReportPersonLink.class, null, WrapInOkrWorkReportPersonLink.Excludes );
	/**
	 ...
	 * @param wrapIn
	 */
	public OkrWorkReportPersonLink save( WrapInOkrWorkReportPersonLink wrapIn ) throws Exception {
		...
		//根据ID查询信息是否存在，如果存在就update，如果不存在就create
			try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
				...
				if( okrWorkReportPersonLink != null ){
					...
					wrapin_copier.copy( wrapIn, okrWorkReportPersonLink );
	 ...
	 * @throws Exception 
	 */
	public List<OkrWorkReportPersonLink> listNextWithFilter( String id, Integer count, WrapInFilter wrapIn ) throws Exception {
		Business business = null;
	 ...
	 * @throws Exception 
	 */
	public List<OkrWorkReportPersonLink> listPrevWithFilter( String id, Integer count, WrapInFilter wrapIn ) throws Exception {
		Business business = null;
		Object sequence = null;
		List<OkrWorkReportPersonLink> okrWorkReportPersonLinkList = new ArrayList<OkrWorkReportPersonLink>();
		if( count == null ){
