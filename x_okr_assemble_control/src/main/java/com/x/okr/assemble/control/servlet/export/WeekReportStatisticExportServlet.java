...
public class WeekReportStatisticExportServlet extends AbstractServletAction {
	...
	protected void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException {
		...
		if (check) {
			...
			if( file.exists() ){
				...
				response.setHeader("Content-Disposition", "fileInfo; filename=" + URLEncoder.encode("汇报情况统计.xls", "utf-8"));
