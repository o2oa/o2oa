...
public class ExcuteListDelegatedNextWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListDelegatedNextWithFilter.class );
