...
public class ExcuteListResponsibilityNextWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListResponsibilityNextWithFilter.class );
