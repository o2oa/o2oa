...
@Wrap( WrapOutOkrReportSubmitStatusStatisticEntity.class)
public class WrapOutOkrReportSubmitStatusStatisticEntity{
	...
	private List<WrapOutOkrReportSubmitStatusStatisticEntity> array = null;
	...
	public List<WrapOutOkrReportSubmitStatusStatisticEntity> getArray() {
		return array;
	}

	public void setArray(List<WrapOutOkrReportSubmitStatusStatisticEntity> array) {
		this.array = array;
	}
