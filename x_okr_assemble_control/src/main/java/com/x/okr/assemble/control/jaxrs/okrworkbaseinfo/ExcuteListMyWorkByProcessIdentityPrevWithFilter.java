...
public class ExcuteListMyWorkByProcessIdentityPrevWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListMyWorkByProcessIdentityPrevWithFilter.class );
