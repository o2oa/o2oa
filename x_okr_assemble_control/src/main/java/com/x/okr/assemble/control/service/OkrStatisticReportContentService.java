				...
				for( String id : ids  ){
					...
					if( _statisticReportContent != null ){
						if( count == 0 ){
							...
							_statisticReportContent.setResponsibilityCompanyName( statisticReportContent.getResponsibilityCompanyName() );
							...
							_statisticReportContent.setResponsibilityOrganizationName( statisticReportContent.getResponsibilityOrganizationName() );
