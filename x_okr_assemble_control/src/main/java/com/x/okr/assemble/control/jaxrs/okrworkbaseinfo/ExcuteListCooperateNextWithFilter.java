...
public class ExcuteListCooperateNextWithFilter extends ExcuteBase {

	private Logger logger = LoggerFactory.getLogger( ExcuteListCooperateNextWithFilter.class );
