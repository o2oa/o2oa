...
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.AppCatagoryPermission.table )
@Inheritance( strategy = InheritanceType.TABLE_PER_CLASS)
public class AppCatagoryPermission extends SliceJpaObject {

	private static final long serialVersionUID = 3856138316794473794L;
	private static final String TABLE = PersistenceProperties.AppCatagoryPermission.table;
	...
	@EntityFieldDescribe( "使用者类别：组织|人员" )
