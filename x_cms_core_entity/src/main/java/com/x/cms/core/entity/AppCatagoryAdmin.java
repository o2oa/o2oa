...
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.AppCatagoryAdmin.table )
@Inheritance( strategy = InheritanceType.TABLE_PER_CLASS)
public class AppCatagoryAdmin extends SliceJpaObject {

	private static final long serialVersionUID = 3856138316794473794L;
	private static final String TABLE = PersistenceProperties.AppCatagoryAdmin.table;
