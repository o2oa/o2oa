...
public class Log_ extends SliceJpaObject_  {
    ...
    public static volatile SingularAttribute<Log,String> catagoryId;
    public static volatile SingularAttribute<Log,Date> createTime;
    ...
    public static volatile SingularAttribute<Log,String> sequence;
    public static volatile SingularAttribute<Log,Date> updateTime;
}
