...
@Entity
@ContainerEntity
@Table(name = PersistenceProperties.Element.ViewCatagory.table)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class ViewCatagory extends SliceJpaObject {

	private static final long serialVersionUID = 3263767038182121907L;
	private static final String TABLE = PersistenceProperties.Element.ViewCatagory.table;
