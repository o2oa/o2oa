...
public class CommandFactory {
	...
	public static void printHelpLine() {
		try {
			...
			help += StringUtils.LF;
			help += " erase content (cms|pp|bss|log|report) (passwd)" + "\t\t" + "remove all data except design.";
			help += StringUtils.LF;
