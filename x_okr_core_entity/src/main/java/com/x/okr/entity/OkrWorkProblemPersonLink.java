...
/**
 * 工作问题请示处理链信息，记录工作问题请示的处理人信息以及步骤信息，流程按处理人链一步一步执行
 * 形成一个简易的流程控制过程
 * @author LIYI
 */
@ContainerEntity
@Entity
@Table(name = PersistenceProperties.OkrWorkProblemPersonLink.table)
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
public class OkrWorkProblemPersonLink extends SliceJpaObject {

	private static final long serialVersionUID = 3856138316794473794L;
	private static final String TABLE = PersistenceProperties.OkrWorkProblemPersonLink.table;
