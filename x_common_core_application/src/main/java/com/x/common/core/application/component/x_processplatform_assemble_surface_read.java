...
public class x_processplatform_assemble_surface_read extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_read o = new x_processplatform_assemble_surface_read();
