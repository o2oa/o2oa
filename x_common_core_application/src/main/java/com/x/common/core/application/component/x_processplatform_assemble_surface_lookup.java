...
public class x_processplatform_assemble_surface_lookup extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_lookup o = new x_processplatform_assemble_surface_lookup();
