...
public class x_processplatform_assemble_surface_worklog extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_worklog o = new x_processplatform_assemble_surface_worklog();
