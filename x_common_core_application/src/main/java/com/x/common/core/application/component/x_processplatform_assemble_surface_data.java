...
public class x_processplatform_assemble_surface_data extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_data o = new x_processplatform_assemble_surface_data();
