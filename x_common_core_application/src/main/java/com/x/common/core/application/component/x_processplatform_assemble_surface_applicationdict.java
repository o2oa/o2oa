...
public class x_processplatform_assemble_surface_applicationdict extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_applicationdict o = new x_processplatform_assemble_surface_applicationdict();
