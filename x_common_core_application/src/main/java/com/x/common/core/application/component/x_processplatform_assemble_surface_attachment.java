...
public class x_processplatform_assemble_surface_attachment extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_attachment o = new x_processplatform_assemble_surface_attachment();
