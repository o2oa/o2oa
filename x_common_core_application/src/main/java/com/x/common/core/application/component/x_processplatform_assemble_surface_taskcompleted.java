...
public class x_processplatform_assemble_surface_taskcompleted extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_taskcompleted o = new x_processplatform_assemble_surface_taskcompleted();
