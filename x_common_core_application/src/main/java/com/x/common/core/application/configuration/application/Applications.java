...
public class Applications extends ConcurrentHashMap<String, CopyOnWriteArrayList<Application>> {
	...
	private HttpURLConnection prepareConnection(Application application, String uri) throws Exception {
		...
		// if (null == ThisApplication.cipher ||
		// StringUtils.isEmpty(ThisApplication.center.getCipher())) {
		// throw new Exception("can not get cipher");
		// }
		...
		// httpUrlConnection.setRequestProperty(HttpAttribute.x_cipher,
		// ThisApplication.center.getCipher());
