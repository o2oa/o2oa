...
public class x_processplatform_assemble_surface_work extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_work o = new x_processplatform_assemble_surface_work();
