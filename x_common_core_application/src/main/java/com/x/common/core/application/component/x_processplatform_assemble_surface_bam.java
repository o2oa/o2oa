...
public class x_processplatform_assemble_surface_bam extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_bam o = new x_processplatform_assemble_surface_bam();
