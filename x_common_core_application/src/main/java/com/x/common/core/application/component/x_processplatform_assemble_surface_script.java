...
public class x_processplatform_assemble_surface_script extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_script o = new x_processplatform_assemble_surface_script();
