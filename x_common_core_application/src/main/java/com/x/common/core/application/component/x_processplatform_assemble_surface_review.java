...
public class x_processplatform_assemble_surface_review extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_review o = new x_processplatform_assemble_surface_review();
