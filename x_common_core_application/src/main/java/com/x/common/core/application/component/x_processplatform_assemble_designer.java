...
public class x_processplatform_assemble_designer extends Assemble {
	...
	static {
		...
		containerEntities.add("com.x.processplatform.core.entity.element.View");
	}
	...
	protected void custom(File dir, String repositoryPath) throws Exception {
		...
		FileUtils.copyDirectory(repository, lib, new WildcardFileFilter("x_processplatform_core_*.jar"));
	}
