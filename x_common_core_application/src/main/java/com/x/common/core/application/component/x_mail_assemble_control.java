...
public class x_mail_assemble_control extends Assemble {

	public static List<String> containerEntities = new ArrayList<>();

	static {
		containerEntities.add("com.x.mail.core.entity.Account");
	}
	...
	protected void custom(File dir, String repositoryPath) throws Exception {
		...
		FileUtils.copyDirectory(repository, lib, new WildcardFileFilter("x_mail_core_entity*.jar"));
	}
	...
	public static void main(String[] args) {
		try {
			...
			x_mail_assemble_control o = new x_mail_assemble_control();
