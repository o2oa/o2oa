...
public class x_processplatform_assemble_surface_query extends Assemble {
	...
	static {
		...
		containerEntities.add("com.x.processplatform.core.entity.query.QueryScheme");
	}
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_query o = new x_processplatform_assemble_surface_query();
