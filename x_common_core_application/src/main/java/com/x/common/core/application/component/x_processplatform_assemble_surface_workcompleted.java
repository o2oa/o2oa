...
public class x_processplatform_assemble_surface_workcompleted extends Assemble {
	...
	public static void main(String[] args) {
		try {
			...
			x_processplatform_assemble_surface_workcompleted o = new x_processplatform_assemble_surface_workcompleted();
